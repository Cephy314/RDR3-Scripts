...
void func_58(var uParam0, bool bParam1, bool bParam2)
{
	...
	if (bVar3)
	{
		...
		else if (uParam0->f_37 == -1)
		{
			...
			bVar8 = func_131(bParam1, bParam2, bVar2, 0);
			if (iVar7 == -1)
			{
				iVar7 = bVar8;
			}
			...
			uParam0->f_37 = func_132(iVar7, bVar8);
		}
	}
	if (func_70(uParam0[1]))
	{
	...
	if (bParam4 || func_121(bVar0, uParam0->f_52))
	{
		if (bParam1)
		{
			if (DATABINDING::_DATABINDING_IS_DATA_ID_VALID(((*Global_1911914)[bParam2 /*9*/])->f_1))
			{
				...
				DATABINDING::_DATABINDING_INSERT_UI_ITEM_TO_LIST_FROM_CONTEXT_HASH_ALIAS(uParam0->f_40, uParam0->f_56, joaat("CRAFTING_LIST_ITEM"), ((*Global_1911914)[bParam2 /*9*/])->f_1);
			}
			else
			{
		...
		if (func_248(bParam0))
		{
			...
			if (func_257() && func_258(4))
			{
				if (!Global_1914319->f_17376)
				{
					if (func_257() && (func_259(38) || func_253(38)))
					{
						func_263(38, COLLECTION::_0x13AAECDA43318BFE(joaat("CIGARETTE_CARDS"), iVar6), COLLECTION::_0xD52D20B0C76BB26D(joaat("CIGARETTE_CARDS"), iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
...
int func_234(bool bParam0, int iParam1)
{
	...
	if (func_392(Var14, iParam1))
	{
		if (func_393(bParam0))
		{
			if (func_394(joaat("SLOTID_HORSE_HORN"), &bVar18))
			{
		...
		{
			if (func_394(joaat("SLOTID_HORSE_HORN"), &bVar19))
			{
				if (func_234(bVar19, 0))
				{
				}
			}
			if (func_394(joaat("SLOTID_HORSE_STIRRUP"), &bVar20))
			{
...
int func_237()
{
	...
	{
		bVar14 = func_395(Var5, joaat("SLOTID_HORSE_SADDLE"), 0);
	}
	if (!func_21(bVar14, 0))
	{
		return 0;
		...
		while (iVar28 < 4)
		{
			...
			if (func_205(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_80(0))
				{
					...
					func_267(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), bParam1, iParam6);
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_149(bParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_IS_WEAPON_MELEE(bVar0))
			{
				...
				{
					func_266(bVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
bool func_305()
{
	...
	return func_404(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("CIGARETTE_CARDS"), 0));
}
...
void func_308(bool bParam0)
{
	...
	{
		if (!func_483(joaat("MP_COMPONENT_TYPE_LOADOUT_3")))
		{
...
void func_425(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_421("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_421("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_421("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_421("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 24:
			...
			if (func_23() == -1)
			{
				if (!func_483(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) || func_569(joaat("MP_COMPONENT_TYPE_LOADOUT_3")) == 2110595215)
				{
					if (func_429())
					{
...
void func_426(bool bParam0, bool bParam1)
{
	...
	{
		iVar1 = func_132(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), bParam1);
