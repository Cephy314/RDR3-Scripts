...
void func_255(struct<5> Param0, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, var uParam10, var uParam11, var uParam12, var uParam13, int iParam14)
{
	...
	if (func_161(Param0.f_4, 0))
	{
		...
		func_540(-1553587059, sVar1, &vVar3, bVar0, iVar7, bVar2, sVar6, joaat("COLOR_PURE_WHITE"));
...
void func_284(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_569(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_569(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
void func_406(bool bParam0)
{
	...
	switch (bParam0)
	{
		case 1369162587: /* GXTEntry: "Hunting Request" */
			...
			func_150(437, 0);
			func_150(440, 0);
			func_689(-949689219, 444160793 /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
			func_285(51, 0, 0, -949689219, sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_572(-949689219, 20), 1, 0);
			func_286(1);
			func_690(-748969569, 0, 0);
			break;
		case 1610047510: /* GXTEntry: "Hunting Request" */
			COLLECTION::_0x3EA62E56F386C997(-1248968496, 1);
			func_689(-1248968496, -1969404854 /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
			func_285(51, 0, 0, -1248968496, sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_572(-1248968496, 20), 1, 0);
			func_286(8);
			break;
		case 1317879106: /* GXTEntry: "Hunting Request" */
			COLLECTION::_0x3EA62E56F386C997(1706369307, 1);
			func_689(1706369307, -832850511 /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
			func_285(51, 0, 0, 1706369307, sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_572(1706369307, 20), 1, 0);
			func_286(64);
			break;
		case 1062444751: /* GXTEntry: "Hunting Request" */
			COLLECTION::_0x3EA62E56F386C997(1520110311, 1);
			func_689(1520110311, -100913452 /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
			func_285(51, 0, 0, 1520110311, sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_572(1520110311, 20), 1, 0);
			func_286(512);
			break;
		case 754186760: /* GXTEntry: "Hunting Request" */
			COLLECTION::_0x3EA62E56F386C997(-1992824800, 1);
			func_150(438, 0);
			func_689(-1992824800, 905173572 /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
			func_285(51, 0, 0, -1992824800, sVar0, 0, -1, 0);
			func_284(51, 0, 0, sVar0, func_572(-1992824800, 20), 1, 0);
			func_286(32768);
			break;
		default:
			func_150(439, 0);
...
void func_421(int iParam0, bool bParam1)
{
	...
	func_569(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
			...
			if (func_111(bParam0, 412399755))
			{
				...
				if (func_692() == 0)
				{
					...
					if (((bParam0 == 281887510 || bParam0 == -164081697) || bParam0 == -1161319399) || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_694(bParam0) < func_695(bParam0))
						{
							func_285(43, bParam0, bParam1, -1791518714, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(bParam0, 709057512))
			{
				...
				if (func_692() == 1)
				{
					...
					if ((bParam0 == -222563712 || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || bParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_694(bParam0) < func_695(bParam0))
						{
							func_285(43, bParam0, bParam1, -2087881550, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(bParam0, -1478961327))
			{
				...
				if (func_692() == 2)
				{
					...
					if (((bParam0 == 2116770557 || bParam0 == joaat("PROVISION_RO_FLOWER_ACUNAS_STAR")) || bParam0 == joaat("PROVISION_RO_FLOWER_CIGAR")) || bParam0 == joaat("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_694(bParam0) < func_695(bParam0))
						{
							func_285(43, bParam0, bParam1, 1908068621, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(bParam0, -1238404098))
			{
				...
				if (func_692() == 3)
				{
					...
					if (((bParam0 == 2085530337 || bParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || bParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_694(bParam0) < func_695(bParam0))
						{
							func_285(43, bParam0, bParam1, 1611247019, iVar0, 1, -1, 0);
						}
					}
				}
			}
			...
			if (func_111(bParam0, 1160548794))
			{
				...
				if (func_692() == 4)
				{
					...
					if (((bParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || bParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || bParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_694(bParam0) < func_695(bParam0))
						{
							func_285(43, bParam0, bParam1, 1319635688, iVar0, 1, -1, 0);
						}
					}
				}
			}
...
int func_776(int iParam0, int iParam1, bool bParam2)
{
	...
	if ((((((((((((((((((((bVar0 == 444160793 || bVar0 == -1969404854) || bVar0 == 1761263432) || bVar0 == -843795569) || bVar0 == -832850511) || bVar0 == -1464585113) || bVar0 == -1290897778) || bVar0 == -100913452) || bVar0 == 313332607) || bVar0 == -124539232) || bVar0 == 59384454) || bVar0 == 905173572) || bVar0 == 1432949803) || bVar0 == -983831788) || bVar0 == -1882344824) || bVar0 == 323124696) || bVar0 == joaat("PROVISION_FISH_CHAIN_PICKEREL_LEGENDARY")) || bVar0 == joaat("PROVISION_FISH_PERCH_LEGENDARY")) || bVar0 == -1114363619) || bVar0 == joaat("PROVISION_FISH_ROCK_BASS_LEGENDARY")) || bVar0 == -1490884871)
	{
		if (func_257(bVar0, 1, 0))
		{
			if (bParam2)
	...
	else if ((((((((((bVar0 == 102446365 || bVar0 == 924882045) || bVar0 == -935543049) || bVar0 == -1866642239) || bVar0 == joaat("PROVISION_FISH_LAKE_STURGEON_LEGENDARY")) || bVar0 == -804542901) || bVar0 == joaat("PROVISION_FISH_MUSKIE_LEGENDARY")) || bVar0 == -787702678) || bVar0 == 1997759228) || bVar0 == 1265573293) || bVar0 == joaat("PROVISION_FISH_STEELHEAD_TROUT_LEGENDARY"))
	{
