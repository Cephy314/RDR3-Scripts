...
int func_11()
{
	...
	bLocal_15 = VOLUME::_CREATE_VOLUME_SPHERE(1322.59f, -2285.19f, 51.316f, 0f, 0f, 0f, 0.25f, 0.25f, 0.25f);
	PED::_0x4C39C95AE5DB1329(bLocal_15, false, 16);
	return 1;
}
...
int func_38(int iParam0)
{
	...
	if (!func_59(-2019549022 /* GXTEntry: "Letter to Nate from Momma" */, 1, 0))
	{
		if (!func_60(4))
		{
...
void func_51(int iParam0, int iParam1, int iParam2)
{
	...
	(Global_1392240->f_1[iParam0 /*18*/])->f_6[iParam1] = func_97(iParam2, 0, 0);
}
...
void func_64()
{
	...
	iVar0 = INTERIOR::GET_INTERIOR_AT_COORDS(func_122(2));
	bVar1 = false;
	...
	if (func_103(2, 2))
	{
		...
		if (iVar6 > 2 || func_124(2, 2))
		{
			...
			func_129(2);
			func_130(2, 2);
			iVar9 = func_131(-658146346);
			if (!GRAPHICS::_0x113857D66A9CABE6(iVar9))
			{
				return;
			}
			GRAPHICS::_0xBFCB17895BB99E4E(iVar9, false);
		}
		else
		{
			...
			iVar10 = func_131(-658146346);
			if (!GRAPHICS::_0x113857D66A9CABE6(iVar10))
			{
				return;
			}
			GRAPHICS::_0xBFCB17895BB99E4E(iVar10, false);
		}
	}
	else
	{
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_150(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_150(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_150(&cVar6, joaat("COLOR_PURE_WHITE")), func_150(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_156(func_155(-1532769513, joaat("areas")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_156(func_155(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_156(func_155(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_156(func_155(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_156(func_155(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_156(func_155(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_156(func_155(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_85(int iParam0)
{
	...
	{
		iVar0 = func_131(-658146346);
		if (!GRAPHICS::_0x113857D66A9CABE6(iVar0))
		{
			return;
		}
		GRAPHICS::_0xBFCB17895BB99E4E(iVar0, false);
		func_165(2);
	}
	func_166(2, 4);
	func_166(2, 32);
...
void func_88(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_170(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
bool func_102(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_186(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
int func_104(int iParam0)
{
	...
	return func_186(((*Global_1392626)[iParam0 /*32*/])->f_3, 1);
}
...
void func_107()
{
	...
	func_187(2, 1073741824 /* Float: 2f */);
...
int func_116(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_194(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_123(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
...
char* func_150(char* sParam0, int iParam1)
{
	...
	return func_204(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_153(int iParam0)
{
	...
	if (func_205())
	{
		if (!func_186(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_209((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_210((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_168(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_170(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_189(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_196(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_242(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_198(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_244(&(Global_1898164->f_1[0 /*5*/]));
		if (func_226(iVar0) && func_245(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
struct<4> func_233(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_262(923904168, func_261(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_262(923904168, func_261(bParam0), -740156546, 0) };
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_264(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
