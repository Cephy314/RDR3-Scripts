...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 1.1f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -3.164f, 4.284f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_152(uParam0, -0.782636f, -2.05975f, 1.03457f, 0f, 1f, 1f, 5f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_KNIFE01X"), 0f, 0f, 0f, "KNIFE", 0, 0, 1);
	func_153(uParam0, joaat("P_WOODWHITTLE02X"), 0f, 0f, 0f, "WHITTLE", 0, 0, 1);
	func_154(uParam0, "script@vignette@micah_6@base", 1, 1, 0, 0);
	iLocal_15 = func_154(uParam0, "script@vignette@micah_6@action_a", 2, 0, 1, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@micah_6@action_b", 2, 0, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@micah_6@action_b_alt_front", 2, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@micah_6@action_b_alt_back", 2, 0, 0, 0);
	iLocal_19 = func_154(uParam0, "script@vignette@micah_6@exit", 0, 0, 0, 0);
	func_155(uParam0, iLocal_14, 3, -1);
	func_156(uParam0, "CMCH6AU");
	Local_20 = { func_157(uParam0, 0.673f, -1.2f, 0.77f, 98.64f, 7f, 0.4f, 0.4f) };
	Local_30 = { func_157(uParam0, -0.883f, -1.2f, 0.77f, -66.24f, 7f, 0.4f, 0.4f) };
	return 1;
}
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_206(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_224(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_226(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_187(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_287(uParam0, iVar1) || func_195(uParam0, iVar1))
			{
...
float func_206(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_302(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
bool func_277(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_330(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
int func_320(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_330(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_382(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_417(iParam0, func_278());
...
void func_393(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_222(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_222(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_222(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_222(iParam5, 32), true);
	...
	else if (func_222(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_222(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_222(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_385(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
