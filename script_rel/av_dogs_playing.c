...
{
	func_33(uParam0, 10911, 10983, 11995);
}
...
{
	func_46(uParam0, "DOGS_PLAYING_TOGETHER", "script@ambient@animal@DOGS_PLAYING_TOGETHER@action", vParam1, vParam4);
	uParam0->f_16 = 1;
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "DOG1", joaat("A_C_DogAmericanFoxhound_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "DOG2", joaat("A_C_DogBlueTickCoonHound_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
{
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_ANIMAL_DOG_RESTING"), 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_ANIMAL_DOG_RESTING"), 1, 0, 0);
	func_56(&uLocal_9, 0);
	func_57(&uLocal_9, 1);
	func_58(&uLocal_9, 1);
	func_59(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (bLocal_37)
		{
			...
			if (!&uParam0->f_469[6])
			{
				if (func_67(uParam0, 3f, 50f, 4, joaat("ACTION"), 1))
				{
							...
							if (!&uParam0->f_469[5])
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
								{
									if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
									{
										...
										TASK::TASK_ANIMAL_UNALERTED(&(uParam0->f_20[1 /*14*/]), -1, false, 0, 0);
...
int func_163(int iParam0, var uParam1)
{
	...
	else if (func_155() - uParam1->f_4) > func_212(uParam1)
	{
