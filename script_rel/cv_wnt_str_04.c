...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(bVar0, 0))
	{
		if (func_131(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
int func_298(var uParam0, var uParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		if (func_377(iVar1, Global_35, 16, -1, 0, 0, 5))
		{
...
void func_321(var uParam0, var uParam1)
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(bVar0, joaat("SCRIPT_TASK_FOLLOW_AND_CONVERSE_WITH_PED"), true) != 1)
	{
		return;
	}
...
int func_348()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_408(Global_35))
	{
		return 1;
	}
	return 0;
...
bool func_395(bool bParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
bool func_444(bool bParam0, var uParam1)
{
...
int func_502(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_535(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_503(bool bParam0, int iParam1)
{
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_250(iParam1), bParam0, 0);
...
void func_566(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_583(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
