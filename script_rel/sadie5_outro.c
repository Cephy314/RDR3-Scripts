...
int func_21(var uParam0)
{
	...
	if (func_45(((*Global_1835011)[72 /*74*/])->f_1) == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(bLocal_15))
		{
			...
			PED::_0x1902C4CFCC5BE57C(bLocal_15, iLocal_17);
			PED::_0xCC8CA3E88256E58F(bLocal_15, true, true, true, true, false);
			return 0;
		}
		func_26(1);
		if (!func_47(512))
...
void func_200(bool bParam0, bool bParam1)
{
	...
	{
		iVar1 = func_216(WEAPON::_0xD3750CCC00635FC2(bParam0), bParam1);
