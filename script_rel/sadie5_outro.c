...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	bLocal_16 = joaat("MES_SADIE5_MALES_01");
...
int func_21(var uParam0)
{
	...
	{
		bLocal_14 = func_44(11, 1, 0, 0f, 0f, 0f, 0f, 0, 1, 0, 1, 0, 0, -1248623443, 0, 0, 0, 1, 1, 1, 0, 0, 1, 0, 1);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_14, true);
		PED::SET_PED_CONFIG_FLAG(bLocal_14, 130, true);
		TASK::TASK_FOLLOW_WAYPOINT_RECORDING(bLocal_14, "sad5_outro", 0, 9224, -1, 0, 0, -1);
		return 0;
	}
	if (func_45(((*Global_1835011)[72 /*74*/])->f_1) == 0)
	{
		...
		{
			bLocal_15 = func_46(bLocal_16, -766.3174f, -1262.813f, 43.0245f, 272.9365f, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			PED::_SET_PED_BODY_COMPONENT(bLocal_15, iLocal_17);
			PED::_UPDATE_PED_VARIATION(bLocal_15, true, true, true, true, false);
			return 0;
		}
		func_26(1);
		if (!func_47(512))
		...
		func_48(&uLocal_19, bLocal_15, "SAD5_FINLEY", 0);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Global_35, true);
		PED::_0xFCA8FB9E15FA80D3(bLocal_15, joaat("SAD5_FINLEY"));
	}
	return 1;
}
...
int func_23(var uParam0)
{
	...
	{
		if (func_52(Global_35, bLocal_14, 0, 0) > 150f || !TASK::IS_WAYPOINT_PLAYBACK_GOING_ON_FOR_PED(bLocal_14, 0))
		{
			PED::SET_PED_CONFIG_FLAG(bLocal_14, 130, false);
			PED::SET_PED_KEEP_TASK(bLocal_14, false);
...
void func_40(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_62(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_64(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
bool func_46(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_86(bVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
int func_47(int iParam0)
{
	...
	bVar0 = PERSCHAR::_0x31C70A716CAE1FEE(func_90(iParam0));
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
...
void func_48(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	...
	if (func_91(uParam0, bParam1, sParam2))
	{
...
{
	func_92(bLocal_15, "SAD5_FINLEY", 5f, 0, 0, 4);
	PED::SET_PED_RESET_FLAG(bLocal_15, 49, true);
	if (func_52(Global_35, bLocal_15, 1, 1) > 6f)
	{
		if (func_93(1))
		{
			func_94(1, 0, 0);
	...
	{
		case 0:
			if (func_95(Global_35, bLocal_15, 5f, 1))
			{
				if (!func_56(&uLocal_123))
				{
					func_57(&uLocal_123);
					TASK::TASK_USE_NEAREST_SCENARIO_CHAIN_TO_COORD(bLocal_15, ENTITY::GET_ENTITY_COORDS(bLocal_15, true, false), 2f, false, false, false, false);
			...
			if (func_99(PLAYER::PLAYER_ID(), bLocal_15))
			{
				if (!func_100(&(uLocal_117[0])))
				{
					uLocal_117[0] = func_101("INTERACT_GREET", joaat("INPUT_INTERACT_LOCKON_POS"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
					func_102(&(uLocal_117[0]), bLocal_15, 0, 0, 1);
				}
				if (!func_100(&(uLocal_117[1])))
				{
					uLocal_117[1] = func_101("INTERACT_INSULT", joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("SHORT_TIMED_EVENT"), 0);
					func_102(&(uLocal_117[1]), bLocal_15, 0, 0, 1);
				}
				if (iLocal_121 > 2)
				{
...
float func_52(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_72(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_54(iParam0))
	{
		return 0;
...
void func_75(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (func_60(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
		if (PED::IS_PED_ON_VEHICLE(bVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_75(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(bVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_75(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_60(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_60(iParam5, 32), true);
	...
	else if (func_60(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_60(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_60(iParam5, 64))
		{
...
void func_86(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_141(bParam1))
		{
			func_142(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_92(bool bParam0, char* sParam1, float fParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	bool bVar1;
...
int func_95(int iParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
int func_99(int iParam0, bool bParam1)
{
	...
	{
		if (((PLAYER::_0x3EE1F7A8C32F24E1(iParam0, &bVar0, false, false) && ENTITY::DOES_ENTITY_EXIST(bVar0)) && bVar0 == bParam1) || ((PLAYER::_0xBEA3A6E5F5F79A6F(iParam0, &bVar0) && ENTITY::DOES_ENTITY_EXIST(bVar0)) && bVar0 == bParam1))
		{
			return 1;
		}
	}
...
int func_101(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_150(iVar1, iParam1, sParam0, 0, iParam10, 0, 0f, 0f, 0f, 0f, 0, 0, 4, 1, iParam2, iParam3, bParam4, iParam5, bParam6, iParam7, iParam8, iParam9, 0, 0, iParam11, bParam12);
		return iVar1;
	}
	return 0;
}

void func_102(int iParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)
{
	int iVar0;

	if (bParam4 && (!func_100(iParam0) || !ENTITY::DOES_ENTITY_EXIST(bParam1)))
	{
		return;
	}
	...
	HUD::_UIPROMPT_SET_GROUP(((*Global_1945938)[iVar0 /*18*/])->f_3, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(bParam1), iParam2);
}
...
float func_111(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_157(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
bool func_140(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(bVar0) || WEAPON::_0x959383DCD42040DA(bVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_178(bVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, bVar3))
					{
						bVar21 = true;
					}
				}
	...
	{
		func_181(bVar0, bParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
...
int func_181(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	if (WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, false))
	{
		...
		while (iVar28 < 4)
		{
			...
			if (func_194(bParam0, &Var0, iVar5, 0))
			{
				if (func_195(bParam0, &Var6, iVar5))
				{
					Var29 = { func_196(bParam0, Var0, iVar5, 0) };
					func_197(bParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_198(0))
				{
					...
					func_199(WEAPON::_0x5C2EA6C44F515F34(bParam0), bParam1, iParam6);
					func_200(bParam0, bParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, bParam0, 0, false))
				{
...
struct<5> func_192(bool bParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_203(bParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_205(bParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_194(bParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_194(bParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_195(bParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
int func_195(bool bParam0, var uParam1, int iParam2)
{
	var uVar0;
...
int func_197(bool bParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_199(bool bParam0, bool bParam1, int iParam2)
{
	if (bParam1 < 1)
	{
		return 1;
...
void func_200(bool bParam0, bool bParam1)
{
	...
	{
		iVar1 = func_216(WEAPON::_GET_WEAPON_CLIP_SIZE(bParam0), bParam1);
...
{
	return func_196(joaat("CHARACTER"), func_218(), -1591664384, bParam0);
}
...
{
	if (func_207(bParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(bParam0))
	{
		if (bParam1)
		{
			return func_219(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_209(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_210(bool bParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_196(bParam0, Param1, iParam5, bParam6) };
...
int func_211(bool bParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_213(0);
	*uParam1 = { func_196(bParam0, func_204(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
