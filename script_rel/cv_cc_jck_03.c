...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -3.84f, -2.72f, 0f, -43.56f, 4f, 9f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@jack_3@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@jack_3@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@jack_3@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@jack_3@action_b_front", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@jack_3@action_b_back_L", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@jack_3@action_b_back_R", 0, 0, 0, 1);
	func_154(uParam0, "CJCK3AU");
	func_155(uParam0, iLocal_15, 2, 1, 0, 0, 0);
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_JACK_POKE_GROUND"), "WORLD_CAMP_JACK_POKE_GROUND_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	Local_21 = { func_160(uParam0, -2.735f, -1.354f, 0.9122f, -105.1f, 8f, 0.3f, 0.3f) };
	Local_31 = { func_160(uParam0, -2.7353f, -1.3544f, 0.9247f, 123.4401f, 8f, 0.514f, 0.75f) };
	Local_41 = { func_160(uParam0, -2.735f, -1.354f, 0.925f, 180f, 6.81f, 0.532f, 0.114f) };
