...
int func_1(var uParam0)
{
	...
	{
		func_10(403634348, -2060316038, 1120952528, -1, 1, 1, 0);
	}
	else
	{
		func_11(12, 1, 1, 1, 1);
...
int func_89(var uParam0)
{
	...
	func_171(uParam0, 0.45f, -3.3475f, 0f, 0f, 2.23f, 2.09f, 5f, -1612834106, -1, 1, 1, 1);
	func_171(uParam0, -0.7f, -0.0975f, 0f, 0f, 1.1f, 1f, 5f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_172(uParam0, 0.850932f, -3.3277f, 1.03721f, 0f, 1.1f, 1.1f, 5f, 665633627, 1);
	...
	func_180(uParam0, -1187193707, 258556191);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_350(747937920, 1) && !func_440(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
