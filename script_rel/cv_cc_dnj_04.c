...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 4.4f, -8.9625f, 0f, 0f, 1.2f, 1.2f, 4f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.9625f, -0.5f, 0f, 0f, 1.87f, 1.87f, 4f, -1612834106, joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0.56f, -0.96f, 1.0325f, 0f, 0.8f, 0.8f, 2f, 665633627, 1);
	...
	func_161(uParam0, 179524346, 1819899304);
...
int func_423(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_455(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
