...
int func_73(var uParam0)
{
	...
	func_152(uParam0, 0.87499f, 0.291573f, 0.481659f, 3f, 0.9f, 0.9f, 2.5f, -1612834106, joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.00493374f, -0.044972f, 0.582031f, 3f, 0.8f, 2f, 2f, -1612834106, joaat("APMS_COMP_JOHN"), 1, 1, 1);
	...
	iLocal_21 = func_157(uParam0, 2.82f, -0.137f, 1f, 0f, 0f, 90f, 5f, 6f, 3f, "TRIGGER", -1612834106);
	...
	func_163(uParam0, 1);
	func_164(uParam0, -1346632935, 1886962119);
	if (func_154(1) || func_154(2))
	{
		func_165(uParam0);
		func_166(uParam0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_340(747937920, 1) && !func_406(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
