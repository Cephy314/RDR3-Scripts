...
int func_8(float fParam0, int iParam1, int iParam2, float fParam3, float fParam4)
{
	...
	if (bVar0)
	{
		if ((((((((((PED::IS_PED_INJURED(bLocal_163) || PED::IS_PED_RAGDOLL(bLocal_163)) || TASK::IS_PED_GETTING_UP(bLocal_163)) || PED::_IS_PED_LASSOED(bLocal_163)) || PED::IS_PED_BEING_STEALTH_KILLED(bLocal_163)) || PED::_0xEF3A8772F085B4AA(bLocal_163)) || PED::IS_PED_BEING_STUNNED(bLocal_163, 0)) || PED::_0x3E592D0486DEC0F6(bLocal_163)) || PED::_IS_PED_HOGTIED(bLocal_163)) || TASK::_0xF330A5C062B29BED(bLocal_163)) || PED::IS_PED_PRONE(bLocal_163))
		{
			*iParam2 = 0;
		}
		else
...
void func_31()
{
	...
	{
		bLocal_176 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), 2542.052f, -1215.467f, 58.01852f, 0f, 0f, 0f, 1.85f, 1.85f, 10f);
...
void func_79(bool bParam0, var uParam1, int iParam2, float fParam3, float fParam4)
{
	...
	*uParam1 = EVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(iParam2, *bParam0, fParam4, fParam3, fParam3, -1f, -1f, 180f, false, false, -1, -1);
}
...
void func_150()
{
	...
	while (iVar3 < iVar4)
	{
		...
		{
			if (((PED::IS_PED_HUMAN(bVar2) && !PED::IS_PED_A_PLAYER(bVar2)) && bVar2 != bLocal_163) && PED::_IS_PED_USING_SCENARIO_HASH(bVar2, joaat("WORLD_HUMAN_STAND_WAITING")))
			{
...
bool func_220(bool bParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
bool func_319(bool bParam0, var uParam1)
{
...
int func_359(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_445(bVar0, 0)))
		{
...
bool func_398(bool bParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((PED::_IS_PED_CARRYING(Global_35) || func_460(Global_35)) || func_461(Global_35)) || func_462(Global_35));
	fVar12 = -1f;
...
int func_406()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_473())
	{
		return 1;
	}
	return 0;
