...
int func_72(var uParam0)
{
	...
	func_153(uParam0, "script@vignette@karen_2@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@karen_2@action", 0, 0, 1, 1);
	func_154(uParam0, "CKAR2AU");
	func_155(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_156(uParam0, iLocal_14, 2, -1);
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
