...
int func_11()
{
	bLocal_14 = ((*Global_1888801)[110 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(bLocal_14, 26);
	bLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volGeneralStore Agg");
	VOLUME::_0x39816F6F94F385AD(bLocal_15, -1987.5f, -1619.5f, 119f, 0f, 0f, 108f, 13f, 7.5f, 3.3f);
	VOLUME::_0x39816F6F94F385AD(bLocal_15, -1993.957f, -1616.896f, 119f, 0f, 0f, 108f, 4f, 3.2f, 3.3f);
	VOLUME::_0x39816F6F94F385AD(bLocal_15, -1993.276f, -1625.02f, 118.1032f, 0f, 0f, 18.70994f, 6.771215f, 10.15464f, 4.094861f);
	VOLUME::_0x39816F6F94F385AD(bLocal_15, -1979.72f, -1641.667f, 118.1032f, 0f, 0f, 18.70994f, 18.24065f, 21.29219f, 4.094861f);
	bLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Manzanita - m_volArtistOwner Agg");
	VOLUME::_0x39816F6F94F385AD(bLocal_16, -1978.791f, -1668.522f, 118.1032f, 0f, 0f, 144.4009f, 7.96674f, 8.658496f, 4.094861f);
	VOLUME::_0x39816F6F94F385AD(bLocal_16, -1975.129f, -1655.416f, 118.1032f, 0f, 0f, 106.1859f, 3.915041f, 4.647958f, 4.094861f);
	VOLUME::_0xB469CFD9E065EB99(bLocal_15, 10106);
	return 1;
}
...
void func_28(int iParam0)
{
	...
	func_50(727, bLocal_15, 1);
	func_50(728, bLocal_15, 0);
	func_50(729, bLocal_15, 0);
	func_50(730, bLocal_15, 0);
	func_50(725, bLocal_16, 1);
	func_50(726, bLocal_16, 0);
}
...
void func_77(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_122(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_85(int iParam0, bool bParam1)
{
	...
	if (func_123(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_87(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_87(iParam0)))
	{
...
bool func_86(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_87(iParam0));
}
...
void func_120(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_122(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_124(int iParam0, bool bParam1)
{
	...
	func_157(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_87(iParam0));
	func_126(iParam0, 0);
	return 1;
}
