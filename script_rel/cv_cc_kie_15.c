...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2.925f, -4.5625f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.125f, -0.4125f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_151(uParam0, -6.55f, 2.7375f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, -4.45f, -4.475f, 0f, -35f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_152(uParam0, -0.325f, -0.736f, 0.6f, -35f, 1f, 1f, 2.5f, joaat("VOLCYLINDER"), 1);
...
void func_257(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_305(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_346(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_384(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
void func_418(bool bParam0, int iParam1)
{
	...
	func_379(bParam0, func_448(iParam1));
