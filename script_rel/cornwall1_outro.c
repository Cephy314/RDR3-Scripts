...
void func_82(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_130(iParam1))
		{
			func_131(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_137(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_141(0))
				{
					...
					func_142(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
void func_143(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_207(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_155(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_214(bVar0, 0)))
		{
