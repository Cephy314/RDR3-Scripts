...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -0.225f, -1.15f, 0.782f, 93.5f, 1.055f, 1.05f, 1.925f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_150(uParam0, -4.6375f, -7.4f, 0.907f, 80f, 1.7975f, 3.355f, 2.025f, -1612834106, joaat("APMS_COMP_JACK"), 1, 1, 1);
...
int func_93(var uParam0)
{
	...
	{
		iLocal_18 = TASK::_0xF533D68FF970D190(2315.74f, 1295.19f, 94.66f, joaat("WORLD_CAMP_JACK_THROWS_ROCKS_CASUAL"), 1.5f, 0, 0);
	}
...
int func_202(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		...
		case 1:
			...
			func_309(uParam0->f_1707, bVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				...
				func_309(uParam0->f_1708, bVar0, 0, 1, -1);
			}
		...
		case 3:
			...
			func_312(Global_35, &Var1, 0, bVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_312(bVar0, &Var1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
var func_312(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
