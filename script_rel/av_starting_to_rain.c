...
{
	func_33(uParam0, 10977, 11086, 11403);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	{
		case 21:
			func_46(uParam0, "AV_STARTING_TO_RAIN_FEMALE", "script@ambient@generic@startingtorain@female01", vParam1, vParam4);
			uVar0 = func_48(func_47());
			break;
		case 22:
			func_46(uParam0, "AV_STARTING_TO_RAIN_MALE", "script@ambient@generic@startingtorain@male01", vParam1, vParam4);
			uVar0 = func_49(func_47());
			break;
	}
	func_50(uParam0, 1, "PBL_ACTION", "", 0);
	func_51(uParam0, 0, "Ped", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_30(var uParam0)
{
	if (*uParam0 == 21)
	{
		...
		iLocal_38 = joaat("WORLD_HUMAN_STARE_STOIC_FEMALE_A");
	}
	else
	{
		iLocal_37 = joaat("WORLD_HUMAN_STAND_WAITING");
		iLocal_38 = joaat("WORLD_HUMAN_STAND_WAITING_MALE_A");
	}
	STREAMING::_REQUEST_SCENARIO_TYPE(iLocal_37, 15, 0, iLocal_38);
	func_63(&uLocal_9, 0);
	func_64(&uLocal_9, 1);
	func_65(&uLocal_9, 1);
	func_66(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[3])
	{
		if (!&uParam0->f_469[4])
		{
			if (func_71(uParam0, fLocal_39, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				func_70(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
	...
	if (!&uParam0->f_469[3])
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
			{
				...
				TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), iLocal_37, 15000, false, iLocal_38, -1f, false);
...
int func_60(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_92(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
int func_61(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_96(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_97(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
				if (fVar8 < (fParam2 * fParam2))
				{
					if (PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/])) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
					{
						...
						if (func_100(&(uParam0->f_490), fParam1))
						{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_97(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_98(&(uParam0->f_490)))
							{
...
float func_96(vector3 vParam0, vector3 vParam3)
{
	vParam0.f_2 = 0f;
	vParam3.f_2 = 0f;
...
void func_111(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_166(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_166(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_166(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_166(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
