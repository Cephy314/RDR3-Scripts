...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 4, "carcass", joaat("A_C_DEER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.3f, 0f), (vParam4.z - 270f), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_18(var uParam0)
{
	...
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_ANIMAL_WOLF_EATING"), 0))
	{
		return 0;
	}
...
int func_28(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[4 /*14*/])))
	{
		...
		_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[4 /*14*/]), iLocal_46);
		MISC::_0x674B90BE1115846D(&(uParam0->f_20[4 /*14*/]), 1);
		PED::SET_PED_KEEP_TASK(&(uParam0->f_20[4 /*14*/]), true);
		func_57(uParam0->f_20[4 /*14*/], 1, 1);
...
int func_30(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_ANIMAL_WOLF_EATING"), 1, joaat("A_C_WOLF_MEDIUM"), 0);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_52 == 1)
		{
			if (func_67(uParam0, &uLocal_10, 1) || func_68(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 625f)
			{
				bLocal_52 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_52)
	{
		if (!&uParam0->f_469[1])
		{
			...
			{
				if (func_75(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
	...
	while (iVar0 <= 3)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			if (iVar0 == 0)
			{
				...
				{
					TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[iVar0 /*14*/]), Global_35, 4, 256, -1082130432, -1, 0);
			...
			{
				if (!func_112(&(uParam0->f_20[iVar0 /*14*/]), 780511057))
				{
			...
			else if (!func_112(&(uParam0->f_20[iVar0 /*14*/]), 518218985))
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[iVar0 /*14*/]), Global_35, 4, 256, -1082130432, -1, 0);
				func_57(uParam0->f_20[iVar0 /*14*/], 0, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[iVar0 /*14*/]), true);
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_68(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_68(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_69(&(uParam0->f_490)))
							{
