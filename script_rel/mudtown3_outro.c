...
void func_115(int iParam0)
{
	...
	switch (iLocal_159)
	{
		...
		case 1:
			...
			break;
		case 2:
			iLocal_18 = MAP::_BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_FRIENDLY"), bLocal_14);
			MAP::_0x662D364ABF16DE2F(iLocal_18, joaat("BLIP_MODIFIER_URGENT_ALERT"));
		...
		case 5:
			...
			{
				TASK::TASK_ANIMAL_INTERACTION(false, bLocal_15, joaat("INTERACTION_POSITIVESHORT"), 0, 0);
			}
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(bLocal_14, iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
