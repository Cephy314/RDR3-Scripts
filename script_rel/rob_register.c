...
struct<4> func_121(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_110(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}
