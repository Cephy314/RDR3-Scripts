...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 15, "DEER", iLocal_11, vParam1, (fVar0 + vParam4.z), 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_28(var uParam0)
{
	...
	while (iVar0 < iLocal_15)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			func_58(uParam0->f_20[iVar0 /*14*/], 1, 1);
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[15 /*14*/])))
	{
		...
		PED::_0xCE6B874286D640BB(&(uParam0->f_20[15 /*14*/]), 0);
		...
		_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[15 /*14*/]), iLocal_16);
		func_58(uParam0->f_20[15 /*14*/], 1, 1);
...
int func_68(var uParam0, var uParam1, bool bParam2)
{
	...
	{
		if (func_114(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
...
void func_74(var uParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iParam1 /*14*/])))
	{
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[iParam1 /*14*/])->f_1))
		{
			...
			func_58(uParam0->f_20[iParam1 /*14*/], 1, 1);
...
float func_109(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_129(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_114(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_189(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
