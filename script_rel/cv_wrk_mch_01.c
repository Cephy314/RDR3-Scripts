...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	vLocal_28 = { 651.7131f, -1258.331f, 42.7264f };
	Var0 = -1;
	Var0.f_1 = -1;
	Var0.f_2 = -1;
	Var0.f_17 = 10;
...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.6875f, 1.2375f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -0.6f, -1.2125f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_151(uParam0, -3.59344f, 10.879f, 0.830566f, 0f, 1.1f, 1.1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -14.461f, -2.763f, -0.136f, 84.35f, 1.5f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -1.25f, 0.7875f, 0f, -26f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	vVar0 = { -14.345f, -2.16691f, 0.826759f };
	iLocal_18 = func_152(uParam0, joaat("S_LOOTABLECAMPCASE"), vVar0, "LOOTBOX", 1, 0, 1);
	...
	func_153(uParam0, "script@vignette@wrk@micah_work_1@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@wrk@micah_work_1@action_a", 0, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@wrk@micah_work_1@action_b", 0, 0, 0, 0);
	...
	func_157(uParam0, iLocal_15, 3, joaat("GENERIC_SEAT_CHAIR_TABLE_SCENARIO"), "GENERIC_SEAT_CHAIR_TABLE_SCENARIO_LF_FWD_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	if (!bLocal_20)
	{
		...
		{
			fVar0 = -65.4f;
			vVar1 = { 652.0314f, -1257.147f, 43.7423f };
			ANIMSCENE::SET_ANIM_SCENE_ORIGIN(&(uParam0->f_1984[iLocal_17]), vLocal_22, vLocal_25, 2);
			TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_14), joaat("STAND"), vVar1, fVar0, 0, true, false, 0, -1f, false);
			bLocal_20 = true;
		}
	}
	if (bLocal_20 && !bLocal_21)
	{
		if (BUILTIN::VDIST2(Global_36, vLocal_28) <= 9f)
		{
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_208(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
int func_149(var uParam0)
{
	...
	vLocal_22 = { func_249(96) };
	vLocal_25 = { func_250(96) };
	return 1;
}
...
int func_197(var uParam0, int iParam1)
{
	...
	{
		if (!func_301((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
float func_208(int iParam0, bool bParam1, bool bParam2)
{
...
void func_248(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
...
bool func_280(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
...
void func_398(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (bParam0 == func_435(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_436(bParam0))
	{
		if (func_437(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
...
int func_416(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_446(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_417(bool bParam0, int iParam1)
{
	...
	func_378(bParam0, func_447(iParam1));
...
void func_419(bool bParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_483(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_496(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
