...
int func_76(bool bParam0, vector3 vParam1, float fParam4, float fParam5)
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 713668775, true) > 1)
	{
		TASK::CLEAR_PED_TASKS(bParam0, 1, 0);
...
int func_77(bool bParam0)
{
	...
	if (func_138(bParam0))
	{
		if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 501393341, true) > 1)
		{
			TASK::CLEAR_PED_TASKS(bParam0, 1, 0);
...
void func_309(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_336(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
