...
int func_11()
{
	...
	bLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGBridge");
	VOLUME::_0x39816F6F94F385AD(bLocal_18, 3321.868f, -610.395f, 48.57418f, 0f, 0f, 40f, 15f, 75f, 20f);
	VOLUME::_0x39816F6F94F385AD(bLocal_18, 3319.213f, -584.038f, 47.83653f, 0f, 0f, 40f, 15f, 29f, 20f);
	iVar1 = POPULATION::_CREATE_POPZONE_FROM_VOLUME(bLocal_18);
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_21, 3353.973f, -672.1495f, 63.768f, 0f, 0f, 14.62307f, 68.21951f, 54.663f, 50f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 3315.974f, -656.2813f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_0x39816F6F94F385AD(bLocal_21, 3382.837f, -665.3976f, 63.76801f, 0f, 0f, -59.89402f, 51.37444f, 37.32103f, 50f);
		VOLUME::_0x39816F6F94F385AD(bLocal_21, 3381f, -693.5285f, 48.96563f, 0f, 0f, 50.13634f, 11.37222f, 36.9617f, 50f);
		VOLUME::_0x39816F6F94F385AD(bLocal_21, 3364.015f, -686.8185f, 63.76801f, 0f, 0f, 60.3014f, 66.63422f, 46.65413f, 50f);
		VOLUME::_0x39816F6F94F385AD(bLocal_21, 3376.356f, -691.6537f, 63.76801f, 0f, 0f, 50.13634f, 65.99199f, 37.71349f, 50f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 3328.904f, -704.5117f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 5.205996f, 25.19653f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 3368.851f, -726.5292f, 75.25407f, 0f, 0f, 40.4587f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 3410.578f, -679.0173f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 3386.604f, -637.0076f, 75.25407f, 0f, 0f, 40.45871f, 4.165449f, 4.203612f, 25.19653f);
		bLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_20, bLocal_21);
		VOLUME::_0xBCE668AAF83608BE(bLocal_20, 3187.881f, -392.378f, 59.70001f, 0f, 0f, -60.2991f, 106.109f, 89.50376f, 100f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_20, 3203.627f, -637.6728f, 59.70001f, 0f, 0f, -63.6916f, 207.2567f, 107.2578f, 100f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_20, 3186.952f, -695.6421f, 59.70001f, 0f, 0f, -63.6916f, 129.2146f, 107.2578f, 100f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_20, 3297.383f, -592.1081f, 59.70001f, 0f, 0f, -63.6916f, 173.9582f, 92.46152f, 100f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_20, 3375.808f, -710.6785f, 59.7f, 0f, 0f, -61.08491f, 129.6087f, 116.591f, 100f);
		bLocal_22 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_22, bLocal_20);
		bLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Sisika - m_volGuardRegistration Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_19, bLocal_22);
		sLocal_23 = "SISIKA";
		LAW::_CREATE_GUARD_ZONE(sLocal_23);
		LAW::_0x8C598A930F471938(sLocal_23, bLocal_19);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_23, bLocal_22);
		LAW::_0x35815F372D43E1E5(sLocal_23, bLocal_20);
		LAW::_0xA1B0E6301E2E02A6(sLocal_23, bLocal_21);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_23, 3355.869f, -676.4202f, 49.5715f);
		LAW::_0xA8A74AA79FB67159(sLocal_23, bLocal_19);
	}
	return 1;
}
...
void func_46()
{
	...
	iVar0 = 7;
	iLocal_14[0] = VOLUME::_0x00BBF7CEAE8C666A(3360.208f, -678.505f, 41.488f, 60f, iVar0, 16384);
}
...
void func_66(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_116(func_115(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_116(func_115(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_116(func_115(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_116(func_115(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_116(func_115(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_116(func_115(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_125()
{
	...
	while (iVar0 < 1)
	{
		if (VOLUME::_0xF6A8A652A6B186CD(&(iLocal_14[iVar0])))
		{
			VOLUME::_0xFDFECC6EE4491E11(&(iLocal_14[iVar0]));
		}
		iVar0++;
	}
}
...
void func_139(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_163(iParam0))
	{
		...
		if (bParam3)
		{
			func_168(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
char* func_142(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_168(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_163(iParam0))
	{
