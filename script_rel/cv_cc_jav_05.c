...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.15f, 0f, 0.95f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@javier_5@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@javier_5@action", 0, 0, 1, 1);
	func_154(uParam0, "CJAV5AU");
	func_155(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_COFFEE_DRINK"), "WORLD_HUMAN_COFFEE_DRINK_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
bool func_87(var uParam0)
{
	...
	return func_192(func_48(uParam0, iLocal_14), Global_35, 1, 1) < 6f;
}
...
float func_192(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_293(var uParam0, float fParam1, float fParam2)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			fVar0 = func_192(Global_35, (uParam0->f_107[iVar1 /*113*/])->f_5, 1, 1);
			if (fVar0 > fParam2)
			{
			}
			else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_320(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_383(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
