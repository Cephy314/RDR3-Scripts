...
{
	func_33(uParam0, 10826, 10916, 11311);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, "AV_CHAMBERPOT_TOSS", "", vParam1, vParam4);
	func_49(uParam0, 0, "Ped", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -6f, 0f), vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
{
	if (TASK::_0x841475AC96E794D1(iLocal_37))
	{
	...
	{
		iLocal_37 = func_50(joaat("WORLD_HUMAN_CHAMBERPOT_EMPTY_RAILING"), uParam0->f_483, uParam0->f_486.f_2, 0, 1000f, 0);
	}
	return 0;
}
...
int func_31(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		if (!&uParam0->f_469[2])
		{
			if (func_68(uParam0, 0.1f, 60f, 4, 33f, 1112014848 /* Float: 50f */))
			{
				func_66(uParam0);
				if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
				{
					if (TASK::_0x841475AC96E794D1(iLocal_37))
					{
						TASK::_TASK_USE_SCENARIO_POINT(&(uParam0->f_20[0 /*14*/]), iLocal_37, 0, 1000, true, false, 0, true, -1f, false);
						uParam0->f_469[2] = 1;
					}
				}
			}
		...
		if (&uParam0->f_469[2])
		{
			if (func_69(&(uParam0->f_20[0 /*14*/]), -76381094))
			{
				if (!&uParam0->f_469[4])
				{
					if (func_70(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
					{
						func_67(*uParam0, uParam0->f_483, 0);
						uParam0->f_469[4] = 1;
					}
...
void func_48(var uParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6)
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
int func_185(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
