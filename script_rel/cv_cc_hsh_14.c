...
int func_122(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_135(bVar0, 0))
	{
		if (func_135(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
int func_509(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_540(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_510(bool bParam0, int iParam1)
{
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_265(iParam1), bParam0, 0);
