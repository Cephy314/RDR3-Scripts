...
void func_74(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_142(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_144(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_89(var uParam0)
{
	...
	func_161(uParam0, 0f, -1.6f, 0f, -2.75f, 3.9f, 6.5f, 5f, -1612834106, joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
...
int func_352(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	bVar0 = func_76(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(bVar0) || !func_67(bVar0, 0)) || (bParam3 && !func_53(iParam1)))
	{
		if (bParam2)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0) && func_67(bVar0, 0))
	{
		*uParam0 = 2;
...
void func_394(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_140(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_140(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_140(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_140(iParam5, 32), true);
	...
	else if (func_140(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_140(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_140(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_417(bool bParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_142(iParam1), bParam0, 0);
		PED::_0xED1C764997A86D5A(func_142(iParam1), bParam0);
