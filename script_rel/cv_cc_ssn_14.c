...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -6.2251f, 1.2273f, 0f, -29f, 1.1f, 1.1f, 4f, -1612834106, joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -0.742f, -0.362f, 1.03f, 0f, 6f, 6f, 4f, -1612834106, joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
...
void func_437(bool bParam0, float fParam1, bool bParam2)
{
	int iVar0;
