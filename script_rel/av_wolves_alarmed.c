...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 1, "WAP_WOLF_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.75f, 0.5f, 0f), (20f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WAP_WOLF_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 4f, 3.5f, 0f), (120f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "WAP_WOLF_4", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3.5f, -2.5f, 0f), (-110f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), joaat("WORLD_ANIMAL_WOLF_SLEEPING"), (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, false, true, 0, -1f, false);
				func_65(uParam0->f_20[0 /*14*/], 1, 1);
			}
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				func_64(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), joaat("WORLD_ANIMAL_WOLF_SITTING"), (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, false, true, 0, -1f, false);
			...
			while (iVar0 <= 3)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iVar0 /*14*/]), joaat("WORLD_ANIMAL_WOLF_RESTING"), (uParam0->f_20[iVar0 /*14*/])->f_5, (uParam0->f_20[iVar0 /*14*/])->f_8, 0, false, true, 0, -1f, false);
