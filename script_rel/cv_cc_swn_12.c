...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.4814f, 2.19f, -0.0125f, 0f, 1.2f, 1.2f, 5f, -1612834106, 1243438920, 1, 1, 1);
	func_151(uParam0, 3.2064f, -3.0975f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1689743484, 1, 1, 1);
	...
	iLocal_18 = func_152(uParam0, "script@vignette@swanson_12@ACTION_B_INT_RIGHT", 2, 0, 0, 1);
	iLocal_19 = func_152(uParam0, "script@vignette@swanson_12@action_b", 0, 0, 0, 0);
	func_153(uParam0, "CSW12AU");
	Local_20 = { func_154(uParam0, 3.5625f, 0.5645f, 0.988f, -22.62f, 6.5f, 0.57f, 0.3375f) };
	Local_30 = { func_154(uParam0, 3.563f, 0.565f, 0.988f, -99.25f, 6.5f, 0.5125f, 0.42f) };
