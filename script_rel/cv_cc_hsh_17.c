...
int func_72(var uParam0)
{
	...
	func_150(uParam0, 4.1112f, -7.5077f, 0.7655f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_150(uParam0, 1.53f, 0.16f, 1f, 0f, 3f, 3f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_151(uParam0, 1.47142f, 0.305939f, 1.00063f, 0f, 1f, 1f, 3f, joaat("VOLCYLINDER"), 1);
