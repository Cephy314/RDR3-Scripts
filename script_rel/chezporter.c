...
void func_25()
{
	...
	bLocal_15 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-410.2579f, 1722.699f, 212.61f, 0f, 0f, 103.7064f, 121.5021f, 67.59155f, 24.51105f, "m_volAmbRestriction");
	POPULATION::_0xB56D41A694E42E86(bLocal_15, 192, 16384, 0, -1, -1, 0);
	POPULATION::_0x18262CAFEBB5FBE1(bLocal_15, 192, 16384, 0, -1, -1, 0);
}
...
void func_52(int iParam0, int iParam1, int iParam2)
{
	...
	(Global_1392240->f_1[iParam0 /*18*/])->f_6[iParam1] = func_93(iParam2, 0, 0);
}
...
void func_58()
{
	...
	{
		func_115(-518858513);
		GRAPHICS::_0xBFCB17895BB99E4E(MISC::GET_HASH_KEY("Che_01_main"), false);
	}
	else
	{
		func_115(-518858513);
		if (func_116(3))
		{
			GRAPHICS::_0xBFCB17895BB99E4E(MISC::GET_HASH_KEY("Che_01_main"), true);
		}
		else
		{
			GRAPHICS::_0xBFCB17895BB99E4E(MISC::GET_HASH_KEY("Che_01_main"), false);
...
void func_68(int iParam0, bool bParam1)
{
	...
	func_137(func_136(-1532769513, joaat("areas")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_137(func_136(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_137(func_136(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_137(func_136(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_137(func_136(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_137(func_136(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_137(func_136(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_102(var uParam0, vector3 vParam1)
{
...
void func_148(int iParam0)
{
	...
	{
		func_188((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_189((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
int func_172(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_208(&(Global_1898164->f_1[0 /*5*/]));
		if (func_202(iVar0) && func_209(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
void func_206(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_233(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
