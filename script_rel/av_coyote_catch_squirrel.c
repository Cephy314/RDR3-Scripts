...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_39)
		{
			if (func_63(uParam0, &uLocal_9, 1) || func_64(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 625f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_39)
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_72(uParam0, 1.5f, 40f, 4, joaat("action"), 1))
				{
					func_68(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
						...
						if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
						{
							if (ENTITY::HAS_ANIM_EVENT_FIRED(&(uParam0->f_20[0 /*14*/]), 811542464))
							{
								if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
								{
									...
									PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[0 /*14*/]), -1115154469, false, 0, false);
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_64(&(uParam0->f_20[iVar2 /*14*/]), Global_35, 1) < 22500f)
				{
					return 0;
				}
			}
