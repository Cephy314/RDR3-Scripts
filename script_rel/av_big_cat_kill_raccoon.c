...
{
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_ANIMAL_BIG_CAT_EATING"), 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_ANIMAL_BIG_CAT_EATING"), 1, 0, 0);
	func_57(&uLocal_11, 0);
	func_58(&uLocal_11, 1);
	func_59(&uLocal_11, 1);
	func_60(&uLocal_11, 1);
...
int func_188(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
