...
int func_72(var uParam0)
{
	...
	func_152(uParam0, "script@vignette@beecher@charles_5@base", 1, 1, 0, 0);
	func_152(uParam0, "script@vignette@beecher@charles_5@action", 0, 0, 1, 1);
	...
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_MALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, 8f, 8f);
	func_159(uParam0, iLocal_14, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	return 1;
}
...
int func_151(var uParam0, int iParam1, int iParam2, char* sParam3)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_283(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_184(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_283(uParam0, uParam0->f_1976.f_1), 1, func_285(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_264(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_283(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
...
Vector3 func_283(var uParam0, vector3 vParam1)
{
