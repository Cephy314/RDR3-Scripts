...
void func_53()
{
	...
	iVar0 = INTERIOR::GET_INTERIOR_AT_COORDS(func_91(5));
	bVar1 = false;
...
void func_54()
{
	...
	if (func_92(5) && !(func_93(3, 16) && !func_94()))
	{
		func_96(-2035177903);
		func_96(-1147247388);
		func_97(-19313405, 1, 0f, 0, 0, 0, 0, 0);
	}
	else
	{
		func_98(-2035177903);
		func_98(-1147247388);
		func_97(-19313405, 0, 0f, 0, 0, 0, 0, 0);
	}
	func_95(5, 64);
}
...
void func_62(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_51(iParam0) && func_79(iParam0, 16777216)) && !Global_1894899->f_9)
	{
...
void func_64(int iParam0, bool bParam1)
{
	...
	func_119(func_118(-1532769513, joaat("areas")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_119(func_118(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_119(func_118(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_119(func_118(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_119(func_118(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_119(func_118(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_119(func_118(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_77(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_132(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_87(int iParam0)
{
	...
	if (((!func_145(94) && !func_146(94)) && !func_145(95)) && !func_146(95))
	{
	}
	func_140(iParam0, 1);
	return 1;
...
int func_92(int iParam0)
{
	...
	if (!func_149(iVar0, 1) && iVar0 != -15)
	{
		func_150(iVar0, &uVar1, &uVar2, &uVar3, &uVar4, &uVar5, &uVar6);
		return 0;
	}
	return 1;
}
...
void func_97(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_152(iParam0))
	{
		...
		if (bParam3)
		{
			func_153(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_130(int iParam0)
{
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_132(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
void func_142(int iParam0, int iParam1, vector3 vParam2, char* sParam5)
{
	int iVar0;
	int iVar1;

	iVar0 = func_186(vParam2);
	iVar1 = 0;
	while (iVar1 < Global_36307)
	{
		if ((func_187(iVar1) == iParam0 && func_188(iVar1) == iParam1) && func_189(iVar1) == iVar0)
		{
...
{
	return func_193(func_109(), iParam0, bParam1);
}

void func_150(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)
{
	func_194(func_109(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}
...
void func_153(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_152(iParam0))
	{
...
int func_160(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_190(iVar0) && func_198(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
void func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
void func_194(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
	...
	if (func_193(iParam0, iParam1, 1))
	{
		...
		iVar2 = (func_217(iParam0) - func_217(iParam1));
		iVar3 = (func_216(iParam0) - func_216(iParam1));
		iVar4 = (func_218(iParam0) - func_218(iParam1));
		iVar5 = (func_110(iParam0) - func_110(iParam1));
		iVar6 = (func_111(iParam0) - func_111(iParam1));
	...
	else
	{
		...
		iVar2 = (func_217(iParam1) - func_217(iParam0));
		iVar3 = (func_216(iParam1) - func_216(iParam0));
		iVar4 = (func_218(iParam1) - func_218(iParam0));
		iVar5 = (func_110(iParam1) - func_110(iParam0));
		iVar6 = (func_111(iParam1) - func_111(iParam0));
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = BUILTIN::ROUND(func_221(BUILTIN::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_229(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
