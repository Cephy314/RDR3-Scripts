...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 54:
			...
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
			break;
		case 74:
			...
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
