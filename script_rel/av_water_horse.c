...
void __EntryFunction__()
{
	...
	iLocal_44 = joaat("WORLD_ANIMAL_HORSE_DRINK_GROUND_DOMESTIC");
	iLocal_45 = -1;
	fLocal_46 = 0.5f;
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iLocal_38 = joaat("A_M_M_HTLROUGHTRAVELLERS_01");
	switch (*uParam0)
	{
		case 54:
			sLocal_43 = "script_respawn@looping@hybrid@generic@unarmed_hat@sit_wake_up@a";
			iLocal_44 = joaat("WORLD_ANIMAL_HORSE_GRAZING_DOMESTIC");
			iLocal_38 = func_48(func_47(), 0, 0, 0, 0, 0, 1);
			iLocal_39 = func_49(joaat("HORSE_CLASS_RIDING"), 1);
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
		case 74:
			iLocal_38 = func_48(func_47(), 1, 1, 1, 1, 1, 1);
			sLocal_43 = "script_respawn@one_shot@hybrid@near_water@unarmed@crouch_stream_wash@b";
			iLocal_39 = func_49(joaat("HORSE_CLASS_RIDING"), 1);
			func_50(uParam0, 1, "MPDHP_HORSE", iLocal_39, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "MPDHP_MAN", iLocal_38, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
				...
				switch (iLocal_9)
				{
					case 0:
						...
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
						{
							...
							if (*uParam0 == 54)
							{
								func_70(&(uParam0->f_20[0 /*14*/]), joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), 0, 0, 0, -1082130432 /* Float: -1f */);
							...
							iLocal_45 = GRAPHICS::_0xFA50F79257745E74((uParam0->f_20[0 /*14*/])->f_5, 1.5f, 2, 27, 0);
						}
						iLocal_9 = 1;
						break;
					case 1:
						if (*uParam0 == 54)
						{
							if (PLAYER::_0x3EE1F7A8C32F24E1(PLAYER::GET_PLAYER_INDEX(), &iVar2, false, false))
							{
								...
								{
									if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iVar2) == &uParam0->f_20[0 /*14*/] && (PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_INTERACT_LOCKON_POS")) || PAD::IS_CONTROL_JUST_PRESSED(0, joaat("INPUT_INTERACT_LOCKON_NEG"))))
									{
										if (PED::_0xC22AA08A8ADB87D4(&(uParam0->f_20[0 /*14*/])) != joaat("WORLD_HUMAN_SIT_GROUND_SLEEPING_MALE_A"))
										{
											func_66(uParam0);
											iLocal_9 = 2;
										}
					...
					case 2:
						...
						if (ENTITY::DOES_ENTITY_EXIST(Global_35) && ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
						{
							...
							{
								PED::_0xEC6935EBE0847B90(&(uParam0->f_20[0 /*14*/]), (uParam0->f_20[1 /*14*/])->f_5);
...
int func_85(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
void func_99(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_165(iParam1))
		{
			func_166(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_150(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_155((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
