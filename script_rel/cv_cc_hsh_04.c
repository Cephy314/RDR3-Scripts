...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.4627f, -0.0848f, 0.5257f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEATED_MALE_F", -1, 0, 45f, 1065353216 /* Float: 1f */, 1);
