...
int func_11()
{
	bLocal_14 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(894.7135f, 260.2712f, 129.5878f, 0f, 0f, -0.492423f, 88.10741f, 65.87466f, 39.61107f, "Larned Sod - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Threat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 901.97f, 261.5441f, 115.7395f, 0f, 0f, -0.825771f, 12.77186f, 7.290863f, 4.182421f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 886.826f, 258.2958f, 120.034f, 0f, 0f, 0f, 6.865234f, 13.71682f, 18.96277f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_16, 887.2566f, 258.3552f, 121.8763f, 0f, 0f, -0.580099f, 4.594322f, 6.421996f, 6.34872f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 889.3727f, 250.7424f, 120.034f, 0f, 0f, -71.9487f, 5.361883f, 5.311553f, 18.96277f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 884.868f, 250.9919f, 120.034f, 0f, 0f, -31.54634f, 3.975522f, 1.561551f, 18.96277f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 886.9943f, 250.5041f, 120.034f, 0f, 0f, -51.34731f, 3.201982f, 2.32918f, 18.96277f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 943.6283f, 240.538f, 120.034f, 0f, 0f, 36.22269f, 2.583991f, 1.168234f, 18.96277f);
		bLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Restricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_15, bLocal_16);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 899.733f, 262.0444f, 121.8763f, 0f, 0f, -8.182039f, 26.6654f, 26.8703f, 20f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 943.883f, 240.5778f, 121.8763f, 0f, 0f, -8.182041f, 4.201227f, 4.104132f, 20f);
		bLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Warning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_17, bLocal_15);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 895.8494f, 261.3904f, 121.8763f, 0f, 0f, -8.182039f, 38.88291f, 38.47965f, 20f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 940.5317f, 241.0733f, 121.8763f, 0f, 0f, -8.182038f, 10.83869f, 7.036053f, 20f);
		bLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Larned Sod - m_volTenantOwner_Registration Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_18, bLocal_17);
		VOLUME::_0xBCE668AAF83608BE(bLocal_18, 895.8494f, 261.3904f, 121.8763f, 0f, 0f, -8.182039f, 46.9045f, 46.40221f, 20f);
		sLocal_19 = "LARNED_SOD";
		LAW::_CREATE_GUARD_ZONE(sLocal_19);
		LAW::_0x8C598A930F471938(sLocal_19, bLocal_18);
		LAW::_0x35815F372D43E1E5(sLocal_19, bLocal_15);
		LAW::_0xA1B0E6301E2E02A6(sLocal_19, bLocal_16);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_19, bLocal_17);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_19, 901.2f, 262.7f, 116.4f);
		LAW::_0xA8A74AA79FB67159(sLocal_19, bLocal_14);
	}
	return 1;
}
...
void func_28(int iParam0)
{
	...
	if (!func_53(bVar1, 0))
	{
		func_54(iVar0, bLocal_15, 1);
		func_54(735, bLocal_15, 0);
...
void func_61()
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(-1956453623);
	if (!PERSCHAR::_0x800DF3FC913355F3(iVar0))
	{
...
void func_69(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_119(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_119(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_119(&cVar6, joaat("COLOR_PURE_WHITE")), func_119(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_71(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_125(func_124(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_125(func_124(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_125(func_124(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_125(func_124(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_125(func_124(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_125(func_124(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_81(int iParam0)
{
	...
	{
		VOLUME::_0x998202B206872672(bLocal_15);
		VOLUME::_0x6D5F9E69BA1BE783(bLocal_15);
