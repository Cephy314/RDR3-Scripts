...
void func_1()
{
	...
	func_34(&bLocal_240, &uLocal_186, 161068336, 20f, 1);
...
int func_13()
{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_240, 623901053);
		...
		func_90(&bLocal_240, &uLocal_186, 161068336, 20f, -1082130432 /* Float: -1f */);
		func_91();
		if (func_81())
		{
			if (iLocal_244 == 0 || iLocal_244 == 2)
