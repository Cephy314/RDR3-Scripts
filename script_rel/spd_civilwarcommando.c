#region Local Var
	...
	var uLocal_228 = 1000;
	var uLocal_229 = 1067450368;
	var uLocal_230 = 5000;
	var uLocal_231 = 42;
	var uLocal_232 = 1103626240;
	var uLocal_233 = 1077936128;
	var uLocal_234 = 1106247680;
	var uLocal_235 = 1103101952;
	var uLocal_236 = 1097859072;
	var uLocal_237 = 1103626240;
	var uLocal_238 = 0;
	int iLocal_239 = 0;
...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	bLocal_14 = joaat("U_M_O_CMRCIVILWARCOMMANDO_01");
	iLocal_15 = joaat("P_CS_RAG01X");
	iLocal_16 = joaat("P_CHAIR02X");
	...
	while (true)
	{
		...
		func_4();
		func_5();
		func_6(7, iLocal_244, &bLocal_240, &uLocal_248, &uLocal_187, 0, 1097859072 /* Float: 15f */, 0);
		func_7(bLocal_240, &iLocal_183, 524288, 7, 0);
		iVar0 = 0;
		iLocal_185 = func_9(&bLocal_240, &iLocal_123, 20f, &Local_144, &iVar0, 0f, 2, 0, 0, func_8(iLocal_239, 0, 0), 0, 0, 2, 1, -1082130432 /* Float: -1f */, 0);
		switch (iLocal_179)
		{
			case 0:
				func_10();
			...
			case 2:
				...
				break;
			case 3:
				vVar1 = { ENTITY::GET_ENTITY_COORDS(bLocal_240, true, false) - ENTITY::GET_ENTITY_COORDS(Global_35, true, false) };
				...
				if (!func_14(iLocal_183, 16))
				{
					...
					{
						iLocal_184 = (700 + MISC::GET_GAME_TIMER());
				...
				{
					ANIMSCENE::_0xDF7B5144E25CD3FE(iLocal_182, sVar6);
					iLocal_180 = iVar5;
				}
				if (((func_17(bLocal_240, Global_35, 0, 15f, 0) || (func_14(iLocal_183, 16) && MISC::GET_GAME_TIMER() >= iLocal_184)) || func_14(iLocal_183, 16384)) && ANIMSCENE::_0x23E33CB9F4A3F547(iLocal_182, sVar6))
				{
					ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(iLocal_182, sVar6, true);
					func_11(4);
				}
				break;
			case 4:
				if (!func_14(iLocal_183, 16384))
				{
					if (!func_14(iLocal_183, 1))
					{
						if (ANIMSCENE::_0x3FBC3F51BF12DFBF(iLocal_182) >= 0.15f)
						{
							if (func_19(func_18(0)))
							{
								...
								func_20(Local_144[0 /*17*/], 0, 0);
								func_20(Local_144[1 /*17*/], 0, 0);
							}
						}
					}
					else
					{
						...
						{
							if (AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_240))
							{
				...
				if (ANIMSCENE::_0x005E6F28DD7ED58D(iLocal_182, "U_M_O_CmrCivilwarcommando_01"))
				{
					if (!func_14(iLocal_183, 16384))
					{
						func_11(5);
			...
			case 5:
				...
				if (!func_14(iLocal_183, 64))
				{
					bVar7 = AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_240);
					if (bVar7 || (MISC::GET_GAME_TIMER() >= iLocal_184 && !bVar7))
					{
						func_15(&iLocal_183, 64);
					}
				}
				else if (!func_14(iLocal_183, 32))
				{
					if (!AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_240))
					{
						func_22(Local_144[0 /*17*/], "INTERACT_DEFUSE");
						func_20(Local_144[0 /*17*/], 1, 0);
						func_20(Local_144[1 /*17*/], 1, 0);
						iLocal_239 = 2;
				...
				else
				{
					...
					if (bVar8)
					{
						func_24(7, &bLocal_240, &iLocal_183, 2097152);
						iLocal_239 = 3;
						func_23(&iLocal_123, 0);
					}
				}
				...
				else if (func_14(iLocal_183, 256))
				{
					...
					else if (!func_14(iLocal_183, 2048))
					{
						if (!func_26())
						{
							if (AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_240) && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE(func_18(4)) == 1)
							{
								iLocal_184 = (1200 + MISC::GET_GAME_TIMER());
					...
					else if (MISC::GET_GAME_TIMER() >= iLocal_184 && !AUDIO::_0x54B187F111D9C6F8(bLocal_240, 0))
					{
						func_15(&iLocal_183, 32768);
						func_11(8);
					}
				}
				else if (MISC::GET_GAME_TIMER() >= iLocal_184)
				{
					if (!func_14(iLocal_183, 2))
					{
						if (func_19(func_18(1)))
						{
							...
							iLocal_184 = MISC::GET_GAME_TIMER() + 6500;
						}
					}
					else if (!func_14(iLocal_183, 4))
					{
						if (func_19(func_18(2)))
						{
							...
							iLocal_184 = MISC::GET_GAME_TIMER() + 5500;
						}
					}
			...
			case 8:
				...
				{
					if (func_29(bLocal_240, 0))
					{
						iLocal_243 = MAP::_BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_ENEMY"), bLocal_240);
					}
				}
				if (!PED::IS_PED_IN_COMBAT(bLocal_240, 0))
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_240, 46, true);
					PED::SET_PED_COMBAT_ATTRIBUTES(bLocal_240, 5, true);
					TASK::TASK_COMBAT_PED(bLocal_240, Global_35, 0, 0);
				}
				func_30(&(iLocal_17[6]));
				break;
			case 7:
				if (MISC::GET_GAME_TIMER() >= iLocal_184)
				{
					...
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(bLocal_240, Global_35, 1000, -1082130432, -1082130432, -1082130432);
					}
					else
					{
						TASK::TASK_TURN_PED_TO_FACE_COORD(bLocal_240, 2022.659f, 618.8069f, 156.3129f, 1000);
					}
					iLocal_184 = (MISC::GET_RANDOM_INT_IN_RANGE(2000, 3500) + MISC::GET_GAME_TIMER());
				}
				break;
		}
...
void func_1()
{
	...
	func_34(&bLocal_240, &uLocal_186, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
	PED::REMOVE_SCENARIO_BLOCKING_AREA(iLocal_188, false);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_241))
	{
		OBJECT::DELETE_OBJECT(&iLocal_241);
	}
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_242))
	{
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_242);
	}
	if (!ENTITY::IS_ENTITY_DEAD(bLocal_240))
	{
		PED::_0x39A2FC5AF55A52B1(bLocal_240, -1);
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&bLocal_240);
	}
...
void func_2()
{
	...
	else if (func_14(iLocal_183, 16777216) && !ENTITY::IS_ENTITY_IN_VOLUME(Global_35, ((*(*Global_1396257)[7 /*638*/])[iLocal_244 /*48*/])->f_47, true, 0))
	{
	...
	else if (func_14(iLocal_183, 16777216) && func_41(7, iLocal_244, &iLocal_189, bLocal_240))
	{
...
void func_3()
{
	...
	if (func_29(bLocal_240, 0))
	{
		if (func_31(Global_35, &(iLocal_17[5]), 0, 1))
		{
			if (((iLocal_179 == 4 || iLocal_179 == 5) || iLocal_179 == 6) || iLocal_179 == 7)
			{
				...
				{
					TASK::TASK_LOOK_AT_ENTITY(bLocal_240, Global_35, -1, 0, 51, 0);
	...
	if (bVar0)
	{
		if (func_14(iLocal_183, 1048576))
		{
			TASK::TASK_CLEAR_LOOK_AT(bLocal_240);
...
void func_4()
{
	if (iLocal_179 == 6)
	{
		if (!PED::IS_PED_HEADTRACKING_ENTITY(Global_35, bLocal_240))
		{
			TASK::TASK_LOOK_AT_ENTITY(Global_35, bLocal_240, -1, 0, 51, 0);
		}
	}
	else if (PED::IS_PED_HEADTRACKING_ENTITY(Global_35, bLocal_240))
	{
...
void func_5()
{
	if (!func_14(iLocal_183, 16384))
	{
		if (func_44(bLocal_240, 0, &uLocal_210, &uLocal_238, 0, 0))
		{
			func_45(Local_144[0 /*17*/], 1);
			func_45(Local_144[1 /*17*/], 1);
	...
	else
	{
		if (!func_14(iLocal_183, 8388608))
		{
			...
			{
				AUDIO::STOP_CURRENT_PLAYING_SPEECH(bLocal_240, 0);
				AUDIO::STOP_CURRENT_PLAYING_AMBIENT_SPEECH(bLocal_240, 0);
				AUDIO::STOP_SCRIPTED_CONVERSATION(func_18(0), false, false);
...
int func_6(int iParam0, int iParam1, bool bParam2, var uParam3, var uParam4, float fParam5, float fParam6, bool bParam7)
{
	if (*uParam4)
	{
		return 0;
	...
	if (bParam7)
	{
		if (AUDIO::IS_SCRIPTED_SPEECH_PLAYING(*bParam2))
		{
			...
			(Global_40.f_11623[iParam0 /*8*/])->f_2 = func_46();
			*uParam4 = 1;
			return 1;
		}
	}
	if (fParam5 == 0f)
	{
		if (!func_47(Global_35, *bParam2, fParam6, 1))
		{
			return 0;
		}
	}
	...
	{
		if (!func_49((Global_40.f_11623[iParam0 /*8*/])->f_2))
		{
			func_50(iParam0);
			*uParam4 = 1;
			func_51(uParam3);
...
void func_7(bool bParam0, int iParam1, int iParam2, int iParam3, float fParam4)
{
	char* sVar0;
	...
	if (fParam4 == 0f)
	{
		if (func_47(bParam0, Global_35, 15f, 1))
		{
...
int func_9(bool bParam0, int* iParam1, float fParam2, var uParam3, int iParam4, float fParam5, int iParam6, int iParam7, char* sParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)
{
	int iVar0;
	var uVar1;
	...
	uVar1 = func_58(bParam0, iParam1, fParam2, uParam3, fParam5, iParam6, iParam7, sParam8, iParam9, iParam10, iParam11, iParam12, fParam14);
	if (!func_57(iVar0, 134217728))
	{
		func_59(iParam1, uParam3, bParam0);
	}
	if (!*iParam4)
	{
...
{
	func_62();
	HUD::_TEXT_DATABASE_REQUEST("SPCWCAU");
	HUD::_TEXT_DATABASE_REQUEST("SPCW");
	STREAMING::REQUEST_MODEL(bLocal_14, false);
	STREAMING::REQUEST_MODEL(iLocal_15, false);
	STREAMING::REQUEST_MODEL(iLocal_16, false);
	STREAMING::REQUEST_ANIM_DICT(func_63());
	func_64();
	func_65(&(iLocal_17[0]), "SP_CWC_Block", 1, 0, 0, 0, -1082130432 /* Float: -1f */);
	POPULATION::_0xB56D41A694E42E86(&(iLocal_17[4]), 2500607, 0, 0, -1, -1, 10);
	iLocal_188 = func_66(&(iLocal_17[4]), 0, 0, 0);
	PED::_0xED9582B3DA8F02B4(1);
	iLocal_182 = ANIMSCENE::_CREATE_ANIM_SCENE(func_67(), 0, func_16(0), false, true);
	ANIMSCENE::LOAD_ANIM_SCENE(iLocal_182);
	func_68(&iLocal_189);
	func_69(&uLocal_210);
...
void func_11(int iParam0)
{
	...
	{
		case 5:
			func_79(bLocal_240, 0);
			iLocal_184 = MISC::GET_GAME_TIMER() + 2000;
			TASK::TASK_AIM_GUN_AT_ENTITY(bLocal_240, Global_35, -1, false, 1);
			iLocal_184 = MISC::GET_GAME_TIMER() + 7000;
			sLocal_181 = func_16(func_25());
			ANIMSCENE::RESET_ANIM_SCENE(iLocal_182, sLocal_181);
			ANIMSCENE::LOAD_ANIM_SCENE(iLocal_182);
			break;
		case 6:
			PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), bLocal_240, "COMMANDO_INTERACT_FOCUS", 0f, 0f, 0f, false, "CommandoConvo");
			func_80(bLocal_240);
			func_45(Local_144[0 /*17*/], 1);
			func_45(Local_144[1 /*17*/], 1);
			iLocal_184 = MISC::GET_GAME_TIMER() + 5000;
			TASK::TASK_TURN_PED_TO_FACE_ENTITY(Global_35, bLocal_240, 2000, -1082130432, -1082130432, -1082130432);
			PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0, false);
			TASK::CLEAR_PED_TASKS(bLocal_240, 1, 0);
			if (func_81())
			{
			...
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, sVar0, Global_35, 0);
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "p_cs_rag01x", iLocal_241, 0);
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "U_M_O_CmrCivilwarcommando_01", bLocal_240, 0);
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "p_chair02x", iLocal_242, 0);
			func_15(&iLocal_183, 262144);
			break;
		case 7:
			PLAYER::_0x946D46CD6DFB9742(PLAYER::GET_PLAYER_INDEX(), 0, MISC::GET_HASH_KEY("DISCOVERABLE_NAME_COMMANDO_01"));
			func_45(Local_144[0 /*17*/], 0);
			func_45(Local_144[1 /*17*/], 0);
			func_22(Local_144[0 /*17*/], "INTERACT_GREET");
			func_35();
			break;
		case 8:
			func_50(7);
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(bLocal_240, ENTITY::GET_ENTITY_COORDS(bLocal_240, true, false), 6f, false, false, 0);
...
int func_12()
{
	if (!HUD::_TEXT_DATABASE_HAS_LOADED("SPCWCAU") || !HUD::_TEXT_DATABASE_HAS_LOADED("SPCW"))
	{
		return 0;
	}
	if (!STREAMING::HAS_MODEL_LOADED(bLocal_14))
	{
		return 0;
	}
...
int func_13()
{
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(bLocal_240, joaat("REL_NO_RELATIONSHIP"));
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(bLocal_240, true);
		PED::SET_PED_KEEP_TASK(bLocal_240, true);
		func_87(bLocal_240, 7);
		if (func_88())
		{
		...
		func_89(&uLocal_25, bLocal_240, "COMMANDO", 0);
		func_90(&bLocal_240, &uLocal_186, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, -1082130432 /* Float: -1f */);
		func_91();
		if (func_81())
		{
			if (iLocal_244 == 0 || iLocal_244 == 2)
		...
		PED::_0x7C00CFC48A782DC0(&(iLocal_17[6]), bLocal_240, 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "U_M_O_CmrCivilwarcommando_01", bLocal_240, 0);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "p_cs_rag01x", iLocal_241, 0);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, sVar5, Global_35, 0);
		ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_182, "p_chair02x", iLocal_242, 0);
		ANIMSCENE::START_ANIM_SCENE(iLocal_182);
		return 1;
	}
...
bool func_17(bool bParam0, bool bParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
	...
	if (!func_47(bParam0, bParam1, fParam3, 1))
	{
		return false;
	}
...
void func_21()
{
	...
	{
		if (func_99(&bLocal_240, 1715123483))
		{
...
{
	if (func_97(iParam0->f_6) && !MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
	{
...
void func_24(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	...
	if ((Global_40.f_11623[iParam0 /*8*/])->f_6 == 1 && func_102(func_101(joaat("SPECIAL_PED_INTERACTION"))) < 5)
	{
		func_103(func_101(joaat("SPECIAL_PED_INTERACTION")), 1);
	}
	(Global_40.f_11623[iParam0 /*8*/])->f_3 = func_46();
...
void func_34(bool bParam0, var uParam1, int iParam2, float fParam3, bool bParam4)
{
	if (bParam4)
	{
...
void func_35()
{
	...
	PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "CommandoConvo");
...
int func_41(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 30) == 0)
	{
		if (iParam2->f_6)
		{
			if (!(func_113(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_19) == 0 && func_113(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_20) == 23))
			{
				iVar0 = func_46();
		...
		if (iParam2->f_7)
		{
			...
			if (((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_40 != 4)
			{
				...
				{
					if (((func_114(&(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_5[0])) || func_114(&(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_5[1]))) || func_115(&(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_5[0]))) || func_115(&(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_5[1])))
					{
						bVar3 = true;
					}
				}
				if (!bVar3)
				{
					if (!func_116(((*(*Global_1396257)[iParam0 /*638*/])[iParam1 /*48*/])->f_40))
					{
						func_15(iParam2, 64);
					}
				}
		...
		if (iParam2->f_8)
		{
			...
			{
				if (func_117(&bParam3, &(iParam2->f_18), iParam2->f_11, iParam2->f_12) || func_118(&bParam3, &(iParam2->f_20), &(iParam2->f_19), iParam2->f_11, iParam2->f_12, 2048))
				{
...
int func_44(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_125(bParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				if (func_126(bParam0, uParam2))
				{
					*uParam3 = 8;
					func_125(bParam0, uParam2, *uParam3);
					return 1;
				}
				else if (func_127(bParam0, bParam1, uParam2))
				{
					*uParam3 = 8;
					func_125(bParam0, uParam2, *uParam3);
					return 1;
		...
		{
			if (func_130(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_131(Global_35, bParam0, uParam2))
					{
						*uParam3 = 4;
						func_125(bParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_132(Global_35, bParam0, uParam2))
					{
						*uParam3 = 256;
						func_125(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_133(Global_35, bParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_125(bParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_133(Global_35, bParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_125(bParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_137(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_138(uParam2, bParam0)) && func_139(uParam2, bParam0))
					{
						*uParam3 = 2;
						func_125(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_137(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_138(uParam2, bParam0)) && func_139(uParam2, bParam0))
				{
					*uParam3 = 2;
					func_125(bParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_140(bParam0, Global_1935630->f_41))
							{
								func_141();
								*uParam3 = 2;
								func_125(bParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_142(uParam2, bParam0) || (uParam2->f_9 > 0 && (func_143() - uParam2->f_9) < 2000))
				{
					if (PED::IS_PED_RAGDOLL(bParam0))
					{
						func_141();
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_144())
					{
						if (func_140(bParam0, Global_1935630->f_42))
						{
							func_141();
							*uParam3 = 2;
							func_125(bParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_146(bParam0, bParam1, uParam2))
				{
					*uParam3 = 2048;
					func_125(bParam0, uParam2, *uParam3);
					return 1;
...
int func_47(bool bParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return 0;
...
int func_58(bool bParam0, int* iParam1, float fParam2, var uParam3, float fParam4, int iParam5, int iParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*bParam0))
	{
		...
		fVar8 = func_155(fParam12 >= 0f, fParam12, BUILTIN::VDIST(Global_36, ENTITY::GET_ENTITY_COORDS(*bParam0, true, false)));
		...
		if (func_156(*bParam0, iParam1, uParam3))
		{
			return -1;
		}
		switch (iParam1->f_2)
		{
			case 0:
				if (bVar2)
				{
					if (func_157(bParam0, iParam1, uParam3, fParam2, iParam8, sParam7, iParam11, fVar8))
					{
						iParam1->f_1 = -1;
						iParam1->f_2 = 1;
						return func_58(bParam0, iParam1, fParam2, uParam3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, fParam12);
					}
				}
				break;
			case 1:
				...
				if (!iParam8 & 33554432 != 0)
				{
					if (iParam8 & 18 != 0)
					{
						...
						{
							func_159(*bParam0, 1, 1);
						}
					}
					else if (func_160(iParam1, 22))
					{
						func_159(*bParam0, 0, 1);
					}
				}
				if (func_161(bParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
					func_162(bParam0, 1, iParam1, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4);
					func_163(iParam8);
					if (func_164(bParam0, iParam1, fVar8, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4, bVar7, bVar5, bVar1, 0))
					{
				...
				else
				{
					...
					if (func_167(*bParam0, iParam1, uParam3))
					{
						return iParam1->f_1;
					}
			...
			case 3:
				break;
			case 4:
				if (func_169(bParam0, iParam1, fParam4, bVar6))
				{
					iVar0 = iParam1->f_1;
					iParam1->f_9 = 0;
					iParam1->f_1 = -1;
			...
			case 2:
				if (func_161(bParam0, iParam8, iParam9, MISC::IS_BIT_SET(*iParam1, 4)))
				{
					func_170(*bParam0, iParam1, uParam3, fParam2, iParam5, iParam6, iParam10, bVar3);
					func_164(bParam0, iParam1, fVar8, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4, bVar7, bVar5, bVar1, 1);
					func_162(bParam0, func_161(bParam0, iParam8, iParam9, 0), iParam1, fParam2, uParam3, bVar3, fParam4, iParam5, iParam6, sParam7, iParam8, iParam9, iParam10, iParam11, bVar4);
					func_163(iParam8);
				}
...
void func_59(int* iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	char* sVar1;
	var uVar2;
	...
	if (iVar0 != -1)
	{
		...
		{
			func_173(Global_35, *bParam2, sVar1, "", -1082130432 /* Float: -1f */, uVar2, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
		}
	}
}
...
void func_64()
{
	iLocal_17[0] = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 100f, 100f, 100f, "CWC_VOL_RANDOM_EVENT_BLOCKER");
	iLocal_17[1] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 5f, 5f, 7f, "CWC_VOL_LOOK_IK");
	iLocal_17[2] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 8f, 8f, 7f, "CWC_VOL_SPEECH_RANGE");
	iLocal_17[3] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 5f, 5f, 7f, "CWC_VOL_TALK_RANGE");
	iLocal_17[4] = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 3f, 3f, 7f, "CWC_VOL_PED_AVOIDANCE");
	iLocal_17[6] = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), 2015.593f, 623.3331f, 157.6585f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
	VOLUME::_0x5B23DFF8E0948BB2(&(iLocal_17[6]), 0);
	VOLUME::_0xBE551C2CC421185D(&(iLocal_17[6]), 1);
	iLocal_17[5] = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("CWC_VOL_LOOK_AT");
	VOLUME::_0x39816F6F94F385AD(&(iLocal_17[5]), 2023.958f, 617.214f, 158.8349f, 0f, 0f, -30f, 23f, 35f, 15f);
	VOLUME::_0x39816F6F94F385AD(&(iLocal_17[5]), 2025.146f, 631.483f, 158f, 0f, 0f, -30f, 35f, 18f, 16f);
	VOLUME::_0x39816F6F94F385AD(&(iLocal_17[5]), 2016.196f, 625.6975f, 158.8349f, 0f, 0f, -30f, 4f, 3f, 15f);
	VOLUME::_0x39816F6F94F385AD(&(iLocal_17[5]), 2007.084f, 613.6472f, 158.8349f, 0f, 0f, -30f, 6f, 12f, 15f);
}

int func_65(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_179(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}

int func_66(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_80(bool bParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		if (DECORATOR::DECOR_EXIST_ON(bParam0, "honor_block"))
		{
			DECORATOR::DECOR_REMOVE(bParam0, "honor_block");
		}
	}
}
...
int func_84(var uParam0, vector3 vParam1, var uParam4)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_240))
	{
		return 1;
	}
	bLocal_240 = func_190(bLocal_14, vParam1, uParam4, 0, 1, 0, 1, 1, 1, 0, 0, 0, 0);
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_240))
	{
		*uParam0 = 1;
		return 1;
...
int func_85(var uParam0, vector3 vParam1)
{
	...
	iLocal_241 = OBJECT::CREATE_OBJECT(iLocal_15, vParam1, true, true, false, false, true);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_241))
	{
		*uParam0 = 1;
		return 1;
...
int func_86(var uParam0)
{
	...
	iLocal_242 = OBJECT::CREATE_OBJECT(iLocal_16, 2015.818f, 623.6882f, 157.6772f, true, true, false, false, true);
	ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iLocal_242, 2015.818f, 623.6882f, 157.6772f, 48.79f, true, false, true);
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_242))
	{
		*uParam0 = 1;
		return 1;
...
void func_89(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam1))
	{
		return;
	...
	if (func_191(uParam0, bParam1, sParam2))
	{
...
void func_90(bool bParam0, var uParam1, int iParam2, float fParam3, float fParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*bParam0))
	{
		return;
...
void func_91()
{
	...
	uVar0 = func_192(&iVar1);
	func_194(Local_144[0 /*17*/], "INTERACT_GREET", func_193(), joaat("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 1, 0);
	func_194(Local_144[1 /*17*/], "INTERACT_INSULT", uVar0, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 1, iVar1);
	func_195(bLocal_240, &Local_144, 20f, 2, 0, 0, 0, 0, 0);
	func_20(Local_144[0 /*17*/], 1, 0);
	func_20(Local_144[1 /*17*/], 1, 0);
	iLocal_239 = 3;
	func_23(&iLocal_123, 0);
	PED::SET_PED_CONFIG_FLAG(bLocal_240, 297, true);
}

bool func_92(int iParam0, int iParam1, float fParam2)
{
	return func_196(iParam0, ENTITY::GET_ENTITY_COORDS(iParam1, false, false), fParam2);
}
...
int func_115(int iParam0)
{
	...
	return func_203(((*Global_1835011)[iParam0 /*74*/])->f_1);
}
...
int func_117(bool bParam0, var uParam1, float fParam2, var uParam3)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_118(bool bParam0, var uParam1, var uParam2, float fParam3, float fParam4, int iParam5)
{
	float fVar0;
	int iVar1;
	vector3 vVar2;
	...
	else
	{
		...
		if (!func_207(iVar1, 0))
		{
			func_208(&iVar1, vVar8, 1083179008 /* Float: 4.5f */);
		}
		return 1;
	}
	return 0;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_211(1) || *uParam0 & 8192 != 0))
				{
...
int func_124(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case joaat("EVENT_DEAD_PED_FOUND"):
			...
			if (!func_214(bParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_215(bParam0, iVar2) <= func_216(uParam1))
			{
				return 1;
			}
			break;
...
void func_125(bool bParam0, var uParam1, int iParam2)
{
	if (iParam2 != 16384)
	{
...
int func_126(bool bParam0, var uParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_220(bParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			if (func_222(uParam1, bParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_127(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	...
	fVar0 = 85f;
	if (func_224(bParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		if (func_222(uParam2, bParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_223(uParam2)
				{
					func_218(uParam2, 1);
					return 1;
				}
...
int func_128(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
	...
	if (func_214(bParam0, uParam1, bVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_223(uParam1)
		{
...
int func_131(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_132(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
int func_133(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_229(bParam1, vVar0, vVar4))
					{
						func_218(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_229(bParam1, vVar0, vVar7))
					{
						func_218(uParam2, 1);
						return 1;
					}
...
int func_134(bool bParam0, var uParam1)
{
	int iVar0;
	float fVar1;
	vector3 vVar2[2];
	...
	{
		if (!func_214(bParam0, uParam1, &(Global_1935630->f_34[iVar0])) || bParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_232(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_233(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_234(uParam1, bParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
...
int func_135(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_137(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int func_140(bool bParam0, bool bParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		...
		if (func_238(bParam0, bParam1, 1, 1) < 4f)
		{
...
int func_142(var uParam0, bool bParam1)
{
	...
	if (bVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(bVar0)))
	{
		...
		if (func_239(bVar0, bParam1, vVar1))
		{
...
int func_146(bool bParam0, bool bParam1, var uParam2)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	return func_244(bParam0, bParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}

int func_147(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar1)
	{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(bParam0, bVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_246(uParam1, bParam0))
					{
						if (func_240(bVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_151(bool bParam0, var uParam1)
{
	...
	{
		return func_249(bParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_156(bool bParam0, int* iParam1, var uParam2)
{
	if (iParam1->f_11 != 0)
	{
		if (func_250(bParam0, iParam1))
		{
...
int func_157(bool bParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	int iVar5;
	...
	if (!ENTITY::IS_ENTITY_DEAD(*bParam0))
	{
		...
		iVar5 = func_252(*bParam0, iParam1, uParam2, fParam3, bVar4);
		if (bVar4)
		{
			PED::SET_PED_CONFIG_FLAG(*bParam0, 178, false);
			return 1;
		...
		if (MISC::_0x870708A6E147A9AD(*bParam0, &cVar0, fParam3, fParam3, iVar6, iParam1->f_7, iParam1->f_8, iVar5, 0, iParam1->f_6))
		{
			...
			if (func_57(iParam4, 268435456))
			{
				iVar8 = func_254(uParam2, joaat("INPUT_INTERACT_LOCKON_NEG"));
				if (iVar8 > -1)
				{
					func_255(iParam1, (*uParam2)[iVar8 /*17*/]);
				}
			}
...
int func_161(bool bParam0, int iParam1, int iParam2, bool bParam3)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bVar0)
	{
		...
		if (func_256(*bParam0, bParam3, bVar2, bVar3))
		{
			return 1;
		}
	}
...
void func_162(bool bParam0, bool bParam1, int* iParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14)
{
	int iVar0;
	...
	if (bParam1)
	{
		if (!MISC::IS_BIT_SET(*iParam2, 1))
		{
			...
			func_195(*bParam0, uParam4, fParam3, iParam7, iParam8, iParam12, func_57(iParam10, 32), 1, 0);
...
bool func_164(bool bParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	int iVar0;
	int iVar1;
	bool bVar2;
	...
	bVar11 = (((PED::_0xA911EE21EDF69DAF(Global_35) || func_258(Global_35)) || func_259(Global_35)) || func_260(Global_35));
	fVar12 = -1f;
	...
	while (iVar0 < *uParam4)
	{
		...
		bVar4 = func_97(((*uParam4)[iVar0 /*17*/])->f_6);
		func_261(*bParam0, (*uParam4)[iVar0 /*17*/], fParam3, iParam7, iParam8, iParam12, bParam5);
		if (MISC::IS_BIT_SET(uParam4[iVar0 /*17*/], 20))
		{
			bVar3 = true;
		}
		if (func_262(*bParam0, iParam1, (*uParam4)[iVar0 /*17*/], bVar4, fParam3, fParam2, iParam7, iParam8, bParam14, bParam16, bParam17, bVar9, bVar10, bParam15, fVar12, bVar11, iVar1))
		{
			if (!bParam18 && !bVar5)
			{
				if (func_263(iParam12, ((*uParam4)[iVar0 /*17*/])->f_6))
				{
					if (!bVar7)
					{
					...
					{
						func_189(iParam1, uParam4, MISC::IS_BIT_SET(*iParam1, 6));
					}
					iParam1->f_1 = iVar0;
					bVar5 = true;
...
void func_168(var uParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < *uParam0)
	{
		if (bParam3)
		{
			if (func_97(((*uParam0)[iVar0 /*17*/])->f_6))
			{
				...
				{
					func_98(&(((*uParam0)[iVar0 /*17*/])->f_6), 1, 1);
					if (bParam2)
					{
...
int func_169(bool bParam0, int* iParam1, float fParam2, bool bParam3)
{
	if (iParam1->f_9)
	{
...
void func_170(int iParam0, int* iParam1, var uParam2, float fParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	...
	iVar0 = iParam1->f_5;
	func_261(iParam0, (*uParam2)[iVar0 /*17*/], fParam3, iParam4, iParam5, iParam6, bParam7);
	iParam1->f_5++;
}
...
bool func_173(bool bParam0, bool bParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_272(bParam0, bParam1, sParam2, sParam3, fParam4, uParam5, bParam6, bParam7, iParam8, bParam9, bParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
int func_179(vector3 vParam0, float fParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_189(int* iParam0, var uParam1, bool bParam2)
{
	...
	{
		func_98(&(((*uParam1)[iParam0->f_3 /*17*/])->f_6), 1, 1);
		if (bParam2)
		{
			func_23(iParam0, 0);
		}
...
bool func_190(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_282(bVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}

bool func_191(var uParam0, bool bParam1, char* sParam2)
{
	bool bVar0;
	int iVar1;
...
void func_194(int* iParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8)
{
	iParam0->f_5 = sParam1;
	iParam0->f_7 = iParam3;
	iParam0->f_8 = iParam6;
...
void func_195(bool bParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	...
	while (iVar0 < *uParam1)
	{
		func_285(bParam0, (*uParam1)[iVar0 /*17*/], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
bool func_196(bool bParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
void func_197(char[4] cParam0, char[4] cParam1, char[4] cParam2, var uParam3)
{
	int iVar0;
...
int func_205(var uParam0, vector3 vParam1, bool bParam4)
{
...
int func_206(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_208(int iParam0, vector3 vParam1, float fParam4)
{
...
int func_214(bool bParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar1 = func_243(bParam2);
	}
	else
	{
		iVar1 = func_242(bParam2);
	}
	if (!PED::IS_PED_HUMAN(bParam0))
	{
...
{
	return func_238(bParam0, bParam1, 1, 1);
}
...
int func_220(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_238(bVar0, bParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_296(bVar0, 0)))
		{
			if (func_297(bParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_222(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_224(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_296(bVar0, 0)))
		{
			if (func_298(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_229(bool bParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_196(bParam0, vParam4, 0.5f))
	{
...
int func_232(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_233(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_234(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_236(bool bParam0, bool bParam1)
{
	...
	if (func_301(bParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return 0;
	}
...
float func_238(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_239(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_240(bParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
float func_240(bool bParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return 0f;
...
int func_244(bool bParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_238(bParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_238(bParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_245(bool bParam0, var uParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;

	func_293(1, &bVar0, &bVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		if (bVar0 != bParam0)
		{
			if (PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
				{
					if (!bParam2 || !func_246(uParam1, bVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		if (bVar1 != bParam0)
		{
			...
			{
				if (!bParam2 || !func_246(uParam1, bVar1))
				{
					if (func_240(bVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_247(int iParam0)
{
	...
	return func_302(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_249(bool bParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
int func_250(bool bParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (PED::IS_PED_IN_COMBAT(bParam0, func_303((bVar1 && !bVar0), Global_35, 0)))
		{
			return 1;
		}
	}
...
void func_251(var uParam0)
{
	...
	while (iVar0 < *uParam0)
	{
		if (func_267((*uParam0)[iVar0 /*17*/]))
		{
			func_95((*uParam0)[iVar0 /*17*/], 14);
		}
		iVar0++;
	}
}

int func_252(bool bParam0, int* iParam1, var uParam2, float fParam3, bool bParam4)
{
	int iVar0;
	...
	if (iParam1->f_3 > -1 && iParam1->f_3 < *uParam2)
	{
		...
		func_285(bParam0, (*uParam2)[iVar0 /*17*/], fParam3, 3, 0, 6, bParam4, 0);
		if (func_97(((*uParam2)[iVar0 /*17*/])->f_6))
		{
			func_95((*uParam2)[iVar0 /*17*/], 11);
...
void func_261(bool bParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	if (MISC::IS_BIT_SET(*iParam1, 14))
	{
		if (func_267(iParam1))
		{
			...
			func_285(bParam0, iParam1, fParam2, iParam3, iParam4, iParam5, bParam6, 0);
		}
	}
}
...
void func_264(var uParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar0 < *uParam0)
	{
		func_20((*uParam0)[iVar0 /*17*/], bParam1, bParam2);
		iVar0++;
	}
}

int func_265(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
...
int func_272(bool bParam0, bool bParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	bool bVar0;
	float fVar1;
	int iVar2;
	...
	if (bParam9)
	{
		if (bParam0 != Global_35 && bParam1 != Global_35)
		{
			if (!ENTITY::IS_ENTITY_DEAD(bParam0))
			{
				if (func_317(bParam0, 1, 1) > fParam4)
				{
					return -1;
				}
			}
	...
	if ((!ENTITY::IS_ENTITY_DEAD(bParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		if (!bVar0)
		{
			fVar1 = func_238(bParam0, bParam1, 1, 1);
		}
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			if (!bVar0 && bParam10)
			{
				...
				if (func_318(bParam0, bParam1, fVar1, bParam13))
				{
			...
			{
				iVar2 = func_320(func_319(bParam0, sParam2, iParam11, bParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, uParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
void func_282(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_321(bParam1))
		{
			func_322(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_285(bool bParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	char* sVar0;
	int iVar1;
	...
	if (!func_97(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		sVar0 = iParam1->f_5;
		if (func_267(iParam1))
		{
			...
			iParam1->f_6 = func_330(sVar0, iParam1->f_7, bParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_97(iParam1->f_6))
			{
				if (!bParam6)
				{
					iVar1 = -1;
					func_311(iParam1->f_6, bParam0, 0, 1, iVar1);
				}
				else
				{
...
var func_296(bool bParam0, int iParam1)
{
	var uVar0;
...
int func_297(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_298(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_298(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
int func_299(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_301(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_311(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
	...
	if (iParam4 == -1)
	{
		iParam4 = HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY(bParam1);
	}
...
float func_317(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return -1f;
	}
	return func_238(Global_35, bParam0, bParam1, bParam2);
}

int func_318(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return 0;
...
bool func_319(bool bParam0, char* sParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, var uParam6, int iParam7)
{
	struct<7> Var0;
...
void func_323(bool bParam0, int iParam1, bool bParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return;
...
void func_327(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1945938)[iParam0 /*18*/])->f_3))
	{
		if (((*Global_1945938)[iParam0 /*18*/])->f_5 == 5 && !func_333(iParam0, 8))
		{
...
int func_330(char* sParam0, int iParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_333(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_343(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, bParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
var func_338(bool bParam0, var uParam1)
{
...
bool func_341(bool bParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
void func_343(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, int iParam10, bool bParam11, int iParam12, int iParam13, int iParam14, int iParam15, bool bParam16, int iParam17, bool bParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
	int iVar0;
