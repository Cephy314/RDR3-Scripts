...
int func_428(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_460(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_333(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
		...
		while (iVar28 < 4)
		{
			...
			if (func_485(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_489(0))
				{
					...
					func_490(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
void func_491(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_508(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
