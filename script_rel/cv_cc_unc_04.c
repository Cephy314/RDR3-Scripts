...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.573273f, 1.16449f, 0.496552f, -23.76f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.526581f, -1.20927f, 0.502571f, -21.96f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	...
	uLocal_16 = func_153(uParam0, "script@vignette@uncle_4@action", 0, 0, 1, 0);
	func_154(uParam0, "CUNC4AU");
	func_155(uParam0, joaat("COMP_UNCCNV4"), joaat("PLAYER_UNCCNV4"));
	func_156(uParam0, uLocal_16, -1, 0.94f);
	func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, 1, -1);
	func_157(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), "PROP_CAMP_SEAT_CHAIR_TABLE_STEW_EATING_MALE_A", iLocal_18, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_159(uParam0, iLocal_15, 1, 5, 0, 0, 0);
	func_158(uParam0, iLocal_15, 1, -1);
	STREAMING::_0x19A6BE7D9C6884D3(joaat("PROP_CAMP_SEAT_CHAIR_TABLE_STEW"), 1, 0, 0);
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_192(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_192(uParam0, uParam0->f_1976.f_1), 1, func_252(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_265(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_192(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
