		...
		switch (iLocal_13)
		{
			...
			case 4:
				...
				while (iVar1 < 12)
				{
					...
					{
						if ((TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_0[iVar1]), -708058584, true) == 8 || iLocal_18[iVar1]) /* PointerArith */)
						{
							iVar2 = 0;
							switch (iVar2)
							{
			...
			case 5:
				...
				while (iVar1 < 12)
				{
					if (!PED::IS_PED_INJURED(&(uLocal_0[iVar1])))
					{
						if (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_0[iVar1]), 475934052, true) != 8)
						{
						}
						else
						{
...
void func_15(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_16(bParam1))
		{
			func_17(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
