		...
		case 3:
			if (func_52(Global_35, func_51(1), 75f, 1, 1))
			{
				if (!PED::IS_PED_IN_ANY_TRAIN(Global_35) && func_53(Global_35, func_51(0), 0))
				{
					...
					Local_14.f_5 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_TERRIFYING_NEW"), func_51(1), 30f, 100f, 150f, -1082130432, -1082130432, -1, -1);
					func_50(&Local_14, 4);
				}
			}
			break;
...
int func_184(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
{
	return func_200(joaat("CHARACTER"), func_201(), -1591664384, bParam0);
}
