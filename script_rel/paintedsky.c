...
int func_11()
{
	bLocal_163 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-606.3235f, -34.1014f, 89.13992f, 0f, 0f, -2.960119f, 91.8399f, 128.2035f, 27.99896f, "Painted Sky - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_167 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Painted Sky - m_volRancherThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -615.0529f, -8.683389f, 84.73939f, 0f, 0f, -61.07222f, 13.06188f, 14.76316f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -630.0898f, -64.73701f, 84.73939f, 0f, 0f, -84.96833f, 20.24605f, 11.7424f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -610.8533f, -30.41994f, 84.73939f, 0f, 0f, -69.27884f, 18.54069f, 7.558324f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -607.0614f, -55.91715f, 84.36602f, 0f, 0f, -86.2037f, 1.607721f, 1.071148f, 2.286196f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -615.6726f, -33.24317f, 84.73939f, 0f, 0f, 20.71626f, 3.79069f, 17.96073f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -618.952f, -32.05656f, 84.73939f, 0f, 0f, -69.27884f, 14.59728f, 1.46241f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -619.0227f, -36.83093f, 84.73939f, 0f, 0f, -69.27884f, 5.661715f, 1.862059f, 9.1551f);
		VOLUME::_0x39816F6F94F385AD(bLocal_167, -619.5566f, -25.02375f, 84.73939f, 0f, 0f, -60.00019f, 1.92512f, 5.056171f, 9.1551f);
		bLocal_166 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Painted Sky - m_volRancherRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_166, bLocal_167);
		VOLUME::_0xBCE668AAF83608BE(bLocal_166, -618.1764f, -35.07673f, 84.00621f, 0f, 0f, -116.2442f, 43.7f, 24.97202f, 13f);
		bLocal_165 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Painted Sky - m_volRancherWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_165, bLocal_166);
		VOLUME::_0xBCE668AAF83608BE(bLocal_165, -618.1764f, -35.07673f, 84.00621f, 0f, 0f, -116.2442f, 52.7998f, 35.21894f, 13f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_165, -589.9137f, -38.42014f, 87.95631f, 0f, 0f, 28.26761f, 18.40042f, 17.08066f, 7.654564f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_165, -584.0537f, -0.019895f, 87.95631f, 0f, 0f, 28.26761f, 21.42276f, 31.19608f, 7.654564f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_165, -595.9303f, -72.77682f, 87.95631f, 0f, 0f, 28.26761f, 35.98802f, 20.27966f, 7.654564f);
		sLocal_164 = "PAINTED_SKY";
		LAW::_CREATE_GUARD_ZONE(sLocal_164);
		LAW::_0x8C598A930F471938(sLocal_164, bLocal_163);
		LAW::_0xA1B0E6301E2E02A6(sLocal_164, bLocal_167);
		LAW::_0x35815F372D43E1E5(sLocal_164, bLocal_166);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_164, bLocal_165);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_164, -611.6139f, -28.3574f, 86.919f);
		LAW::_0xA8A74AA79FB67159(sLocal_164, bLocal_165);
	}
	return 1;
}
...
void func_28(int iParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_165))
	{
		func_51(885, bLocal_165, 1);
		func_51(780, bLocal_165, 0);
		func_51(781, bLocal_165, 0);
		VOLUME::_0x4A8FEFC43FD8AC9B(bLocal_165, 3, 1);
		VOLUME::_0x53D05D60E5F5B40C(bLocal_165, 3, 1, func_52(781));
		VOLUME::_0x53D05D60E5F5B40C(bLocal_165, 3, 1, func_52(780));
		if (func_53(8))
		{
			PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_54(885), func_54(781), 0);
		}
		else
		{
			PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_54(780), func_54(781), 0);
		}
	}
}
...
void func_79(int iParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_165))
	{
		VOLUME::_0x998202B206872672(bLocal_165);
		VOLUME::_0x6D5F9E69BA1BE783(bLocal_165);
		func_130(bLocal_165);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_166))
	{
		VOLUME::_0x6D5F9E69BA1BE783(bLocal_166);
		func_130(bLocal_166);
	}
	if (func_20() == -1)
	{
...
void func_154(var uParam0)
{
	...
	func_199(&uLocal_18, bVar3, uParam0->f_37, 0);
	...
	if (!func_142(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			bVar5 = func_54(&(uParam0->f_3[iVar4 /*3*/]));
			if (!func_198(bVar5, 0))
			{
				return;
			}
			...
			Call_Loc(uParam0->f_44);
			sVar6 = StackVal;
			func_199(&uLocal_18, bVar5, sVar6, 0);
...
int func_190(var uParam0, bool bParam1)
{
	...
	if (!func_237(bVar0, func_142(uParam0, 2048)))
	{
		return 0;
	}
	if (uParam0->f_30 == 0)
...
int func_195(var uParam0, int iParam1)
{
	...
	if (func_142(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			bVar1 = func_54(&(uParam0->f_3[iVar0 /*3*/]));
			if (func_198(bVar1, 0) && func_240(bVar1, iParam1, 1, 1) <= 4f)
			{
				uParam0->f_21 = iVar0;
				return 1;
			}
...
void func_199(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	...
	if (func_248(uParam0, bParam1, sParam2))
	{
...
int func_201(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	...
	else if (func_249(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		bVar0 = uParam0[0 /*4*/];
		bVar1 = uParam0[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(bVar0) && !func_250(bVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(bVar1) && !func_250(bVar1, 0)))
		{
			if (!func_251(vParam4))
			{
...
int func_231(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_267(bVar0, 0)))
		{
...
float func_240(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_248(var uParam0, bool bParam1, char* sParam2)
{
	bool bVar0;
	int iVar1;
...
var func_267(bool bParam0, int iParam1)
{
	var uVar0;
