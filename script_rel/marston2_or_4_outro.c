...
{
	return func_53(bParam0, &(Global_1946804->f_1949));
}
...
{
	return func_90(bParam0, iParam1, &(Global_1946804->f_1949), 1, 0, 0);
}

bool func_53(bool bParam0, var uParam1)
{
	int iVar0;
...
int func_87(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_37(bVar0, 0))
	{
		if (func_37(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
int func_90(bool bParam0, int iParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (uParam2->f_1 != 0 && func_121(uParam2, 1))
	{
		if (uParam2->f_1 == iVar1)
		{
			if (bParam3)
			{
				return func_122(bParam0, uParam2);
			}
			else
			{
				return 1;
...
int func_122(bool bParam0, var uParam1)
{
	...
	return func_53(bParam0, uParam1);
}
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*74*/])->f_27))
	{
		...
		if (func_226(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_227((*Global_1835011)[iParam0 /*74*/], 2))
			{
				if (func_91(iParam0))
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_92(iParam0));
					bVar2 = true;
				}
				else
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_55(iParam0));
				}
			}
			...
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_RADIUS(joaat("BLIP_STYLE_MISSION"), func_230(iParam0), func_231(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_91(iParam0))
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_154(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_92(iParam0));
		...
		else if (func_153(iParam0))
		{
			if (iParam0 == 7)
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_RCM"), func_55(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_55(iParam0));
