...
{
	func_33(uParam0, 10732, 10769, 11858);
}
...
{
	func_46(uParam0, "EAGLE_DIVE_CATCH_FISH", "script@ambient@animal@eagle_dive_catch_fish@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "EAGLE", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_48(uParam0, 1, "FISH", iLocal_10, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	...
	sVar0 = "script_amb@animal@eagle_dive_catch_fish";
	sVar1 = "eagle_exit_a";
	sVar2 = "fish_exit_a";
	vVar3 = { 0f, 0f, 0f };
	vVar6 = { 0f, 0f, 0f };
	if (!&uParam0->f_469[0])
	{
		...
		if (!bLocal_39 == 1)
		{
			if ((func_60(uParam0, &uLocal_11, 0) || func_61(&(uParam0->f_20[0 /*14*/]), Global_35, 1) < 225f) || func_62(Global_35, uParam0->f_483, 1) < 49f)
			{
				bLocal_39 = true;
			}
		}
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_72(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("action"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[6] = 1;
				}
							...
							if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
							{
								if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
								{
									if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[1 /*14*/])))
									{
										...
										ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), PED::GET_PED_BONE_INDEX(&(uParam0->f_20[0 /*14*/]), 38142), vVar3, vVar6, true, false, false, false, 2, true, true, false);
