...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_53(uParam0, 0, "BARBER", uVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_53(uParam0, 1, "CUSTOMER", uVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_201(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
