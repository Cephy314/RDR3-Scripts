...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.3f, 0.8f, 0.4f, -12f, 3.75f, 2.5f, 2f, joaat("VOLBOX"), 1);
	func_152(uParam0, -0.95f, -1.85f, 0f, 0f, 3.8f, 7f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
