...
int func_73(var uParam0)
{
	...
	func_152(uParam0, -0.0125f, 0.5375f, 1.4875f, 0f, 2.1875f, 2.18f, 2.7575f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, "script@vignette@abigail_21@base", 1, 1, 0, 0);
	uLocal_17 = func_153(uParam0, "script@vignette@abigail_21@action_a", 0, 0, 1, 0);
	func_154(uParam0, "CAB21AU");
	func_155(uParam0, joaat("COMP_ABICNV21"), joaat("PLAYER_ABICNV21"));
	func_156(uParam0, uLocal_17, -1, 0.9f);
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	...
	func_157(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SEAT_CHAIR"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_D", -1, 1, 35f, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_15, 1, -1);
	func_159(uParam0, iLocal_15, 1, 4, 0, 0, 0);
	iLocal_16 = func_161(uParam0, -2.6625f, -3f, 2.6125f, 0f, 0f, 0f, 17.2325f, 16.44f, 3.575f, "Trigger", joaat("VOLBOX"));
	func_162(uParam0, 1);
	return 1;
}
