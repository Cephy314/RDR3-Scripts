...
void __EntryFunction__()
{
	...
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	bLocal_169 = joaat("CS_TIMOTHYDONAHUE");
	...
	while (true)
	{
		...
		else
		{
			...
			if (VOLUME::_DOES_VOLUME_EXIST(bLocal_179) && func_8(Global_35, bLocal_179, 1, 0))
			{
			...
			if (iLocal_22 == 28 || (((iLocal_22 >= 6 && iLocal_22 <= 27) && ANIMSCENE::_0xCBFC7725DE6CE2E0(iLocal_188, 0)) && ANIMSCENE::_0x8D81E7824B7753F7(iLocal_188, "s_base_end", 1)))
			{
				if (bLocal_279)
				{
					...
					{
						if ((VOLUME::_DOES_VOLUME_EXIST(bLocal_178) && !ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_178, true, 0)) && !ENTITY::IS_ENTITY_ON_SCREEN(&(uLocal_173[0])))
						{
							func_1(1, 1);
						}
					}
			...
			if (iLocal_22 > 2)
			{
				...
				{
					iVar0 = func_20(iLocal_183, bLocal_179, &uLocal_162, 6f);
					switch (iVar0)
					{
						case 1:
				...
				func_23(uLocal_173[0], iLocal_183, bLocal_179, &iLocal_190, 2097152);
			}
			...
			{
				if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_180, true, 0) && ENTITY::IS_ENTITY_IN_VOLUME(&(uLocal_173[0]), bLocal_180, true, 0))
				{
			...
			switch (iLocal_22)
			{
				case 0:
					...
					if (ANIMSCENE::_0x25557E324489393C(iLocal_188) && ANIMSCENE::_0x25557E324489393C(iLocal_189))
					{
						...
						STREAMING::REQUEST_MODEL(bLocal_169, false);
						...
						func_31(bLocal_178, "SP_TimothyDonahue2_Block", 1, 0, 0, 0, -1082130432 /* Float: -1f */);
						func_32(2644.443f, -1207.946f, 52.3368f, 10f, 0);
						iLocal_185 = func_33(bLocal_181, 0, 0, 0);
				...
				case 1:
					...
					if (!STREAMING::HAS_MODEL_LOADED(bLocal_169))
					{
						bVar1 = false;
					}
					...
					break;
				case 2:
					if (((func_61(uLocal_173[0], bLocal_169, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_62(&bLocal_175, iLocal_171, 2644.251f, -1208.702f, 53.5354f)) && func_62(&bLocal_176, iLocal_171, 2643.541f, -1208.416f, 53.1764f)) && func_62(&iLocal_177, iLocal_170, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(&(uLocal_173[0]), 0))
						{
							...
							PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), &(uLocal_173[0]), "SPECIAL_PED_LIGHTWEIGHT_1_1", 0f, 0f, 0f, false, "TimothyBubble");
							PED::_0x7C00CFC48A782DC0(bLocal_184, &(uLocal_173[0]), 0f, 0f, 0f, 0f, 0f, 0f, 2, 1);
							...
							ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_188, "p_cs_getrich_book01x", bLocal_175, 0);
							ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_188, "p_cs_getrich_book01x^1", bLocal_176, 0);
							...
							ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_189, "p_cs_getrich_book01x^1", bLocal_176, 0);
				...
				case 28:
					...
					if (func_19(iLocal_190, 2) && !func_19(iLocal_190, 4))
					{
						if (func_19(iLocal_190, 16))
						{
							...
							{
								func_76(&bLocal_179, &iLocal_277, &uLocal_278);
							}
							func_77(1);
				...
				case 32:
					if (ANIMSCENE::_0x25557E324489393C(iLocal_189))
					{
						if (!ENTITY::IS_ENTITY_ATTACHED(bLocal_176))
						{
							PHYSICS::ACTIVATE_PHYSICS(bLocal_176);
						}
				...
				case 33:
					if (!ENTITY::IS_ENTITY_DEAD(&(uLocal_173[0])) && !ENTITY::IS_ENTITY_DEAD(Global_35))
					{
						...
						if (!func_19(iLocal_190, 128))
						{
							...
							{
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", false, 1065353216, 0.5f, 1);
								func_21(&iLocal_190, 128);
							}
							else
							{
								TASK::WAYPOINT_PLAYBACK_OVERRIDE_SPEED(&(uLocal_173[0]), 2.1f, 0, -1082130432, 0);
								TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE("spd_tmd_escape", true, 1065353216, 0.9f, 1);
							}
						}
						else
						{
							...
							{
								TASK::_TASK_SMART_FLEE_STYLE_PED(&(uLocal_173[0]), Global_35, 3, 0, -1082130432, -1, false);
...
void func_1(bool bParam0, bool bParam1)
{
	...
	if (ANIMSCENE::_0xCBFC7725DE6CE2E0(iLocal_188, 0))
	{
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(iLocal_188, "p_cs_getrich_book01x", bLocal_175);
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(iLocal_188, "p_cs_getrich_book01x^1", bLocal_176);
	}
	if (ANIMSCENE::_0xCBFC7725DE6CE2E0(iLocal_189, 0))
	{
		ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(iLocal_189, "p_cs_getrich_book01x^1", bLocal_176);
	}
	...
	{
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_175);
	}
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_176))
	{
		ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&bLocal_176);
	}
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_181))
	{
		POPULATION::_0xB56D41A694E42E86(bLocal_181, 2500607, 0, 0, -1, -1, 10);
		POPULATION::_0xA1CFB35069D23C23(bLocal_181);
		VOLUME::_DELETE_VOLUME(bLocal_181);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_180))
	{
...
void func_17()
{
	...
	if (bLocal_18)
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_175))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_175))
			{
				ENTITY::DETACH_ENTITY(bLocal_175, true, true);
			}
			ENTITY::APPLY_FORCE_TO_ENTITY(bLocal_175, 1, 0f, 0f, 0.5f, 0f, 0f, -0.1f, 0, true, true, true, false, true);
		}
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_176))
		{
			if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(bLocal_176))
			{
				ENTITY::DETACH_ENTITY(bLocal_176, true, true);
			}
			ENTITY::APPLY_FORCE_TO_ENTITY(bLocal_176, 1, 0f, 0f, 0.5f, 0f, 0f, -0.1f, 0, true, true, true, false, true);
		}
...
void func_18()
{
	...
	{
		if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_179, true, 0))
		{
			func_21(&iLocal_190, 2);
		}
	}
	else if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_179, true, 0))
	{
...
int func_20(int iParam0, bool bParam1, var uParam2, float fParam3)
{
...
void func_23(var uParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	bool bVar0;
...
void func_26(int iParam0)
{
	...
	if (fLocal_17 < 15f)
	{
		if (func_19(iLocal_190, 8192))
		{
			...
			{
				PLAYER::_0xC67A4910425F11F1(PLAYER::PLAYER_ID(), "TimothyBubble");
				PLAYER::_0x3946FC742AC305CD(PLAYER::PLAYER_ID(), &(uLocal_173[0]), "SPECIAL_PED_GENERIC_INTERACT_FOCUS", 0f, 0f, 0f, false, "TimothyConvo");
...
void func_30()
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_178))
	{
		bLocal_178 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(2644.527f, -1208.351f, 52.287f, 0f, 0f, 0f, 32f, 32f, 32f, "RandomEventBlock");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_180))
	{
		bLocal_180 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2644.642f, -1210.8f, 61.5079f, 0f, 0f, 0f, 7f, 3f, 10f, "Notice");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_179))
	{
		bLocal_179 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2644.405f, -1210.418f, 53.7178f, 0f, 0f, 0f, 1.5f, 2f, 3f, "Trigger");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_181))
	{
		bLocal_181 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(2644.397f, -1208.503f, 53.77906f, 0f, 0f, 0f, 6f, 2f, 4f, "StayAway");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(iLocal_182))
	{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_184))
	{
		bLocal_184 = VOLUME::_0x0EB78C2B156635B1(joaat("VOLCYLINDER"), 2644.566f, -1208.341f, 53.3452f, 0f, 0f, 0f, 1.85f, 1.85f, 3f);
		VOLUME::_0xBE551C2CC421185D(bLocal_184, 1);
		VOLUME::_0x5B23DFF8E0948BB2(bLocal_184, 0);
	}
}

int func_31(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_61(var uParam0, bool bParam1, vector3 vParam2, float fParam5, bool bParam6, bool bParam7, bool bParam8)
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		BUILTIN::WAIT(0);
		if (!bParam7)
		{
			*uParam0 = func_179(bParam1, vParam2, fParam5, 0, 1, bParam6, 1, 1, 1, 0, 0, 0, 0);
		}
		else
		{
			*uParam0 = func_179(bParam1, vParam2, fParam5, 0, 1, bParam6, 1, 1, bParam8, 1, 1, 0, 0);
		}
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
...
int func_62(bool bParam0, int iParam1, vector3 vParam2)
{
...
void func_65(bool bParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_180(bParam0, iParam1))
		{
			if (func_181(bParam0, iParam1))
			{
				if (func_182(bParam0, iParam1))
				{
...
bool func_74(bool bParam0, char* sParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
int func_80(bool bParam0, int iParam1, char* sParam2, char* sParam3, bool bParam4, float fParam5, int iParam6)
{
	...
	if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(iParam1, sParam2, &vVar1, false, sParam3, 2))
	{
		...
		else if ((bParam4 && !func_110(Global_35, 242628503)) || (((!bParam4 && ENTITY::IS_ENTITY_AT_COORD(Global_35, vVar1, 2.5f, 2.5f, 3f, false, true, 0)) && !AUDIO::IS_ANY_SPEECH_PLAYING(Global_35)) && !AUDIO::IS_ANY_SPEECH_PLAYING(bParam0)))
		{
			bLocal_14 = false;
			return 1;
		}
...
bool func_108(bool bParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bParam0) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		...
		return func_202(bParam0, joaat("CURRENCY_CASH"), iParam1, iVar0);
	}
...
int func_147(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_219(bParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				if (func_220(bParam0, uParam2))
				{
					*uParam3 = 8;
					func_219(bParam0, uParam2, *uParam3);
					return 1;
				}
				else if (func_221(bParam0, bParam1, uParam2))
				{
					*uParam3 = 8;
					func_219(bParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_25)
		{
			if (func_224(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_225(Global_35, bParam0, uParam2))
					{
						*uParam3 = 4;
						func_219(bParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_226(Global_35, bParam0, uParam2))
					{
						*uParam3 = 256;
						func_219(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_227(Global_35, bParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_219(bParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_227(Global_35, bParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_219(bParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_231(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_232(uParam2, bParam0)) && func_233(uParam2, bParam0))
					{
						*uParam3 = 2;
						func_219(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_231(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_232(uParam2, bParam0)) && func_233(uParam2, bParam0))
				{
					*uParam3 = 2;
					func_219(bParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_234(bParam0, Global_1935630->f_41))
							{
								func_235();
								*uParam3 = 2;
								func_219(bParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_236(uParam2, bParam0) || (uParam2->f_9 > 0 && (func_210() - uParam2->f_9) < 2000))
				{
					if (PED::IS_PED_RAGDOLL(bParam0))
					{
						func_235();
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_237())
					{
						if (func_234(bParam0, Global_1935630->f_42))
						{
							func_235();
							*uParam3 = 2;
							func_219(bParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_239(bParam0, bParam1, uParam2))
				{
					*uParam3 = 2048;
					func_219(bParam0, uParam2, *uParam3);
					return 1;
...
var func_192(bool bParam0, var uParam1)
{
...
var func_202(bool bParam0, int iParam1, var uParam2, int iParam3)
{
	struct<13> Var0;
	int iVar23;
...
int func_213(int iParam0, vector3 vParam1, bool bParam4)
{
...
int func_214(int iParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_220(bool bParam0, var uParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_294(bParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			if (func_296(uParam1, bParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_221(bool bParam0, bool bParam1, var uParam2)
{
	float fVar0;
	float fVar1;
	...
	fVar0 = 85f;
	if (func_298(bParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		if (func_296(uParam2, bParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
...
int func_222(bool bParam0, var uParam1)
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_225(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_226(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
int func_227(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_303(bParam1, vVar0, vVar4))
					{
						func_292(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_303(bParam1, vVar0, vVar7))
					{
						func_292(uParam2, 1);
						return 1;
					}
...
int func_228(bool bParam0, var uParam1)
{
	int iVar0;
	float fVar1;
	vector3 vVar2[2];
	...
	while (iVar0 < Global_1935630->f_39)
	{
		...
		else
		{
			...
			if (func_306(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_307(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_308(uParam1, bParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
...
int func_234(bool bParam0, bool bParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		...
		if (func_312(bParam0, bParam1, 1, 1) < 4f)
		{
...
int func_236(var uParam0, bool bParam1)
{
	...
	if (bVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(bVar0)))
	{
		...
		if (func_313(bVar0, bParam1, vVar1))
		{
...
int func_240(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(bParam0, bVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, bVar4, 17) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
				{
					...
					{
						if (func_314(bVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
bool func_243(bool bParam0, var uParam1)
{
	return PED::_0xE33F98BD76490ABC(*bParam0, PLAYER::PLAYER_ID(), 0);
}

int func_244(bool bParam0, var uParam1)
{
...
void func_268(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_360(bParam1))
		{
			func_65(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
{
	return func_312(bParam0, bParam1, 1, 1);
}
...
int func_294(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_312(bVar0, bParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_375(bVar0, 0)))
		{
			if (func_376(bParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_296(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_298(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_375(bVar0, 0)))
		{
			if (func_377(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_303(bool bParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_307(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_308(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_312(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_313(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_314(bParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
float func_314(bool bParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return 0f;
...
int func_318(bool bParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_312(bParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_312(bParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		if (bVar1 != bParam0)
		{
			if (PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
			{
				...
				{
					if (func_314(bVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_328(bool bParam0, int* iParam1, var uParam2)
{
	if (iParam1->f_11 != 0)
	{
		if (func_384(bParam0, iParam1))
		{
...
bool func_345(bool bParam0, bool bParam1, char* sParam2, char* sParam3, float fParam4, var uParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, int iParam14)
{
	return func_408(bParam0, bParam1, sParam2, sParam3, fParam4, uParam5, bParam6, bParam7, iParam8, bParam9, bParam10, iParam11, 0, bParam12, bParam13, iParam14) >= 0;
}
...
var func_375(bool bParam0, int iParam1)
{
	var uVar0;
...
int func_376(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_377(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_384(bool bParam0, int* iParam1)
{
	...
	if (bVar0 || bVar1)
	{
		if (PED::IS_PED_IN_COMBAT(bParam0, func_422((bVar1 && !bVar0), Global_35, 0)))
		{
			return 1;
		}
	}
...
int func_408(bool bParam0, bool bParam1, char* sParam2, char* sParam3, float fParam4, int iParam5, bool bParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12, bool bParam13, bool bParam14, int iParam15)
{
	bool bVar0;
	float fVar1;
	int iVar2;
	...
	if (bParam9)
	{
		if (bParam0 != Global_35 && bParam1 != Global_35)
		{
			if (!ENTITY::IS_ENTITY_DEAD(bParam0))
			{
				if (func_436(bParam0, 1, 1) > fParam4)
				{
					return -1;
				}
			}
	...
	if ((!ENTITY::IS_ENTITY_DEAD(bParam0) || iParam11 == 1718175949) || bParam9 == 0)
	{
		if (!bVar0)
		{
			fVar1 = func_312(bParam0, bParam1, 1, 1);
		}
		if (((bVar0 || bParam7) || fVar1 < fParam4) || bParam9 == 0)
		{
			...
			if (!bVar0 && bParam10)
			{
				...
				if (func_437(bParam0, bParam1, fVar1, bParam13))
				{
			...
			{
				iVar2 = func_274(func_74(bParam0, sParam2, iParam11, bParam1, NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0, iParam5, iParam15), 1, -1);
			}
			if (iVar2 >= 0)
			{
			}
...
float func_436(bool bParam0, bool bParam1, bool bParam2)
{
	if (bParam2 && ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return -1f;
	}
	return func_312(Global_35, bParam0, bParam1, bParam2);
}

int func_437(bool bParam0, bool bParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return 0;
...
int func_438(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_324(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_442(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
