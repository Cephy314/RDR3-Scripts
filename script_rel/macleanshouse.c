...
int func_11()
{
	bLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2257.921f, -129.5337f, 51.985f, 0f, -1E-06f, 13.20028f, 82.29547f, 67.60979f, 21.17161f, "MacLean's Ranch - m_volTown");
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacLean's Ranch - m_volRancherThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2241.916f, -109.335f, 47.39677f, 0f, 0f, 81.00094f, 15.27625f, 30.5406f, 14.65559f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2242.125f, -118.91f, 49.79729f, 0f, 0f, -9.792401f, 22.84632f, 3.968585f, 11.03726f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2229.892f, -115.0595f, 50.13812f, 0f, 0f, -43.69167f, 7.061154f, 5.28716f, 10.09026f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2253.012f, -119.7667f, 49.20896f, 0f, 0f, -55.08507f, 2.867169f, 4.725968f, 9.455753f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2244.684f, -99.80244f, 49.79729f, 0f, 0f, -6.792556f, 27.39669f, 5.430289f, 11.03726f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2230.888f, -99.64697f, 49.20896f, 0f, 0f, -141.6504f, 5.207262f, 4.725968f, 9.455753f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2236.452f, -142.7769f, 50.13812f, 0f, 0f, -49.1528f, 7.766057f, 7.596688f, 10.09026f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2236.481f, -142.6387f, 47.39677f, 0f, 0f, 39.75399f, 7.495997f, 7.665227f, 14.65559f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2282.604f, -118.0235f, 45.6339f, 0f, 0f, -24.74522f, 3.359454f, 14.73906f, 12.52731f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2274.63f, -102.5251f, 46.93924f, 0f, 0f, -12.90716f, 17.48779f, 5.873432f, 15.33682f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2273.252f, -116.878f, 46.93924f, 0f, 0f, -9.949313f, 19.00171f, 22.66021f, 15.33682f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 2283.666f, -109.4251f, 44.44471f, 0f, 0f, 0f, 3.780884f, 6.839418f, 7.568232f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 2275.129f, -99.41361f, 44.81648f, 0f, 0f, -12.62545f, 8.420317f, 1f, 9.244777f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 2269.443f, -125.7176f, 44.44471f, 0f, 0f, 73.07793f, 3.302727f, 7.064869f, 7.568232f);
		bLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacLean's Ranch - m_volRancherRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_16, bLocal_17);
		VOLUME::_0xBCE668AAF83608BE(bLocal_16, 2255.429f, -122.8375f, 51.985f, -1E-06f, 0f, 78.69922f, 38.29042f, 36.90052f, 21.17161f);
		bLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("MacLean's Ranch - m_volRancherWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_18, bLocal_16);
		VOLUME::_0xBCE668AAF83608BE(bLocal_18, 2254.417f, -126.5447f, 51.985f, -1E-06f, 0f, 78.69922f, 51.7244f, 47.73219f, 21.17161f);
		sLocal_15 = "MACLEANS_RANCH";
		LAW::_CREATE_GUARD_ZONE(sLocal_15);
		LAW::_0x8C598A930F471938(sLocal_15, bLocal_14);
		LAW::_0x35815F372D43E1E5(sLocal_15, bLocal_16);
		LAW::_0xA1B0E6301E2E02A6(sLocal_15, bLocal_17);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_15, bLocal_18);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_15, 2235.653f, -143.1516f, 47.8762f);
		LAW::_0xA8A74AA79FB67159(sLocal_15, bLocal_14);
	}
	return 1;
}
...
void func_28(int iParam0)
{
	...
	func_50(905, bLocal_16, 1);
	func_50(772, bLocal_16, 0);
	func_50(906, bLocal_16, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(bLocal_16, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(bLocal_16, 3, 1, func_51(906));
	VOLUME::_0x53D05D60E5F5B40C(bLocal_16, 3, 1, func_51(772));
	PED::_0x931B241409216C1F(func_52(905), func_52(772), 0);
}
...
void func_53(var uParam0, bool bParam1, int iParam2)
{
	if (uParam0->f_61 >= 20)
	{
		return;
...
bool func_60(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_90(iParam0));
}
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_92(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	if (!func_93(iParam4))
	{
		if (func_54(iParam0))
		{
			iParam4 = func_94(func_6(iParam0));
		}
		else
		{
	...
	if (func_93(iParam4))
	{
		iVar3 = func_95(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_97(func_96(iParam2));
	}
	...
	{
		iVar4 = func_101(func_100());
		iVar5 = func_102(func_100());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_103(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_104(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_104(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_104(&cVar6, joaat("COLOR_PURE_WHITE")), func_104(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_105(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_65(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_110(func_109(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_110(func_109(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_110(func_109(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_110(func_109(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_110(func_109(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_110(func_109(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_68(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_112(iVar1) && !func_115(iVar1, iParam2)) && (!bParam3 || !func_116(iVar1))) && (!bParam4 || !func_117(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_118(iVar0);
...
void func_75(int iParam0)
{
	...
	func_119(bLocal_18);
	func_119(bLocal_17);
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_16))
	{
		VOLUME::_0x998202B206872672(bLocal_16);
		VOLUME::_0x6D5F9E69BA1BE783(bLocal_16);
		VOLUME::_DELETE_VOLUME(bLocal_16);
	}
}
...
void func_78(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_123(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_130())
	{
		return 1;
	}
	if (iParam0 == 61)
...
char* func_92(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_133(Global_1894899->f_162);
	}
...
char* func_104(char* sParam0, int iParam1)
{
...
var func_105(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
int func_107(int iParam0)
{
	...
	if (func_139())
	{
		if (!func_140(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_144((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_145((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_121(int iParam0)
{
	...
	{
		func_148((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_149((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_123(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
