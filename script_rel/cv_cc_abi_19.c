...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.25f, -5.8f, 0.85f, -65.75f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_151(uParam0, -8.975f, -7.575f, 0.85f, -65.75f, 4.5975f, 4.1125f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_152(uParam0, joaat("P_STICKFIREPOKER01X"), 0f, 0f, 0f, "p_stickFirePoker01x", 0, 1, 1);
	func_153(uParam0, "script@vignette@abigail_19@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@abigail_19@action", 0, 0, 1, 0);
	func_154(uParam0, "CAB19AU");
	func_155(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STARE_STOIC"), "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_PORCH"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_CAMP_JACK_TREE"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
