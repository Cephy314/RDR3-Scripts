...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (*uParam0)
	{
		case 72:
			...
			iLocal_50 = joaat("STAND");
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 1f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 3f, 0f), (180f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
		case 73:
			iLocal_10 = func_48(func_47(), 1, 0, 1, 0, 0, 0);
			...
			func_50(uParam0, 1, "WWD_MAN", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 1f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_50(uParam0, 0, "WWD_DOG", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 5f, 0f), (180f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
	...
	switch (iLocal_9)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_50, (uParam0->f_20[0 /*14*/])->f_5, (uParam0->f_20[0 /*14*/])->f_8, 0, false, true, 0, -1f, false);
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[1 /*14*/]), iLocal_51, (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 0, false, true, 0, -1f, false);
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				if (!PED::_IS_PED_USING_SCENARIO_HASH(&(uParam0->f_20[1 /*14*/]), iLocal_51))
				{
					...
					func_74(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), &uLocal_12, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, 1f, 1, 32, fVar1, fVar2, 1f, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
					iLocal_9 = 5;
				}
			}
			break;
