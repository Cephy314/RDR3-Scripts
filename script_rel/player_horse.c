	...
	*uParam1 = 0;
	...
	if (func_71(iParam0))
	{
		...
		*uParam1 = func_88(iParam0);
		...
		uParam1->f_9 = PED::_GET_HORSE_RIDER(*uParam1, false);
...
void func_47(struct<5> Param0, var uParam5, var uParam6)
{
	...
	if (iVar0 == 2)
	{
		...
		if (vVar1.z)
		{
			...
			{
				bVar13 = PED::_GET_HORSE_RIDER(vVar1.x, false);
...
void func_51(struct<5> Param0, var uParam5, var uParam6)
{
	...
	if (bVar0)
	{
		...
		{
			iVar3 = ENTITY::_GET_ENTITY_STATUS(bVar1);
			switch (iVar3)
			{
				case 4:
				case 5:
	...
	while (iVar198 < 3)
	{
		...
		else
		{
			...
			if (STREAMING::IS_MODEL_A_PED(Var1))
			{
				...
				Var1.f_92 = 0;
				if (PED::_0xFB4891BD7578CDC1(bVar195, 43391475) || ENTITY::_GET_IS_LOOTED(bVar194))
				{
					Var1.f_92 = 1;
				}
...
void func_67()
{
	...
	{
		Global_1900383->f_393.f_1 = MAP::_BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_PLAYER_HORSE_SADDLE"), iVar0);
...
void func_86(int iParam0)
{
	...
	if (!bVar2)
	{
		...
		{
			bVar67 = PLAYER::_SET_PED_AS_PLAYER_TEMPORARY_HORSE(iVar0, bVar1);
		}
		if (func_97(iParam0))
		{
...
void func_124()
{
	...
	iVar1 = PED::_GET_HORSE_RIDER(bVar0, false);
	if (iVar1 != 0)
	{
		if (iVar1 != Global_35)
		{
...
void func_141(int iParam0)
{
	...
	bVar3 = false;
	if (PED::_GET_HORSE_RIDER(iVar1, false) != Global_35)
	{
		bVar3 = true;
	}
	bVar4 = false;
...
void func_143(int iParam0)
{
	...
	bVar2 = PED::_GET_HORSE_RIDER(iVar1, false) == Global_35;
	if (!bVar2)
	{
		return;
	}
...
void func_153(int iParam0)
{
	...
	if (Var0.f_4 && func_465(Var0.f_2))
	{
		...
		if (bVar9)
		{
			if (PLAYER::_GET_PLAYER_MAIN_HORSE(iVar6) == bVar7)
			{
				PLAYER::_SET_PED_AS_PLAYER_MAIN_HORSE(iVar6, 0);
			}
	...
	if (Var0.f_4 && func_474(Var0.f_2))
	{
		...
		{
			bVar28 = func_88(0);
			PLAYER::_SET_PED_AS_PLAYER_MAIN_HORSE(iVar6, bVar28);
		}
		if (func_71(1))
		{
			bVar29 = func_88(1);
			bVar30 = PLAYER::_SET_PED_AS_PLAYER_TEMPORARY_HORSE(iVar6, bVar29);
		}
		else
		{
			PLAYER::_SET_PED_AS_PLAYER_TEMPORARY_HORSE(iVar6, 0);
		}
		bVar31 = func_211();
...
void func_161(int iParam0)
{
	...
	if (PED::IS_PED_ON_MOUNT(Global_35))
	{
		if (PED::_GET_HORSE_RIDER(bVar5, false) == Global_35)
		{
			bVar7 = true;
		}
	}
...
void func_188(int iParam0, int iParam1)
{
	...
	bVar3 = false;
	if (bVar1 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(iVar0))
	{
		bVar3 = true;
	}
...
int func_286(bool bParam0, bool bParam1)
{
	...
	iVar0 = INVENTORY::_0x13D234A2A3F66E63(bParam0);
	if (ENTITY::_0x9A100F1CF4546629(bParam1) || ENTITY::_IS_ENTITY_A_BIRD(bParam1))
	{
					...
					if (STREAMING::IS_MODEL_A_PED(Var10))
					{
						...
						else
						{
							...
							if (Var10.f_92)
							{
								...
								ENTITY::_SET_IS_LOOTED(bVar2, true);
							}
							iVar9 = func_698(iVar114);
...
void func_475(bool bParam0)
{
	...
	func_200(0, 1);
	func_776(0);
	PLAYER::_SET_PED_AS_PLAYER_MAIN_HORSE(PLAYER::PLAYER_ID(), bParam0);
	if (func_201() == 0)
	{
...
void func_712(int iParam0, bool bParam1)
{
	...
	iVar1 = PED::_GET_HORSE_RIDER(bVar0, false);
	iVar2 = PED::_GET_HORSE_RIDER(bVar0, true);
	if (iVar1 != iVar2)
	{
		return;
	}
