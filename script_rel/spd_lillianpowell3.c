		...
		if (!func_5(iLocal_272, 1) && iLocal_14 > 2)
		{
			...
			else
			{
				...
				if (!func_5(iLocal_272, 1))
				{
					...
					if (iLocal_15 == 14)
					{
						if (ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_260, true, 0) && iLocal_14 < 78)
						{
				...
				if ((((ENTITY::DOES_ENTITY_EXIST(bLocal_253) && !ENTITY::IS_ENTITY_DEAD(bLocal_253)) && iLocal_14 != 82) && VOLUME::_DOES_VOLUME_EXIST(bLocal_266)) && func_28(Global_35, bLocal_266, 1, 0))
				{
				...
				switch (iLocal_14)
				{
					...
					case 29:
						...
						{
							func_123(&bLocal_261, &iLocal_387, &uLocal_388);
							func_124(1);
					...
					case 85:
						...
						if (iLocal_381 < 7)
						{
							...
							if (func_163(&uLocal_382, 6f))
							{
								...
								{
									case 0:
										func_164(bLocal_253, "GREET_PLAYER_ANGRY", -417894478, Global_35, 1, "LILLIAN_POWELL", 1, 1);
										break;
									case 1:
										func_164(bLocal_253, "GREET_PLAYER_ANGRY", -417894478, Global_35, 1, "LILLIAN_POWELL", 2, 1);
										break;
									case 2:
										func_164(bLocal_253, "GET_AWAY_FROM_ME", -417894478, Global_35, 1, "LILLIAN_POWELL", 1, 1);
										break;
									case 3:
										func_164(bLocal_253, "GET_AWAY_FROM_ME", -417894478, Global_35, 1, "LILLIAN_POWELL", 2, 1);
										break;
									case 4:
										func_164(bLocal_253, "GET_AWAY_FROM_ME", -417894478, Global_35, 1, "LILLIAN_POWELL", 3, 1);
										break;
									case 5:
										func_164(bLocal_253, "GENERIC_ANGRY_REACTION", -417894478, Global_35, 1, "LILLIAN_POWELL", 1, 1);
										break;
									case 6:
										func_164(bLocal_253, "GENERIC_SHOCKED_HIGH", -417894478, Global_35, 1, "LILLIAN_POWELL", 1, 1);
										break;
								}
								iLocal_380++;
...
void func_1()
{
	...
	func_171(&bLocal_253, &uLocal_273, joaat("EVENT_SHOCKING_BEAT_INSIGNIFICANT_NEW"), 20f, 1);
	...
	{
		func_176(&uLocal_306, bLocal_262, 0);
...
void func_6()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bLocal_253) && ENTITY::DOES_ENTITY_EXIST(Global_35))
	{
		iVar0 = func_177(bLocal_253, Global_35, 0f);
		iVar1 = func_177(bLocal_253, Global_35, 1f);
...
void func_27()
{
	if ((((((!func_5(iLocal_272, 524288) && func_5(iLocal_272, 262144)) && iLocal_15 > 4) && iLocal_15 < 14) && ENTITY::DOES_ENTITY_EXIST(bLocal_254)) && func_221(137, 0)) && func_178(Global_35, bLocal_254, 1, 1) <= 3f)
	{
		if (!AUDIO::_0xA2CAC9DEF0195E6F(1))
		{
...
void func_29()
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_264))
	{
		bLocal_264 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2637.288f, -1230.323f, 54.36793f, 0f, 0f, 0f, 3f, 3f, 6f, "Focus");
	}
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_266))
	{
...
void func_79()
{
	...
	if (iLocal_15 == 1 && (((!func_5(iLocal_272, 262144) || !func_221(137, 0)) || !ENTITY::DOES_ENTITY_EXIST(bLocal_254)) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_254)))
	{
		iLocal_15 = 2;
	}
	switch (iLocal_15)
...
int func_81(int iParam0, char* sParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, float fParam12)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
...
void func_123(bool bParam0, int iParam1, var uParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_125(bool bParam0, float fParam1, float fParam2, int iParam3, bool bParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8)
{
	vector3 vVar0;
	int iVar3;
...
void func_157()
{
	...
	iLocal_312 = iVar0;
	func_164(bLocal_253, "PLAYER_STILL_HANGING", -417894478, Global_35, 1, "LILLIAN_POWELL", iVar0, 1);
}
...
void func_158()
{
	...
	iLocal_314 = iVar0;
	func_164(bLocal_253, "PLAYER_LOITERING", -417894478, Global_35, 1, "LILLIAN_POWELL", iVar0, 1);
}
...
void func_159()
{
	...
	iLocal_313 = iVar0;
	func_164(bLocal_253, "HEY_IM_TALKING", -417894478, Global_35, 1, "LILLIAN_POWELL", iVar0, 1);
}
...
var func_164(bool bParam0, char* sParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
int func_180(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_213(int iParam0)
{
	...
	iVar1 = 0;
	iVar0 = func_330(&bLocal_253, Local_317[iParam0 /*58*/], 8f, &((Local_317[iParam0 /*58*/])->f_21), 0f, 2, 1, iVar1, (Local_317[iParam0 /*58*/])->f_56, 0, 0, 2, -1082130432 /* Float: -1f */);
	if (func_331())
	{
...
int func_214()
{
	...
	if (!func_5(iLocal_272, 2) && func_332(0, &iVar0))
	{
		if (iVar0 == 0)
		{
			if (func_36())
			{
				func_164(Global_35, "GREET_GENERAL", -417894478, bLocal_253, 1, 0, 0, 1);
			}
			else
			{
				func_164(Global_35, "GREET_GENERAL", -417894478, bLocal_253, 1, 0, 0, 1);
		...
		else if (iVar0 == 1)
		{
			if (func_36())
			{
				func_164(Global_35, "INSULT_FEMALE_CONV_PART1", -417894478, bLocal_253, 1, "JOHN_PLAYER", 6, 1);
			}
			else
			{
				func_164(Global_35, "INSULT_LILLIAN_CONV_PART1", -417894478, bLocal_253, 1, 0, 2, 1);
			}
		}
		func_333(16, &bLocal_253, &iLocal_272, 4096);
		func_8(&iLocal_272, 2);
...
int func_322(var uParam0, vector3 vParam1, bool bParam4)
{
...
int func_323(var uParam0, int iParam1, vector3 vParam2, float fParam5, bool bParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_331()
{
	if (((((((((ENTITY::DOES_ENTITY_EXIST(Global_35) && !Global_1935630->f_12) && VOLUME::_DOES_VOLUME_EXIST(bLocal_260)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_260, true, 0)) && func_177(Global_35, bLocal_253, 1060437492 /* Float: 0.707f */) != 1) && ((((iLocal_309 >= 11 && ANIMSCENE::_0x25557E324489393C(iLocal_316)) && ANIMSCENE::_0x3FBC3F51BF12DFBF(iLocal_316) >= func_454(iLocal_14)) && !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bLocal_253)) || func_455())) && iLocal_14 != 80) && iLocal_14 != 6) && !func_5(iLocal_272, 2)) && !func_456())
	{
		func_457(0, 1);
		return 1;
	}
