...
int func_234(var uParam0, bool bParam1)
{
	...
	if ((Global_1914319->f_17371 || func_282(func_173(*uParam0), 1, 1, 1, 0)) || PED::_IS_PED_HOGTIED(func_173(*uParam0)))
	{
		func_278(uParam0);
		return uParam0->f_30;
	}
...
int func_282(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_313(bVar0, 0)))
		{
...
int func_284()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_316(Global_35))
	{
		return 1;
	}
	return 0;
