...
int func_200(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		...
		case 1:
			...
			func_306(uParam0->f_1707, iVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				...
				func_306(uParam0->f_1708, iVar0, 0, 1, -1);
			}
		...
		case 3:
			...
			func_309(Global_35, &Var1, 0, iVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_309(iVar0, &Var1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
bool func_309(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
		...
		while (iVar28 < 4)
		{
			...
			if (func_492(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_496(0))
				{
					...
					func_497(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
