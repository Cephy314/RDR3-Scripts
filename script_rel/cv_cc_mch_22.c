...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, -2.4f, 1.15f, -25.52f, 4.0675f, 6.955f, 2.67f, -1612834106, -1, 1, 1, 1);
	...
	func_160(uParam0, -1336850168, -1605632950);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_332(747937920, 1) && !func_411(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
