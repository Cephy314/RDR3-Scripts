...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 5.8719f, 1.5408f, 1.0151f, 40f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, -1.15f, -0.85f, 0f, 40f, 3f, 4f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SEAN"), 1, 1, 1);
	func_152(uParam0, 0.48f, -1.2f, 1.0005f, 28.08f, 0.96f, 0.72f, 3f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, "script@vignette@hosea_18@base", 1, 1, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@hosea_18@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@hosea_18@action_b", 0, 0, 0, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@hosea_18@action_b_alt_front", 0, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@hosea_18@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@hosea_18@action_b_alt_right", 0, 0, 0, 1);
	func_154(uParam0, "CCH18AU");
	Local_21 = { func_155(uParam0, 0.1f, -1.5f, 1f, 90f, 8f, 0.5f, 0.5f) };
	Local_31 = { func_155(uParam0, 0.1f, -1.5f, 1f, 180f, 8f, 0.5f, 0.5f) };
	Local_41 = { func_155(uParam0, 0.1f, -1.5f, 1f, 0f, 8f, 0.5f, 0.5f) };
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STAND_WAITING"), 0, -1, 1, 45f, 1065353216 /* Float: 1f */, 1);
	func_157(uParam0, iLocal_14, 3, 0);
	func_158(uParam0, iLocal_14, 2, 1, 0, 0, 0);
	func_159(uParam0, iLocal_14, 1);
	func_156(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SIT_GROUND"), 0, -1, 1, 55f, 1065353216 /* Float: 1f */, 1);
...
int func_93(var uParam0)
{
	...
	{
		if (func_198(uParam0, Local_21, 1, 0))
		{
			func_189(uParam0, iLocal_18, 1);
		}
		else if (func_198(uParam0, Local_31, 1, 0))
		{
			func_189(uParam0, iLocal_19, 1);
		}
		else if (func_198(uParam0, Local_41, 1, 0))
		{
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_227(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_229(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_189(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_294(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
void func_406(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (bParam0 == func_443(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_444(bParam0))
	{
		if (func_445(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_225(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_225(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_225(iParam5, 32), true);
	...
	else if (func_225(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_225(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_225(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_425(bool bParam0, int iParam1)
{
	...
	func_386(bParam0, func_455(iParam1));
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_227(iParam1), bParam0, 0);
		PED::_0xED1C764997A86D5A(func_227(iParam1), bParam0);
...
void func_427(bool bParam0, float fParam1, bool bParam2)
{
	int iVar0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_327(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_398(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
