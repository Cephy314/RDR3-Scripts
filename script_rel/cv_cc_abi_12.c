...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 0.0763f, -1.44f, 0.1559f, -176.4356f, 2.56f, 3.53f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_153(uParam0, 4.4707f, -1.4952f, 0.8447f, -17.4529f, 2.8f, 1.96f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
...
int func_93(var uParam0)
{
	...
	{
		TASK::TASK_START_SCENARIO_AT_POSITION(func_48(uParam0, iLocal_16), joaat("WORLD_ANIMAL_HORSE_GRAZING_CAMP"), vLocal_17, fLocal_20, 15000, true, false, 0, -1f, false);
