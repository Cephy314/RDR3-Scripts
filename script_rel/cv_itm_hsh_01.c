...
int func_76(var uParam0)
{
	...
	func_155(uParam0, -0.0328f, 1.2303f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
...
void func_358(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_409(iParam1))
		{
			func_410(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_487(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_520(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
