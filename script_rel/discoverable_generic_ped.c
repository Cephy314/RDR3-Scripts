	...
	switch (Local_51)
	{
		...
		case 10:
			...
			if (*iParam0 == -2008558277)
			{
				if (func_52(iParam0))
				{
					if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_41, true, 0))
					{
			...
			{
				if ((!func_11(*iParam0, 8) && VOLUME::_DOES_VOLUME_EXIST(bLocal_41)) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_41, true, 0))
				{
					func_70(iParam0);
				}
				if (!func_53(*iParam0))
						...
						if (func_33(&(uLocal_48[0])))
						{
							...
							if (func_78(&(uLocal_48[0]), 1))
							{
								...
								else
								{
									...
									{
										PATHFIND::_0x2C87C3E1C7B96EE2(bLocal_43);
										POPULATION::_0x74C2B3DC0B294102(bLocal_43);
										PED::_0x0CAB404CD2DB41F5(Global_1935630->f_40, bLocal_43);
			...
			else if (*iParam0 == -35775921)
			{
				...
				else if (ENTITY::DOES_ENTITY_EXIST(&(Local_157[0])) && PED::_0x09B83E68DE004CD4(&(Local_157[0])) == Global_35)
				{
					func_67(iParam0);
					func_68(iParam0);
					func_54(&Local_51, 13, 1);
...
{
	func_68(uParam0);
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41))
	{
		VOLUME::_DELETE_VOLUME(bLocal_41);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_42))
	{
		VOLUME::_DELETE_VOLUME(bLocal_42);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_43))
	{
		PATHFIND::_0x2C87C3E1C7B96EE2(bLocal_43);
...
float func_14(bool bParam0, vector3 vParam1, bool bParam4)
{
...
void func_28(var uParam0)
{
	if (!func_33(uParam0->f_6.f_8))
	{
		...
		else if (*uParam0 == 1861313914)
		{
			...
			{
				uParam0->f_6.f_8 = func_102("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
			}
		}
		...
		{
			uParam0->f_6.f_8 = func_102("DISCO_EXAMINE", joaat("INPUT_CONTEXT_Y"), Global_35, 0, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1753096650, 0, 0);
		}
...
int func_59(var uParam0)
{
	...
	if (*uParam0 == -415839138)
	{
		...
		if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41))
		{
			...
			{
				iLocal_46 = func_154(bLocal_41, 0, 0, 0);
			}
		}
		if (func_15())
		{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(Local_63.f_1[0])))
	{
		...
		switch (&Local_87[0 /*4*/])
		{
			...
			case 20:
				...
				break;
			case 15:
				if (VOLUME::_DOES_VOLUME_EXIST(bLocal_42) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_42, true, 0))
				{
				...
				if (ANIMSCENE::_0x25557E324489393C(&(uLocal_31[0])) && ANIMSCENE::_0x477122B8D05E7968(&(uLocal_31[0]), 1, 0))
				{
					if (ANIMSCENE::_0xA9016536015DE29D(&(uLocal_31[0]), &cLocal_25) && ANIMSCENE::_0x1F0E401031E20146(&(uLocal_31[0]), &cLocal_25))
					{
						if (!&iLocal_14[3])
						{
							...
							{
								iLocal_14[3] = 1;
								iLocal_36 = EVENT::ADD_SHOCKING_EVENT_FOR_ENTITY(joaat("EVENT_SHOCKING_SEEN_MELEE_ACTION"), &(Local_63.f_1[0]), -1f, -1f, -1f, -1082130432, -1082130432, 1127481344, 0, 0, -1, -1);
							}
						}
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(Local_63.f_1[0])))
	{
		...
		switch (&Local_87[0 /*4*/])
		{
			...
			case 19:
				...
				else if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41) && ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_41, true, 0))
				{
			...
			case 21:
				...
				TASK::TASK_FOLLOW_WAYPOINT_RECORDING(false, "discoverable_monk_flee", 0, 9226, -1, 0, 0, -1);
				TASK::TASK_SMART_FLEE_PED(false, Global_35, 350f, -1, 0, 3f, 0);
			...
			switch (&Local_87[iVar0 /*4*/])
			{
				case 0:
					...
					if (*uParam0 == -654238687 || *uParam0 == -35775921)
					{
						...
						if (VOLUME::_DOES_VOLUME_EXIST(bLocal_42))
						{
							TASK::TASK_WANDER_IN_VOLUME(&(Local_63.f_1[iVar0]), bLocal_42, 1077936128, 1086324736, 0);
						}
				...
				case 19:
					...
					if (!ENTITY::IS_ENTITY_IN_VOLUME(Global_35, bLocal_41, true, 0) && !func_72(Global_35, func_91(uParam0, 0), 1.5f, 1, 1))
					{
						iLocal_14[4] = 1;
						iLocal_14[7] = 1;
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(&(Local_63.f_1[iVar0]), true);
...
void func_68(var uParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41))
	{
		func_196(&iLocal_46, bLocal_41, 0);
	}
	if (TASK::_0x841475AC96E794D1(iLocal_45))
	{
	...
	if (!bVar3)
	{
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_255(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_256(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER"):
				...
				{
					func_255(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER"), 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
...
bool func_101(bool bParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_102(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_302(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_303(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_116()
{
	...
	if (INVENTORY::_0x3D10D7179D7034AF(func_307(0), iVar0, false))
	{
		return 0;
	}
...
int func_121(bool bParam0, var uParam1)
{
	...
	vVar6 = { VOLUME::_0x18675BC914891122(bParam0) };
	fVar9 = vVar6.z;
...
void func_137(var uParam0)
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_41))
	{
		...
		if ((*uParam0 == -654238687 || *uParam0 == -2008558277) || *uParam0 == -415839138)
		{
			...
			bLocal_41 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_322(uParam0));
		}
		else
		{
			if (*uParam0 == -35775921)
			...
			bLocal_41 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, func_322(uParam0));
		}
	}
	if ((*uParam0 == -654238687 || *uParam0 == 1861313914) || *uParam0 == -35775921)
	{
		if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_42))
		{
			if (*uParam0 == -654238687)
			{
				...
				bLocal_42 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "DISC_VOL_CABIN_WANDER");
			}
			else if (*uParam0 == 1861313914)
			{
				if (func_16(59))
				...
				bLocal_42 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "DISC_VOL_BRAITH_ENTER");
			}
			else if (*uParam0 == -35775921)
			{
				...
				bLocal_42 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "DISC_VOL_SHEEP_WANDER");
			}
		}
		if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_43) && *uParam0 == 1861313914)
		{
			vVar0 = { 895.55f, -1968.068f, 43.71555f };
			vVar3 = { 0f, 0f, 0f };
			vVar6 = { 3f, 3f, 4f };
			bLocal_43 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vVar0, vVar3, vVar6, "DISC_VOL_BRAITH_AVOID");
			PATHFIND::_0x19C7567D2F2287D6(bLocal_43, 15);
			POPULATION::_0xB56D41A694E42E86(bLocal_43, 2238463, 0, 0, -1, -1, 10);
			PED::_0xE9B168527B337BF0(Global_1935630->f_40, bLocal_43);
...
void func_150(var uParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	if (!&uParam0->f_12[iParam5] == 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1[iParam5])))
		{
			uParam0->f_1[iParam5] = func_326(&(uParam0->f_12[iParam5]), vParam1, iParam4, 1, 1, 0, 0, 0, 1, 0, 0, 0, 0);
...
int func_151(var uParam0, var uParam1, var uParam2, bool bParam3, int iParam4, int iParam5)
{
	if (bParam3)
	{
		while (*uParam1 < 10)
		{
			func_150(uParam1, func_131(uParam0, *uParam1), func_149(uParam0, *uParam1), *uParam1, iParam4, iParam5);
		}
		func_327(uParam2, 2);
		return 1;
	}
...
void func_153(bool bParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		{
			if (func_329(bParam0, iParam1))
			{
				if (func_330(bParam0, iParam1))
				{
...
int func_154(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
	...
	if (*uParam0 == 1861313914)
	{
		if (VOLUME::_DOES_VOLUME_EXIST(bLocal_41))
		{
			if (!func_33(&(uLocal_48[0])))
			{
				if (func_16(59))
				{
					uLocal_48[0] = func_334("PEEK_DOOR", joaat("INPUT_CONTEXT_LT"), bLocal_42, 2, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
				}
				else
				{
					uLocal_48[0] = func_334("PEEK_DOOR", joaat("INPUT_CONTEXT_LT"), bLocal_41, 2, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
				}
			}
		}
	}
	else if (*uParam0 == -415839138)
	{
		...
		while (iVar0 <= (2 - 1))
		{
			if (!func_33(&(uLocal_48[iVar0])))
			{
				if (iVar0 == 0)
				{
					uLocal_48[iVar0] = func_102("INTERACT_GREET", joaat("INPUT_CONTEXT_X"), Global_35, 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
					func_336(&(uLocal_48[iVar0]), &(Local_63.f_1[0]), func_335(uParam0));
				}
				else if (iVar0 == 1)
				{
					uLocal_48[iVar0] = func_102("INTERACT_INSULT", joaat("INPUT_CONTEXT_B"), Global_35, 2, 0, 0, 0, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
					func_336(&(uLocal_48[iVar0]), &(Local_63.f_1[0]), func_335(uParam0));
				}
			}
			iVar0++;
...
int func_175(bool bParam0, bool bParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_343(bParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				if (func_344(bParam0, uParam2))
				{
					*uParam3 = 8;
					func_343(bParam0, uParam2, *uParam3);
					return 1;
				}
				else if (func_345(bParam0, bParam1, uParam2))
				{
					*uParam3 = 8;
					func_343(bParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_25)
		{
			if (func_348(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
					if (func_349(Global_35, bParam0, uParam2))
					{
						*uParam3 = 4;
						func_343(bParam0, uParam2, *uParam3);
						return 1;
				...
				{
					if (func_350(Global_35, bParam0, uParam2))
					{
						*uParam3 = 256;
						func_343(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_351(Global_35, bParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_343(bParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_351(Global_35, bParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_343(bParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				...
				{
					if ((func_355(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_356(uParam2, bParam0)) && func_357(uParam2, bParam0))
					{
						*uParam3 = 2;
						func_343(bParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_355(bParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_356(uParam2, bParam0)) && func_357(uParam2, bParam0))
				{
					*uParam3 = 2;
					func_343(bParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_358(bParam0, Global_1935630->f_41))
							{
								func_359();
								*uParam3 = 2;
								func_343(bParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_360(uParam2, bParam0) || (uParam2->f_9 > 0 && (func_98() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_361())
					{
						if (func_358(bParam0, Global_1935630->f_42))
						{
							func_359();
							*uParam3 = 2;
							func_343(bParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_363(bParam0, bParam1, uParam2))
				{
					*uParam3 = 2048;
					func_343(bParam0, uParam2, *uParam3);
					return 1;
...
int func_179(var uParam0)
{
	...
	if (PLAYER::_0x3EE1F7A8C32F24E1(PLAYER::GET_PLAYER_INDEX(), &iVar0, false, false))
	{
...
int func_186(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
int func_190(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	float fVar0;
	...
	{
		fVar0 = func_14(bParam0, Global_36, 1);
	}
	if (fParam2 > 0f)
	{
		if (fVar0 < fParam2)
...
void func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_407(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_407(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_388(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0xD955FEE4B87AFA07(iVar0))
			{
				...
				if ((((func_416(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_252(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_416(iVar7) && func_252(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0))
				{
...
int func_241()
{
	if (((((func_436(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_436(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_436(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_436(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_436(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_436(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return 1;
	}
	return 0;
...
void func_246(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1369162587: /* GXTEntry: "Hunting Request" */
			...
			func_212(437, 0);
			func_212(440, 0);
			func_448(-949689219, 444160793 /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1610047510: /* GXTEntry: "Hunting Request" */
			...
			func_448(-1248968496, -1969404854 /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1317879106: /* GXTEntry: "Hunting Request" */
			...
			func_448(1706369307, -832850511 /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1062444751: /* GXTEntry: "Hunting Request" */
			...
			func_448(1520110311, -100913452 /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case 754186760: /* GXTEntry: "Hunting Request" */
			...
			func_212(438, 0);
			func_448(-1992824800, 905173572 /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_251(int iParam0, int iParam1, int iParam2)
{
	...
	switch (iParam0)
	{
		case 489075255: /* GXTEntry: "$1.00" */
			func_242(-949580860, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1394529493: /* GXTEntry: "$5.00" */
			func_242(-1171997683, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1262623627: /* GXTEntry: "$10.00" */
			func_242(-2140931002, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case 675090918: /* GXTEntry: "Coin Sack" */
			func_242(-1531790128, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("money_coinstack"):
			func_242(1351791770, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -1243851340: /* GXTEntry: "Money Pile" */
			if (!func_460())
			{
				func_242(1330954593, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case -525490740: /* GXTEntry: "Change Cup" */
			func_242(817681514, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1736635264: /* GXTEntry: "Coin Cup" */
			func_242(1404311868, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1302860970: /* GXTEntry: "$50.00" */
			func_242(-175152067, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1027115192: /* GXTEntry: "$100.00" */
			func_242(-526915387, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1064332555: /* GXTEntry: "$200.00" */
			func_242(101362741, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1954478446: /* GXTEntry: "$45.00" */
			func_242(1458818027, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -518592739: /* GXTEntry: "$50.00" */
			func_242(-1957208512, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -2010073778: /* GXTEntry: "$70.00" */
			func_242(2066857461, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -700133011: /* GXTEntry: "$100.00" */
			func_242(803940201, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1415414735: /* GXTEntry: "$120.00" */
			func_242(-1717765429, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 2045548742: /* GXTEntry: "$150.00" */
			func_242(1379920914, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 830381058: /* GXTEntry: "$350.00" */
			func_242(447209691, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_263(int iParam0, bool bParam1)
{
	...
	func_407(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_283(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((iParam1 == 1 || func_222(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == -1424823393) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
int func_299(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_294(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(bVar0) == Global_35)
		{
			return 0;
		}
	}
...
void func_303(int iParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5, vector3 vParam6, float fParam9, bool bParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, bool bParam16, int iParam17, bool bParam18, int iParam19, int iParam20, int iParam21, bool bParam22, int iParam23, int iParam24, bool bParam25)
{
	...
	((*Global_1945938)[iParam0 /*18*/])->f_10 = bParam10;
	...
	{
		HUD::_0x4D107406667423BE(iVar0, bParam10);
	}
	else if (iParam3 == 5)
	{
...
bool func_326(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_527(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
bool func_330(bool bParam0, int iParam1)
{
	int iVar0;
	int iVar1;
...
int func_334(char* sParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, int iParam9, bool bParam10, int iParam11, int iParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_302(iVar0, 2))
		{
			if (bParam2 == ((*Global_1945938)[iVar0 /*18*/])->f_10 && iParam1 == ((*Global_1945938)[iVar0 /*18*/])->f_4)
			{
				return iVar0;
			}
		}
	...
	if (iVar1 != 0)
	{
		func_303(iVar1, iParam1, sParam0, 2, iParam3, iParam4, 0f, 0f, 0f, 0f, bParam2, 0, 1, iParam5, iParam6, iParam7, bParam8, iParam9, bParam10, iParam11, 1065353216 /* Float: 1f */, 0, 0, 0, iParam12, bParam13);
		return iVar1;
	}
	return 0;
}
...
int func_335(var uParam0)
{
	...
	{
		case -415839138:
			return -1980449911 /* GXTEntry: "Meditating Monk" */;
		default:
			break;
	}
	return 1542656504 /* GXTEntry: "?" */;
}
...
int func_342(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar0)
	{
		...
		case 1589923363:
			...
			if (!func_534(bParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_535(bParam0, iVar2) <= func_536(uParam1))
			{
				return 1;
			}
			break;
...
void func_343(bool bParam0, var uParam1, int iParam2)
{
	if (iParam2 != 16384)
	{
...
int func_344(bool bParam0, var uParam1)
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_540(bParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			if (func_542(uParam1, bParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_345(bool bParam0, bool bParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_544(bParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		if (func_542(uParam2, bParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
...
int func_346(bool bParam0, var uParam1)
{
	...
	if (func_534(bParam0, uParam1, bVar1))
	{
		if (uParam1->f_3 == 0)
		{
...
int func_349(var uParam0, bool bParam1, var uParam2)
{
	float fVar0;
	int iVar1;
	float fVar2;
...
int func_350(var uParam0, bool bParam1, var uParam2)
{
	var uVar0;
...
int func_351(var uParam0, bool bParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_549(bParam1, vVar0, vVar4))
					{
						func_538(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_549(bParam1, vVar0, vVar7))
					{
						func_538(uParam2, 1);
						return 1;
					}
...
int func_352(bool bParam0, var uParam1)
{
	int iVar0;
	float fVar1;
	vector3 vVar2[2];
	...
	{
		if (!func_534(bParam0, uParam1, &(Global_1935630->f_34[iVar0])) || bParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			...
			if (func_552(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_553(uParam1, bParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
			...
			else if (func_554(uParam1, bParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = bParam0;
...
int func_353(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_355(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	bool bVar1;
	int iVar2;
...
int func_357(var uParam0, bool bParam1)
{
	if (func_557(uParam0))
	{
		return 1;
...
int func_358(bool bParam0, bool bParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam1))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(bParam0, bParam1, 1, 1))
		...
		if (func_558(bParam0, bParam1, 1, 1) < 4f)
		{
...
int func_360(var uParam0, bool bParam1)
{
	...
	if (bVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(bVar0)))
	{
		...
		if (func_559(bVar0, bParam1, vVar1))
		{
			uParam0->f_9 = func_98();
			return 1;
		}
...
int func_363(bool bParam0, bool bParam1, var uParam2)
{
	...
	return func_563(bParam0, bParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}

int func_364(bool bParam0, var uParam1)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	switch (iVar1)
	{
		...
		case -1601932249:
			...
			if (PED::_0x06087579E7AA85A9(bParam0, bVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_565(uParam1, bParam0))
					{
						if (func_14(bVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
bool func_367(bool bParam0, var uParam1)
{
	return PED::_0xE33F98BD76490ABC(*bParam0, PLAYER::PLAYER_ID(), 0);
}

int func_368(bool bParam0, var uParam1)
{
	...
	{
		return func_568(bParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
bool func_370(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, Vector3 vParam8)
{
...
void func_378(char[4] cParam0, char[4] cParam1, char[4] cParam2, var uParam3)
{
	int iVar0;
...
int func_446()
{
	...
	while (iVar1 < 30)
	{
		if (func_639(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("dino_bones"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_448(int iParam0, int iParam1, char* sParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_476(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
int func_498(int iParam0)
{
	...
	if (!func_691(iParam0, &uVar0, joaat("inventory"), 0, 0, joaat("ui_itemviewer")))
	{
...
int func_510(int iParam0)
{
	...
	if (!func_294(iParam0, 16) && !func_695(iVar0, 0))
	{
		return 0;
	}
	return 1;
...
void func_527(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
int func_534(bool bParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		iVar1 = func_562(bParam2);
	}
	else
	{
		iVar1 = func_561(bParam2);
	}
	if (!PED::IS_PED_HUMAN(bParam0))
	{
...
float func_535(bool bParam0, bool bParam1)
{
	return func_558(bParam0, bParam1, 1, 1);
}
...
int func_540(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(bVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, bParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, bParam0)) && func_558(bVar0, bParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_706(bVar0, 0)))
		{
			if (func_707(bParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_542(var uParam0, bool bParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_544(bool bParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	bool bVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_706(bVar0, 0)))
		{
			if (func_708(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_549(bool bParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_101(bParam0, vParam4, 0.5f))
	{
...
int func_552(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_553(var uParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_554(var uParam0, bool bParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_556(bool bParam0, bool bParam1)
{
	if (PED::_0xB65A4DAB460A19BD(bParam0) == bParam1)
	{
		return 1;
	}
	if (func_710(bParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return 0;
	}
...
float func_558(bool bParam0, bool bParam1, bool bParam2, bool bParam3)
{
...
int func_559(bool bParam0, bool bParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_14(bParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_563(bool bParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_558(bParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_558(bParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_564(bool bParam0, var uParam1, bool bParam2)
{
	bool bVar0;
	bool bVar1;

	func_703(1, &bVar0, &bVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
		if (bVar0 != bParam0)
		{
			if (PED::_0x06087579E7AA85A9(bParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(bParam0, Global_35, 17))
				{
					if (!bParam2 || !func_565(uParam1, bVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		if (bVar1 != bParam0)
		{
			...
			{
				if (!bParam2 || !func_565(uParam1, bVar1))
				{
					if (func_14(bVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_568(bool bParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
{
	return func_420(joaat("character"), func_711(), -1591664384, bParam0);
}
...
int func_572(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_386(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_575(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
int func_597()
{
	...
	while (iVar1 < 30)
	{
		if (func_723(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("dino_bones"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_655(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_743(0);
	if (iParam2 != 0 && func_744(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_672(int iParam0, char* sParam1, bool bParam2)
{
	char* sVar0;
...
var func_706(bool bParam0, int iParam1)
{
	var uVar0;
...
int func_707(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		if (func_708(ENTITY::GET_ENTITY_COORDS(bParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_709(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_710(bool bParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
void func_719(int iParam0, int iParam1, int iParam2)
{
	...
	func_407(sVar7, sVar1, iVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_783(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_727()
{
	...
	func_787(0);
	func_788(7);
	func_789(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_489() == 1160113249)
	{
		func_789(joaat("clothing_p3_player_three_ms1_hat_000_000"), 1, 1, 1);
		func_789(-361635024 /* GXTEntry: "The Cowboy" */, 1, 1, 1);
	}
...
void func_734(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	func_792(iParam0, iParam6);
	func_793(iParam0, iParam5);
	func_794(iParam0, iParam4);
	func_795(iParam0, iParam3);
	func_796(iParam0, iParam2);
...
int func_784(int iParam0, int iParam1, int iParam2, var uParam3)
{
	bool bVar0;
	struct<4> Var1;
	int iVar5;
...
void func_789(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
	bool bVar1;
	...
	{
		case -2061583405:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_21), Global_1946804->f_2657.f_26.f_1, bParam1);
			break;
		case 81053684:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_23), 1, bParam1);
			break;
		case -999503751:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_20), Global_1946804->f_2657.f_26, bParam1);
			break;
		case -525676072:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_22), Global_1946804->f_2657.f_26.f_2, bParam1);
			break;
		case -1719060085:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
		case -413129408:
			bVar1 = func_829(iParam0, &(Global_1946804->f_2657.f_24), 1, bParam1);
			break;
...
bool func_822(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
