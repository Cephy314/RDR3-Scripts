...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.1484f, -1.8598f, 0.9909f, 38.16f, 1.3f, 1.3f, 3f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -1.1415f, -1.4343f, 0.991f, 50.04f, 1.3f, 1.3f, 3f, -1612834106, joaat("APMS_COMP_JAVIER"), 1, 1, 1);
...
float func_215(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_320(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_263(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
