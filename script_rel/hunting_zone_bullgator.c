...
int func_5(var uParam0)
{
	...
	if (uParam0->f_11 > 0)
	{
		...
		if ((SCRIPTS::_0x9E4EF615E307FBBE() && SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("HUNTING1")) == 0) && !func_37(15))
		{
			bVar0 = true;
		}
		...
		else if (func_40(PLAYER::PLAYER_ID(), 1, 0, 1))
		{
...
int func_6(var uParam0)
{
	switch (uParam0->f_11)
	{
		...
		case 2:
			if (uParam0->f_623)
			{
				PED::_0xED9582B3DA8F02B4(func_45(0) + 1);
			}
			else
			{
			...
			break;
		case 3:
			if (PED::_0x5E420FF293EE5472() && func_47(uParam0))
			{
				uParam0->f_11 = 4;
			}
			break;
			...
			else
			{
				...
				if (bParam3)
				{
					...
					else if (bParam2)
					{
						...
						{
							fVar3 = func_73(Global_35, func_72(iVar0), 1);
...
void func_23(int iParam0, bool bParam1)
{
	...
	iVar3 = 0;
	iVar4 = 0;
	uVar21 = func_74(iParam0);
	func_75(iParam0, &uVar22);
	...
	if (iVar4 > 0 && iVar4 < 15)
	{
		...
		{
			bVar0 = false;
			if (func_76(&(uVar5[iVar3]), 369710026, &bVar0))
			{
				bVar0 = (bVar0 - func_77(&(uVar5[iVar3]), 1));
				if (bVar0 > 0)
				{
					if (func_78(&(uVar5[iVar3]), 1))
					{
						if (!func_79(&(uVar5[iVar3]), 1, bVar0))
						{
							bVar1 = false;
						}
						else
			...
			if (bParam1 && func_76(&(uVar5[iVar3]), -768110908, &bVar0))
			{
				bVar0 = (bVar0 - func_77(&(uVar5[iVar3]), 0));
				if (bVar0 > 0)
				{
					if (func_78(&(uVar5[iVar3]), 0))
					{
						if (!func_79(&(uVar5[iVar3]), 0, bVar0))
						{
							bVar1 = false;
						}
						else
		...
		if (bVar1)
		{
			...
			func_80(&(Global_20709.f_2407), uVar21);
			if (bVar2)
			{
				func_41(467, 1);
			}
...
void func_25(int iParam0, int iParam1, vector3 vParam2, bool bParam5, int iParam6)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		...
		{
			iVar2 = func_81(iParam0, iParam1, 1);
			if (iVar2 != 0)
			{
				func_82(iVar2, 0);
			}
		...
		else
		{
			...
			if (iVar2 != 0)
			{
				...
				{
					iVar2 = func_81(iParam0, iParam1, 0);
					if (iVar2 != 0)
					{
						func_82(iVar2, 0);
					}
...
int func_34(int iParam0)
{
	...
	return func_88(((*Global_1347702)[iParam0 /*49*/])->f_15, 1);
}

bool func_35()
{
	return (func_36(&Global_1935630, 4096) || SCRIPTS::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("RESPAWN_DUMP_BODY")) > 0);
}
...
void func_41(int iParam0, bool bParam1)
{
	...
	func_91(iParam0, &iVar0, &iVar1);
	if (!func_92(iParam0, iVar0, iVar1, bParam1))
	{
		return;
	}
	func_93(iVar0, iVar1);
...
var func_42(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
int func_48(var uParam0)
{
	...
	func_99(uParam0->f_3, "Hunting Zone Target Pending", 0, 0, 8192, 0, -1082130432 /* Float: -1f */);
	return 1;
}
...
int func_49(var uParam0)
{
	...
	iVar0 = 0;
	while (iVar0 < func_100())
	{
		iVar1 = 0;
		while (iVar1 < func_45(iVar0))
		{
			func_101(uParam0, iVar0, iVar1);
			uParam0->f_618++;
			iVar1++;
		}
		iVar0++;
...
int func_50(var uParam0)
{
	...
	if (uParam0->f_12.f_1 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
		{
			if (uParam0->f_12.f_5)
			{
				uParam0->f_12 = PED::_0xEAF682A14F8E5F53(uParam0->f_12.f_9, uParam0->f_12.f_10, false, true, true, 0, 0);
			}
			else
			{
				uParam0->f_12 = func_103(uParam0->f_12.f_1, uParam0->f_12.f_10, 0, 1, 1, 0, 1, 0, 1, 0, 0, 0, 0);
			}
			func_104(uParam0);
			return 0;
		}
	...
	while (iVar0 < func_30())
	{
		if ((uParam0->f_31[iVar0 /*36*/])->f_4 != 0)
		{
			if (!ENTITY::DOES_ENTITY_EXIST((uParam0->f_31[iVar0 /*36*/])->f_1) && (uParam0->f_31[iVar0 /*36*/])->f_28 < 3)
			{
				...
				{
					(uParam0->f_31[iVar0 /*36*/])->f_2 = func_103((uParam0->f_31[iVar0 /*36*/])->f_4, (uParam0->f_31[iVar0 /*36*/])->f_17, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
					if (ENTITY::DOES_ENTITY_EXIST((uParam0->f_31[iVar0 /*36*/])->f_2))
					{
						func_105((uParam0->f_31[iVar0 /*36*/])->f_2, 0, 0);
					...
					(uParam0->f_31[iVar0 /*36*/])->f_1 = func_106((uParam0->f_31[iVar0 /*36*/])->f_2);
				}
				...
				if (ENTITY::DOES_ENTITY_EXIST((uParam0->f_31[iVar0 /*36*/])->f_1))
				{
					...
					vVar7 = { func_107(vVar4, 1.5f) };
					vVar10 = { func_107(vVar4, fVar13) };
					...
					*(uParam0->f_630[4 /*8*/]) = { *(uParam0->f_630[3 /*8*/]) + vVar7 };
					func_108(uParam0->f_630[1 /*8*/], 50, 10, 0);
					func_108(uParam0->f_630[2 /*8*/], 50, 10, 0);
					func_108(uParam0->f_630[3 /*8*/], 50, 10, 0);
					func_108(uParam0->f_630[4 /*8*/], 50, 10, 0);
					TASK::_0x5C885E0978B6AD60(func_109(&((uParam0->f_31[iVar0 /*36*/])->f_29)), &(uParam0->f_630), 5, 0);
				}
...
void func_51(var uParam0)
{
	...
	while (iVar2 < func_30())
	{
		...
		if ((uParam0->f_31[iVar2 /*36*/])->f_13)
		{
			...
			fVar4 = func_110(Global_35, (uParam0->f_31[iVar2 /*36*/])->f_17, 1);
			if (fVar4 < fVar0)
			{
				fVar0 = fVar4;
				iVar1 = iVar2;
...
void func_52(var uParam0)
{
	...
	while (iVar0 < uParam0->f_618)
	{
		if (!(uParam0->f_31[iVar0 /*36*/])->f_14)
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST((uParam0->f_31[iVar0 /*36*/])->f_1))
			{
				fVar8 = func_111(Global_35, (uParam0->f_31[iVar0 /*36*/])->f_1, 1);
				if (((uParam0->f_31[iVar0 /*36*/])->f_13 && fVar8 < 2500f) && ENTITY::IS_ENTITY_ON_SCREEN((uParam0->f_31[iVar0 /*36*/])->f_1))
				{
					...
					if ((fVar8 < 6.25f && !func_112()) && !bVar6)
					{
						bVar7 = false;
						if (!func_84((uParam0->f_31[iVar0 /*36*/])->f_16))
						{
							(uParam0->f_31[iVar0 /*36*/])->f_16 = func_113("INSPECT_GENERIC", joaat("INPUT_CONTEXT_Y"), (uParam0->f_31[iVar0 /*36*/])->f_1, 2, 0, 0, 0, 5, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("MEDIUM_TIMED_EVENT"), 0, 0);
							func_114((uParam0->f_31[iVar0 /*36*/])->f_16, 2.5f, 0);
							func_115(&((uParam0->f_31[iVar0 /*36*/])->f_16), (uParam0->f_31[iVar0 /*36*/])->f_1);
						}
						else if ((uParam0->f_31[iVar0 /*36*/])->f_8 == 5)
						{
							HUD::_UIPROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY((uParam0->f_31[iVar0 /*36*/])->f_1), func_109(&((uParam0->f_31[iVar0 /*36*/])->f_31)), 2);
						}
						else
						{
							HUD::_UIPROMPT_SET_AMBIENT_GROUP_THIS_FRAME((uParam0->f_31[iVar0 /*36*/])->f_1, 2.5f, 2, 1, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY((uParam0->f_31[iVar0 /*36*/])->f_1), func_109(&((uParam0->f_31[iVar0 /*36*/])->f_31)), 2);
						}
						if (func_116((uParam0->f_31[iVar0 /*36*/])->f_16, 1))
						{
							...
							func_117((uParam0->f_31[iVar0 /*36*/])->f_16, 0, 1);
							...
							func_118(uParam0, (uParam0->f_31[iVar0 /*36*/])->f_27);
						}
					}
					...
					if (bVar7 && func_84((uParam0->f_31[iVar0 /*36*/])->f_16))
					{
						func_32(&((uParam0->f_31[iVar0 /*36*/])->f_16), 1, 1);
					}
				}
		...
		else if ((uParam0->f_31[iVar0 /*36*/])->f_15)
		{
			...
			{
				HUD::_UIPROMPT_SET_AMBIENT_GROUP_THIS_FRAME(Global_35, 2.5f, 2, 1, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY((uParam0->f_31[iVar0 /*36*/])->f_1), func_109(&((uParam0->f_31[iVar0 /*36*/])->f_33)), 2);
			}
			else
			{
				HUD::_UIPROMPT_SET_AMBIENT_GROUP_THIS_FRAME((uParam0->f_31[iVar0 /*36*/])->f_1, 2.5f, 2, 1, HUD::_UIPROMPT_GET_GROUP_ID_FOR_TARGET_ENTITY((uParam0->f_31[iVar0 /*36*/])->f_1), func_109(&((uParam0->f_31[iVar0 /*36*/])->f_33)), 2);
			}
			iVar9 = MISC::GET_GAME_TIMER();
			if ((iVar9 - (uParam0->f_31[iVar0 /*36*/])->f_25) > iVar3 || ((iVar9 - (uParam0->f_31[iVar0 /*36*/])->f_25) > iVar1 && !func_119(Global_35, 242628503)))
			{
			...
			{
				func_121(uParam0->f_12, func_109(&((uParam0->f_31[iVar0 /*36*/])->f_29)), 1, 0.762f, 1053609165 /* Float: 0.4f */, 0, 2f, 1);
				if (VOLUME::_DOES_VOLUME_EXIST((uParam0->f_31[iVar0 /*36*/])->f_10))
				{
					func_122((uParam0->f_31[iVar0 /*36*/])->f_10);
				}
	...
	if (uParam0->f_614 > 0)
	{
		if (!uParam0->f_624)
		{
			...
			else if (func_110(Global_35, uParam0->f_12.f_10, 1) > 400f && !CAM::IS_SPHERE_VISIBLE(uParam0->f_12.f_10, 1f))
			{
				uParam0->f_621 = 1;
				func_124(uParam0);
				uParam0->f_624 = 1;
...
void func_53(var uParam0)
{
	...
	{
		if (((func_110(uParam0->f_12, uParam0->f_12.f_16, 1) >= 2500f && func_111(Global_35, uParam0->f_12, 1) > 400f) && !PED::IS_PED_INJURED(uParam0->f_12)) && !func_119(uParam0->f_12, 242628503))
		{
			func_125(uParam0);
			uParam0->f_12.f_2 = 1;
			fVar1 = 3f;
			...
			TASK::_TASK_FLEE_FROM_PED(false, Global_35, uParam0->f_12.f_16, 25f, -1, 1024, fVar1, 0);
			TASK::TASK_WANDER_IN_AREA(false, uParam0->f_12.f_16, 15f, 1.5f, 3f, true);
			TASK::CLOSE_SEQUENCE_TASK(iVar0);
			TASK::TASK_PERFORM_SEQUENCE(uParam0->f_12, iVar0);
		}
	}
	else if (func_110(uParam0->f_12, uParam0->f_12.f_16, 1) >= 100f)
	{
		uParam0->f_12.f_2 = 0;
	}
}
...
int func_76(int iParam0, int iParam1, bool bParam2)
{
	...
	*bParam2 = 0;
	Var0 = { func_131(-1591664384, -1591664384, 0, 0, iParam1, 0, -1, 0, 0) };
	...
	if (iVar11 != -1)
	{
		...
		while (iVar12 < iVar10)
		{
			...
			{
				if (func_132(iVar13, iParam1, &Var14, &iVar45, 1, 0))
				{
					iVar46 = 0;
					while (iVar46 < iVar45)
					{
						...
						{
							*bParam2 = (*bParam2 + (Var14[iVar46 /*2*/])->f_1);
						}
						iVar46++;
					}
				}
...
int func_77(int iParam0, int iParam1)
{
	...
	Var0 = { func_133(0) };
	Var0.f_4 = func_134(iParam1);
	Var5 = { func_135(iParam0, Var0, Var0.f_4, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var5))
	{
		return 0;
	}
	uVar9 = INVENTORY::_0xC97E0D2302382211(func_136(0), &Var5, 0);
	return uVar9;
}
...
int func_78(int iParam0, int iParam1)
{
	...
	Var0.f_4 = func_134(iParam1);
	if (!func_137(iParam0, Var0.f_4))
	{
		return 0;
	}
	iVar5 = func_138(iParam0, &Var0, 1, 0);
	iVar6 = func_139(iParam0, 0);
...
int func_79(int iParam0, int iParam1, bool bParam2)
{
	...
	if (iParam1 == 1)
	{
		if (func_140(iParam0) && func_141(iParam0))
		{
			iVar0 = 0;
			if (func_76(iParam0, 369710026, &iVar0))
			{
				bParam2 = iVar0;
			}
		}
	}
	Var1.f_4 = func_134(iParam1);
	Var1 = { func_133(0) };
	if (!func_142(iParam0, &uVar6, &Var1, bParam2, 752097756, 1))
	{
		return 0;
	}
	return 1;
...
var func_94(bool bParam0, var uParam1)
{
...
bool func_95(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_88(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
int func_99(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_158(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
...
bool func_103(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_171(bVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_104(var uParam0)
{
	...
	PED::_0xFCA8FB9E15FA80D3(uParam0->f_12, func_172());
...
int func_108(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
int func_112()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_175(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_113(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
...
void func_114(int iParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
void func_118(var uParam0, var uParam1)
{
	...
	if (uParam0->f_614 == 0)
	{
		...
		uParam0->f_5 = func_182(uParam0->f_4, 0, 0, 0);
		func_183(uParam0);
		if (!MAP::DOES_BLIP_EXIST(uParam0->f_6))
		{
		...
		func_99(uParam0->f_3, "Hunting Zone Target", 0, 0, 0, 0, -1082130432 /* Float: -1f */);
		uParam0->f_622 = 1;
	}
	uParam0->f_614++;
	if (!uParam0->f_614 >= func_100())
	{
		...
		while (iVar0 < iVar1)
		{
			...
			{
				func_167(&((uParam0->f_31[iVar0 /*36*/])->f_10), (uParam0->f_31[iVar0 /*36*/])->f_17, 0f, 0f, 0f, uParam0->f_7, uParam0->f_7, uParam0->f_7, "volHerbBlocking - Legendary Tracking Clue");
				if (VOLUME::_DOES_VOLUME_EXIST((uParam0->f_31[iVar0 /*36*/])->f_10))
				{
					func_168((uParam0->f_31[iVar0 /*36*/])->f_10, 1);
				}
...
int func_121(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	int iVar0;
	...
	if (ENTITY::_0x29BA9F78321E5A6C(bParam0, sParam1, iParam2, iParam3, iParam4, iParam5, 0, 0, 0, iParam6, 0, iParam7))
	{
		return 1;
	}
	return 0;
...
void func_124(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_12))
	{
		func_187(uParam0->f_12, uParam0->f_12.f_10, func_102(uParam0->f_615), 2, 1073741824 /* Float: 2f */);
		...
		TASK::TASK_WANDER_IN_AREA(uParam0->f_12, uParam0->f_12.f_10, 10f, 1.5f, 3f, true);
	}
}
...
void func_125(var uParam0)
{
	...
	iVar0 = func_189(0, func_188(), uParam0->f_616);
	uParam0->f_616 = iVar0;
	uParam0->f_12.f_16 = { func_169(iVar0) };
}
...
struct<10> func_131(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
	struct<10> Var0;
...
int func_132(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4, bool bParam5)
{
	struct<37> Var0;
	int iVar47;
	...
	*iParam3 = Var0.f_3;
	...
	if (bParam4)
	{
		func_190(iParam0, iParam1, uParam2, *iParam3);
	}
	return 1;
}
...
{
	return func_135(joaat("CHARACTER"), func_191(), -1591664384, bParam0);
}
...
struct<4> func_135(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_138(int iParam0, var uParam1, bool bParam2, bool bParam3)
{
	if (!func_130(iParam0, 0))
	{
		return 0;
...
int func_139(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_136(bParam1), iParam0, 0);
}
...
int func_142(int iParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!func_130(iParam0, 0))
	{
	}
	...
	if (func_197(iParam0, uParam2, bParam3, bParam5, 0))
	{
		return 0;
	}
	if (!func_194(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_136(0), uParam1, uParam2, iParam0, uParam2->f_4, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_145(int iParam0)
{
	...
	while (iVar0 < 20)
	{
		...
		{
			func_144(&(Global_40.f_11922[iVar0]), 0);
...
int func_152(int iParam0)
{
	...
	while (iVar0 < Global_40.f_7756)
	{
		if ((Global_40.f_7756[iVar0 /*3*/])->f_2 == iParam0)
		{
			...
			if (iVar2 < 1800 && func_153(iParam0, 32768))
			{
				return 1;
			}
		}
...
int func_158(vector3 vParam0, float fParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
Vector3 func_159(int iParam0, int iParam1)
{
	...
	{
		case 0:
			vVar0 = { func_203(1, iParam1) };
			break;
		case 1:
			vVar0 = { func_203(2, iParam1) };
			break;
		case 2:
			vVar0 = { func_203(3, iParam1) };
			break;
	}
	return vVar0;
}
...
var func_160(int iParam0, int iParam1)
{
	...
	{
		case 0:
			uVar0 = func_170(1, iParam1);
			break;
		case 1:
			uVar0 = func_170(2, iParam1);
			break;
		case 2:
			uVar0 = func_170(3, iParam1);
			break;
	}
	return uVar0;
}
...
void func_167(var uParam0, vector3 vParam1, vector3 vParam4, vector3 vParam7, char* sParam10)
{
...
void func_171(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_207(bParam1))
		{
			func_208(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_172()
{
	return 1983113051 /* GXTEntry: "Legendary Bull Gator" */;
}
...
int func_182(bool bParam0, int iParam1, bool bParam2, int iParam3)
{
	int iVar0;
...
void func_184(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
...
void func_187(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bParam0 == func_106(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_222(bParam0))
	{
		if (func_223(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_224(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
		if (PED::IS_PED_ON_VEHICLE(bVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_187(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(bVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_187(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_224(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_224(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_224(iParam5, 32), true);
	...
	else if (func_224(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_224(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_224(iParam5, 64))
		{
...
int func_189(int iParam0, int iParam1, int iParam2)
{
	...
	if (iVar0 == iParam2)
	{
		...
		{
			iVar0 = func_56(func_225(), iParam0, (iParam1 - 1));
		}
	}
	return iVar0;
}

void func_190(int iParam0, int iParam1, var uParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_194(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_136(bParam0));
}
...
int func_197(int iParam0, var uParam1, int iParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
	...
	if (func_227(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
		{
			Var0 = { func_228(0) };
			Var4.f_9 = -1591664384;
			if (!func_229(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
			{
				return 0;
			}
			else if (func_230(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
			{
				return 0;
			}
			if (func_231(iParam0, 1))
			{
				if (!func_229(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					return 0;
				}
				else if (func_230(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
				{
					return 0;
				}
			}
		}
		else if (!func_232(iParam0, &uVar26, 0))
		{
			return 0;
		}
		return 1;
	}
	iVar27 = func_138(iParam0, uParam1, bParam3, bParam4);
	if (iVar27 < 0)
	{
		return 0;
	}
	...
	if (bParam3)
	{
		iVar28 = func_233(iParam0, *uParam1, uParam1->f_4, bParam4);
	}
	else
	{
		iVar28 = INVENTORY::_0xE787F05DFC977BDE(func_136(bParam4), iParam0, 0);
	}
...
void func_198(bool bParam0)
{
	...
	{
		func_235(&(Global_40.f_12018.f_42), 1);
	}
}
...
Vector3 func_203(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return 2176.243f, -818.1503f, 40.528f;
				case 1:
					return 2135.634f, -778.7705f, 40.52f;
				case 2:
		...
		case 1:
			...
			{
				case 0:
					return 2114.94f, -726.4951f, 40.5653f;
				case 1:
					return 2129.346f, -859.8976f, 40.6406f;
				case 2:
					return 2228.658f, -820.9073f, 40.6338f;
			}
			break;
		case 2:
			switch (iParam1)
			{
				...
				case 1:
					return 2160.59f, -850.282f, 40.5404f;
				case 2:
					return 2187.157f, -819.4145f, 40.6378f;
			}
			break;
		case 3:
			switch (iParam1)
			{
				case 0:
					return 2122.984f, -796.6561f, 40.6865f;
				case 1:
					return 2167.422f, -827.3166f, 40.6391f;
				case 2:
					return 2150.882f, -809.5778f, 40.52f;
			}
			break;
	}
	return 0f, 0f, 0f;
...
void func_209(bool bParam0, int iParam1, bool bParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return;
...
int func_217(int iParam0)
{
	...
	if (func_241(64) && func_242(iParam0))
	{
		return 1;
	}
...
{
	return func_244(iParam0) == joaat("WEAPON");
}
...
struct<4> func_228(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_135(923904168, func_133(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_135(923904168, func_133(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_135(923904168, func_133(bParam0), -740156546, 0);
}

bool func_229(int iParam0, var uParam1, int iParam2, bool bParam3)
{
	return func_233(iParam0, *uParam1, iParam2, bParam3) > 0;
}

int func_230(int iParam0, var uParam1, int iParam2)
{
	var uVar0;

	if (func_245(iParam0, &uVar0, uParam1, iParam2))
	{
...
{
	if (func_192(iParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_139(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_232(int iParam0, var uParam1, bool bParam2)
{
	struct<5> Var0;
	int iVar5;
	struct<10> Var6;
	...
	while (iVar29 < 4)
	{
		iVar5 = func_247((375 + iVar29), 1);
		if (func_229(iParam0, &Var0, iVar5, 0))
		{
			bVar28 = func_230(iParam0, &Var6, iVar5);
...
int func_233(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_135(iParam0, Param1, iParam5, bParam6) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var0))
	{
		return 0;
	}
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_136(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_245(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_136(0);
	*uParam1 = { func_135(iParam0, func_228(0), iParam3, 0) };
...
struct<5> func_246(int iParam0, bool bParam1, bool bParam2)
{
	...
	switch (func_244(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_135(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (bParam2 && func_231(iParam0, 1))
			{
				...
				else if (!func_229(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_230(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_249(iParam0, -1823706425))
			{
				Var0 = { func_135(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_249(iParam0, -1483207246))
			{
				Var0 = { func_135(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_0x780C5B9AE2819807(iParam0, -833319691))
			{
				...
				if (!func_250(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
struct<4> func_248(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_135(271701509, func_133(bParam0), 12999093, 0) };
		}
		return *Global_1224218;
	}
	return func_135(271701509, func_133(bParam0), 12999093, 0);
}
...
int func_250(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_136(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
