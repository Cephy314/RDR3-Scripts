...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 1f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_152(uParam0, joaat("P_BOTTLEBEER01X"), 0f, 0f, 0f, "BEER", 0, 1, 1);
	if (!func_153(15))
	{
		func_154(uParam0, "script@vignette@pearson_par_1@base", 65, 1, 0, 0);
	}
	func_154(uParam0, "script@vignette@pearson_par_1@action", 64, 0, 1, 0);
...
void func_157(var uParam0, int iParam1, float fParam2)
{
...
{
	func_252(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
...
void func_252(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
...
void func_321(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_340(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
