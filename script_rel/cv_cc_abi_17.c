...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -0.792594f, -0.612121f, 0.981384f, 3f, 0.9f, 0.9f, 2.5f, -1612834106, joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_150(uParam0, -0.0645018f, -0.121576f, 0.728058f, 3f, 0.8f, 2f, 2f, -1612834106, joaat("APMS_COMP_JOHN"), 1, 1, 1);
...
float func_215(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_312(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
bool func_287(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_341(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_341(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_403(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (bParam0 == func_444(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_445(bParam0))
	{
		if (func_446(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
...
int func_425(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_457(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
...
void func_426(bool bParam0, int iParam1)
{
	...
	func_379(bParam0, func_458(iParam1));
...
void func_428(bool bParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
int func_494(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_507(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
