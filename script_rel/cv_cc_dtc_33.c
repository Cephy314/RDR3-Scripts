...
int func_116(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_129(bVar0, 0))
	{
		if (func_129(PED::_0xB676EFDA03DADA52(bVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
void func_213(var uParam0)
{
	...
	if ((PED::_0xA911EE21EDF69DAF(Global_35) || func_300(uParam0, iLocal_19)) || func_297(func_22(uParam0)))
	{
		func_327();
		return;
	}
...
int func_350()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_403(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_477(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_509(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
...
void func_478(bool bParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_247(iParam1), bParam0, 0);
...
void func_540(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_557(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
