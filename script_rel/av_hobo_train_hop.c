...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_51(uParam0, 0, "Ped", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_18(var uParam0)
{
	...
	else if (!ENTITY::IS_ENTITY_DEAD(iLocal_42))
	{
		iLocal_48 = 4;
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		...
		{
			if ((!bLocal_10 && func_78(Global_36, uParam0->f_483) < 15625f) && !ENTITY::IS_ENTITY_DEAD(iLocal_42))
			{
				VEHICLE::_0xCFE122EC635CC2B2(VEHICLE::GET_TRAIN_CARRIAGE(iLocal_42, 0), "MOVING", 0, 0);
				bLocal_10 = true;
			}
		}
		if (((Global_1415419->f_9757 == -310375866 && func_78(Global_36, uParam0->f_483) < 12100f) || func_79(uParam0, 1065353216 /* Float: 1f */, 100f, 4, 50f, 1112014848 /* Float: 50f */)) || func_56(&uLocal_51) > 100f)
		{
			func_75(uParam0);
			VEHICLE::_0x787E43477746876F(iLocal_42);
			if (bLocal_12)
			{
				VEHICLE::SET_TRAIN_CRUISE_SPEED(iLocal_42, 4.91f);
			}
			else
			{
				VEHICLE::_0x15206E88FF7617DF(uLocal_43, 4.91f);
			}
			uParam0->f_469[2] = 1;
		}
	}
	if (uParam0->f_469[2] && !&uParam0->f_469[0])
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_42))
		{
			if (!bLocal_11)
			{
				vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_44, (uParam0->f_20[0 /*14*/])->f_5) };
				if (vVar0.y <= vLocal_45.y)
				{
					ANIMSCENE::ATTACH_ANIM_SCENE_TO_ENTITY_PRESERVING_LOCATION(uParam0->f_3.f_1, iLocal_44, 0);
					bLocal_11 = true;
			...
			{
				VEHICLE::SET_TRAIN_SPEED(iLocal_42, 4.91f);
			}
		}
		if (!&uParam0->f_469[4])
		{
			if (func_81(uParam0, 3f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				func_76(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[4] = 1;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x73616E64696C616E(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1, 1, 0))
			{
				if (&uParam0->f_469[6])
				{
					...
					vVar6 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_44, vVar3) };
					ENTITY::SET_ENTITY_COORDS(&(uParam0->f_20[0 /*14*/]), vVar6, true, false, true, true);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(&(uParam0->f_20[0 /*14*/]), iLocal_44, 0, vVar3, 0f, 0f, 86.11757f, false, false, false, false, 2, true, true, false);
					TASK::_TASK_START_SCENARIO_IN_PLACE(&(uParam0->f_20[0 /*14*/]), joaat("WORLD_HUMAN_SEAT_LEDGE_NEW"), -1, false, 0, 0f, true);
		...
		if (bLocal_12)
		{
			if (func_78(Global_36, ENTITY::GET_ENTITY_COORDS(iLocal_42, true, false)) > 62500f)
			{
				uParam0->f_469[3] = 1;
			}
		}
...
int func_58(vector3 vParam0)
{
	...
	{
		vVar0 = { VEHICLE::_0x6DE03BCC15E81710(vParam0) };
...
int func_59(var uParam0)
{
	...
	if (!bLocal_12)
	{
		if (ENTITY::IS_ENTITY_DEAD(iLocal_42))
		{
			iLocal_42 = VEHICLE::_0x6E585A616ABB8401(uLocal_43);
			return 0;
		}
		if (!VEHICLE::_0x0516FAE561276EFC(uLocal_43))
		{
	...
	{
		iLocal_44 = VEHICLE::GET_TRAIN_CARRIAGE(iLocal_42, iLocal_48);
		return 0;
	}
	if (!bLocal_9)
	{
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_44, 0, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_44, 2, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_44, 1, false, true);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_44, 3, false, true);
		bLocal_9 = true;
	}
	if (ENTITY::GET_ENTITY_SPEED(iLocal_42) < 0.001f)
	{
		if (Global_1415419->f_9757 != -310375866)
		{
			func_55(&uLocal_51, 0);
		}
		ANIMSCENE::SET_ANIM_SCENE_ORIGIN(uParam0->f_3.f_1, ENTITY::GET_ENTITY_COORDS(iLocal_44, true, false), ENTITY::GET_ENTITY_ROTATION(iLocal_44, 2), 2);
		if (ANIMSCENE::_GET_ANIM_SCENE_ENTITY_MATRIX(uParam0->f_3.f_1, "Ped", &vVar0, true, "Pl_Action_Without_Lootsack", 2))
		{
			(uParam0->f_20[0 /*14*/])->f_5 = { vVar0 };
			vLocal_45 = { ENTITY::GET_OFFSET_FROM_ENTITY_GIVEN_WORLD_COORDS(iLocal_44, vVar0) };
			return 1;
		}
	}
	return 0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_127(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_54(&(uParam0->f_490)))
							{
...
int func_90(vector3 vParam0, float fParam3)
{
	int iVar0;
...
void func_110(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_145(iParam1))
		{
			func_146(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_120(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_150(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_150(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_150(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
