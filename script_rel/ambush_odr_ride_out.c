	...
	switch (Local_274.f_6)
	{
		...
		case 1:
			...
			if (func_297(&(iLocal_15[Local_274.f_9]), Local_274.f_42[Local_274.f_9], 41, 0, 0, 1084227584 /* Float: 5f */, 100, 0, 0) || func_47(Local_274.f_10[5 /*3*/], 2f))
			{
				...
				{
					func_298();
					Local_274.f_59 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_TERRIFYING_NEW"), iLocal_15.f_209, -1f, 100f, 100f, -1082130432, -1082130432, 4, 4);
					if (Local_274.f_59 != 0)
					{
					}
				}
...
void func_174()
{
	...
	while (iVar0 < 5)
	{
		if (!func_136(&iLocal_15, iVar0, 16777216))
		{
			...
			{
				if (func_61(&(iLocal_15.f_40[iVar0]), 0, 1) && PED::_GET_HORSE_RIDER(&(iLocal_15.f_40[iVar0]), false) != 0)
				{
...
int func_631(int iParam0, var uParam1)
{
	...
	*uParam1 = func_706(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
int func_632(int iParam0, var uParam1)
{
	...
	*uParam1 = func_706(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_560(*uParam1, 0))
	{
		return 0;
	}
