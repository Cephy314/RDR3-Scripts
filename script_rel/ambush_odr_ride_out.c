...
int func_20()
{
	...
	if (func_61(&(iLocal_15[iVar0]), 0, 0))
	{
		...
		func_127(&(iLocal_15[iVar0]), func_126(&Local_274, iVar0), 1);
		if (func_128(&(iLocal_15.f_40[iVar0]), 0))
		{
...
void func_29()
{
	...
	if (!func_30(&iLocal_15, 8388608))
	{
		if (!func_30(&iLocal_15, 4194304))
		{
			...
			{
				func_165(&iLocal_15, 1.1f);
			}
			else
			{
				func_165(&iLocal_15, 1.2f);
			}
...
int func_31()
{
	...
	Local_274.f_56 = func_166(&iLocal_15);
	func_167();
	func_168();
	iVar0 = 0;
	while (iVar0 < iLocal_15.f_215)
	{
		func_169(&iLocal_15, iVar0, &(iLocal_15.f_40[iVar0]));
		iVar0++;
	}
	switch (Local_274.f_5)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_172(&iLocal_15, &(Local_274.f_54), Local_274.f_10[3 /*3*/], "COMBAT_FLEE", 1092616192 /* Float: 10f */))
			{
				func_173();
...
void func_49()
{
	...
	if (!func_18(Global_1393447, 65536))
	{
		...
		{
			func_195(&iLocal_15, 0, 2);
			TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_15[0]), iLocal_15.f_209, 4, 16768, -1f, -1, 0);
			PED::SET_PED_KEEP_TASK(&(iLocal_15[0]), true);
		}
		if (func_61(&(iLocal_15[1]), 0, 0))
		{
			func_195(&iLocal_15, 1, 2);
			TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_15[1]), iLocal_15.f_209, 4, 16768, -1f, -1, 0);
			PED::SET_PED_KEEP_TASK(&(iLocal_15[1]), true);
		}
	}
}
...
void func_75()
{
	...
	if (iLocal_15.f_19 < iLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15[iVar0])))
		{
			...
			{
				if (func_221(&(iLocal_15[iVar0]), 200f, -1082130432 /* Float: -1f */, &(iLocal_15.f_9[iVar0]), -1082130432 /* Float: -1f */))
				{
					func_195(&iLocal_15, iVar0, 8);
				}
			}
		}
	}
	else if (iLocal_15.f_19 < (iLocal_15.f_215 + iLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15.f_40[iVar0])))
		{
			...
			{
				if (func_221(&(iLocal_15.f_40[iVar0]), 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					func_162(&iLocal_15, iVar0, 8);
				}
			}
		}
	}
...
int func_83()
{
	switch (iLocal_15.f_151)
	{
		...
		case 10:
			func_241(&Local_274);
			if (func_243(0) || func_30(&iLocal_15, 2))
			{
				func_242(&Local_274);
			}
			break;
	...
	Local_274.f_58 = iLocal_15.f_222;
	func_22(&iLocal_15, 131072);
	func_246(&iLocal_15, 2, 1);
	func_247();
	func_248();
...
int func_92(int iParam0)
{
	...
	{
		case 0:
			if (&iLocal_15.f_57[iVar0] == 0)
			{
				iLocal_15.f_57[iVar0] = joaat("a_c_horse_thoroughbred_brindle");
			}
			break;
		case 1:
			if (&iLocal_15.f_57[iVar0] == 0)
			{
				iLocal_15.f_57[iVar0] = joaat("a_c_horse_americanpaint_overo");
			}
			break;
	}
	if (&iLocal_15.f_57[iVar0] == 0)
	{
		iLocal_15.f_57[iVar0] = func_257(iLocal_15.f_181, 0, 1);
	}
	return &(iLocal_15.f_57[iVar0]);
}
...
int func_95()
{
	...
	switch (Local_274.f_3)
	{
		...
		case 1:
			...
			if (!func_262(&iLocal_15, &Local_274))
			{
				iVar0 = 0;
			}
			return iVar0;
...
{
	PED::SET_PED_ACCURACY(&(iLocal_15[iParam0]), iParam1);
}
...
void func_134(int iParam0, int iParam1)
{
	...
	PED::SET_PED_SHOOT_RATE(&(iLocal_15[iParam0]), iVar0);
}
...
int func_138()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15.f_40[Local_274.f_55])))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(&(iLocal_15.f_40[Local_274.f_55]), Global_35, 1, 1))
		{
			return 1;
		}
	}
	if (func_278(&iLocal_15, &(iLocal_15.f_152), &(iLocal_15.f_180), &(Local_274.f_55), 0, 4, 1))
	{
		return 1;
	}
	return 0;
...
void func_139()
{
	if (!func_61(iLocal_15.f_56, 0, 0))
	{
		iLocal_15.f_56 = func_279(&iLocal_15, 0);
		if (func_61(iLocal_15.f_56, 0, 0))
		{
...
void func_140()
{
	...
	while (iVar1 <= 4)
	{
		if (func_61(&(iLocal_15[iVar1]), 0, 0))
		{
			if (!bVar0)
			{
			}
...
int func_146()
{
	...
	{
		func_288(&iLocal_15, func_287(36, 1), 0, 0, 1, 0);
	}
	if (func_61(&(iLocal_15[1]), 0, 1))
	{
		func_288(&iLocal_15, func_287(36, 1), 1, 1, 1, 1.2f);
	}
	return 1;
}
...
int func_147()
{
	...
	{
		func_291(&(iLocal_15[0]), Global_35, 3, 1, 100, 0);
		if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(&(iLocal_15[0]), Global_35, 17))
		{
			return 1;
		}
	}
...
void func_151()
{
	...
	func_293(&(iLocal_15.f_152), 1);
	func_234(&(iLocal_15.f_152), 1);
	func_294(&(iLocal_15.f_152), 1);
...
int func_152()
{
	...
	switch (Local_274.f_6)
	{
		case 0:
			...
			if (!func_125(&Local_274))
			{
				TASK::TASK_AIM_GUN_AT_ENTITY(&(iLocal_15[Local_274.f_8]), Global_35, BUILTIN::FLOOR((1f * 1000f)) + 4000, 0, 1);
			}
		...
		case 1:
			...
			if (func_297(&(iLocal_15[Local_274.f_9]), Local_274.f_42[Local_274.f_9], 41, 0, 0, 1084227584 /* Float: 5f */, 100, 0, 0) || func_47(Local_274.f_10[5 /*3*/], 2f))
			{
				if (!func_125(&Local_274))
				{
					func_298();
					Local_274.f_59 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(-2108467590, iLocal_15.f_209, -1f, 100f, 100f, -1082130432, -1082130432, 4, 4);
					if (Local_274.f_59 != 0)
					{
					}
				}
				...
				*(vVar0[1 /*3*/]) = { func_300(&Local_274, Local_274.f_8) };
				...
				func_200(&(iLocal_15[Local_274.f_8]), &iVar7, 0, 0, 1, 1);
		...
		case 2:
			...
			*(vVar0[1 /*3*/]) = { func_300(&Local_274, Local_274.f_9) };
			...
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, *(vVar0[1 /*3*/]), 2f, -1, 0.25f, 1056773, 40000f);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_200(&(iLocal_15[Local_274.f_9]), &iVar7, 0, 0, 1, 1);
		...
		case 3:
			...
			if (func_47(Local_274.f_10[1 /*3*/], 0.2f))
			{
				...
				{
					sVar8 = func_301(&iLocal_15, &Local_274);
					iVar10 = func_302(&Local_274);
					cVar9 = func_126(&Local_274, 0);
					func_303(&(iLocal_15[0]), Global_35, sVar8, -1073741824 /* Float: -2f */, 0, -500314840, 0, cVar9, iVar10);
					func_304(&(iLocal_15[0]), iLocal_15.f_22[0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
...
void func_153()
{
	...
	while (iVar0 <= 4)
	{
		...
		{
			if (PED::IS_PED_IN_COVER(&(iLocal_15[iVar0]), 0, 0))
			{
				func_304(&(iLocal_15[iVar0]), iLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
			...
			if (func_47(Local_274.f_10[0 /*3*/], 2.5f))
			{
				...
				if (func_326(iVar0))
				{
					...
					if (!func_148(&Local_274, 2))
					{
						...
						func_303(&(iLocal_15[iVar0]), Global_35, sVar2, -1073741824 /* Float: -2f */, 1, -500314840, 0, cVar1, iVar3);
		...
		case 1:
			if (func_47(Local_274.f_10[2 /*3*/], 5f))
			{
				...
				if (func_326(iVar0))
				{
					...
					func_303(&(iLocal_15[iVar0]), Global_35, sVar2, -1073741824 /* Float: -2f */, 1, 1744022339, 0, cVar1, iVar3);
...
int func_172(int iParam0, var uParam1, var uParam2, char* sParam3, float fParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_174()
{
	...
	while (iVar0 < 5)
	{
		if (!func_136(&iLocal_15, iVar0, 16777216))
		{
			if (func_342(&(iLocal_15[iVar0]), Global_35, 10f, 1))
			{
				if (func_61(&(iLocal_15.f_40[iVar0]), 0, 1) && PED::_0xB676EFDA03DADA52(&(iLocal_15.f_40[iVar0]), 0) != 0)
				{
					TASK::CLEAR_PED_TASKS(&(iLocal_15.f_40[iVar0]), 1, 0);
				}
				TASK::TASK_COMBAT_PED(&(iLocal_15[iVar0]), Global_35, 100663296, 0);
				func_162(&iLocal_15, iVar0, 16777216);
			}
		}
		iVar0++;
	}
...
int func_197(int iParam0)
{
	...
	if (func_371(&iLocal_15, &(iLocal_15[iParam0])))
	{
		return 1;
	}
...
int func_202(int iParam0, int iParam1)
{
	...
	if (func_373(&(iLocal_15.f_40[iParam0]), iParam1))
	{
		return 1;
	}
	if (func_371(&iLocal_15, &(iLocal_15.f_40[iParam0])))
	{
		return 1;
	}
...
int func_203(int iParam0)
{
	...
	if (func_375(&(iLocal_15.f_84[iParam0]), fVar0))
	{
		return 0;
	}
...
int func_204(int iParam0)
{
	...
	if (func_376(&iLocal_15, &(iLocal_15.f_49[iParam0])))
	{
		return 1;
	}
...
void func_281()
{
	...
	while (iVar3 <= 4)
	{
		if (func_61(&(iLocal_15[iVar3]), 0, 0))
		{
			...
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_200(&(iLocal_15[iVar3]), &iVar4, fVar5, 0, 1, 1);
		}
		iVar3++;
	}
...
void func_283()
{
	...
	if (!bVar2)
	{
		if (func_61(&(iLocal_15[0]), 0, 1))
		{
			func_341(&(iLocal_15[0]), Global_35, func_301(&iLocal_15, &Local_274), 0, 70f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
			bVar2 = true;
		}
	}
	iVar0 = 0;
	while (iVar0 < iLocal_15.f_215)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 1))
		{
			...
			func_200(&(iLocal_15[iVar0]), &iVar1, 0.3f, 1f, 1, 1);
			func_304(&(iLocal_15[iVar0]), iLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
			if (!bVar2)
			{
				func_341(&(iLocal_15[iVar0]), Global_35, func_301(&iLocal_15, &Local_274), 0, 70f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				bVar2 = true;
			}
		}
		iVar0++;
...
void func_288(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, float fParam7)
{
	...
	if (func_221(iParam0[iParam4], 250f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */) || (func_424(iParam5) && func_221(&(iParam0->f_40[iParam5]), 250f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */)))
	{
		...
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(iParam0[iParam4], -401180987);
...
void func_298()
{
	...
	Var3.f_8 = -1082130432;
	Var3 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(iLocal_15[1]), 0f, 2f, 1f) };
	Var3.f_3 = { vVar0 };
...
bool func_315(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_441(iParam0, joaat("currency_cash"), iParam1, uVar0);
	}
...
int func_336(int iParam0, int iParam1)
{
	...
	while (iVar0 <= iParam1)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			fVar3 = func_220(&(iLocal_15[iVar0]), Global_36, 0);
			if (fVar3 < fVar2)
			{
				fVar2 = fVar3;
				iVar1 = iVar0;
...
int func_392(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_442(int iParam0, int iParam1, bool bParam2, int iParam3)
{
	...
	while (iVar2 <= iParam1)
	{
		if (func_61(&(iLocal_15[iVar2]), 0, 0))
		{
			fVar1 = &iLocal_15.f_9[iVar2];
			if ((fVar1 < fVar0 && !bParam2) || !AUDIO::IS_SCRIPTED_SPEECH_PLAYING(&(iLocal_15[iVar2])))
			{
...
bool func_534(int iParam0, float fParam1, int iParam2)
{
	int iVar0[3];
	int iVar4;
	int iVar5;
...
int func_553(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_661(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_711(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	int iVar1;
