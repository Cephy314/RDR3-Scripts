...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	iLocal_9 = func_48(joaat("HORSE_CLASS_RIDING"), 1);
	func_49(uParam0, 0, "DHP_HORSE", iLocal_9, vParam1, vParam4.z, 1, 1, 0, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 == 150)
	{
		func_49(uParam0, 1, "RDED1_DOG_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 1.25f, 0.2f, 0f), (90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
	...
	switch (iLocal_11)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[0 /*14*/]), iLocal_14);
			...
			{
				func_47(&((uParam0->f_20[1 /*14*/])->f_5), 50, 10, 0);
