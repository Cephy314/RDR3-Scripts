...
{
	func_33(uParam0, 10822, 10954, 11513);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uParam0->f_16 = 1;
	func_46(uParam0, "DROP_RABBIT_TABLE", "script@ambient@campfireGeneral@Drop_Rabbit_Table@Action", vParam1, vParam4);
	func_47(uParam0, 2, "Pl_Drop_Exit_Back", "PL_DROP_ADDRESS_EXIT", 0);
	iVar0 = func_49(func_48());
	func_50(uParam0, 0, "MALE", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_50(uParam0, 1, "RABBIT", joaat("a_c_rabbit_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_28(var uParam0)
{
	...
	{
		PED::_0x6569F31A01B4C097(&(uParam0->f_20[1 /*14*/]), 0, 0);
		PED::_0x6569F31A01B4C097(&(uParam0->f_20[1 /*14*/]), 1, 0);
...
int func_30(var uParam0)
{
	...
	iLocal_37 = VOLUME::_CREATE_VOLUME_BY_HASH(-1612834106, vVar0, uParam0->f_486, 2.2825f, 2.6175f, 2.0875f);
	func_58(&uLocal_9, 0);
	func_59(&uLocal_9, 1);
	func_60(&uLocal_9, 1);
	func_61(&uLocal_9, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		{
			if (func_65(&(uParam0->f_20[0 /*14*/]), 0, &uLocal_9, &uVar0, 0, 0))
			{
	...
	if (!&uParam0->f_469[1])
	{
		if (func_68(uParam0, 1065353216 /* Float: 1f */, 90f, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
		{
			func_66(uParam0);
			if (func_69())
			{
	...
	if (&uParam0->f_469[1])
	{
		if (!&uParam0->f_469[2])
		{
			if (func_71(uParam0, 1.2f, 1116471296 /* Float: 70f */, 4, joaat("action"), 1))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[2] = 1;
			}
...
int func_69()
{
	...
	iVar0 = func_143(func_142(func_73()));
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (func_144(iVar0, iLocal_37, 1, 0))
		{
			return 1;
		}
	}
...
int func_70(var uParam0)
{
	...
	iVar0 = uParam0->f_3.f_1;
	sVar1 = "PL_DROP_ADDRESS_EXIT";
	...
	if (!ANIMSCENE::_0xA9016536015DE29D(iVar0, sVar1))
	{
		return 0;
	}
	if (!ANIMSCENE::_0x23E33CB9F4A3F547(iVar0, sVar1))
	{
		return 0;
	}
	ANIMSCENE::_SET_ANIM_SCENE_PLAYBACK_LIST_BOOL(iVar0, sVar1, true);
	return 1;
}
...
int func_76(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_150(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_77(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_128(int iParam0, var uParam1)
{
	...
	else if (func_120() - uParam1->f_4) > func_203(uParam1)
	{
...
void func_132(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_150((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
float func_137(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_206(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
