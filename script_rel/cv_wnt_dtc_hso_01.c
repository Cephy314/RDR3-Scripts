...
int func_92(var uParam0)
{
	...
	if (bLocal_94)
	{
		...
		{
			if (PED::_0x7F9B9791D4CB71F6(func_53(uParam0, iLocal_18), Global_35, false, 0) == 1 && !PED::IS_PED_USING_ANY_SCENARIO(func_53(uParam0, iLocal_18)))
			{
...
int func_118(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_131(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_233(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
float func_233(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_343(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_275(var uParam0, var uParam1)
{
	...
	bVar1 = func_251(iVar0);
	if (!ENTITY::DOES_ENTITY_EXIST(bVar1))
	{
		return 0;
	}
	return func_362(bVar1);
}
...
int func_278(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool func_303(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_372(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_321(var uParam0, var uParam1)
{
	...
	func_374(Global_35, bVar0, &Var1, 0f, 0f, 0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_226(1);
}
...
void func_322(var uParam0, var uParam1)
{
	...
	Var1.f_19 = -1;
	Var1.f_26 = -1082130432;
	func_375(bVar0, Global_35, &Var1, -1082130432 /* Float: -1f */, 0, 0, uParam1->f_4, uParam1->f_5, 1, uParam1->f_26, 0, 0, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
}
...
void func_333(var uParam0, var uParam1)
{
	...
	func_391(Global_35, bVar0, 1, 1, 1, 0, 0, 1, 0, 1, 1);
	if (uParam1->f_6 > 0f)
	{
...
void func_334(var uParam0, var uParam1)
{
	...
	func_392(bVar0, Global_35, 1, 1, 1, 0, 1, 1, 0, 1, 1);
	...
	switch (uParam1->f_47.f_1)
	{
		case 0:
			if (func_396(uParam0, uParam1))
			{
				...
				if (uParam0->f_2 == 456)
				{
					func_397(Global_35, "WNT_INTERRUPT_NAGGED", -417894478, bVar0, 1, 0, 5, 1);
					func_398(uParam1, 2);
					return;
				}
				func_397(Global_35, func_399(uParam0, uParam1), -417894478, bVar0, 1, 0, 0, 1);
		...
		case 2:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_397(bVar0, func_404(uParam0, uParam1), -417894478, Global_35, 1, 0, 0, 1);
...
void func_372(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
...
void func_374(bool bParam0, bool bParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
...
void func_375(bool bParam0, bool bParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> Var0;
...
void func_392(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
	}
...
bool func_397(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_468(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_249(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_249(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_249(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_249(iParam5, 32), true);
	...
	else if (func_249(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_249(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_249(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
