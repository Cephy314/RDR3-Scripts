	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_497(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0x959383DCD42040DA(iVar0))
			{
				...
				{
					func_370(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
int func_438()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_627(Global_35))
	{
		return 1;
	}
	return 0;
...
void func_530(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_712(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_876(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_939(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_877(bool bParam0, int iParam1)
{
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_248(iParam1), bParam0, 0);
