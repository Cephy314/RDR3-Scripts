...
int func_141()
{
	...
	switch (iLocal_276)
	{
		case 0:
			if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_52[0])))
			{
				if (VOLUME::_0xF256A75210C5C0EB(bVar3, vVar0))
				{
					PLAYER::SET_PLAYER_INVINCIBLE(PLAYER::PLAYER_ID(), true);
					func_144(&uLocal_289);
					func_25(&uLocal_15, 1);
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar1])))
		{
			...
			else
			{
				if (func_61(&(uLocal_15[iVar1]), 0, 0))
				{
					...
					PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iVar1]), false, 0, 0);
					if (PED::IS_PED_IN_COMBAT(&(uLocal_15[iVar1]), Global_35))
					{
						TASK::CLEAR_PED_TASKS(&(uLocal_15[iVar1]), 0, 0);
						TASK::_TASK_SMART_FLEE_STYLE_PED(&(uLocal_15[iVar1]), Global_35, 4, iVar0, -1082130432, -1, 0);
...
void func_151(var uParam0, bool bParam1, vector3 vParam2, float fParam5, float fParam6, float fParam7, bool bParam8)
{
	int iVar0;
			...
			if (!func_133(&uLocal_278, 2048))
			{
				if (func_47(&uLocal_289, 0.75f))
				{
					if (func_61(&(uLocal_15[4]), 0, 0))
					{
						...
						PED::_0x7DE9692C6F64CFE8(&(uLocal_15[4]), false, 0, 0);
						func_269(&(uLocal_15[4]), uLocal_15.f_22[4], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
						PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(uLocal_15[4]), vVar0, 3f, 0, 0, 0);
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			if (func_267(&uLocal_15, iVar0))
			{
				...
				func_269(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), joaat("BLIP_MODIFIER_URGENT_ALERT"), 0, 0);
			}
			else
			{
				PED::DELETE_PED(uLocal_15[iVar0]);
...
int func_171(float fParam0, int iParam1, int iParam2, bool bParam3)
{
...
void func_250(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return;
...
int func_266(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
...
int func_273(vector3 vParam0)
{
	...
	if (VOLUME::_0xF256A75210C5C0EB(&(iLocal_280[0]), func_413(Global_36, vParam0, 0.2f)))
	{
		return 1;
	}
	if (VOLUME::_0xF256A75210C5C0EB(&(iLocal_280[1]), func_413(Global_36, vParam0, 0.2f)))
	{
		return 1;
	}
	return 0;
...
void func_287()
{
	...
	if (!func_133(&uLocal_278, 512))
	{
		...
		iVar27 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_TERRIFYING"), vVar22, -1f, -1f, -1f, -1082130432, -1082130432, -1, -1);
		...
		while (iVar21 < iVar20)
		{
			if (func_61(&(uVar0[iVar21]), 0, 0))
			{
				...
				TASK::_TASK_SMART_FLEE_STYLE_COORD(0, vVar22, 3, 4096, -1f, -1, 0);
		...
		while (iVar21 < iVar20)
		{
			if (func_61(&(uVar9[iVar21]), 0, 0))
			{
				...
				{
					if (PED::_GET_HORSE_RIDER(&(uVar9[iVar21]), true) != Global_35)
					{
						TASK::OPEN_SEQUENCE_TASK(&iVar25);
						TASK::TASK_HORSE_ACTION(0, 2, 0, 0);
						TASK::_TASK_SMART_FLEE_STYLE_COORD(0, vVar22, 4, 4096, -1f, -1, 0);
...
bool func_302(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		uVar0 = func_439(iParam0);
		return func_440(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
...
int func_349(int iParam0, float fParam1)
{
...
int func_364(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_463(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_467(0))
				{
					...
					func_468(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
int func_390(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_410(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
...
int func_416(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, int iParam7, bool bParam8)
{
	struct<15> Var0;
	int iVar20;
	int iVar21;
...
var func_428(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	int iVar0;
	var uVar1;
	...
	uVar1 = func_519(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_196(iVar0);
	return uVar1;
}
...
int func_429(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7)
{
	...
	iVar0 = VOLUME::_CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	uVar1 = func_520(uParam0, uParam1, iParam2, iVar0, bParam7);
	func_196(iVar0);
	return uVar1;
}
...
var func_440(int iParam0, int iParam1, var uParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
struct<5> func_461(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
...
int func_464(int iParam0, var uParam1, int iParam2)
{
	var uVar0;
...
struct<4> func_465(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_544(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

int func_466(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
int func_467(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_544(bParam0));
}
...
void func_469(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_547(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_481(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_359(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_553(iVar0, 0)))
		{
...
int func_483(int iParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_485(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_489(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_493(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_498(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_507(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
int func_517(var uParam0, float fParam1, int iParam2)
{
	var uVar0[5];
	var uVar6[9];
	int iVar16;
...
int func_522(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!bParam3)
	{
		return 0;
...
int func_529(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0;
...
struct<4> func_535(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_465(923904168, func_533(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_465(923904168, func_533(bParam0), -740156546, 0) };
		}
...
int func_536(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_586(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
struct<4> func_537(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_465(271701509, func_533(bParam0), 12999093, 0) };
		}
...
int func_540(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_544(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_542(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;
...
int func_555(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_567(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	if (bParam3 && ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		return 0;
...
var func_572(int iParam0, var uParam1)
{
...
void func_575(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_621(func_620(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_622())
	{
...
float func_580(int iParam0)
{
	...
	fVar6 = func_623(iParam0);
	fVar7 = BUILTIN::TO_FLOAT(ATTRIBUTE::GET_DEFAULT_ATTRIBUTE_POINTS_NEEDED_FOR_RANK(iVar0, 7, iVar1));
	fVar8 = BUILTIN::TO_FLOAT(ATTRIBUTE::GET_DEFAULT_ATTRIBUTE_POINTS_NEEDED_FOR_RANK(iVar0, 7, iVar5));
	fVar9 = (fVar6 - fVar7);
	fVar10 = (fVar8 - fVar7);
	fVar11 = (fVar9 / fVar10);
	uVar12 = func_624(fVar3, fVar4, fVar11);
	return uVar12;
}
...
int func_586(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_544(bParam1), iParam0, 0);
}
...
int func_591(int iParam0)
{
	...
	if (PED::IS_PED_GROUP_MEMBER(iParam0, func_626(), 1))
	{
		return 1;
	}
	return 0;
...
{
	return func_627(iParam0, Global_1894899->f_2, bParam1);
}
...
void func_596(int iParam0)
{
	...
	func_632(&Var0);
	func_633(iParam0, Var0);
	func_634(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_15));
	func_635(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_298));
	func_636(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_356));
	func_637(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_372));
	iVar2 = 0;
	while (iVar2 < 2)
	{
		func_638(iVar2, (Global_40.f_1095.f_1[iParam0 /*436*/])->f_398[iVar2 /*4*/]);
		iVar2++;
	}
	iVar3 = 0;
	while (iVar3 < 3)
	{
		func_639(iVar3, (Global_40.f_1095.f_1[iParam0 /*436*/])->f_407[iVar3 /*4*/]);
		iVar3++;
	}
	func_640(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_420));
	func_641(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_422));
	func_642(&((Global_40.f_1095.f_1[iParam0 /*436*/])->f_425));
...
{
	return func_643(ZONE::_GET_MAP_ZONE_AT_COORDS(vParam0, 10));
}
...
void func_610(int iParam0)
{
	...
	func_650(&uVar0, &uVar1, &uVar2);
	func_651(iParam0, uVar0);
	func_652(iParam0, uVar1);
	func_653(iParam0, uVar2);
	func_654(iParam0, 1);
	func_655(iParam0, 1);
}
...
struct<2> func_614(int iParam0)
{
	...
	if (!func_657(iParam0, &uVar2))
	{
	}
	if (!func_658(iParam0, &uVar3))
	{
	}
	Var0 = uVar2;
	Var0.f_1 = uVar3;
...
struct<6> func_615()
{
	...
	if (func_659(joaat("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_659(joaat("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_659(joaat("SLOTID_HORSE_HORN"), &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_659(joaat("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_659(joaat("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_659(joaat("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
void func_616(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	func_662(iParam0);
	func_663(iParam0, uParam2);
	if (iParam3 != 0)
	{
		func_664(iParam0, iParam3, 0);
	}
...
char* func_621(char* sParam0, int iParam1)
{
	if (iParam1 == joaat("COLOR_PURE_WHITE"))
	{
		return MISC::_CREATE_VAR_STRING(10, "PLAYER_STRING", sParam0);
	}
	return func_666(MISC::_CREATE_VAR_STRING(10, "PLAYER_STRING", sParam0), iParam1);
}
...
int func_627(int iParam0, int iParam1, bool bParam2)
{
	...
	if (!func_667(iParam1, &uVar0, &iVar1, 0, 0))
	{
		return -1;
	}
	return func_668(iParam0, uVar0, iVar1, bParam2);
}
...
int func_628(bool bParam0)
{
	...
	if (bParam0)
	{
		return func_669(Global_1359489->f_4);
	}
	PED::GET_GROUP_SIZE(func_626(), &uVar2, &iVar1);
	if (iVar1 == 0)
	{
		return 0;
	}
	...
	while (iVar3 < iVar1)
	{
		iVar4 = PED::GET_PED_AS_GROUP_MEMBER(func_626(), iVar3);
		if (func_670(iVar4))
		{
			iVar0++;
		}
...
void func_633(int iParam0, struct<2> Param1)
{
	iParam0 = func_290(iParam0);
	if (iParam0 == -1)
	{
...
int func_650(var uParam0, int iParam1, var uParam2)
{
	bool bVar0;
...
int func_657(int iParam0, var uParam1)
{
	...
	*uParam1 = func_702(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
int func_658(int iParam0, var uParam1)
{
	...
	*uParam1 = func_702(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_543(*uParam1, 0))
	{
		return 0;
	}
...
int func_659(int iParam0, var uParam1)
{
	...
	if (!func_703(856287005, iParam0))
	{
		return 0;
	}
	Var0 = { func_704() };
	*uParam1 = func_702(Var0, iParam0, 0);
	if (!func_543(*uParam1, 0))
	{
		return 0;
	}
...
void func_661(int iParam0, var uParam1)
{
	...
	func_705(iParam0, *uParam1);
	func_705(iParam0, uParam1->f_1);
}
...
void func_663(int iParam0, var uParam1)
{
	...
	func_705(iParam0, *uParam1);
	func_705(iParam0, uParam1->f_1);
	func_705(iParam0, uParam1->f_2);
	func_705(iParam0, uParam1->f_3);
	func_705(iParam0, uParam1->f_4);
	func_705(iParam0, uParam1->f_5);
}
...
int func_665(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_706(&(Global_1109400->f_4), iVar0, 5);
	}
	if (iParam1 == func_707())
	{
		return func_706(&(Global_1109400->f_4), iVar0, 5);
	...
	{
		return func_706(&(((*Global_1108178)[iParam1 /*37*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_668(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		iVar2 = iVar1;
		if (func_708(iVar2) != 0 && PERSCHAR::_0x800DF3FC913355F3(func_709(iVar2)))
		{
			if (func_709(iVar2) == iVar0)
			{
				return iVar2;
			}
		}
...
int func_677(int iParam0, var uParam1)
{
	...
	Var1.f_9 = -1591664384;
	Var15 = { func_533(0) };
	if (!func_713(Var15, iVar0, &Var1, 0, 0))
	{
		return 0;
	}
	if (!func_714(&Var1, uParam1))
	{
		return 0;
	}
	return 1;
...
int func_679(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10)
{
	...
	{
		return func_715(Param0, Param4, iParam8, 1, bParam9, 1) != -1;
	}
	...
	if (func_716(&(Var0.f_5), &Param4) && Var0.f_9 == iParam8)
	{
		return 1;
	}
...
int func_680(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	...
	if (!func_467(bParam9))
	{
		return func_717(Param0, Param4, iParam8, 1) != -1;
	}
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Param0) || !INVENTORY::_0xB881CA836CC4B6D4(&Param4))
	{
		return 0;
	}
	if (func_716(&Param0, &Param4))
	{
		return 0;
	}
	Var0.f_9 = -1591664384;
	...
	if (func_716(&(Var0.f_5), &(Var14.f_5)) && Var0.f_9 == Var14.f_9)
	{
		return 0;
	}
...
int func_681(int iParam0)
{
	...
	if (func_718(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		return 1;
	}
...
int func_702(struct<4> Param0, int iParam4, int iParam5)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_721(Param0, iParam4, &Var0, iParam5))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_711(struct<4> Param0, int iParam4)
{
	struct<11> Var0;

	if (!func_467(0))
	{
		return func_724(Param0, iParam4, 1) != -1;
	}
...
int func_713(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_715(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> Var0;
	int iVar14;
	int iVar15;
...
int func_717(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	struct<16> Var28;
...
int func_721(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_724(struct<4> Param0, int iParam4, bool bParam5)
{
	int iVar0;
	struct<11> Var1;
	int iVar15;
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_732(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_726(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_727(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
{
	return INVENTORY::_0x033EE4B89F3AC545(func_544(bParam2), uParam0, iParam1);
}
...
struct<28> func_729(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_544(bParam4), &uParam0, &Var28, 29, 1))
	{
		return Var0;
	}
	Var0 = { func_726(&Var28) };
...
struct<17> func_731(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	...
	if (!INVENTORY::_0x025A1B1FB03FBF61(func_544(bParam4), &uParam0, &Var17, 15, 1))
	{
		return Var0;
	}
	Var0 = { func_726(&Var17) };
