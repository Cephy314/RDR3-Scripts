		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar1])))
		{
			...
			else
			{
				if (func_61(&(uLocal_15[iVar1]), 0, 0))
				{
					...
					{
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(&(uLocal_15[iVar1]), -401180987);
					}
...
void func_287()
{
	...
	if (!func_133(&uLocal_278, 512))
	{
		...
		iVar27 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(495656844, vVar22, -1f, -1f, -1f, -1082130432, -1082130432, -1, -1);
...
struct<6> func_615()
{
	...
	if (func_659(-997150586, &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_659(-1189569496, &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_659(325139909, &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_659(1310070322, &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_659(986998820, &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_659(-415648720, &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
int func_657(int iParam0, var uParam1)
{
	...
	*uParam1 = func_702(Var0, 1415981582, 0);
...
int func_658(int iParam0, var uParam1)
{
	...
	*uParam1 = func_702(Var0, -2119169513, 0);
	if (!func_543(*uParam1, 0))
	{
		return 0;
	}
