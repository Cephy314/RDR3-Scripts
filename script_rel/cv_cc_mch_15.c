...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 2.5297f, 1.7437f, 0.8499f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 6.5423f, -9.5295f, -0.5817f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_15, 3, joaat("WORLD_HUMAN_SMOKE"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 3, 0);
	func_157(uParam0, iLocal_15, 0.8f, 1065353216 /* Float: 1f */, 1092616192 /* Float: 10f */);
	func_155(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_156(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_250(func_148(uParam0), func_249(uParam0, iParam1), func_19(uParam0), 1) };
			break;
		default:
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_319(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_384(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
