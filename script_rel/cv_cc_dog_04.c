...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 5.3689f, 1.39f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
...
int func_93(var uParam0)
{
	...
	if (func_202(uParam0, iLocal_14) && !bLocal_18)
	{
		...
		TASK::TASK_SMART_FLEE_PED(false, func_48(uParam0, iLocal_15), 15f, 2000, 65792, 1.6001f, 0);
...
void func_312(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	int iVar0;
