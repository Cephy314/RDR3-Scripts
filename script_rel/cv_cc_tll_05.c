...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 4.505f, 7.6925f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 8.1249f, 2.6499f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, -1612834106, joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_152(uParam0, 1);
...
int func_86(var uParam0)
{
	...
	while (iVar0 < 3)
	{
		...
		{
			TASK::TASK_GO_STRAIGHT_TO_COORD((Global_1357549->f_1675[iVar0 /*5*/])->f_3, 2371.127f, 1340.22f, 106.0719f, 1f, 20000, 40000f, 1056964608, 0);
		}
		iVar0++;
	}
	return 1;
