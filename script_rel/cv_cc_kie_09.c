...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.1503f, -0.2019f, 0.9451f, 0f, 1.5f, 1.5f, 2f, joaat("VOLCYLINDER"), joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	func_152(uParam0, joaat("P_CS_ROPE03X"), 0f, 0f, 0f, "ROPE", 0, 1, 1);
	func_153(uParam0, "script@vignette@kieran_9@base_intro", 1, 1, 0, 0);
	iLocal_15 = func_153(uParam0, "script@vignette@kieran_9@wait", 1, 0, 0, 0);
	iLocal_16 = func_153(uParam0, "script@vignette@kieran_9@action_a", 2, 0, 1, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@kieran_9@action_b", 2, 0, 0, 1);
	iLocal_18 = func_153(uParam0, "script@vignette@kieran_9@action_c", 0, 0, 0, 0);
	iLocal_19 = func_153(uParam0, "script@vignette@kieran_9@to_base", 0, 0, 0, 0);
	func_154(uParam0, "CKIE9AU");
	Local_20 = { func_155(uParam0, 0.165f, -0.113f, 0.979f, -140f, 8f, 0.7f, 0.7f) };
	...
	if (func_162(joaat("CSTAG_FLOW_FIRST_VISIT_MUD1_POST"), 1))
	{
		uParam0->f_14 = 1;
	}
	return 1;
...
int func_93(var uParam0)
{
	...
	if (!bLocal_33)
	{
		...
		{
			func_204(uParam0, iLocal_14, 0, 1);
			bLocal_33 = true;
		}
	}
	if (bLocal_33)
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_214(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_232(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_234(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_192(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_202(uParam0, iVar1) || func_201(uParam0, iVar1))
			{
...
float func_214(int iParam0, bool bParam1, bool bParam2)
{
...
int func_251()
{
	...
	if (func_162(joaat("CSTAG_PLAYER_DONATED_FOOD"), 1))
	{
		return 1;
	}
	return 0;
...
int func_252()
{
	...
	if (func_162(joaat("CSTAG_PLAYER_DONATED_MONEY"), 1))
	{
		return 1;
	}
	return 0;
...
int func_331(vector3 vParam0, float fParam3, int iParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
...
void func_405(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_230(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_230(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_230(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_230(iParam5, 32), true);
	...
	else if (func_230(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_230(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_230(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_423(bool bParam0, int iParam1)
{
	...
	func_386(bParam0, func_453(iParam1));
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_232(iParam1), bParam0, 0);
		PED::_0xED1C764997A86D5A(func_232(iParam1), bParam0);
	...
	func_396(iParam1, func_451(iParam1, 8192), func_451(iParam1, 16384), 1);
}
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_397(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_433(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_397(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_433(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_162(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_397(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
