...
int func_15(int iParam0)
{
	...
	if (func_49(32768, 0, &uVar0))
	{
	}
	if (func_47(28, func_46(0)) && !func_48(28))
	{
		return func_52(&uLocal_14, 32768, &uLocal_14, func_50(), 0, func_51(), 1, 1, 1);
	}
	return 0;
}
...
int func_49(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
	...
	if (func_89(iParam0, fParam2))
	{
		*fParam2 = func_90(iParam0);
		return 1;
	}
	return 0;
}
...
int func_52(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	int iVar0;
	vector3 vVar1;
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(func_91(iParam3)))
	{
		return 0;
	}
	...
	if (bParam8)
	{
		vVar1 = { func_92(iParam1) };
		if (!func_93(vVar1))
		{
			if (func_94(vVar1, 1, 776, 0))
			{
				return 0;
			}
		}
	}
	if ((bParam6 && func_95(128, 0, 1)) && !iParam1 == 64)
	{
		return 0;
	}
	if (iParam7 && func_96(PLAYER::GET_PLAYER_INDEX(), 1, 1, 1))
	{
		return 0;
	}
	uParam0->f_1 = iParam1;
	uParam0->f_5 = func_88(func_86(iParam1), 0, 3, func_87(iParam1));
	func_97(&(uParam0->f_5), &(uParam0->f_3));
	if (!func_98(uParam0->f_3, 4))
	{
		iVar0 = 4;
	}
	else if (!func_98(uParam0->f_3, 8))
	{
		iVar0 = 8;
	}
	else if (!func_98(uParam0->f_3, 16))
	{
		iVar0 = 16;
	}
	else if (!func_98(uParam0->f_3, 32))
	{
		iVar0 = 32;
	}
	else if (!func_98(uParam0->f_3, 64))
	{
		iVar0 = 64;
	}
	if (iParam1 == 32768)
	...
	if (!func_98(uParam0->f_3, iVar0))
	{
		if (func_98(uParam0->f_3, 2))
		{
			if (!SCRIPTS::IS_THREAD_ACTIVE(*uParam2, false))
			{
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_101(iParam0) && !func_102(iParam0))
	{
	}
	if (func_103(iParam0, &iVar0, &iVar1, 0, 0))
	{
		if (func_104(iParam1))
		{
			iVar0 = iParam1;
...
void func_66(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_110(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_122(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_122(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_122(&cVar6, joaat("COLOR_PURE_WHITE")), func_122(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_123(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_68(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_128(func_127(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_128(func_127(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_128(func_127(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_128(func_127(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_128(func_127(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_128(func_127(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_69()
{
	return (Global_1894899 & 1 != 0 && func_129() != -1);
}
...
void func_71(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_130(iVar1) && !func_133(iVar1, iParam2)) && (!bParam3 || !func_134(iVar1))) && (!bParam4 || !func_135(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_136(iVar0);
...
void func_81(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_141(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_84(int iParam0, int iParam1)
{
	...
	{
		case 3:
			iVar0 = func_144(iParam0, 0);
			iVar0 = (iVar0 + func_144(iParam0, 2));
			iVar0 = (iVar0 + func_144(iParam0, 11));
			return iVar0;
		case 0:
			iVar0 = func_144(iParam0, 1);
			iVar0 = (iVar0 + func_144(iParam0, 7));
			iVar0 = (iVar0 + func_144(iParam0, 6));
			iVar0 = (iVar0 + func_144(iParam0, 12));
			return iVar0;
		case 2:
			iVar0 = func_144(iParam0, 3);
			iVar0 = (iVar0 + func_144(iParam0, 10));
			return iVar0;
		case 1:
			iVar0 = func_144(iParam0, 4);
			iVar0 = (iVar0 + func_144(iParam0, 9));
			return iVar0;
		case 4:
			return func_144(iParam0, 8);
		case 5:
			iVar0 = func_144(iParam0, 13);
			iVar0 = (iVar0 + func_144(iParam0, 14));
			iVar0 = (iVar0 + func_144(iParam0, 15));
			iVar0 = (iVar0 + func_144(iParam0, 16));
			return iVar0;
		default:
			break;
	}
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar5 = func_146(iVar3, iVar4, iParam2);
	if (Global_1572887->f_12 == -1)
	{
		iVar0 = iVar1;
		iVar0 = iVar1;
		...
		{
			iVar6 = iVar0;
			if (func_147(iVar6) == iVar5)
			{
				return iVar6;
			}
			if (func_147(iVar6) == 0)
			{
				return func_148(iVar3, iVar4, iParam2, iVar0, iParam3);
			}
			iVar0++;
		}
		iVar1 = 751;
	...
	else
	{
		...
		while (iVar0 <= iVar2)
		{
			...
			{
				return func_148(iVar3, iVar4, iParam2, iVar0, 0);
			}
			iVar0++;
		}
	}
...
int func_89(int iParam0, float fParam1)
{
	int iVar0;
...
int func_94(vector3 vParam0, int iParam3, int iParam4, int iParam5)
{
	int iVar0[4];
	int iVar5[4];
...
int func_95(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_151(&(Global_1898164->f_1[0 /*5*/]));
		if (func_152(iVar0) && func_153(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
int func_99(var uParam0)
{
	...
	if ((!func_98(uParam0->f_3, 32768) && func_157(uParam0->f_1, &fVar1)) && func_49(uParam0->f_1, 0, &fVar0))
	{
		fVar2 = func_158();
		if ((func_158() - fVar1) >= fVar0)
		{
			func_156(&(uParam0->f_3), 32768);
		}
	}
	if (func_98(uParam0->f_3, 32768))
	{
		return 1;
	}
	return 0;
...
int func_106(int iParam0, bool bParam1)
{
	...
	if (func_142(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_161(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_161(iParam0)))
	{
...
char* func_110(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1894899->f_162)))
	{
		sVar0 = func_166(Global_1894899->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_168(func_167(Global_36));
	}
...
char* func_122(char* sParam0, int iParam1)
{
	...
	return func_171(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_125(int iParam0)
{
	...
	if (func_172())
	{
		if (!func_173(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_177((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_178((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_139(int iParam0)
{
	...
	{
		func_181((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_182((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_141(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_143(int iParam0, bool bParam1)
{
	...
	func_190(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_161(iParam0));
	func_160(iParam0, 0);
	return 1;
}
...
int func_148(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	iVar0 = func_146(iParam0, iParam1, iParam2);
	iVar1 = iParam3;
	func_193(iVar1, 0);
	func_194(iVar1, 0);
	func_195(iVar1, 0);
...
float func_158()
{
	...
	iVar6 = func_118();
	iVar4 = func_203(iVar6);
	iVar5 = func_204(iVar6);
	iVar3 = func_205(iVar5, iVar4);
	iVar2 = func_206(iVar6);
	iVar1 = func_119(iVar6);
...
var func_166(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
int func_205(int iParam0, int iParam1)
{
	...
	if (iVar1 > 0)
	{
		...
		while (iVar0 < iVar1)
		{
			iVar2 = (iVar2 + func_226(iVar1, iParam1));
			iVar0++;
		}
	}
	return iVar2;
...
int func_207(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
