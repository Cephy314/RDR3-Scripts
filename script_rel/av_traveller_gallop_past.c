...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
		...
		case 61:
			switch (uParam0->f_489)
			{
				...
				case default:
					...
					iVar0 = 0;
					uLocal_38 = func_51();
					func_52(uParam0, "CART", uLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
					break;
				case 1:
				...
				case 2:
					...
					iVar0 = 0;
					iVar2 = 1;
					uLocal_38 = func_54(func_53(), &iVar2);
					func_52(uParam0, "CART", uLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
					break;
			}
			break;
	...
	func_55(uParam0, 0, "TGPP_MAN", iLocal_39, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_55(uParam0, 1, "TGPP_HORSE", iVar0, vParam1, vParam4.z, 1, 1, 1, iVar1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (iVar2 == 2)
	{
		func_55(uParam0, 2, "TGPP_HORSE_2", iVar0, vParam1, vParam4.z, 1, 1, 1, iVar1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_61((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_62(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				uVar0 = func_72((uParam0->f_20[0 /*14*/])->f_5);
				...
				{
					func_75(&(uParam0->f_20[1 /*14*/]), (uParam0->f_20[0 /*14*/])->f_5, uVar0, 2, 1073741824 /* Float: 2f */);
					func_76(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), 1, -1, 1);
				}
				else if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
				{
					func_75(uParam0->f_453, (uParam0->f_20[0 /*14*/])->f_5, uVar0, 2, 1073741824 /* Float: 2f */);
...
void func_52(var uParam0, char* sParam1, var uParam2, vector3 vParam3, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	uParam0->f_453.f_2 = sParam1;
	uParam0->f_453.f_1 = uParam2;
...
int func_70(var uParam0, var uParam1, bool bParam2)
{
...
void func_75(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (iParam0 == func_113(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_114(iParam0))
	{
	...
	if (func_112(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		iVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0);
	...
	if (func_112(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_112(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_112(iParam5, 32), true);
	...
	else if (func_112(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(iParam0, vParam1, func_112(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(iParam0) == Global_35 && !func_112(iParam5, 64))
		{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_120(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_182(1) || *uParam0 & 8192 != 0))
				{
...
int func_144(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_195(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_193(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_194(uParam2)
				{
					func_189(uParam2, 1);
					return 1;
				}
...
int func_145(int iParam0, var uParam1)
{
	...
	if (func_185(iParam0, uParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_194(uParam1)
		{
...
int func_168(int iParam0, var uParam1)
{
	...
	{
		return func_219(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_170(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_220(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_220(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_220(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
int func_185(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_191(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_208(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_193(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_195(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_200(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_203(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_204(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_209(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_214(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_208(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_215(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
