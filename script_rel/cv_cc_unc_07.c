...
float func_10(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_50(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_74(var uParam0)
{
	...
	func_153(uParam0, 0.0125f, -0.25f, 1.15f, 1.81f, 3.1925f, 3.055f, 2.685f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_153(uParam0, 3.4249f, 8.675f, 1.15f, 10.25f, 1.285f, 2.97f, 2.685f, -1612834106, joaat("APMS_COMP_UNCLE"), 1, 1, 1);
...
int func_109(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_122(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_10(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
