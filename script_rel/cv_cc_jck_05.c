...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -3.85f, 2.375f, -0.218f, 80f, 1f, 1f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_151(uParam0, -2.225f, -1.75f, -0.218f, 135.75f, 1.7025f, 2.1125f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@jack_5@base", 1, 1, 0, 0);
	iLocal_17 = func_153(uParam0, "script@vignette@jack_5@action_a", 2, 0, 1, 0);
	iLocal_18 = func_153(uParam0, "script@vignette@jack_5@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = func_153(uParam0, "script@vignette@jack_5@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = func_153(uParam0, "script@vignette@jack_5@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_21 = func_153(uParam0, "script@vignette@jack_5@action_b", 0, 0, 0, 0);
	...
	func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_READING"), "PROP_HUMAN_SEAT_CHAIR_READING_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 0f, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_cs_book04x_PH_R_HAND", 0, 0);
	Local_22 = { func_159(uParam0, -1.2375f, -0.785f, -0.02f, 159f, 6.5f, 0.26f, 0.66f) };
	Local_32 = { func_159(uParam0, -1.238f, -0.785f, -0.02f, -126.25f, 6.5f, 0f, 0.567f) };
	Local_42 = { func_159(uParam0, -1.238f, -0.785f, -0.02f, 60.09f, 6.5f, 0.4375f, 0.0475f) };
	return 1;
}
...
float func_208(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_305(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
