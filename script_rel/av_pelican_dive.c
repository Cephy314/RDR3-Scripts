...
{
	func_33(uParam0, 10699, 10736, 11378);
}
...
{
	func_46(uParam0, "PELICAN_DIVE", "script@ambient@animal@pelican_dive@action", vParam1, vParam4);
	func_47(uParam0, 1, "pbl_action", "", 0);
	func_48(uParam0, 0, "PELICAN", iLocal_9, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[0])
	{
		...
		if (!bLocal_38 == 1)
		{
			if (func_60(uParam0, &uLocal_10, 0) || func_61(Global_35, uParam0->f_483, 1) < 225f)
			{
				bLocal_38 = true;
			}
		}
...
float func_61(int iParam0, vector3 vParam1, bool bParam4)
{
	vector3 vVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_111(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_62(&(uParam0->f_490)))
							{
							...
							if (func_67(&(uParam0->f_490), fParam1))
							{
								return 1;
							}
							else
...
int func_161(int iParam0, var uParam1)
{
	...
	else if (func_153() - uParam1->f_4) > func_209(uParam1)
	{
...
int func_182(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
