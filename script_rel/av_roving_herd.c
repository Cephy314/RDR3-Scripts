...
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_55))
	{
		vLocal_56 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[0 /*14*/]), 0f, 50f, 0f) };
		bLocal_55 = VOLUME::_CREATE_VOLUME_CYLINDER(vLocal_56, 0f, 0f, 0f, 15f, 15f, 10f);
	}
	return 1;
}
...
void func_73(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[iVar0 /*14*/]), 0);
		}
		iVar0++;
	}
}
...
void func_79(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		...
		TASK::TASK_ANIMAL_UNALERTED(0, -1, bLocal_55, 0, 0);
	...
	TASK::TASK_WANDER_IN_VOLUME(0, bLocal_55, 1077936128, 1086324736, 1);
	TASK::CLOSE_SEQUENCE_TASK(iVar1);
...
void func_80(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iLocal_26 /*14*/])))
	{
		...
		{
			TASK::TASK_ANIMAL_UNALERTED(&(uParam0->f_20[iLocal_26 /*14*/]), -1, bLocal_55, 0, 0);
		}
...
void func_86(var uParam0)
{
	...
	while (iVar0 <= 14)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			...
			{
				TASK::CLEAR_PED_TASKS(&(uParam0->f_20[iVar0 /*14*/]), 1, 0);
				TASK::TASK_ANIMAL_UNALERTED(&(uParam0->f_20[iVar0 /*14*/]), -1, bLocal_55, 0, 0);
			}
		}
		iVar0++;
	}
...
int func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
