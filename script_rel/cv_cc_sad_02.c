...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -2.2125f, -3.875f, 1.4875f, 0f, 2f, 2f, 3.2075f, -1612834106, joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	if (!func_152(10))
	{
		func_153(uParam0, "script@vignette@sadie_2@base", 1, 1, 0, 0);
	}
	func_153(uParam0, "script@vignette@sadie_2@Action", 0, 0, 1, 0);
	func_154(uParam0, "CCSD2AU");
	func_155(uParam0, 562543677, -159734628);
	func_156(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0);
	func_157(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	if (func_152(10))
	{
		...
		func_157(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_SAD"), "PROP_HUMAN_SEAT_CHAIR_SAD_FEMALE_B", -1, 0, -1f, 1065353216 /* Float: 1f */, 1);
		func_156(uParam0, iLocal_15, 4, joaat("prop_human_seat_chair"), "PROP_HUMAN_SEAT_CHAIR_GENERIC_FEMALE_C", -1, 0);
		func_162(uParam0, iLocal_15, -155.193f, -38.87f, 94.619f, -84.049f, 0, 0);
...
void func_162(var uParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, bool bParam7)
{
	if (bParam7)
	{
		vParam2 = { func_252(uParam0, vParam2) };
