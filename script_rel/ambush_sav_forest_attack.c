		...
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			...
			switch (iVar0)
			{
				...
				case 4:
					...
					break;
				case 5:
					func_128(&(iLocal_15[iVar0]), &(iLocal_15.f_40[0]), 0, -1, 1);
					func_131(&iLocal_15, iVar0, 0);
					func_132(&iLocal_15, 0, 0);
					break;
				case 6:
					func_128(&(iLocal_15[iVar0]), &(iLocal_15.f_40[1]), 0, -1, 1);
					func_131(&iLocal_15, iVar0, 0);
					func_132(&iLocal_15, 1, 0);
					break;
			}
			func_133(&iLocal_15, iVar0, iVar1, iVar2);
	...
	switch (Local_274.f_3)
	{
		case 0:
			...
			else
			{
				...
				{
					func_139();
					Local_274.f_66 = &iLocal_15.f_9[0];
					func_32(&iLocal_15, 1);
					func_25(&iLocal_15, 1);
					func_150();
...
int func_31()
{
	func_165();
	func_142();
	Local_274.f_61 = func_166(&iLocal_15);
	switch (Local_274.f_4)
	{
		case 0:
			...
			func_167(&iLocal_15, 1, 0, (iLocal_15.f_215 - 1));
			func_132(&iLocal_15, 0, 1);
			func_132(&iLocal_15, 1, 1);
		...
		case 1:
			...
			break;
		case 2:
			if (func_170(&iLocal_15, &(Local_274.f_57), &(iLocal_15.f_241), "AMBUSH_RA1_FLEE", 3f))
			{
				func_171();
...
void func_126(int iParam0)
{
	...
	Local_274.f_67[iParam0] = func_268(&(iLocal_15[iParam0]), iVar0, -1, func_270(iParam0), 0, 0.8f, 1065353216 /* Float: 1f */, 0);
}
...
int func_138()
{
	if (func_274(&iLocal_15, &(iLocal_15.f_152), &(iLocal_15.f_180), &(Local_274.f_58), 0, 1, 1))
	{
		return 1;
	}
	if (Local_274.f_5 >= 4)
...
void func_140()
{
	...
	while (iVar0 <= 6)
	{
		...
		else
		{
			...
			PED::_0x7DE9692C6F64CFE8(&(iLocal_15[iVar0]), false, 0, 0);
			if (func_277(func_276(&(iLocal_15[iVar0]), 0)))
			{
				iVar2 = 67108864;
			}
			else
			...
			func_278(&iLocal_15, iVar0, joaat("BLIP_STYLE_ENEMY"), 0);
			if (!func_137(&Local_274, 64))
			{
				func_279(&(iLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824 /* Float: -2f */, 1, -500314840, 1);
...
int func_143()
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(&(Local_274.f_49[1])))
	{
		...
		{
			if (func_281(&iLocal_15, &(iLocal_15.f_152), &(iLocal_15.f_180), &(Local_274.f_59), 0, (iLocal_15.f_215 - 1), 1))
			{
...
int func_144()
{
	...
	switch (Local_274.f_5)
	{
		case 0:
			func_278(&iLocal_15, iVar0, joaat("BLIP_STYLE_ENEMY"), 0);
			func_282(&(iLocal_15[iVar0]), Global_35, -1);
		...
		case 2:
			if (func_284(-5f, 1, 0, 0))
			{
				...
				uVar5[1] = Global_35;
				iVar8 = func_285(&uVar1, &uVar5, 3, ENTITY::GET_ENTITY_COORDS(&(iLocal_15[iVar0]), false, true), 15f, 0, 1, 1, -1, 1, 0, -1082130432 /* Float: -1f */, 0, 0);
				iVar9 = 0;
				while (iVar9 < iVar8)
				{
...
int func_151()
{
	...
	switch (Local_274.f_6)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_47(Local_274.f_8[1 /*3*/], 1f) || func_220(&(iLocal_15[0]), 10f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
			{
		...
		case 3:
			...
			{
				func_278(&iLocal_15, 0, joaat("BLIP_STYLE_ENEMY"), 0);
				func_278(&iLocal_15, 1, joaat("BLIP_STYLE_ENEMY"), 0);
				func_186(Local_274.f_8[1 /*3*/]);
		...
		case 4:
			...
			{
				iVar0 = -1;
				iVar0 = func_309(&iLocal_15, 3, 6, 0);
				if (iVar0 >= 0)
				{
					if (func_279(&(iLocal_15[iVar0]), Global_35, "ITS_MALE_EXTREME_RECOGNIZE", -1073741824 /* Float: -2f */, 1, 1744022339, 0))
					{
...
int func_169()
{
	...
	else
	{
		if (!func_137(&Local_274, 16384))
		{
			if ((func_47(Local_274.f_8[0 /*3*/], 10f) || (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15[5])) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(iLocal_15[5])))) || (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15[6])) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(iLocal_15[6]))))
			{
				func_327(0);
				func_242(&Local_274, 16384);
			}
	...
	switch (Local_274.f_7)
	{
		case 0:
			...
			if (func_284(0, 1, 0, 0))
			{
				iVar0 = func_309(&iLocal_15, 0, (iLocal_15.f_215 - 1), 1);
				if (iVar0 >= 0)
				{
					if (func_279(&(iLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 2))
					{
		...
		case 1:
			if (func_284(0, 1, 0, 0))
			{
				...
				if (iVar0 >= 0)
				{
					if (func_279(&(iLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 3))
					{
...
void func_171()
{
	if (func_61(iLocal_15.f_56, 0, 0))
	{
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(iLocal_15.f_56, true, func_335(iLocal_15.f_181));
	}
}
...
int func_195(int iParam0)
{
	...
	if (func_356(&iLocal_15, &(iLocal_15[iParam0])))
	{
		return 1;
	}
...
int func_200(int iParam0, int iParam1)
{
	...
	if (func_369(&(iLocal_15.f_40[iParam0]), iParam1))
	{
		return 1;
	}
	if (func_356(&iLocal_15, &(iLocal_15.f_40[iParam0])))
	{
		return 1;
	}
...
int func_201(int iParam0)
{
	...
	if (func_371(&(iLocal_15.f_84[iParam0]), fVar0))
	{
		return 0;
	}
...
int func_202(int iParam0)
{
	...
	if (func_357(&iLocal_15, &(iLocal_15.f_49[iParam0])))
	{
		return 1;
	}
...
void func_244()
{
	...
	func_303(&(iLocal_15.f_152), 1);
	func_235(&(iLocal_15.f_152), 1);
	func_384(&(iLocal_15.f_152), 1);
	func_385(&(iLocal_15.f_152), 1);
}
...
void func_245()
{
	...
	{
		case 0:
			func_386(&iLocal_15, &Local_274);
			break;
		case 1:
			func_387(&iLocal_15, &Local_274);
			break;
	}
}
...
{
	if (func_412(&(iLocal_15[iParam0]), "BATTLE_CRY", 1744022339, Global_35, 0, "0260_G_M_M_UniMountainMen_03_NATIVE_02", iParam1, 1))
	{
	}
}

int func_281(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_285(var uParam0, var uParam1, int iParam2, vector3 vParam3, float fParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10, bool bParam11, bool bParam12, float fParam13, bool bParam14, bool bParam15)
{
	...
	uVar1 = func_416(uParam0, uParam1, iParam2, iVar0, bParam7, bParam8, bParam9, iParam10, bParam11, bParam12, bParam14, bParam15);
	func_417(iVar0);
	return uVar1;
}
...
bool func_300(bool bParam0, vector3 vParam1)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return false;
...
void func_307()
{
	...
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			func_131(&iLocal_15, iVar0, 1);
			PED::_0x7DE9692C6F64CFE8(&(iLocal_15[iVar0]), false, 0, 0);
			PED::FORCE_PED_MOTION_STATE(&(iLocal_15[iVar0]), joaat("motionstate_run"), false, 0, false);
...
void func_308()
{
	...
	while (iVar0 <= 1)
	{
		...
		{
			if (func_279(&(iLocal_15[iVar0]), Global_35, "PEDTYPE_WON_FIGHT", -1073741824 /* Float: -2f */, 1, -500314840, 3))
			{
				bVar1 = true;
			}
		}
...
bool func_320(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_439(iParam0, joaat("currency_cash"), iParam1, uVar0);
	}
...
int func_390(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
void func_434(vector3 vParam0, int iParam3)
{
	...
	PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(iLocal_15[iParam3]), vParam0, fVar0, iVar1, false, 0);
	if (bVar2)
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_15[iParam3]), 51, true);
	}
}
...
bool func_531(int iParam0, float fParam1, int iParam2)
{
	int iVar0[3];
	int iVar4;
	int iVar5;
...
int func_569(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
