...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.2548f, -4.3769f, 1.2774f, 137.8534f, 1.5f, 1.5f, 3f, -1612834106, joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	func_151(uParam0, 0.72f, -0.97f, 1f, 90f, 3f, 3f, 3f, -1612834106, joaat("APMS_COMP_KAREN"), 1, 1, 1);
