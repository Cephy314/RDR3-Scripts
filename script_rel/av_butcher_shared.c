...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "HANGER", joaat("p_cs_meathanger01x"), 0f, 0f, 0f, 0f, 1);
	if (uParam0->f_489 == 0)
	{
		func_49(uParam0, 1, "FRAME", joaat("p_targetframe01x"), vParam1, vParam4.z, 0);
	}
	switch (*uParam0)
	{
		case 2:
	...
	func_52(uParam0, 1, "DEER", joaat("a_c_deer_01"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	...
	else
	{
		if (iLocal_44 == 0)
		{
			iVar2[0] = joaat("p_basin01x");
			iVar4 = func_53(&uVar0, &iVar2, 1, uParam0->f_483, 2f);
			if (iVar4 > 0)
			{
				vVar5 = { ENTITY::GET_ENTITY_COORDS(&(uVar0[0]), true, false) };
				iLocal_44 = ENTITY::_0x6F3068258A499E52(&(iVar2[0]), vVar5, 15);
			}
			else
			{
				uParam0->f_499 = 1;
		...
		if (iLocal_44 != 0)
		{
			if (ENTITY::_0x1FF441D7954F8709(iLocal_44))
			{
				uParam0->f_372[3 /*8*/] = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_0x4735E2A4BB83D9DA(iLocal_44));
			}
			else
			{
				iLocal_44 = 0;
	...
	if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		{
			uParam0->f_20[0 /*14*/] = func_55(iLocal_42, 0, 0, 1, 1, 1);
		}
		else
		{
	...
	while (iVar12 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar12 /*14*/])->f_2 != 0)
		{
			...
			if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar12 /*14*/])))
			{
				...
				{
					uParam0->f_20[iVar12 /*14*/] = func_64((uParam0->f_20[iVar12 /*14*/])->f_2, (uParam0->f_20[iVar12 /*14*/])->f_5, (uParam0->f_20[iVar12 /*14*/])->f_8, 1, 1, 0, 1, (uParam0->f_20[iVar12 /*14*/])->f_11, (uParam0->f_20[iVar12 /*14*/])->f_9, 0, 0, 0, 0);
				}
				...
				if (!PED::IS_PED_HUMAN(&(uParam0->f_20[iVar12 /*14*/])))
				{
					if (!func_65(&(uParam0->f_20[iVar12 /*14*/])))
					{
...
int func_28(var uParam0)
{
	...
	else
	{
		...
		if (!bLocal_46)
		{
			vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 0.156614f, -0.0456434f, 0.0362015f) };
			ENTITY::SET_ENTITY_COORDS(&(uParam0->f_372[3 /*8*/]), vVar0, true, false, true, true);
			ENTITY::_0x9587913B9E772D29(&(uParam0->f_372[3 /*8*/]), 0);
	...
	if (uParam0->f_489 == 0)
	{
		ENTITY::_0x9587913B9E772D29(&(uParam0->f_372[1 /*8*/]), 0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_78(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
		{
			func_76(uParam0);
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[5])
		{
			if (func_79(uParam0, 3f, 1116471296 /* Float: 70f */, 4, joaat("action"), 1))
			{
				func_77(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[5] = 1;
			}
	...
	if (&uParam0->f_469[2])
	{
		...
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_372[2 /*8*/])->f_1))
			{
...
int func_32(var uParam0, var uParam1)
{
	...
	if (iLocal_44 != 0)
	{
		if (ENTITY::_0x1FF441D7954F8709(iLocal_44))
		{
			ENTITY::_0xD2B9C78537ED5759(iLocal_44);
		}
	}
	if (ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_372[3 /*8*/])))
	{
...
int func_53(var uParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	...
	uVar1 = func_98(uParam0, iParam1, iVar0, iParam2);
	func_5(iVar0);
	return uVar1;
}
...
int func_56(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!PERSCHAR::_0x800DF3FC913355F3(func_104(iParam0)))
	{
		func_107(iParam0, 0);
		return 0;
	}
	...
	if (!func_7(vVar0))
	{
		PERSCHAR::_0x59C7AD6FEA2AC449(func_104(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = PERSCHAR::_0x08FC896D2CB31FCC(func_104(iParam0), 0);
	}
	else
	{
		iVar3 = PERSCHAR::_0x0CADC3A977997472(func_104(iParam0), 0);
	}
	if (!func_7(vVar0))
	{
...
int func_74(var uParam0, var uParam1, bool bParam2)
{
	if ((MISC::GET_FRAME_COUNT() % 3) == 0 || bParam2)
	{
		if (func_126(&(uParam0->f_20[uParam0->f_501 /*14*/]), 0, uParam1, &(uParam0->f_468), 0, 0))
		{
			return 1;
		}
		uParam0->f_501++;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_134(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_79(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	int iVar0;
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_134(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_135(&(uParam0->f_490)))
							{
...
int func_86(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_148(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_87(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_148(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_107(int iParam0, bool bParam1)
{
	...
	if (func_48(iParam0, 32) && !bParam1)
	{
		...
		if (func_96() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_104(iParam0));
...
bool func_108(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_104(iParam0));
}
...
int func_109(int iParam0)
{
	...
	{
		PERSCHAR::_0x49A8C2CD97815215(func_104(iParam0));
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_0x0CADC3A977997472(func_104(iParam0), 0)))
		{
			return 0;
		}
	}
...
void func_128(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_196(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_196(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_196(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_129(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_148((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
float func_134(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_197(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_147(int iParam0, bool bParam1)
{
	...
	func_146(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_104(iParam0));
	func_156(iParam0, 0);
	return 1;
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_210(1) || *uParam0 & 8192 != 0))
				{
...
int func_170(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_223(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_221(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_222(uParam2)
				{
					func_217(uParam2, 1);
					return 1;
				}
...
int func_171(int iParam0, var uParam1)
{
	...
	if (func_213(iParam0, uParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_222(uParam1)
		{
...
int func_194(int iParam0, var uParam1)
{
	...
	{
		return func_247(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_219(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_236(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_254(iVar0, 0)))
		{
...
int func_223(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_254(iVar0, 0)))
		{
			if (func_256(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_228(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_234(int iParam0, int iParam1)
{
	...
	if (func_260(iParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return 0;
	}
...
int func_237(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_242(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_236(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_255(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_256(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_256(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
