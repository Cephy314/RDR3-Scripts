...
int func_11(var uParam0)
{
	...
	TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(2), false, 1065353216, 1f, 1);
...
int func_25(int iParam0, bool bParam1, vector3 vParam2, float fParam5)
{
	bool bVar0;
	...
	uLocal_42[iParam0] = func_54(bParam1, vParam2, fParam5, 1, 1, bVar0, 1, 1, 1, 0, 0, 0, 0);
...
int func_29(var uParam0)
{
	...
	switch (iLocal_26)
	{
		...
		case 1:
			...
			break;
		case 2:
			TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(0), true, 1065353216, 1f, 1);
			...
			TASK::TASK_PLAY_ANIM(&(uLocal_42[2]), func_21(1), func_21(0), 1000f, -1000f, -1, 132, 0.474f, false, 0, false, 0, false);
			func_56(3);
			break;
		case 3:
			if (!bLocal_58)
		...
		case 4:
			...
			CLOCK::PAUSE_CLOCK(true, 0);
			TASK::USE_WAYPOINT_RECORDING_AS_ASSISTED_MOVEMENT_ROUTE(func_22(0), false, 1065353216, 1f, 1);
			STREAMING::END_SRL();
...
int func_99(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_40(bVar0, 0))
	{
		if (func_40(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*74*/])->f_27))
	{
		...
		if (func_178(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_179((*Global_1835011)[iParam0 /*74*/], 2))
			{
				if (func_180(iParam0))
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_181(iParam0));
					bVar2 = true;
				}
				else
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_182(iParam0));
				}
			}
			...
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_RADIUS(joaat("BLIP_STYLE_MISSION"), func_185(iParam0), func_186(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_180(iParam0))
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_143(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_181(iParam0));
		...
		else if (func_142(iParam0))
		{
			if (iParam0 == 7)
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_RCM"), func_182(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_182(iParam0));
