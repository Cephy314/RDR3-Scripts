...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 4.5375f, 3.1625f, 1f, 80f, 2.5f, 2.5f, 3f, -1612834106, joaat("APMS_COMP_SEAN"), 1, 1, 1);
...
int func_86(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_8(uParam0, iLocal_24)))
	{
		...
		PED::_0xCC8CA3E88256E58F(func_8(uParam0, iLocal_24), false, true, true, true, false);
		return 1;
	}
	return 0;
}
