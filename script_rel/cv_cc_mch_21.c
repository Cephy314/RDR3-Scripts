...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0128f, 0.9238f, 0.531f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, -0.0934f, -0.9858f, 0.6002f, 0f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN"), "PROP_CAMP_MICAH_SEAT_CHAIR_CLEAN_GUN_MALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_95(var uParam0)
{
	...
	{
		vLocal_53 = { ENTITY::GET_ENTITY_COORDS(func_207(uParam0, iLocal_22), true, false) };
	}
...
int func_391(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			if ((bParam2 && !func_206(vVar0)) && !func_208(vVar0, ENTITY::GET_ENTITY_COORDS(((*Global_1360165)[iParam0 /*1157*/])->f_124, true, false), 1056964608 /* Float: 0.5f */, 1))
			{
...
void func_421(bool bParam0, int iParam1)
{
	...
	func_382(bParam0, func_451(iParam1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_394(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
