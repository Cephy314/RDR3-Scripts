...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.3f, -2.0004f, 0f, 0f, 4.5f, 3f, 5f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
...
int func_150(var uParam0)
{
	...
	while (iVar2 < 27)
	{
		...
		{
			bVar3 = func_234(iVar2);
			if (ENTITY::IS_ENTITY_DEAD(bVar3))
			{
			}
			else
			{
				fVar4 = BUILTIN::VDIST2(ENTITY::GET_ENTITY_COORDS(bVar3, true, false), uParam0->f_29);
				if (fVar4 < fVar1)
				{
					iVar0 = iVar2;
					fVar1 = fVar4;
...
void func_426(bool bParam0, int iParam1)
{
	...
	func_390(bParam0, func_456(iParam1));
