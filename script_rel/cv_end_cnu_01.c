...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.5001f, 1.2125f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_UNCLE"), 1, 1, 1);
	func_151(uParam0, -0.0251f, -1.175f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	func_152(uParam0, -0.15f, 0f, 0f, 12f, 0.94f, 1.57f, 3f, joaat("VOLCYLINDER"), 1);
	...
	func_156(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 2, joaat("CC_PROP_CAMP_FIRE_SEATED_DRINKING"), "PROP_CAMP_FIRE_SEATED_DRINKING_BEER_MALE_B", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_192(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6)
{
	...
	else if (func_295(ENTITY::GET_ENTITY_COORDS(iParam0, bParam5, false), vParam1) <= (fParam4 * fParam4))
	{
		return 1;
	}
	return 0;
...
float func_208(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_295(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
