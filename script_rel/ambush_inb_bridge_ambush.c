...
int func_20()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			if (func_128(iVar0))
			{
				func_129(&uLocal_15, iVar0, 0);
			}
			PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 45, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 47, true);
			PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 51, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 62, false);
			PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iVar0]), 98, true);
			func_130(&(uLocal_15[iVar0]), &(Local_274.f_27[1]));
			switch (iVar0)
			{
				case 1:
					PED::_0x89F5E7ADECCCB49C(&(uLocal_15[iVar0]), "intimidate");
					break;
				case 2:
					func_131(&(uLocal_15.f_152), &(uLocal_15[iVar0]), 1, 60f, 200f, 60f);
					Var1 = { func_132(&Local_274, iVar0) };
					Local_274.f_47[0] = func_134(func_133(), Var1, Var1.f_3, 0, -1f, 1);
					TASK::_TASK_USE_SCENARIO_POINT(&(uLocal_15[iVar0]), &(Local_274.f_47[0]), 0, -1, false, true, 0, false, -1f, false);
					break;
			}
			func_135(&uLocal_15, iVar0, -1, -1);
			func_136(&uLocal_15, iVar0);
		}
		iVar0++;
	}
	return 1;
...
int func_23()
{
	...
	switch (Local_274.f_3)
	{
		case 0:
			...
			{
				func_143();
				Local_274.f_46 = func_152(&(uLocal_15[0]), Global_36, 1);
				func_25(&uLocal_15, 1);
				func_32(&uLocal_15, 1);
				func_153();
...
int func_31()
{
	func_171();
	func_156();
	Local_274.f_43 = func_172(&uLocal_15);
...
void func_49()
{
	if (func_61(&(uLocal_15[2]), 0, 0))
	{
		if (!func_18(Global_1393447, 65536))
		{
			func_195(&uLocal_15, 2, 2);
		}
		if (func_137(&uLocal_15, 2, 2))
		{
			TASK::_TASK_FLEE_FROM_COORD(&(uLocal_15[2]), uLocal_15.f_209, 0f, 0f, 0f, 300f, -1, 294912, 2f, 0);
		}
	}
	func_175();
}
...
void func_75()
{
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_49[iVar0])))
		{
			if (!func_228(&uLocal_15, iVar0, 8))
			{
				if (ENTITY::IS_ENTITY_A_VEHICLE(&(uLocal_15.f_49[iVar0])) && !ENTITY::IS_ENTITY_DEAD(&(uLocal_15.f_49[iVar0])))
				{
					if (func_229(&(uLocal_15.f_49[iVar0]), 200f, -1082130432 /* Float: -1f */))
					{
						func_230(&uLocal_15, iVar0, 8);
					}
				}
			}
		}
...
int func_83()
{
	...
	func_243();
	func_244();
	func_245(&(uLocal_15.f_182), 65, 0f, 2f, 2f, 2f, 32768);
...
int func_92(int iParam0)
{
	if (&uLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			uLocal_15.f_57[iParam0] = func_258(joaat("HORSE_CLASS_RIDING"), 1);
		}
		else
		{
...
void func_114(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	...
	*iParam4 = PED::GET_PED_BONE_INDEX(&(uLocal_15.f_40[iParam0]), 62111);
}
...
void func_125(int iParam0)
{
	...
	func_271(&(uLocal_15[iParam0]), cVar0, 0);
}
...
void func_126(int iParam0)
{
	...
	func_272(&(uLocal_15[iParam0]), joaat("WEAPON_MELEE_KNIFE"), -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
	iVar0 = func_273(iParam0);
	switch (iVar0)
	{
		case joaat("WEAPON_SHOTGUN_DOUBLEBARREL"):
			func_274(&uLocal_15, &(uLocal_15[iParam0]), joaat("WEAPON_SHOTGUN_DOUBLEBARREL"), 1);
			break;
		default:
			func_274(&uLocal_15, &(uLocal_15[iParam0]), iVar0, 1);
			break;
	}
}
...
bool func_140(bool bParam0, vector3 vParam1)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return false;
...
int func_142()
{
	...
	{
		if (func_278(&uLocal_15, &(uLocal_15.f_152), &(uLocal_15.f_180), &(Local_274.f_42), 0, 4, 1))
		{
			func_279(0);
			return 1;
		}
...
void func_143()
{
	if (!func_61(uLocal_15.f_56, 0, 0))
	{
		...
		if (func_61(uLocal_15.f_56, 0, 0))
		{
			ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_15.f_56, false, func_282(uLocal_15.f_181));
		}
	}
}
...
void func_144()
{
	...
	if (AUDIO::_0x4A98E228A936DBCC(&(uLocal_15[0])) == joaat("TAUNT_GEN_LOCATION"))
	{
		bVar2 = true;
	}
	...
	{
		func_283(&(uLocal_15[0]), Global_35, "OPENS_FIRE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
		bVar2 = true;
	}
	iVar0 = 0;
	while (iVar0 <= 4)
	{
		...
		else
		{
			...
			{
				case 2:
					func_284(&(uLocal_15[2]), Global_36, 2, 0, 3);
					break;
				case 3:
				case 4:
					if (!ENTITY::IS_ENTITY_VISIBLE(&(uLocal_15[iVar0])))
					{
						if (ENTITY::IS_ENTITY_ON_SCREEN(&(uLocal_15[iVar0])))
						{
							PED::DELETE_PED(uLocal_15[iVar0]);
							Jump @324; //curOff = 200
						}
			...
			func_200(&(uLocal_15[iVar0]), &iVar1, 0.1f, 0.3f, 1, 1);
			func_285(&uLocal_15, iVar0, joaat("BLIP_STYLE_ENEMY"), 0);
			if (!bVar2)
			{
				func_283(&(uLocal_15[iVar0]), Global_35, "OPENS_FIRE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
				bVar2 = true;
			}
		}
		iVar0++;
...
int func_151()
{
	...
	if (func_140(&(Local_274.f_27[4]), vVar0))
	{
		...
		{
			if (!PED::_0xD5FE956C70FF370B(Global_35) || PED::_0x06087579E7AA85A9(&(uLocal_15[2]), Global_35, -1f, -1f, -1f, -1f))
			{
				return 1;
			}
		}
...
int func_155()
{
	...
	switch (Local_274.f_5)
	{
		case 0:
			...
			func_284(&(uLocal_15[2]), Global_36, 2, 0, 3);
			TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(&(uLocal_15[2]), vVar0, 2f, 20000, 0.25f, false, 40000f);
		...
		case 1:
			...
			if (func_47(Local_274.f_8[1 /*3*/], 0.5f))
			{
				...
				func_283(&(uLocal_15[2]), Global_35, "CALL_FOR_SUPPORT", -1073741824 /* Float: -2f */, 1, -500314840, 1);
		...
		case 2:
			func_306();
			if (func_47(Local_274.f_8[1 /*3*/], 1.5f) || func_222(&(uLocal_15[0]), 1116471296 /* Float: 70f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
			{
				func_307();
				func_190(Local_274.f_8[1 /*3*/]);
		...
		case 3:
			...
			if (func_47(Local_274.f_8[1 /*3*/], 2.5f))
			{
				...
				if (func_283(&(uLocal_15[0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824 /* Float: -2f */, 1, -500314840, 0))
				{
...
void func_157()
{
	...
	while (iVar0 <= 4)
	{
		...
		else if (!func_308(&uLocal_15, iVar0))
		{
		}
		else
		{
		...
		case 3:
			if (!func_139(&Local_274, 4096))
			{
				if (func_327(-2f, 1, 0, 0))
				{
					...
					while (iVar0 <= 4)
					{
						if (func_61(&(uLocal_15[iVar0]), 0, 0) && ENTITY::IS_ENTITY_VISIBLE(&(uLocal_15[iVar0])))
						{
							func_283(&(uLocal_15[iVar0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824 /* Float: -2f */, 1, -500314840, 0);
						}
						else
						{
							iVar0++;
...
void func_175()
{
	if (func_61(uLocal_15.f_56, 0, 0))
	{
		ENTITY::SET_ENTITY_CAN_BE_DAMAGED_BY_RELATIONSHIP_GROUP(uLocal_15.f_56, true, func_282(uLocal_15.f_181));
	}
}
...
{
	if (func_228(&uLocal_15, iParam0, 2))
	{
		return 0;
	}
	...
	if (func_228(&uLocal_15, iParam0, 4))
	{
		return 1;
	}
	...
	if (!func_228(&uLocal_15, iParam0, 8))
	{
		return 1;
	}
	return 0;
...
void func_257(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return;
...
void func_303()
{
	...
	if (Local_274.f_5 >= 2)
	{
		if (func_61(&(uLocal_15[2]), 0, 0))
		{
			if ((func_152(&(uLocal_15[2]), Global_36, 0) < 9f || func_280(*(Local_274.f_58[0 /*3*/]), *(Local_274.f_58[1 /*3*/]), ENTITY::GET_ENTITY_COORDS(&(uLocal_15[2]), true, false))) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(&(uLocal_15[2])))
			{
				TASK::CLEAR_PED_TASKS(&(uLocal_15[2]), 1, 0);
				TASK::TASK_COMBAT_PED(&(uLocal_15[2]), Global_35, 0, 0);
				func_285(&uLocal_15, 2, joaat("BLIP_STYLE_ENEMY"), 0);
				PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[2]), 45, true);
...
void func_306()
{
	...
	{
		if (func_152(&(uLocal_15[2]), Global_36, 0) < (9f + 3f))
		{
	...
	func_420(&(uLocal_15[2]), &(Local_274.f_65), vVar0, 1, 30f, (Local_274.f_46 + 2f), 3000, 4000, 1000, 1075838976 /* Float: 2.5f */, 0, 1, 1084227584 /* Float: 5f */);
}
...
void func_307()
{
	...
	func_200(&(uLocal_15[0]), &iVar0, 0, 0, 1, 1);
	...
	TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar1, Global_35, 2f, 0, 1056964608, 1082130432, 1, 0, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000, 0);
	TASK::TASK_COMBAT_PED(0, Global_35, 33554432, 0);
	func_200(&(uLocal_15[1]), &iVar0, 0, 0, 1, 1);
}
...
void func_310(int iParam0)
{
	...
	if (ENTITY::WOULD_ENTITY_BE_OCCLUDED(joaat("G_M_M_UNIINBRED_01"), ENTITY::GET_ENTITY_COORDS(&(uLocal_15[iParam0]), true, false), true))
	{
		func_129(&uLocal_15, iParam0, 1);
		func_421(&(uLocal_15[iParam0]), vVar0, 4f, 1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(&(uLocal_15[iParam0]), 51, true);
		PED::_0x7DE9692C6F64CFE8(&(uLocal_15[iParam0]), true, 0, 0);
		TASK::TASK_COMBAT_PED(&(uLocal_15[iParam0]), Global_35, 0, 0);
		func_285(&uLocal_15, iParam0, joaat("BLIP_STYLE_ENEMY"), 0);
	}
	else
	{
		PED::DELETE_PED(uLocal_15[iParam0]);
	}
}
...
bool func_321(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_426(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
		...
		while (iVar0 <= 4)
		{
			switch (iVar0)
			{
				...
				case 4:
					if (func_61(&(uLocal_15[iVar0]), 0, 0))
					{
						PED::_0xFC3DB99C8144CD81(&(uLocal_15[iVar0]), &(Local_274.f_27[5]), 0, 0, 0);
					}
					break;
			}
			iVar0++;
		...
		while (iVar0 <= 4)
		{
			switch (iVar0)
			{
				...
				case 1:
					if (func_61(&(uLocal_15[iVar0]), 0, 0))
					{
						PED::_0xFC3DB99C8144CD81(&(uLocal_15[iVar0]), &(Local_274.f_27[6]), 0, 0, 0);
					}
					break;
			}
			iVar0++;
...
int func_379(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_555(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_652(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_732(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
