...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1f, -0.7f, 0.9f, 0f, 4f, 2f, 2f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -3.7358f, 3.0285f, 0.9857f, 0f, 1.2f, 1.2f, 3f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_152(uParam0, -0.524f, -0.544f, 1.0089f, 0f, 0.8f, 0.8f, 3f, 665633627, 1);
	...
	func_159(uParam0, 117898874, 327398231);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_335(747937920, 1) && !func_416(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
