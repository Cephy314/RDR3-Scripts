...
int func_5(var uParam0)
{
	...
	{
		case 0:
			if (func_10(uParam0->f_483))
			{
				if ((MISC::GET_GAME_TIMER() - uParam0->f_481) > 1000)
				{
					iVar1 = 0;
					uParam0->f_482 = func_11(*uParam0, &iVar1, 1, 0, 0);
					if (uParam0->f_482 != -1)
					{
			...
			if (bVar0)
			{
				...
				TELEMETRY::_0x3145044F3990D321(func_14(*uParam0), uParam0->f_489, uParam0->f_483, &(uParam0->f_20[0 /*14*/]), uParam0->f_453);
				fVar2 = func_15(*uParam0);
				if (fVar2 > 0f)
				{
					uParam0->f_496 = func_16(uParam0->f_483, fVar2, "AMB_VIG", 1, 0, 8, 0, -1082130432 /* Float: -1f */);
				}
				...
				{
					uParam0->f_497 = VOLUME::_CREATE_VOLUME_CYLINDER(uParam0->f_483, 0f, 0f, 0f, func_18(uParam0));
		...
		case 5:
			if (func_22(uParam0))
			{
				...
				if (func_24(*uParam0))
				{
					func_25(uParam0->f_483, 6f, 1, 1, 0, 0, 0);
				}
				uParam0->f_464 = 4;
			}
			else
...
{
	func_36(uParam0, 11213, 11284, 12077);
}
...
int func_11(bool bParam0, int iParam1, bool bParam2, bool bParam3, float fParam4)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	{
		bVar3 = func_38(bParam0);
		bVar3 = (bVar3 * bVar3);
		bVar4 = func_39(bParam0);
		bVar4 = (bVar4 * bVar4);
		iVar0 = (Global_1415419->f_19[bParam0 /*12*/])->f_8;
		while (iVar0 <= (Global_1415419->f_19[bParam0 /*12*/])->f_9)
		{
			*iParam1++;
			if (!func_40(bParam0, *(Global_1415419->f_2996[iVar0 /*7*/])))
			{
			}
			else
			{
				...
				{
					iVar5 = func_41(Global_35, *(Global_1415419->f_2996[iVar0 /*7*/]), 1060437492 /* Float: 0.707f */);
					if (iVar5 == 1)
					{
					}
					else if (fVar6 < fVar2)
					{
						if (func_42(*(Global_1415419->f_2996[iVar0 /*7*/]), fVar6, (bParam0 <= 33 || bParam0 == 72), fParam4, bVar3, bVar4, bParam0))
						{
							iVar1 = iVar0;
							fVar2 = fVar6;
							if (bParam3)
...
void func_13(int iParam0, vector3 vParam1, int iParam4)
{
	if (func_43() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_43();
	}
	func_44(&((Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5), 0, 0, 1, 0, 0, 0, 0);
...
int func_16(vector3 vParam0, float fParam3, char* sParam4, bool bParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9)
{
	int iVar0;
	int iVar1;
	vector3 vVar2;
	...
	func_48(iVar0, bParam8);
	return iVar0;
}

void func_17(var uParam0, vector3 vParam1, vector3 vParam4)
{
	func_49(uParam0, "LIGHT_SMOKE", "script@ambient@town@LIGHT_SMOKE@action", vParam1, vParam4);
	...
	func_51(uParam0, 0, "MALE_A", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_51(uParam0, 1, "MALE_B", iLocal_37, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
...
{
	return STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_HUMAN_SMOKE"), 0);
}
...
int func_22(var uParam0)
{
	...
	while (iVar1 < uParam0->f_19)
	{
		if ((uParam0->f_20[iVar1 /*14*/])->f_2 != 0)
		{
			if (func_10((uParam0->f_20[iVar1 /*14*/])->f_5))
			{
...
int func_28(var uParam0)
{
	...
	while (iVar0 < uParam0->f_371)
	{
		...
		{
			if (((uParam0->f_372[iVar0 /*8*/])->f_7 && func_10((uParam0->f_372[iVar0 /*8*/])->f_3)) && !MISC::IS_STRING_NULL_OR_EMPTY(uParam0->f_3))
			{
...
{
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_HUMAN_SMOKE"), 1, 0, 0);
	func_60(&uLocal_9, 0);
	func_61(&uLocal_9, 1);
	func_62(&uLocal_9, 1);
	func_63(&uLocal_9, 1);
...
int func_34(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!&uParam0->f_469[1])
		{
			...
			{
				if (func_70(uParam0, 0.5f, 80f, 4, 1109393408 /* Float: 40f */, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_71(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_69(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
					...
					if (ANIMSCENE::_0x1F0E401031E20146(uParam0->f_3.f_1, "pbl_action"))
					{
						if (!&uParam0->f_469[4])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
							{
								...
								PED::_0x3BBDD6143FF16F98(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_372[0 /*8*/]), "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", "WORLD_HUMAN_SMOKE_MALE_A", 1);
						...
						if (!&uParam0->f_469[5])
						{
							if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
							{
								...
								PED::_0x3BBDD6143FF16F98(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_372[1 /*8*/]), "p_cigarette_cs01x_PH_R_HAND", "WORLD_HUMAN_SMOKE", "WORLD_HUMAN_SMOKE_MALE_C", 1);
								func_72(&(uParam0->f_20[1 /*14*/]), joaat("WORLD_HUMAN_SMOKE"), 60000, 0, joaat("WORLD_HUMAN_SMOKE_MALE_C"), 0.7f);
...
int func_40(int iParam0, vector3 vParam1)
{
	switch (iParam0)
	{
		case 58:
...
int func_41(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_42(vector3 vParam0, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7, int iParam8)
{
	bool bVar0;
	int iVar1[3];
	var uVar5;
	...
	if (iParam3 != 0)
	{
		...
		while (iVar0 < 248)
		{
			if ((Global_1415419->f_19[iVar0 /*12*/])->f_5 == iParam3)
			{
				if (iVar0 != iParam0)
				{
					if (func_43() > (Global_32073.f_2697.f_6[iVar0 /*6*/])->f_5)
					{
						(Global_32073.f_2697.f_6[iVar0 /*6*/])->f_5 = func_43();
					}
					func_44(&((Global_32073.f_2697.f_6[iVar0 /*6*/])->f_5), 0, 0, iParam1, iParam2, 0, 0, 0);
					func_12(&((Global_1415419->f_19[iVar0 /*12*/])->f_11), 2);
				}
			}
			iVar0++;
		}
...
void func_49(var uParam0, char* sParam1, char* sParam2, vector3 vParam3, vector3 vParam6)
{
	uParam0->f_2 = sParam1;
	uParam0->f_3 = sParam2;
...
void func_50(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4)
{
...
bool func_56()
{
	return (Global_1894899 & 1 != 0 && func_6() != -1);
}
...
void func_69(int iParam0, vector3 vParam1, bool bParam4)
{
	...
	func_44(&((Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5), 0, 0, (Global_1415419->f_19[iParam0 /*12*/])->f_7, 0, 0, 0, 0);
	if (bParam4)
	{
		if (iParam0 <= 74)
		{
...
void func_72(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
...
float func_108(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_164(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
int func_161(int iParam0, var uParam1)
{
	...
	else if (func_153() - uParam1->f_4) > func_213(uParam1)
	{
...
void func_163(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
int func_186(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
