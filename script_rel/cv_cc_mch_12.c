...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.7703f, 0.8061f, 0.5545f, 56f, 1.5f, 1.5f, 3f, -1612834106, joaat("APMS_COMP_MICAH"), 1, 1, 1);
	func_151(uParam0, 8.5246f, 2.6798f, 1.0747f, 53f, 1.5f, 1.5f, 3f, -1612834106, joaat("APMS_COMP_CHARLES"), 1, 1, 1);
...
int func_204(var uParam0)
{
	...
	switch (uParam0->f_1699)
	{
		...
		case 1:
			...
			func_315(uParam0->f_1707, bVar0, 0, 1, -1);
			if (uParam0->f_1709)
			{
				...
				func_315(uParam0->f_1708, bVar0, 0, 1, -1);
			}
		...
		case 3:
			...
			func_318(Global_35, &Var1, 0, bVar0, 1, 0, 0, 1);
			uParam0->f_1699++;
			break;
		case 4:
			if (!AUDIO::IS_ANY_SPEECH_PLAYING(Global_35))
			{
				...
				func_318(bVar0, &Var1, 0, Global_35, 1, 0, 0, 1);
				uParam0->f_1699++;
			}
			break;
		case 5:
...
int func_314(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
...
var func_318(bool bParam0, var uParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
