...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (func_61(uParam0, &uLocal_11, 0) || func_62(&(uParam0->f_20[1 /*14*/]), Global_35, 1) < 100f)
		{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[6])
			{
				if (func_71(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_66(*uParam0, uParam0->f_483, 0);
					uParam0->f_469[6] = 1;
				}
...
int func_32(var uParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		...
		while (iVar2 < uParam0->f_19)
		{
			...
			{
				if (ENTITY::IS_ENTITY_ON_SCREEN(&(uParam0->f_20[iVar2 /*14*/])) || ((uParam0->f_469[4] && !&uParam0->f_469[5]) && func_62(&(uParam0->f_20[iVar2 /*14*/]), Global_35, 1) < 22500f))
				{
					return 0;
				}
			}
