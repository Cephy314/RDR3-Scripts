...
int func_76(var uParam0)
{
	...
	func_158(uParam0, 0.2865f, 1.346f, 0f, 0f, 2.8125f, 3.0925f, 5f, -1612834106, joaat("APMS_COMP_KIERAN"), 1, 1, 1);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_373(-1780177928 /* GXTEntry: "Revolver Cartridges - High Velocity" */);
...
void func_320(int iParam0)
{
	...
	{
		case 9:
			if (func_374(1427759409 /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_375();
...
void func_321(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			...
			func_382(5, 0, -998653403 /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_352(747937920, 1) && !func_439(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
