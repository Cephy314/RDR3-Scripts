...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -2.25f, 0.75f, 0f, 0f, 3f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_CHOP_CARROT_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	PLAYER::_0x3946FC742AC305CD(PLAYER::GET_PLAYER_INDEX(), func_48(uParam0, iLocal_14), "CCPRS_CNV_4", 0f, 0f, 0f, false, 0);
	return 1;
}
...
{
	if (PED::_0x569F1E1237508DEB(func_48(uParam0, iLocal_14)) == joaat("PROP_HUMAN_FOODPREP_STEW_VEGDROP_CARROT_MALE_B"))
	{
		if (!bLocal_21)
		{
			bLocal_21 = true;
