	...
	while (!SCRIPTS::_0x9E4EF615E307FBBE())
	{
		...
		switch (Var0)
		{
			...
			case 2:
				...
				PED::_0xCB9401F918CB0F75(Global_35, "BLOCK_COFFEE_DISCARD_PROMPT", 1, 1);
				if (TASK::_0x6AA3DCA2C6F5EB6D(Global_35) != joaat("DRINK_COFFEE_HOLD"))
				{
				}
				else
				{
...
var func_27(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
var func_58(bool bParam0, var uParam1)
{
...
int func_63(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	func_111(bVar0, iParam0, fParam1);
...
void func_111(bool bParam0, int iParam1, float fParam2)
{
	char* sVar0;
