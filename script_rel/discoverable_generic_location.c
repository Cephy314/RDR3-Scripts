...
void func_87(char* sParam0)
{
	...
	func_208(MISC::_CREATE_VAR_STRING(2, "DISCO_DREAM"), sParam0, joaat("hud_toasts"), -1316482209, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, "COL_CTX_PLAYER_LOG"), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
