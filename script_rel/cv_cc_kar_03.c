...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0f, 0f, 0f, 102.24f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_152(uParam0, iLocal_14, joaat("WEAPON_REPEATER_CARBINE"), "SHOTGUN");
	func_153(uParam0, "script@vignette@karen_3@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@karen_3@action", 0, 0, 1, 1);
	func_154(uParam0, "CKAR3AU");
	func_155(uParam0, iLocal_14, 4, 1, 0, 0, 0);
	func_156(uParam0, iLocal_14, 2, -1);
	func_157(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_GUARD_SCOUT"), "WORLD_HUMAN_GUARD_SCOUT_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	Local_15 = { func_158(uParam0, 0f, 0f, 0f, 0f, 8f, 0.6f, 0.6f) };
	func_159(uParam0, 1);
...
{
	return func_191(uParam0, Local_15, 1, 0);
}
