...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 5.1653f, 3.3586f, 0f, -10f, 1f, 1f, 5f, -1612834106, joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_151(uParam0, 0.6339f, -2.4567f, 0f, 3.7983f, 1f, 1f, 5f, -1612834106, joaat("APMS_COMP_TILLY"), 1, 1, 1);
