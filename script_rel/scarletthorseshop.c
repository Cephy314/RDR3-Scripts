...
int func_11()
{
	bLocal_229 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1209.053f, -193.1814f, 101.852f, 0f, 0f, 19.83985f, 6.216366f, 11.62523f, 3.695f, "ScarlettMeadows Horse Shop - m_volHorseShop");
	...
	bLocal_231 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("SCH_HORSESHOP_GUARD");
	VOLUME::_0x39816F6F94F385AD(bLocal_231, 1193.417f, -220.1935f, 101.9785f, 0f, 0f, 14.80028f, 34.68813f, 24.66934f, 23.864f);
	VOLUME::_0x39816F6F94F385AD(bLocal_231, 1214.513f, -212.8789f, 101.9785f, 0f, 0f, 15.60754f, 23.67516f, 28.10355f, 23.864f);
	VOLUME::_0x39816F6F94F385AD(bLocal_231, 1187.173f, -208.151f, 105.1929f, 0f, 0f, 43.4823f, 32.91484f, 13.00947f, 30.26328f);
	bLocal_232 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(1209.053f, -193.1814f, 101.9785f, 0f, 0f, 19.83985f, 100.2164f, 100.6252f, 30.88881f, "ScarlettMeadows Horse Shop - GUARDS REGISTER");
	return 1;
}
...
{
	func_55(9, 804, bLocal_229, iParam0, 0, 0, 2, -1082130432 /* Float: -1f */, 0, 0);
	func_56(9, 1);
	func_56(9, 16384);
	func_57(9, 1);
...
{
	func_61(804, bLocal_229, 1);
	if (func_20() == -1)
	{
		if (!bLocal_234)
		{
			LAW::_CREATE_GUARD_ZONE("SCARLET_HORSE_SHOP_OUTSIDE_PENS");
			LAW::_0x8C598A930F471938("SCARLET_HORSE_SHOP_OUTSIDE_PENS", bLocal_232);
			LAW::_0x35815F372D43E1E5("SCARLET_HORSE_SHOP_OUTSIDE_PENS", bLocal_231);
			LAW::_0xAD3E07C37A7C1ADC("SCARLET_HORSE_SHOP_OUTSIDE_PENS", bLocal_231);
			LAW::_0xA1B0E6301E2E02A6("SCARLET_HORSE_SHOP_OUTSIDE_PENS", bLocal_231);
			func_61(804, bLocal_231, 1);
			func_61(806, bLocal_231, 0);
			bLocal_234 = true;
		}
	}
}
...
int func_38(int iParam0)
{
	...
	func_66(35, 805, bLocal_231, 9, &iLocal_233);
	return 0;
}
...
void func_47()
{
	...
	(Local_183[0 /*45*/])->f_43 = 10142;
	(Local_183[0 /*45*/])->f_44 = 10237;
...
int func_50(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, char* sParam5, bool bParam6, int iParam7, bool bParam8)
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(func_96(iParam3)))
	{
		return 0;
	}
...
void func_55(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
...
void func_66(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_74(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else
	{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_164(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_164(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_164(&cVar6, joaat("COLOR_PURE_WHITE")), func_164(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
...
void func_76(int iParam0, bool bParam1)
{
	...
	func_170(func_169(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_170(func_169(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_170(func_169(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_170(func_169(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_170(func_169(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_170(func_169(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_170(func_169(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_144(var uParam0)
{
	...
	func_238(&uLocal_85, bVar3, uParam0->f_37, 0);
	...
	if (!func_226(uParam0, 65536))
	{
		...
		{
			iVar4 = uParam0->f_21;
			bVar5 = func_145(&(uParam0->f_3[iVar4 /*3*/]));
			if (!func_237(bVar5, 0))
			{
				return;
			}
			...
			Call_Loc(uParam0->f_44);
			sVar6 = StackVal;
			func_238(&uLocal_85, bVar5, sVar6, 0);
...
int func_204(int iParam0, int iParam1, float fParam2)
{
	int iVar0;
...
int func_229(var uParam0, bool bParam1)
{
	...
	if (!func_307(bVar0, func_226(uParam0, 2048)))
	{
		return 0;
	}
	if (uParam0->f_30 == 0)
...
int func_234(var uParam0, int iParam1)
{
	...
	if (func_226(uParam0, 128))
	{
		...
		while (iVar0 < 5)
		{
			bVar1 = func_145(&(uParam0->f_3[iVar0 /*3*/]));
			if (func_237(bVar1, 0) && func_309(bVar1, iParam1, 1, 1) <= 4f)
			{
				uParam0->f_21 = iVar0;
				return 1;
			}
...
void func_238(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	...
	if (func_314(uParam0, bParam1, sParam2))
	{
...
int func_240(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	bool bVar0;
	bool bVar1;
	...
	else if (func_315(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		bVar0 = uParam0[0 /*4*/];
		bVar1 = uParam0[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(bVar0) && !func_316(bVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(bVar1) && !func_316(bVar1, 0)))
		{
			if (!func_98(vParam4))
			{
...
void func_242(var uParam0)
{
	...
	if (func_226(uParam0, 4096))
	{
		...
		bVar1 = func_145(*uParam0);
		if (func_299(iVar0) && func_307(bVar1, 1))
		{
			func_319(iVar0, 0);
...
int func_302(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_336(bVar0, 0)))
		{
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0) || func_316(bParam0, 0))
	{
		return 0;
	}
	if (func_339(bParam0))
...
float func_309(bool bParam0, int iParam1, bool bParam2, bool bParam3)
{
...
bool func_314(var uParam0, bool bParam1, char* sParam2)
{
	bool bVar0;
	int iVar1;
...
var func_336(bool bParam0, int iParam1)
{
	var uVar0;
...
{
	if (((func_333(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(bParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(bParam0))
	{
		return 1;
	}
	return 0;
