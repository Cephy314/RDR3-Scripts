...
int func_72(var uParam0)
{
	...
	uLocal_17 = func_158(uParam0, -2.5f, 2.5f, 2f, 0f, 0f, 0f, 5.5f, 5.5f, 2.5f, "volTrigger", joaat("VOLCYLINDER"));
	func_159(uParam0, 1);
	func_160(uParam0, iLocal_16, 1094713344 /* Float: 12f */, 1092616192 /* Float: 10f */);
	return 1;
}
...
{
	return func_191(uParam0, &uLocal_17, 1);
}
...
void func_185(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_252(uParam0, uParam0->f_1976.f_1), 1, func_284(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_191(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	return func_293(Global_35, *uParam1, 1, 0);
}
