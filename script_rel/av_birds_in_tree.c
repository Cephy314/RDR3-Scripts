...
{
	func_33(uParam0, 11287, 11345, 11808);
}
...
{
	func_46(uParam0, "BIRDS_IN_TREE", "", vParam1, vParam4);
	func_47(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, -1f), (0f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0.5f, -1f), (135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0f, -1f), (45f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0f, -1f), (-100f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.45f, -0.5f, -1f), (-135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, -1f), (-145f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-15f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, -1f), (50f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, -1f), (0f + vParam4.z), 0, 1, 1, 1, joaat("META_OUTFIT_ANIMAL_SONGBIRDTANAGER"), 1);
	func_47(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0.5f, -1f), (35f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (func_62(uParam0, &uLocal_11, 0))
		{
			func_63(uParam0);
			uParam0->f_469[1] = 1;
		}
	...
	switch (iLocal_10)
	{
		case 0:
			...
			{
				func_64(uParam0->f_20[iLocal_42 /*14*/], 1, 1);
				ENTITY::FREEZE_ENTITY_POSITION(&(uParam0->f_20[iLocal_42 /*14*/]), true);
				TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[iLocal_42 /*14*/]), joaat("STAND"), (uParam0->f_20[iLocal_42 /*14*/])->f_5, (uParam0->f_20[iLocal_42 /*14*/])->f_8, 0, false, true, 0, -1f, false);
			}
			iLocal_42++;
			if (iLocal_42 >= 12)
			{
		...
		case 2:
			if (func_65(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				while (iVar1 <= 11)
				{
					...
					{
						func_66(&(uParam0->f_20[iVar1 /*14*/]), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[iVar1 /*14*/]), 0f, 0f, 4.5f), uParam0->f_486.f_2, 32, 1073741824 /* Float: 2f */);
						...
						TASK::TASK_FLY_TO_COORD(0, 3f, ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[iVar1 /*14*/]), 0f, 2.5f, 0f), 0, 0);
						TASK::TASK_FLY_AWAY(0, Global_35);
						TASK::CLOSE_SEQUENCE_TASK(iVar0);
						TASK::TASK_PERFORM_SEQUENCE(&(uParam0->f_20[iVar1 /*14*/]), iVar0);
						PED::SET_PED_KEEP_TASK(&(uParam0->f_20[iVar1 /*14*/]), true);
...
int func_65(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_102(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_103(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
int func_73(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_113(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_74(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_113(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_114(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
{
	func_115(uParam0, iParam6);
	func_116(uParam0, iParam5);
...
float func_103(int iParam0, int iParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
...
int func_113(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_156(int iParam0, var uParam1)
{
	...
	else if (func_148() - uParam1->f_4) > func_208(uParam1)
	{
...
void func_159(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_113((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
