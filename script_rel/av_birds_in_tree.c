...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BLS_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, -1f), (0f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 1, "BLS_BIRD_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0.5f, -1f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "BLS_BIRD_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 3, "BLS_BIRD_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, 0f, -1f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "BLS_BIRD_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0f, -1f), (-100f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 5, "BLS_BIRD_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.45f, -0.5f, -1f), (-135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "BLS_BIRD_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, -1f), (-145f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 7, "BLS_BIRD_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "BLS_BIRD_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.5f, -1f), (-45f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 9, "BLS_BIRD_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.75f, -1f), (50f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 10, "BLS_BIRD_11", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0.5f, -1f), (0f + vParam4.z), 0, 1, 1, 1, -220316070, 1);
	func_47(uParam0, 11, "BLS_BIRD_12", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.75f, 0.5f, -1f), (35f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
