...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "MSAWP_MAN", func_48(func_47(), 0, 0, 0, 0, 0, 1), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -2.5f, 0f), (179f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_130(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_181(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_179(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_180(uParam2)
				{
					func_175(uParam2, 1);
					return 1;
				}
...
int func_131(int iParam0, var uParam1)
{
	...
	if (func_171(iParam0, uParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_180(uParam1)
		{
...
int func_154(int iParam0, var uParam1)
{
	...
	{
		return func_205(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_177(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_194(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_181(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_186(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_190(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_195(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_200(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_194(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
...
int func_201(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
