	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_85)
		{
			...
			switch (iLocal_84)
			{
				...
				case 1:
					func_5(iLocal_86);
					if (func_7(func_6(iLocal_86)))
					{
						func_8(func_6(iLocal_86), 4);
					}
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_86));
					iVar1 = func_10(iLocal_86);
					if (iVar1 != -1)
					{
				...
				case 2:
					...
					break;
				case 3:
					if (func_13(iLocal_86) || iLocal_87 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_86);
						iLocal_87 = (MISC::GET_GAME_TIMER() + iLocal_83);
						iLocal_84 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_86) || iLocal_87 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_86);
				...
				case 6:
					if (func_7(func_6(iLocal_86)))
					{
						if (func_17(func_6(iLocal_86), 4) && !iLocal_87 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_86) || iLocal_87 < MISC::GET_GAME_TIMER())
							{
								func_19(iLocal_86, 4);
								iLocal_87 = (iLocal_83 + MISC::GET_GAME_TIMER());
								iLocal_84 = 7;
							...
							Jump @788; //curOff = 456
							if (iLocal_87 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_86);
								func_22();
								if (!func_23(2057, 0))
							...
							func_34(iLocal_86, Global_1898004);
							iLocal_84 = 10;
							Jump @788; //curOff = 597
							func_35(iLocal_86);
							if (func_20() != -1)
							...
							func_39(Global_1898004, iLocal_86);
							func_40(iLocal_86);
							func_19(iLocal_86, 8);
							if (func_41())
							{
...
int func_11()
{
	bLocal_14 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volTown Agg");
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 69.6883f, 50.95198f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 49.04269f, 28.47917f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583631f, 30.73095f, 51.93652f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76538f, 38.38671f, 59.01843f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 38.38671f, 37.38729f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 11.55689f, 14.41201f, 15.9332f);
	VOLUME::_0x39816F6F94F385AD(bLocal_14, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644386f, 138.1747f, 21.08713f, 16.54283f);
	VOLUME::_0xBCE668AAF83608BE(bLocal_14, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 8.372574f, 17.93935f, 18.54283f);
	VOLUME::_0x39816F6F94F385AD(bLocal_14, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 15.22373f, 31.89837f, 18.54283f);
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2065.472f, -851.4658f, 42.55719f, 0f, 0f, 0f, 19.02366f, 13.64085f, 16.67954f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2019.272f, -774.1213f, 41.40026f, 0f, 0f, 37.13808f, 9.83179f, 10.20259f, 16.67954f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 2013.173f, -774.8469f, 41.40026f, 0f, 0f, 37.13808f, 4.350712f, 4.302257f, 16.67954f);
		bLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_15, bLocal_17);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 2076.114f, -860.0187f, 44.706f, 0f, 0f, 0f, 36.89741f, 35.70032f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 2050.994f, -804.7936f, 44.706f, 0f, 0f, 39.76539f, 36.89741f, 57.33146f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 2012.807f, -764.5793f, 44.706f, 0f, 0f, 39.76538f, 10.22549f, 13.5511f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 1998.531f, -853.2407f, 44.706f, 0f, 0f, 0f, 45.40543f, 35.23671f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_15, 2099.362f, -835.4238f, 44.706f, 0f, 0f, 38.97644f, 6.372574f, 15.93935f, 16.54283f);
		bLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Orange Plantation - m_volWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_16, bLocal_15);
		VOLUME::_0xBCE668AAF83608BE(bLocal_16, 2014.568f, -844.9777f, 44.706f, 0f, 0f, 0f, 68.19901f, 49.26501f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_16, 1968.462f, -859.535f, 44.706f, 0f, 0f, -0.583632f, 29.24165f, 50.24955f, 15.9332f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_16, 1994.893f, -813.8496f, 44.706f, 0f, 0f, 32.02662f, 47.55339f, 26.7922f, 15.9332f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 2040.947f, -887.8384f, 44.706f, 0f, 0f, 2.644384f, 136.6854f, 19.40016f, 15.9332f);
		VOLUME::_0x39816F6F94F385AD(bLocal_16, 2106.672f, -874.8062f, 44.706f, 0f, 0f, 173.7751f, 13.22373f, 29.89837f, 16.54283f);
		sLocal_18 = "ORANGE_PLANTATION";
		LAW::_CREATE_GUARD_ZONE(sLocal_18);
		LAW::_0x8C598A930F471938(sLocal_18, bLocal_14);
		LAW::_0x35815F372D43E1E5(sLocal_18, bLocal_15);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_18, bLocal_16);
		LAW::_0xA1B0E6301E2E02A6(sLocal_18, bLocal_17);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_18, 2066.902f, -851.1766f, 43.3946f);
		LAW::_0xA8A74AA79FB67159(sLocal_18, bLocal_14);
	}
	return 1;
}
...
void func_14(int iParam0)
{
	...
	if (func_20() == -1)
	{
		func_46(&uLocal_19, 945, 3, "", joaat("CHUCKWAGON000X"), 2066.077f, -879.7555f, 42.3275f, -179.75f, joaat("PG_DELIVERY_ORANGE01X"), 0);
		func_46(&uLocal_39, 946, 5, "", joaat("CHUCKWAGON000X"), 2070.248f, -798.5662f, 42.3792f, -1.05f, joaat("PG_DELIVERY_ORANGE01X"), 0);
		func_46(&uLocal_59, 947, 5, "", joaat("CHUCKWAGON000X"), 2009.136f, -822.2015f, 42.3163f, -78f, joaat("PG_DELIVERY_ORANGE01X"), 0);
	}
}
...
int func_38(int iParam0)
{
	if (!bLocal_82)
	{
		if (ENTITY::DOES_ENTITY_EXIST(bLocal_80))
		{
			if (!ENTITY::IS_ENTITY_DEAD(bLocal_80))
			{
				if (!DECORATOR::DECOR_EXIST_ON(bLocal_80, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(bLocal_80, "HAS_VOICE"))
				{
					DECORATOR::DECOR_SET_BOOL(bLocal_80, "HAS_VOICE", true);
					AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_80, "0941_A_M_M_Foreman_White_AVOID_01");
					bLocal_82 = true;
				}
			}
		}
	...
	if (!bLocal_81)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_DEAD(bLocal_79))
			{
				if (!DECORATOR::DECOR_EXIST_ON(bLocal_79, "HAS_VOICE") || !DECORATOR::DECOR_GET_BOOL(bLocal_79, "HAS_VOICE"))
				{
					DECORATOR::DECOR_SET_BOOL(bLocal_79, "HAS_VOICE", true);
					AUDIO::SET_AMBIENT_VOICE_NAME(bLocal_79, "0946_A_M_M_Guard_White_AGGRESSIVE_01");
					bLocal_81 = true;
				}
			}
		}
...
void func_51(var uParam0, bool bParam1, int iParam2)
{
	if (uParam0->f_61 >= 20)
	{
		return;
...
void func_55(var uParam0)
{
	...
	{
		case 0:
			if (func_91(uParam0->f_13))
			{
				*uParam0 = 9;
			}
			if (!PERSCHAR::_0x800DF3FC913355F3(PERSCHAR::_0x112DDF56300BC6E5(func_92(uParam0->f_1))))
			{
				*uParam0 = 9;
			}
			*uParam0 = 1;
		...
		case 7:
			...
			{
				PERSCHAR::_0x187D65F3AEC5D679(func_92(uParam0->f_1), &(uParam0->f_3));
			}
			if (ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_0x31C70A716CAE1FEE(PERSCHAR::_0x112DDF56300BC6E5(func_92(uParam0->f_1)))))
			{
				*uParam0 = 6;
			}
			else
...
void func_63(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	else if ((func_52(iParam0) && func_80(iParam0, 16777216)) && !Global_1894899->f_9)
	{
...
{
	if (func_130(bLocal_80, 0))
	{
		DECORATOR::DECOR_SET_BOOL(bLocal_80, "HAS_VOICE", false);
	}
	if (func_130(bLocal_79, 0))
	{
		DECORATOR::DECOR_SET_BOOL(bLocal_79, "HAS_VOICE", false);
	}
...
int func_87(int iParam0, bool bParam1)
{
	...
	if (func_136(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_90(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_90(iParam0)))
	{
...
int func_95(var uParam0)
{
	...
	iVar0 = PERSCHAR::_0x112DDF56300BC6E5(func_92(uParam0->f_1));
	if (PERSCHAR::_0x800DF3FC913355F3(iVar0))
	{
...
int func_118(int iParam0)
{
	...
	if (func_151())
	{
		if (!func_152(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_157((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_158((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_133(int iParam0)
{
	...
	{
		func_161((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_162((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
int func_137(int iParam0, bool bParam1)
{
	...
	func_170(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_90(iParam0));
	func_138(iParam0, 0);
	return 1;
}
...
void func_141(vector3 vParam0, float fParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
int func_144(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_173(iVar0) && func_174(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
char* func_145(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
void func_170(int iParam0)
{
	...
	{
		if (ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(bVar0, false))
		{
...
int func_176(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
