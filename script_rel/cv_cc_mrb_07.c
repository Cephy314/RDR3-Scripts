...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.175f, -7.0875f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, -1377448058, 1, 1, 1);
	func_151(uParam0, 0.85f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, -1612834106, -1689743484, 1, 1, 1);
	func_152(uParam0, -0.207769f, -1.05733f, 1.00032f, 0f, 1.1f, 1.1f, 3.2f, 665633627, 1);
	...
	func_155(uParam0, iLocal_14, 3, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_14, iLocal_16, "p_cs_knitting01x_PH_R_HAND", 0, 0);
	func_154(uParam0, iLocal_15, 3, 830847823, "WORLD_HUMAN_STARE_STOIC_FEMALE_A", -1, 1);
	func_157(uParam0, iLocal_15, 1, -1);
	func_158(uParam0, 417092960, 1023367897);
	func_159(uParam0, "script@vignette@marybeth_7@base", 1, 1, 0, 0);
	func_159(uParam0, "script@vignette@marybeth_7@Action", 0, 0, 1, 0);
