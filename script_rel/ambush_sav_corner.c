...
void func_149()
{
	...
	if (iLocal_15.f_227)
	{
		...
		{
			if (func_304(&(iLocal_15[0]), 273784715, "bLineHola", func_303(), 1067030938 /* Float: 1.2f */, 1))
			{
	...
	{
		if (func_304(&(iLocal_15[0]), 1700452288, "bLineYell", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&Local_274, 0, 2);
		}
	}
	...
	if (!func_302(&Local_274, 0, 2))
	{
		if (func_304(&(iLocal_15[0]), 1611840838, "bLineBypass", func_303(), 1067030938 /* Float: 1.2f */, 1))
		{
			func_305(&Local_274, 0, 2);
		}
	}
