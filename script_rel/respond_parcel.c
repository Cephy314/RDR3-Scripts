...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	if (!func_37(iParam0, &bVar0, iParam1))
	{
		return 0;
	}
	...
	if (!bVar3)
	{
		...
		{
			if (!func_71(iParam0, &bVar0, iParam5))
			{
				bParam2 = true;
			}
			bVar4 = true;
	...
	if (!bVar4)
	{
		...
		iVar10 = iParam0;
		func_113(&iVar10);
		if (!func_114(iVar10, bVar0, iParam5))
		{
			return 0;
		}
		else if (!func_66(0))
	...
	else if (!bParam2)
	{
		...
		func_121(iParam0, bVar0, 0, bVar37, 0);
	}
	return 1;
}
...
int func_37(int iParam0, bool bParam1, int iParam2)
{
	...
	*bParam1 = iParam2;
	...
	if (func_133(iParam0, &Var0, *bParam1, 0, 0))
	{
		if (iVar6 < iVar5)
		{
			*bParam1 = (iVar5 - iVar6);
...
int func_67(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_167(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_66(0))
				{
					...
					func_68(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), bParam1, iParam6);
					func_171(iParam0, bParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
				{
...
int func_69(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_133(iParam0, &uVar1, 1, 0, 0))
		{
			...
			bVar6 = func_173(iVar0);
			if (WEAPON::_IS_WEAPON_SNIPER(iVar0))
			{
				func_67(iVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0);
			}
			...
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				...
				if ((((func_165(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_90(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_165(iVar7) && func_90(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0))
				{
					if (!func_67(iVar0, bVar6, bParam3, bParam4, 3, 1, iParam1, 0))
					{
						return 0;
					}
				}
				else if (!func_67(iVar0, bVar6, bParam3, bParam4, 0, 1, iParam1, 0))
				{
					return 0;
				}
			}
			else if (!func_67(iVar0, bVar6, bParam3, bParam4, 0, 0, iParam1, 0))
			{
				return 0;
			}
		}
...
int func_71(int iParam0, bool bParam1, int iParam2)
{
	...
	if (func_66(0))
	{
		if (func_68(iParam0, bVar0, iParam2))
		{
			*bParam1 = bVar0;
			return 1;
		}
	...
	{
		return func_114(iParam0, *bParam1, iParam2);
	}
	return 0;
}
...
int func_114(int iParam0, bool bParam1, int iParam2)
{
	...
	return func_235(iParam0, &Var5, &Var0, bParam1, iParam2, 0);
}
...
void func_121(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;
	char cVar2[32];
	...
	if (!func_252())
	{
		func_253(iParam0, bParam1, bParam2, bParam4);
		return;
	}
	bVar0 = false;
	...
	if (((((bParam1 == 1 || func_57(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_127(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	...
	if (bParam2 || !func_164(iVar0))
	{
		...
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iVar0, 0, false) && func_39(iParam0, 0, 0) == 0))
		{
			...
			{
				func_121(iParam0, bParam1, 0, 0, 0);
...
int func_133(int iParam0, var uParam1, bool bParam2, bool bParam3, bool bParam4)
{
	struct<4> Var0;
	struct<10> Var4;
	var uVar26;
...
struct<4> func_169(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_137(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}
...
void func_171(int iParam0, bool bParam1)
{
	...
	{
		iVar1 = func_317(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), bParam1);
...
int func_235(int iParam0, var uParam1, var uParam2, bool bParam3, int iParam4, bool bParam5)
{
	if (!func_35(iParam0, 0))
	{
	}
	...
	if (func_133(iParam0, uParam2, bParam3, bParam5, 0))
	{
		return 0;
	}
	if (!func_66(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_137(0), uParam1, uParam2, iParam0, uParam2->f_4, bParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_250(int iParam0)
{
	...
	if (!func_386(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
void func_253(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
int func_258(bool bParam0, int iParam1, bool bParam2)
{
	...
	else
	{
		...
		{
			iVar0 = (iVar0 + func_394(INVENTORY::_0x13D234A2A3F66E63(bParam0), iParam1));
		}
	}
...
int func_349(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_429(0);
	if (iParam2 != 0 && func_430(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
int func_393(int iParam0, bool bParam1)
{
	...
	if (func_457(Global_1935689->f_10186, 1))
	{
		...
		iVar1 = (iVar1 + func_394(INVENTORY::_0x13D234A2A3F66E63(bVar0), iParam0));
	}
...
int func_430(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
struct<4> func_503(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
...
bool func_509(int iParam0, bool bParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
