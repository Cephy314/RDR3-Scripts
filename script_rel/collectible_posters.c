...
void __EntryFunction__()
{
	...
	{
		iLocal_14 = COLLECTION::_0x126CBEBBA46693CF(func_7(), joaat("taxidermy"), -1160144609);
...
void func_417(int iParam0, int iParam1, int iParam2)
{
	...
	func_176(sVar7, sVar1, iVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_481(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
