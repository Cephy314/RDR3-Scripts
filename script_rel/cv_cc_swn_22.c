...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -1.156f, -1.6725f, 0f, -40f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_TILLY"), 1, 1, 1);
	func_150(uParam0, 1.055f, -1.8675f, 0f, 37.75f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	iLocal_14 = func_151(uParam0, 22, 0);
	iLocal_15 = func_151(uParam0, 21, 0);
	uLocal_25 = func_152(uParam0, joaat("S_CRATESEAT03X"), -1.1669f, -1.683f, -0.0234985f, 0, 1, 0, 1);
	uLocal_26 = func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 1.19761f, -1.86883f, -0.0285263f, 0, 1, 0, 1);
	...
	func_154(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_B", uLocal_26, 0);
	func_155(uParam0, iLocal_15, 1, -1);
	func_156(uParam0, iLocal_15, 1, 6, 0, 0, 0);
	func_157(uParam0, iLocal_15, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_MALE_B", uLocal_26, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_154(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", uLocal_25, 0);
	func_156(uParam0, iLocal_14, 1, 1, 0, 0, 0);
	func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_SEAT_CHAIR_STEW"), "PROP_CAMP_SEAT_CHAIR_STEW_EATING_FEMALE_A", uLocal_25, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_27 = { func_159(uParam0, -1.04f, -1.631f, 0.988f, 23.5f, 6f, 0.3125f, 0.42f) };
	Local_37 = { func_159(uParam0, -1.04f, -1.6305f, 0.988f, 89.75f, 6f, 0.305f, 0.4225f) };
	Local_47 = { func_159(uParam0, -1.04f, -1.631f, 0.988f, -76.16f, 6f, 0.685f, 0.0875f) };
	func_160(uParam0, "script@vignette@swanson_22@base", 1, 1, 0, 0);
	iLocal_16 = func_160(uParam0, "script@vignette@swanson_22@action_a", 2, 0, 1, 0);
	iLocal_17 = func_160(uParam0, "script@vignette@swanson_22@action_b", 0, 0, 0, 0);
	iLocal_19 = func_160(uParam0, "script@vignette@swanson_22@action_b_alt_front", 0, 0, 0, 1);
	iLocal_18 = func_160(uParam0, "script@vignette@swanson_22@action_b_alt_left", 0, 0, 0, 1);
	iLocal_20 = func_160(uParam0, "script@vignette@swanson_22@action_b_alt_right", 0, 0, 0, 1);
...
{
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("PROP_CAMP_SEAT_CHAIR_STEW"), 0))
	{
		return 0;
	}
	return 1;
...
int func_93(var uParam0)
{
	...
	{
		if (func_201(uParam0, Local_27, 1, 0))
		{
			func_191(uParam0, iLocal_19, 1);
		}
		else if (func_201(uParam0, Local_37, 1, 0))
		{
			func_191(uParam0, iLocal_18, 1);
		}
		else if (func_201(uParam0, Local_47, 1, 0))
		{
...
int func_257(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool func_282(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_337(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_337(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
