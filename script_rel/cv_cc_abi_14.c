...
int func_73(var uParam0)
{
	...
	func_152(uParam0, 1.1566f, -0.516f, 0f, 31.68f, 2f, 3f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	if (iVar0 == 1)
	{
	...
	func_158(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_GROUND"), "WORLD_HUMAN_SIT_GROUND_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_15, 2, joaat("WORLD_CAMP_JACK_SLEEP"), "WORLD_CAMP_JACK_SLEEP", -1, 1, 240f, 1065353216 /* Float: 1f */, 1);
	func_162(uParam0, 1);
	...
	iLocal_29 = func_165(uParam0, 0.5875f, -1.025f, 0.95f, 0f, 0f, 80.98939f, 1.1f, 1.1f, 1.38f, "Grief", joaat("VOLCYLINDER"));
	func_166(uParam0, 1);
	return 1;
}
