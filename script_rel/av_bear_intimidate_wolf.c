...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "BIW_BEAR", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "BIW_WOLF", joaat("A_C_WOLF"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 16f, 20f, 0f), (vParam4.z + 135f), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "BIW_DEER", joaat("A_C_DEER_01"), OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 1f, 0f), (vParam4.z - 90f), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		{
			if (func_69(uParam0, 4f, 90f, 4, joaat("ACTION"), 0))
			{
				func_67(*uParam0, uParam0->f_483, 1);
				uParam0->f_469[0] = 1;
			}
	...
	switch (iLocal_11)
	{
		case 0:
			...
			bLocal_75 = VOLUME::_CREATE_VOLUME_SPHERE(OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 8f, 10f, 0f), 0f, 0f, 0f, 20f, 20f, 20f);
			POPULATION::_0xB56D41A694E42E86(bLocal_75, 2016, 16384, 0, -1, -1, 0);
			POPULATION::_0x18262CAFEBB5FBE1(bLocal_75, 2016, 16384, 0, -1, -1, 0);
			iLocal_13 = EVENT::ADD_SHOCKING_EVENT_AT_POSITION(joaat("EVENT_SHOCKING_BEAT_DANGEROUS"), uParam0->f_483, -1f, -1f, -1f, -1082130432, -1082130432, -1, -1);
			iLocal_11 = 1;
			break;
		case 1:
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_75))
	{
		POPULATION::_0x74C2B3DC0B294102(bLocal_75);
		POPULATION::_0xA1CFB35069D23C23(bLocal_75);
		VOLUME::_DELETE_VOLUME(bLocal_75);
	}
	if (iLocal_13 != 0)
	{
		EVENT::REMOVE_SHOCKING_EVENT(iLocal_13);
