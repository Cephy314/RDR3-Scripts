...
int func_93(var uParam0)
{
	...
	func_166(uParam0, -2.2375f, -0.5425f, 0f, 18.75f, 1.15f, 1.275f, 5f, -1612834106, joaat("APMS_COMP_CHARLES"), 1, 1, 1);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_383(-1780177928 /* GXTEntry: "Revolver Cartridges - High Velocity" */);
...
void func_325(int iParam0)
{
	...
	{
		case 9:
			if (func_384(1427759409 /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_385();
...
void func_326(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			...
			func_392(5, 0, -998653403 /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
