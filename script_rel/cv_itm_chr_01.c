...
int func_134(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_58(bVar0, 0))
	{
		if (func_58(PED::_0xB676EFDA03DADA52(bVar0, 0), 0) && !bParam4)
		{
			return 0;
		}
...
int func_342()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_404(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_492(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_523(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
...
void func_493(bool bParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_128(iParam1), bParam0, 0);
