...
void __EntryFunction__()
{
	...
	while (true)
	{
		...
		else
		{
			...
			{
				case 0:
					if (func_27(345667237 /* GXTEntry: "Get Rich Quick" */, 1, 0))
					{
						func_28(27, 12);
						func_1(1, 0);
					}
				...
				case 2:
					if ((((func_62(uLocal_171[0], bLocal_166, 2644.443f, -1207.946f, 52.3368f, 199.0776f, 1, 0, 1) && func_63(&bLocal_173, iLocal_168, 2644.251f, -1208.702f, 53.5354f)) && func_63(&bLocal_174, iLocal_168, 2643.541f, -1208.416f, 53.1764f)) && func_63(&iLocal_175, iLocal_169, 2644.625f, -1208.099f, -108.1324f)) && func_63(&iLocal_176, iLocal_167, 2643.355f, -1208.241f, 52.3474f))
					{
						if (func_9(&(uLocal_171[0]), 0))
						{
							...
							func_67(&(uLocal_171[0]), 345667237 /* GXTEntry: "Get Rich Quick" */, 1, 0);
				...
				case 32:
					...
					else if ((ANIMSCENE::_0x1F0E401031E20146(iLocal_189, func_79()) && ANIMSCENE::_0x3FBC3F51BF12DFBF(iLocal_189) > 0.65f) && !func_18(iLocal_190, 256))
					{
						...
						if (!func_27(345667237 /* GXTEntry: "Get Rich Quick" */, 1, 0))
						{
							func_113(345667237 /* GXTEntry: "Get Rich Quick" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						}
						func_28(27, 1);
						func_114(27);
...
void func_242(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_421(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_421(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
void func_285(int iParam0, bool bParam1)
{
	...
	func_421(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
