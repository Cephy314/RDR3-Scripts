...
int func_162()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_352())
	{
		return 1;
	}
	return 0;
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_403(bParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0x959383DCD42040DA(bVar0))
			{
				...
				{
					func_252(bVar0, WEAPON::_0xD3750CCC00635FC2(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
void func_435(bool bParam0, bool bParam1)
{
	...
	{
		iVar1 = func_659(WEAPON::_0xD3750CCC00635FC2(bParam0), bParam1);
