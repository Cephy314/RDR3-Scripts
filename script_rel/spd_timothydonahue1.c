	...
	if (!bVar3)
	{
		...
		switch (bParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_277(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_278(&bVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER"):
				...
				{
					func_277(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER"), 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
...
void func_299(bool bParam0)
{
	...
	if ((bParam0 == joaat("CLOTHING_SP_OFFHAND_000") || bParam0 == -1515874150) || bParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		{
			func_277(Global_35, bParam0, 0, 99217379, 1, 1, 1, 0, 1, 1);
		}
		func_246(24);
		if (func_278(&bVar2, 0))
		{
		...
		case 24:
			...
			if (func_184() == -1)
			{
				if (!func_502(99217379) || func_655(99217379) == 2110595215)
				{
					...
					func_277(Global_35, bVar0, 0, 99217379, 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
