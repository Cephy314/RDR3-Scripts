...
Vector3 func_160()
{
	return func_203("ATZ_INS_EXC_BG");
}

Vector3 func_161()
{
	return func_203("ATZ_INS_FUR_BG");
}
...
Vector3 func_165()
{
	return func_203("ATZ_INS_TRB_BG");
}
...
int func_171()
{
	return -808485662 /* GXTEntry: "Legendary Big Horn Ram" */;
}
...
Vector3 func_202(int iParam0, int iParam1)
{
	switch (iParam0)
	{
		case 0:
			...
			{
				case 0:
					return -1053.943f, 774.46f, 123.397f;
				case 1:
					return -948.5314f, 895.2468f, 138.4047f;
				case 2:
					return -1004.844f, 750.6244f, 116.6094f;
			}
			break;
		case 1:
			switch (iParam1)
			{
				...
				case 1:
					return -1084.208f, 835.4189f, 116.1535f;
				case 2:
					return -1054.102f, 867.2668f, 121.9913f;
			}
			break;
		case 2:
			switch (iParam1)
		...
		case 3:
			...
			{
				case 0:
					return -1002.504f, 798.8792f, 117.5009f;
				case 1:
					return -996.9072f, 884.1312f, 124.106f;
				case 2:
					return -1010.108f, 820.0167f, 117.1967f;
			}
			break;
	}
	return 0f, 0f, 0f;
