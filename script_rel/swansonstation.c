...
void func_64(int iParam0, bool bParam1)
{
	...
	func_122(func_121(-1532769513, joaat("areas")), 1);
	switch (func_6(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_122(func_121(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_122(func_121(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_122(func_121(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_122(func_121(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_122(func_121(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_122(func_121(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
{
	return func_145(iParam0, iParam1, 4, MISC::GET_HASH_KEY(func_144(iParam1)));
}
...
char* func_116(char* sParam0, int iParam1)
{
	...
	return func_159(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
void func_148(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		...
		else if (!STATS::_0x01F4D242765C6B24(func_183(iParam0)))
		{
...
char* func_154(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
