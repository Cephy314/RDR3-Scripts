...
void func_14(int iParam0, bool bParam1)
{
	if (TASK::_DOES_SCENARIO_POINT_EXIST(iParam0->f_7))
	{
		if (bParam1)
		{
			if (!TASK::_IS_SCENARIO_POINT_ACTIVE(iParam0->f_7))
			{
				TASK::_SET_SCENARIO_POINT_ACTIVE(iParam0->f_7, true);
			}
		}
		else if (TASK::_IS_SCENARIO_POINT_ACTIVE(iParam0->f_7))
		{
		...
		while (iVar28 < 4)
		{
			...
			if (func_241(bParam0, &Var0, iVar5, 0))
			{
				...
				if (func_139(0))
				{
					...
					func_141(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(bParam0), bParam1, iParam6);
...
int func_252(int iParam0, bool bParam1, var uParam2)
{
	var uVar0;
	bool bVar1;
	int iVar2;
