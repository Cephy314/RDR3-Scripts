...
void func_1()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(Local_14.f_4) && !func_6(506073827 /* GXTEntry: "The Elemental Trail Map 1" */, 1, 0))
	{
		func_7(&(Local_14.f_4));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_14.f_12) && !func_6(506073827 /* GXTEntry: "The Elemental Trail Map 1" */, 1, 0))
	{
...
int func_11(int iParam0)
{
	...
	if (iParam0->f_9 == -1491419385 || iParam0->f_9 == 1809565830)
	{
		if (iParam0->f_9 == -1491419385)
		{
	...
	else if ((((((((iParam0->f_9 == -628873767 || iParam0->f_9 == -405421956) || iParam0->f_9 == -1108972386) || iParam0->f_9 == -878376933) || iParam0->f_9 == 1053716392) || iParam0->f_9 == 806507056) || iParam0->f_9 == 1571925350) || iParam0->f_9 == 1330352282) || iParam0->f_9 == 975496781)
	{
		if (!func_12())
		{
			return 1;
	...
	if (func_42(iParam0->f_9) && !ENTITY::DOES_ENTITY_EXIST(iParam0->f_2))
	{
		...
		{
			if (iParam0->f_9 == -878376933)
			{
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_2, func_45(-878376933), 2, true);
			}
			else if (iParam0->f_9 == 975496781)
			{
				ENTITY::SET_ENTITY_ROTATION(iParam0->f_2, func_45(975496781), 2, true);
				ENTITY::SET_ENTITY_COORDS(iParam0->f_2, func_43(975496781), true, false, true, true);
			}
		}
		iVar0 = 0;
	}
	if ((((func_46(iParam0->f_9) && func_13(iParam0->f_9)) && iParam0->f_9 != -878376933) && iParam0->f_9 != 975496781) && !ENTITY::DOES_ENTITY_EXIST(iParam0->f_3))
	{
		if (iParam0->f_9 == 1595354593 || iParam0->f_9 == -2016706455)
		{
			iVar5 = joaat("s_pickup_goldbar01x");
		}
		else if (iParam0->f_9 == 1809565830)
		{
			...
			if (iParam0->f_9 == 1214120047)
			{
				if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_2))
				{
					if (ENTITY::DOES_ENTITY_HAVE_DRAWABLE(iParam0->f_2))
					{
						...
						ENTITY::ATTACH_ENTITY_TO_ENTITY(iParam0->f_3, iParam0->f_2, 0, -0.045f, 0.03f, 0.05f, func_45(1214120047), false, false, false, false, 2, true, false, false);
					}
				}
			}
			else if (iParam0->f_9 == 1809565830)
	...
	if ((((iParam0->f_9 != 854119837 && iParam0->f_9 != -335460405) && iParam0->f_9 != 1809565830) && iParam0->f_9 != -628873767) && !TASK::_0x841475AC96E794D1(iParam0->f_7))
	{
		switch (iParam0->f_9)
		{
			case -1292544588:
		...
		if (iParam0->f_9 == -696705861 || iParam0->f_9 == 975496781)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_2))
			{
				iParam0->f_7 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(iParam0->f_2, -491792868, 0f, 0f, 0f, 0, 0, 0, 1);
			}
		}
		else if (iParam0->f_9 == -878376933)
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_2))
			{
				iParam0->f_7 = TASK::CREATE_SCENARIO_POINT_ATTACHED_TO_ENTITY(iParam0->f_2, -203096485, 0f, 0f, 0f, 0, 0, 0, 1);
			}
		}
		else if (iParam0->f_9 == 1214120047)
		{
			iParam0->f_7 = TASK::_0xF533D68FF970D190(TASK::_0xA8452DD321607029(iParam0->f_6, 1), 202274149, 1.5f, 0, 0);
		}
		else
		{
			vVar1 = { TASK::_0xA8452DD321607029(iParam0->f_6, 1) };
			iParam0->f_7 = TASK::CREATE_SCENARIO_POINT(iVar18, vVar1, TASK::_0xB93EA7184BAA85C3(iParam0->f_6, 1), 0f, 0, 0);
		}
		iVar0 = 0;
	}
	func_14(iParam0, 0);
	...
	else if (iParam0->f_9 == 1809565830 && func_13(iParam0->f_9))
	{
		if (!func_38(iParam0->f_8))
		{
			iParam0->f_8 = func_50(MISC::_CREATE_VAR_STRING(2, "GENERIC_SEARCH"), joaat("INPUT_CONTEXT_X"), TASK::_0xA8452DD321607029(iParam0->f_6, 1), 1070386381 /* Float: 1.6f */, 1, 0, 0, 4, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0);
			iVar0 = 0;
		}
...
int func_13(int iParam0)
{
	switch (iParam0)
	{
		case -1292544588:
		case 854119837:
			return func_6(-1937935584 /* GXTEntry: "Jack Hall Gang Map 1" */, 1, 0);
		case -1003325394:
			return func_6(2127812557 /* GXTEntry: "Jack Hall Gang Map 2" */, 1, 0);
		case -696705861:
			return func_6(808991383 /* GXTEntry: "Jack Hall Gang Map 3" */, 1, 0);
		case -335460405:
		case 903797617:
			return func_6(1134518629 /* GXTEntry: "High Stakes Treasure Map 1" */, 1, 0);
		case 669728650:
			return func_6(902940106 /* GXTEntry: "High Stakes Treasure Map 2" */, 1, 0);
		case 1595354593:
			return func_6(-418174898 /* GXTEntry: "High Stakes Treasure Map 3" */, 1, 0);
		case 1214120047:
			return 1;
		case 655769340:
			return func_6(-648114971 /* GXTEntry: "The Poisonous Trail Map 1" */, 1, 0);
		case 885316185:
			return func_6(211153747 /* GXTEntry: "The Poisonous Trail Map 2" */, 1, 0);
		case -2016706455:
			return func_6(-32876996 /* GXTEntry: "The Poisonous Trail Map 3" */, 1, 0);
		case -1491419385:
			return 1;
		case 1809565830:
			return func_6(1191437462 /* GXTEntry: "Le Tresor des Morts Map 1" */, 1, 0);
		case 2056119786:
			return func_6(1119149048 /* GXTEntry: "Le Tresor des Morts Riddle Note" */, 1, 0);
		case -628873767:
			return 1;
		case -405421956:
			return func_6(506073827 /* GXTEntry: "The Elemental Trail Map 1" */, 1, 0);
		case -1108972386:
			return func_6(-1876986168 /* GXTEntry: "The Elemental Trail Map 2" */, 1, 0);
		case -878376933:
			return func_6(2142623221 /* GXTEntry: "The Elemental Trail Map 3" */, 1, 0);
		case 1053716392:
			return 1;
		case 806507056:
			return func_6(1508215381 /* GXTEntry: "Landmarks of Riches Map 1" */, 1, 0);
		case 1571925350:
			return func_6(-888935280 /* GXTEntry: "Landmarks of Riches Map 2" */, 1, 0);
		case 1330352282:
			return func_6(-1252474566 /* GXTEntry: "Landmarks of Riches Map 3" */, 1, 0);
		case 975496781:
			return func_6(-1465702449 /* GXTEntry: "Landmarks of Riches Map 4" */, 1, 0);
		default:
			break;
	}
	return 0;
...
{
	if (TASK::_0x841475AC96E794D1(iParam0->f_7))
	{
		if (bParam1)
		{
			if (!TASK::_0x0CC36D4156006509(iParam0->f_7))
			{
				TASK::_0xEEE4829304F93EEE(iParam0->f_7, 1);
			}
		}
		else if (TASK::_0x0CC36D4156006509(iParam0->f_7))
		{
			TASK::_0xEEE4829304F93EEE(iParam0->f_7, 0);
		}
	}
}
...
int func_17(int iParam0)
{
	switch (iParam0->f_9)
	{
		...
		case 1595354593:
			...
			{
				TASK::_0xA6A76D666A281F2D(ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(iParam0->f_3), -102111672);
			}
			return func_53(-102111672 /* GXTEntry: "Map" */);
		case 1809565830:
			if (func_38(iParam0->f_8))
			{
...
int func_19(int iParam0)
{
	...
	switch (iParam0->f_9)
	{
		...
		case -1003325394:
			...
			break;
		case -696705861:
			bVar0 = 146855730; /* GXTEntry: "Gold Bar" */
			iVar1 = 2;
			break;
		case -335460405:
			bVar0 = false;
	...
	if (iVar1 > 0)
	{
		...
		else if (iParam0->f_9 == -878376933)
		{
			...
			if (!iParam0->f_23)
			{
				func_64(146855730 /* GXTEntry: "Gold Bar" */, 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				iParam0->f_23 = 1;
				return 0;
			}
			if (!iParam0->f_24)
...
void func_30(int iParam0, bool bParam1)
{
	...
	func_71(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_63(bool bParam0)
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(bParam0, 716706914, 1) != 8)
	{
		iVar0 = 0;
	}
	return iVar0;
	...
	if (!bVar3)
	{
		...
		switch (bParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_163(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_164(&bVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER"):
				...
				{
					func_163(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER"), 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
...
int func_99(var uParam0)
{
	...
	func_204(uParam0->f_4, -1632917921 /* GXTEntry: "Horse Ointment" */, 1, 0);
...
void func_130(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_71(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_71(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
	...
	if (WEAPON::IS_WEAPON_VALID(bVar0))
	{
		...
		if (!func_216(bParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0x959383DCD42040DA(bVar0))
			{
				...
				{
					func_140(bVar0, WEAPON::_0xD3750CCC00635FC2(bVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
...
int func_150()
{
	if (((((func_260(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_260(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_260(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_260(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_260(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_260(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return 1;
	}
	return 0;
		...
		else if (func_131(bParam0, 412399755))
		{
			...
			if (func_273() == 0)
			{
				...
				if (((bParam0 == 281887510 || bParam0 == -164081697) || bParam0 == -1161319399) || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_128(43, bParam0, iParam1, -1791518714, iVar1, 0, -1, 0);
		...
		else if (func_131(bParam0, 709057512))
		{
			...
			if (func_273() == 1)
			{
				...
				if ((bParam0 == -222563712 || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || bParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_275(bParam0) < func_276(bParam0))
					{
						func_128(43, bParam0, iParam1, -2087881550, iVar1, 0, -1, 0);
		...
		else if (func_131(bParam0, -1478961327))
		{
			...
			if (func_273() == 2)
			{
				...
				if (bParam0 == 2116770557)
				{
					...
					if (func_275(bParam0) < func_276(bParam0))
					{
						func_128(43, bParam0, iParam1, 1908068621, iVar1, 0, -1, 0);
		...
		else if (func_131(bParam0, -1238404098))
		{
			...
			if (func_273() == 3)
			{
				...
				if (((bParam0 == 2085530337 || bParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || bParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_275(bParam0) < func_276(bParam0))
					{
						func_128(43, bParam0, iParam1, 1611247019, iVar1, 0, -1, 0);
		...
		else if (func_131(bParam0, 1160548794))
		{
			...
			if (func_273() == 4)
			{
				...
				if (((bParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || bParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || bParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_275(bParam0) < func_276(bParam0))
					{
						func_128(43, bParam0, iParam1, 1319635688, iVar1, 0, -1, 0);
...
void func_160(bool bParam0, int iParam1, int iParam2)
{
	...
	switch (bParam0)
	{
		case 489075255: /* GXTEntry: "$1.00" */
			func_151(-949580860, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1394529493: /* GXTEntry: "$5.00" */
			func_151(-1171997683, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1262623627: /* GXTEntry: "$10.00" */
			func_151(-2140931002, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case 675090918: /* GXTEntry: "Coin Sack" */
			func_151(-1531790128, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case joaat("money_coinstack"):
			func_151(1351791770, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		...
		case -1243851340: /* GXTEntry: "Money Pile" */
			if (!func_281())
			{
				func_151(1330954593, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			}
			break;
		case -525490740: /* GXTEntry: "Change Cup" */
			func_151(817681514, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case -1736635264: /* GXTEntry: "Coin Cup" */
			func_151(1404311868, 0, 1065353216 /* Float: 1f */, 1, 0, 0, iParam1 == -897553835, -1);
			break;
		case 1302860970: /* GXTEntry: "$50.00" */
			func_151(-175152067, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1027115192: /* GXTEntry: "$100.00" */
			func_151(-526915387, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1064332555: /* GXTEntry: "$200.00" */
			func_151(101362741, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1954478446: /* GXTEntry: "$45.00" */
			func_151(1458818027, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -518592739: /* GXTEntry: "$50.00" */
			func_151(-1957208512, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -2010073778: /* GXTEntry: "$70.00" */
			func_151(2066857461, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -700133011: /* GXTEntry: "$100.00" */
			func_151(803940201, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case -1415414735: /* GXTEntry: "$120.00" */
			func_151(-1717765429, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 2045548742: /* GXTEntry: "$150.00" */
			func_151(1379920914, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
		case 830381058: /* GXTEntry: "$350.00" */
			func_151(447209691, 0, 1065353216 /* Float: 1f */, 1, 0, 0, 0, -1);
			break;
	}
}
...
void func_177(bool bParam0)
{
	...
	if ((bParam0 == 899611344 || bParam0 == -1515874150) || bParam0 == joaat("UPGRADE_OFFHAND_HOLSTER"))
	{
		...
		{
			func_163(Global_35, bParam0, 0, 99217379, 1, 1, 1, 0, 1, 1);
		}
		func_134(24);
		if (func_164(&bVar2, 0))
		{
...
void func_183(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((bParam1 == 1 || func_131(bParam0, 1443104131)) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || bParam0 == -1424823393) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_185(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bVar1 > 0)
	{
		...
		func_27(func_311(1644987397), bVar1);
	}
}
		...
		case 24:
			...
			if (func_66() == -1)
			{
				if (!func_307(99217379) || func_372(99217379) == 2110595215)
				{
					...
					func_163(Global_35, bVar0, 0, 99217379, 1, 1, 1, 0, 1, 1);
				}
			}
			break;
		case 48:
...
void func_245(bool bParam0, bool bParam1)
{
	...
	{
		iVar1 = func_376(WEAPON::_0xD3750CCC00635FC2(bParam0), bParam1);
...
void func_458(int iParam0, int iParam1, int iParam2)
{
	...
	func_71(sVar7, sVar1, iVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_525(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
