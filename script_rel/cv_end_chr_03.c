...
int func_72(var uParam0)
{
	...
	uLocal_18 = func_159(uParam0, -0.31f, 9.12f, 0f, 0f, 0f, 0f, 10f, 10f, 5f, "volTrigger", joaat("VOLBOX"));
	func_160(uParam0, 1);
...
int func_425(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_284(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_426(bool bParam0, int iParam1)
{
	...
	func_379(bParam0, func_456(iParam1));
