...
int func_83(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_136(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_137(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_99()
{
	...
	if (INVENTORY::_0x3D10D7179D7034AF(func_143(0), iVar0, false))
	{
		return 0;
	}
...
int func_104(bool bParam0, var uParam1)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
int func_133(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_128(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(bVar0) == Global_35)
		{
			return 0;
		}
	}
...
int func_179(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_143(bParam2), iParam0, 0);
	return iVar2;
}
...
int func_214(var uParam0, var uParam1, int iParam2, bool bParam3)
{
	*uParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_143(bParam3), uParam0, iParam2);
	if (*uParam1 >= 0)
	{
		return 1;
	}
