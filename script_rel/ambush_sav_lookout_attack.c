...
int func_20()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			...
			WEAPON::REMOVE_ALL_PED_WEAPONS(&(iLocal_15[iVar0]), true, true);
			if (func_61(&(iLocal_15[iVar0]), 0, 0))
			{
			...
			switch (iVar0)
			{
				case 0:
					...
					func_130(&(iLocal_15[iVar0]), &iVar1, 0, 0, 1, 1);
					func_127(&(iLocal_15[iVar0]), joaat("WEAPON_BOW"), -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				case 1:
					Var2 = { func_131(&Local_274, iVar0) };
					func_127(&(iLocal_15[iVar0]), joaat("GROUP_REPEATER"), -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					func_129(&(iLocal_15[iVar0]), joaat("WORLD_HUMAN_SMOKE"), Var2, Var2.f_3, -1, 1, 1, 0, -1082130432 /* Float: -1f */);
					break;
				case 2:
					func_127(&(iLocal_15[iVar0]), joaat("GROUP_REVOLVER"), -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					func_132(&(iLocal_15[iVar0]), &(iLocal_15.f_40[iVar0]), 0, -1, 1);
					break;
				case 3:
					func_127(&(iLocal_15[iVar0]), joaat("GROUP_REPEATER"), -1, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					func_132(&(iLocal_15[iVar0]), &(iLocal_15.f_40[iVar0]), 0, -1, 1);
	...
	switch (Local_274.f_4)
	{
		case 0:
			...
			else if (func_146())
			{
				...
				{
					func_147(&(iLocal_15[0]), Global_36, 3, 1, 1);
					...
					func_130(&(iLocal_15[0]), &iVar0, 0, 0, 1, 1);
				}
				func_25(&iLocal_15, 1);
				func_32(&iLocal_15, 1);
				func_148();
...
int func_31()
{
	...
	Local_274.f_35 = func_163(&iLocal_15);
	func_149();
	func_164();
	iVar0 = 0;
	while (iVar0 < iLocal_15.f_215)
	...
	switch (Local_274.f_5)
	{
		...
		case 1:
			if (func_47(Local_274.f_8[0 /*3*/], 5f) || Local_274.f_35 <= 2)
			{
				...
				{
					func_167(&(iLocal_15[0]));
					PED::SET_PED_COMBAT_RANGE(&(iLocal_15[0]), 0);
					PED::SET_PED_COMBAT_MOVEMENT(&(iLocal_15[0]), 2);
					PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_15[0]), 98, true);
				}
		...
		case 2:
			if (Local_274.f_35 <= 1)
			{
				Local_274.f_37 = func_168(&iLocal_15);
				func_169();
				func_170();
...
int func_42()
{
	if (func_47(&(iLocal_15.f_244), 45f) && func_192())
	{
		func_54(&iLocal_15);
		func_193(&(iLocal_15.f_244));
	}
	return 0;
}
...
void func_49()
{
	...
	while (iVar0 <= 4)
	{
		(iLocal_15.f_118[iVar0 /*4*/])->f_1 = { func_195(&Local_274, iVar0) };
		iVar0++;
	}
	func_196(&iLocal_15, 110, 1065353216 /* Float: 1f */);
}
			...
			else
			{
				if (func_61(&(iLocal_15[iVar0]), 0, 0))
				{
					...
					else if ((iLocal_15.f_215 == iLocal_15.f_216 && func_61(&(iLocal_15.f_40[iVar0]), 0, 1)) && !PED::IS_PED_IN_ANY_VEHICLE(&(iLocal_15[iVar0]), true))
					{
						...
						func_130(&(iLocal_15[iVar0]), &iVar12, 0, 0, 1, 1);
						PED::SET_PED_KEEP_TASK(&(iLocal_15[iVar0]), true);
					}
					else
					{
...
int func_92(int iParam0)
{
	if (&iLocal_15.f_57[iParam0] == 0)
	{
		...
		{
			iLocal_15.f_57[iParam0] = func_252(joaat("HORSE_CLASS_RIDING"), 1);
		}
		else
		{
			iLocal_15.f_57[iParam0] = func_253(iLocal_15.f_181, 0, 1);
		}
	}
...
int func_93(int iParam0)
{
	if (&iLocal_15.f_75[iParam0] == 0)
	{
		...
		{
			iLocal_15.f_75[iParam0] = func_254(iLocal_15.f_181, iParam0, 0);
		}
		else
		{
...
int func_137()
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_15.f_40[Local_274.f_34])))
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(&(iLocal_15.f_40[Local_274.f_34]), Global_35, 1, 1))
		{
			return 1;
		}
	}
	if (Local_274.f_34 <= 1)
	{
		if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(&(iLocal_15[Local_274.f_34]), Global_35, 1, 1))
		{
			return 1;
		}
	}
	if (func_273(&iLocal_15, &(iLocal_15.f_152), &(iLocal_15.f_180), &(Local_274.f_34), 0, 4, 1))
	{
		return 1;
	}
	return 0;
...
void func_138()
{
	...
	if (!func_61(iLocal_15.f_56, 0, 0))
	{
		iLocal_15.f_56 = func_274(&iLocal_15, 0);
		if (func_61(iLocal_15.f_56, 0, 0))
		{
			iVar0 = func_275(iLocal_15.f_181);
...
void func_139()
{
	...
	while (iVar0 < iLocal_15.f_215)
	{
		...
		{
			PED::_0x7DE9692C6F64CFE8(&(iLocal_15[iVar0]), false, 0, 0);
			func_147(&(iLocal_15[iVar0]), Global_36, 3, 0, 3);
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_130(&(iLocal_15[iVar0]), &iVar1, 0.1f, 0.3f, 1, 1);
			if (!func_136(&Local_274, 1024))
			{
				func_276(&(iLocal_15[iVar0]), Global_35, "GENERIC_FRIGHTENED_HIGH", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
...
int func_144()
{
	...
	if (!func_278(&(Local_274.f_27[2]), Global_36))
	{
		if (func_278(&(Local_274.f_27[1]), Global_36))
		{
			...
			{
				func_279(&iLocal_15, 7);
				func_172(&Local_274, 8192);
				return 1;
			}
		}
	}
	if (func_280(&iLocal_15))
	{
		func_172(&Local_274, 8192);
		return 1;
	}
...
void func_148()
{
	...
	func_79(&(iLocal_15.f_152), 1);
	func_281(&(iLocal_15.f_152), 1);
	func_282(&(iLocal_15.f_152), 1);
	func_236(&(iLocal_15.f_152), 1);
	func_283(&(iLocal_15.f_152), 1);
...
void func_149()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 1))
		{
			...
			{
				if (PED::IS_PED_SHOOTING(&(iLocal_15[iVar0])) || func_222(&(iLocal_15[iVar0]), 50f, 10f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					func_284(&(iLocal_15[iVar0]), iLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
				}
			}
		}
		iVar0++;
...
int func_150()
{
	switch (Local_274.f_6)
	{
		...
		case 1:
			...
			{
				func_276(&(iLocal_15[0]), Global_35, "ARRIVAL_COMBAT_NEUTRAL", -1073741824 /* Float: -2f */, 1, -500314840, 1);
				func_285(&Local_274, 2);
			}
			break;
		case 2:
			if (func_286(0, 1, &(iLocal_15[0]), 1))
			{
				func_276(&(iLocal_15[0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824 /* Float: -2f */, 1, -500314840, 2);
...
void func_164()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			if (MAP::DOES_BLIP_EXIST(&(iLocal_15.f_22[iVar0])))
			{
				func_276(&(iLocal_15[iVar0]), Global_35, "ARRIVAL_COMBAT_RAID_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, -1);
...
void func_169()
{
	if (PED::IS_PED_ON_MOUNT(&(iLocal_15[Local_274.f_37])))
	{
		PED::_0x1854217C640B39EC(&(iLocal_15[Local_274.f_37]), Global_35, 0f, 0f, 0f, 12f, 0, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_15[Local_274.f_37]), 51, true);
	}
	else
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_15[Local_274.f_37]), 51, false);
		PED::_0x1854217C640B39EC(&(iLocal_15[Local_274.f_37]), Global_35, 0f, 0f, 0f, 8f, 0, 0);
	}
	PED::SET_PED_COMBAT_RANGE(&(iLocal_15[Local_274.f_37]), 0);
}
...
int func_171()
{
	...
	if ((&iLocal_15.f_9[Local_274.f_37] > 18f || PED::IS_PED_ON_MOUNT(&(iLocal_15[Local_274.f_37]))) || PED::IS_PED_ON_MOUNT(Global_35))
	{
		return 0;
	}
	if (WEAPON::_0xF29A186ED428B552(&(iLocal_15[Local_274.f_37]), joaat("WEAPON_MELEE_KNIFE")))
	{
		iVar0 = joaat("WEAPON_MELEE_KNIFE");
	}
	else if (WEAPON::_0xF29A186ED428B552(&(iLocal_15[Local_274.f_37]), joaat("WEAPON_MELEE_HATCHET_MELEEONLY")))
	{
	...
	WEAPON::SET_CURRENT_PED_WEAPON(&(iLocal_15[Local_274.f_37]), iVar0, false, 0, false, false);
	TASK::TASK_SWAP_WEAPON(&(iLocal_15[Local_274.f_37]), 1, 1, 0, 0);
	TASK::OPEN_SEQUENCE_TASK(&iVar1);
	TASK::TASK_MELEE(0, Global_35, 0, 1, 1, 2f, 1, -1082130432);
	func_130(&(iLocal_15[Local_274.f_37]), &iVar1, 0, 0, 1, 1);
	return 1;
}
...
int func_173()
{
	...
	if ((PED::IS_PED_ON_MOUNT(&(iLocal_15[Local_274.f_37])) || PED::IS_PED_ON_MOUNT(Global_35)) || &iLocal_15.f_9[Local_274.f_37] > 30f)
	{
		iVar0 = WEAPON::GET_BEST_PED_WEAPON(&(iLocal_15[Local_274.f_37]), false, false);
		if (!WEAPON::IS_WEAPON_VALID(iVar0))
		{
			return 0;
		}
...
int func_188(int iParam0)
{
	...
	{
		fVar0 = func_194(&(iLocal_15.f_247));
...
int func_198(int iParam0)
{
	...
	if (func_327(&iLocal_15, &(iLocal_15[iParam0])))
	{
		return 1;
	}
...
int func_202(int iParam0, int iParam1)
{
	...
	if (func_343(&(iLocal_15.f_40[iParam0]), iParam1))
	{
		return 1;
	}
	if (func_327(&iLocal_15, &(iLocal_15.f_40[iParam0])))
	{
		return 1;
	}
...
int func_203(int iParam0)
{
	...
	if (func_345(&(iLocal_15.f_84[iParam0]), fVar0))
	{
		return 0;
	}
	if (func_190(&(iLocal_15.f_84[iParam0]), Global_36, 1) < 10f)
	{
		return 0;
	}
	return 1;
...
int func_204(int iParam0)
{
	...
	if (func_329(&iLocal_15, &(iLocal_15.f_49[iParam0])))
	{
		return 1;
	}
...
void func_251(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return;
...
int func_273(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_287()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(iLocal_15[iVar0]), 0, 0))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
			func_130(&(iLocal_15[iVar0]), &iVar1, fVar2, 0, 1, 1);
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(iLocal_15[iVar0]), vVar3, 5f, 0, false, 0);
...
void func_288()
{
	...
	while (iVar3 <= 1)
	{
		if (func_61(&(iLocal_15[iVar3]), 0, 0))
		{
			...
			switch (iVar3)
			{
				case 0:
					...
					TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
					func_130(&(iLocal_15[iVar3]), &iVar4, fVar5, 0, 1, 1);
					PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(iLocal_15[iVar3]), vVar0, 3f, 1, false, 0);
					break;
				case 1:
					if (func_61(&(iLocal_15.f_40[iVar3]), 0, 0))
					{
						func_147(&(iLocal_15[iVar3]), Global_36, 3, 0, 3);
						TASK::OPEN_SEQUENCE_TASK(&iVar4);
						if (!PED::IS_PED_ON_MOUNT(&(iLocal_15[iVar3])))
						{
							TASK::TASK_MOUNT_ANIMAL(0, &(iLocal_15.f_40[iVar3]), 20000, -1, 2f, 1, 0, 0);
						}
						TASK::TASK_COMBAT_PED(0, Global_35, 0, 0);
						func_130(&(iLocal_15[iVar3]), &iVar4, 0, 0, 1, 1);
					}
					break;
			}
		}
...
bool func_299(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_397(iParam0, joaat("currency_cash"), iParam1, uVar0);
	}
...
{
	iParam0->f_238 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(iParam0->f_209, 0f, 0f, 0f, 60f, 60f, 40f, "volAvoidance");
...
int func_361(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
		...
		while (iVar28 < 4)
		{
			...
			if (func_421(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_425(0))
				{
					...
					func_426(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
int func_387(int iParam0)
{
	if (!func_30(iParam0, 262144))
	{
		if (iParam0->f_20 < 60f)
		{
			if (func_489(iParam0, 60f, iParam0->f_239))
			{
				return 1;
			}
		}
...
int func_388(int iParam0)
{
	if (!func_30(iParam0, 524288))
	{
		if (iParam0->f_20 < 60f)
		{
			if (func_490(iParam0, 60f, iParam0->f_239))
			{
				return 1;
			}
		}
...
struct<5> func_419(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
...
void func_427(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_380(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
...
bool func_489(int iParam0, float fParam1, int iParam2)
{
	...
	return func_592(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584 /* Float: 5f */, bVar6, iParam2);
}
...
int func_490(int iParam0, float fParam1, int iParam2)
{
	...
	{
		iVar18 = func_594(&uVar0, &uVar6, 5, iParam0->f_209, fParam1);
	}
	iVar16 = 0;
	while (iVar16 < iVar18)
	{
		...
		if (iVar27 != 0 && iVar27 != Global_35)
		{
			...
			if (!func_69(vVar21))
			{
				...
				{
					if (func_351(vVar21, vVar24, 5f, 0) && PED::IS_PED_HEADING_TOWARDS_POSITION(iVar27, iParam0->f_209, 40f))
					{
						iVar19 = 1;
						iVar20 = 1;
					}
...
int func_526(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
