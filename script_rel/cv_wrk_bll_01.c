...
int func_72(var uParam0)
{
	...
	func_153(uParam0, 3.975f, -3.15f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	func_153(uParam0, -1.475f, -3.4875f, 0.85f, 0f, 1f, 1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_153(uParam0, -0.2875f, 0.025f, 0.85f, 0f, 3.285f, 1.9625f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	...
	func_155(uParam0, "script@vignette@WRK@bill_work_1@base", 1, 1, 0, 0);
	iLocal_17 = func_155(uParam0, "script@vignette@WRK@bill_work_1@action_a", 2, 0, 1, 0);
	iLocal_18 = func_155(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Front", 2, 0, 0, 1);
	iLocal_19 = func_155(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Left", 2, 0, 0, 1);
	iLocal_20 = func_155(uParam0, "script@vignette@WRK@bill_work_1@Action_A_Int_Right", 2, 0, 0, 1);
	iLocal_21 = func_155(uParam0, "script@vignette@WRK@bill_work_1@action_b", 0, 0, 0, 0);
	...
	func_160(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_161(uParam0, iLocal_14, iLocal_16, "p_cs_rag02x_PH_R_HAND", 0, 0);
	Local_22 = { func_162(uParam0, -0.6925f, 0.248f, 1.38f, 123.12f, 7.5f, 0.2025f, 0.7995f) };
	Local_32 = { func_162(uParam0, -0.693f, 0.248f, 1.38f, -169.56f, 7.5f, 0.265f, 0.545f) };
	Local_42 = { func_162(uParam0, -0.693f, 0.248f, 1.38f, 0.09f, 7.5f, 0.567f, 0.2125f) };
	return 1;
}
...
void func_251(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	uParam0->f_23 = { func_326(iParam1) + Vector(fParam4, fParam3, fParam2) };
...
int func_277(var uParam0, int iParam1, vector3 vParam2)
{
	...
	if (func_298(uParam0) == 3 || func_298(uParam0) == 8)
	{
...
int func_390(int iParam0, bool bParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, bool bParam9, int iParam10)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_70.f_12)
	{
		...
		case 3:
			...
			sVar12 = func_425(iParam0, func_282());
