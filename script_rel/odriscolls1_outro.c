...
void func_27(bool bParam0)
{
	...
	while (iVar0 < 27)
	{
		if (func_12(iVar0))
		{
			...
			{
				AUDIO::STOP_PED_SPEAKING(bVar1, bParam0);
			}
		}
		iVar0++;
	}
...
void func_64(int iParam0)
{
	...
	bVar0 = func_57(iParam0);
	iVar1 = func_35(iParam0, 0);
	func_83(iParam0, bVar0);
	if (ENTITY::DOES_ENTITY_EXIST(bVar0))
	{
...
int func_68(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_34(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_84(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
float func_84(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_116(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_95(int iParam0, float fParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	if (!MAP::DOES_BLIP_EXIST(((*Global_1835011)[iParam0 /*74*/])->f_27))
	{
		...
		if (func_128(iParam0, iVar0) && !bVar3)
		{
			if (bParam3 || func_129((*Global_1835011)[iParam0 /*74*/], 2))
			{
				if (func_130(iParam0))
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_131(iParam0));
					bVar2 = true;
				}
				else
				{
					((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_132(iParam0));
				}
			}
			...
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_RADIUS(joaat("BLIP_STYLE_MISSION"), func_135(iParam0), func_136(iParam0));
			}
		}
		else if (bVar3)
		{
			if (!func_130(iParam0))
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_94(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_131(iParam0));
		...
		else if (func_93(iParam0))
		{
			if (iParam0 == 7)
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_RCM"), func_132(iParam0));
			}
			else
			{
				((*Global_1835011)[iParam0 /*74*/])->f_27 = MAP::_BLIP_ADD_FOR_COORD(joaat("BLIP_STYLE_MISSION"), func_132(iParam0));
	...
	if (((((((func_124(&(((*Global_1835011)[iParam0 /*74*/])->f_29), 4096) && !func_124(&(((*Global_1835011)[iParam0 /*74*/])->f_29), 8192)) && IntToFloat(func_127()) >= 10f) && !Global_1935630->f_12) && !Global_16) && !func_147(Global_35, joaat("PROP_PLAYER_SLEEP_TENT_A_FRAME"))) && !PED::_0x34D6AC1157C8226C(Global_35, joaat("PROP_PLAYER_SLEEP_BED"))) && !PED::_0x34D6AC1157C8226C(Global_35, joaat("WORLD_PLAYER_SLEEP_BEDROLL")))
	{
...
int func_100(int iParam0, bool bParam1, bool bParam2)
{
	...
	while (iVar1 < 27)
	{
		...
		{
			bVar2 = func_57(func_154(iParam0));
...
int func_109(bool bParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	float fVar0;
	...
	{
		fVar0 = func_160(bParam0, Global_36, 1);
	}
	if (fParam2 > 0f)
	{
		if (fVar0 < fParam2)
...
float func_160(bool bParam0, vector3 vParam1, bool bParam4)
{
	if (!ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		return 0f;
