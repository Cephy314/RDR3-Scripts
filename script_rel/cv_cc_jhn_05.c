...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.225f, -0.0125f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, -1612834106, joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_151(uParam0, 7.215f, 7.4175f, 0.85f, -65.75f, 1f, 1f, 3.2075f, -1612834106, joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	...
	func_159(uParam0, -1416957568, 1575789792);
...
int func_431(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_463(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_334(747937920, 1) && !func_401(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_494(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_511(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
