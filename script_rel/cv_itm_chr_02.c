...
int func_94(var uParam0)
{
	...
	func_174(uParam0, iLocal_14, 3, 665864199, "PROP_CAMP_CHARLES_SEAT_CHAIR_ARROW_FLETCH_MALE_A", iLocal_19, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	*uParam0 = iParam1;
	...
	switch (iParam1)
	{
		case 1:
			...
			uParam0->f_22 = func_369(-1780177928 /* GXTEntry: "Revolver Cartridges - High Velocity" */);
...
void func_318(int iParam0)
{
	...
	{
		case 9:
			if (func_370(1427759409 /* GXTEntry: "Thimble" */, 0, 0) < 1)
			{
				func_371();
...
void func_319(var uParam0)
{
	...
	if (!UILOG::_UILOG_IS_ENTRY_REGISTERED(9, iVar0))
	{
		...
		if (*uParam0 == 21)
		{
			...
			func_378(5, 0, -998653403 /* GXTEntry: "Skunk" */);
			iVar3 = 0;
			while (iVar3 < 6)
			{
				if (iVar3 == 0)
