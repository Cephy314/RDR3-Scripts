...
int func_1(var uParam0)
{
	if (!bLocal_43)
	{
		if (uParam0->f_9 && TASK::_0x841475AC96E794D1((uParam0->f_107[iLocal_14 /*113*/])->f_8.f_23))
		{
...
int func_337()
{
	if (PED::_0xA911EE21EDF69DAF(Global_35) || func_391(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_489(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_0x1902C4CFCC5BE57C(bParam1, func_522(iParam0));
	PED::_0xCC8CA3E88256E58F(bParam1, false, true, true, true, false);
...
void func_490(bool bParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_129(iParam1), bParam0, 0);
