...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_51(uParam0, 0, "MPDHP_HORSE", iLocal_70, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MPDHP_MAN", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 0f), (10f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (*uParam0 != 71)
	{
...
void func_51(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_75(int iParam0, int iParam1)
{
	...
	if (ENTITY::_0x9A100F1CF4546629(iParam1) || ENTITY::_IS_ENTITY_A_BIRD(iParam1))
	{
...
void func_218(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_162((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
bool func_220(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
...
struct<5> func_222(int iParam0)
{
	...
	Var0 = { func_223(iParam0, joaat("CHARACTER"), func_253(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}
