...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.9875f, 0.2625f, 0.832f, 87.12f, 2f, 4.45f, 2.135f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -3.775f, -1.1375f, 0.8945f, 80f, 1f, 1f, 2.2325f, -1612834106, joaat("APMS_COMP_LENNY"), 1, 1, 1);
	func_152(uParam0, -1.04f, 0.88f, 0.9787f, 0f, 0.8f, 0.8f, 2.2325f, 665633627, 1);
	...
	func_154(uParam0, "script@vignette@dutch_and_lenny_2@base", 1, 1, 0, 0);
	func_154(uParam0, "script@vignette@dutch_and_lenny_2@action", 0, 0, 1, 0);
	func_155(uParam0, "CDNL2AU");
	func_156(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0);
	func_157(uParam0, iLocal_14, 3, -787460071, "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_158(uParam0, iLocal_14, iLocal_16, "p_cs_bookEvelynMiller_PH_R_HAND", 0, 0);
	func_159(uParam0, iLocal_15, 1, -1);
	func_160(uParam0, 662616452, -1608850330);
	return 1;
}
