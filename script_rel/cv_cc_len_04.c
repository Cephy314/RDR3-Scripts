...
int func_72(var uParam0)
{
	...
	uLocal_16 = func_153(uParam0, "script@vignette@lenny_4@action", 0, 0, 1, 0);
	func_154(uParam0, "CLEN4AU");
	func_155(uParam0, iLocal_14, 1, joaat("WORLD_HUMAN_COFFEE_DRINK"), 0, -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_160(uParam0, uLocal_16, -1, 0.92f);
	return 1;
}
