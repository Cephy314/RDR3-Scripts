...
{
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_HUMAN_CROUCH_INSPECT"), 0))
	{
		return 0;
	}
	return 1;
...
{
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_HUMAN_CROUCH_INSPECT"), 5, 0, joaat("WORLD_HUMAN_CROUCH_INSPECT_MALE_C"));
	func_57(&uLocal_9, 0);
	func_58(&uLocal_9, 1);
	func_59(&uLocal_9, 1);
	func_60(&uLocal_9, 1);
