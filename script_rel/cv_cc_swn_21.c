...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -5.57f, -1.6425f, 0f, 0f, 1.265f, 1.325f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_150(uParam0, -1.081f, -0.2975f, 0f, -5.25f, 1.805f, 1.47f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	...
	func_159(uParam0, iLocal_15, 2, joaat("WORLD_HUMAN_SIT_FALL_ASLEEP"), "WORLD_HUMAN_SIT_GROUND_TIRED_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	return 1;
}
