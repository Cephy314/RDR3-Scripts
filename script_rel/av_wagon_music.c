...
void __EntryFunction__()
{
	...
	iLocal_43 = joaat("PG_VEH_WAGON02X_1");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 10973, 11038, 11782);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (iLocal_45)
	{
		case 0:
			...
			break;
		case 1:
			iLocal_43 = joaat("PG_VEH_WAGON02X_2");
			break;
		case 2:
			iLocal_43 = joaat("PG_VEH_WAGON02X_3");
			break;
	}
	iVar0 = func_48(func_47(), 1, 0, 1, 1, 0, 0);
	func_49(uParam0, 0, "WBPP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_49(uParam0, 1, "WBPP_MAN_2", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	...
	func_50(uParam0, "WAGON", iLocal_38, vParam1, vParam4.z, 0, 0, 0, 0);
}
...
{
	if (!PROPSET::_HAS_PROPSET_LOADED(iLocal_43))
	{
		return 0;
	}
	return 1;
...
int func_28(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
	{
		...
		VEHICLE::_0x8268B098F6FCA4E2(uParam0->f_453, 0);
...
{
	PROPSET::_REQUEST_PROPSET(iLocal_43);
	func_58(&uLocal_10, 0);
	func_59(&uLocal_10, 1);
	func_60(&uLocal_10, 1);
	func_61(&uLocal_10, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (func_65(uParam0, &uLocal_10, 0))
		{
			uParam0->f_469[1] = 1;
		}
		if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_453))
			...
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					switch (uParam0->f_489)
					{
						case 0:
						case 1:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), joaat("WAGON_PASSENGER_TRANS_HARMONICA"), 10f);
							break;
						case 2:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), joaat("WAGON_PASSENGER_TRANS_WHISTLING"), 10f);
							break;
						case 3:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), joaat("WAGON_PASSENGER_TRANS_JAWHARP"), 10f);
							break;
					}
				}
				func_68(&uLocal_40);
...
int func_32(var uParam0, var uParam1)
{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				if (!&uParam0->f_469[1])
				{
					if (iVar0 == 0)
					{
						if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_70(&(uParam0->f_20[iVar0 /*14*/]), -258271821))
							{
	...
	if (PROPSET::_DOES_PROPSET_EXIST(iLocal_47))
	{
		PROPSET::_SET_PROPSET_AS_NO_LONGER_NEEDED(iLocal_47);
	}
	return 1;
}
...
int func_178(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
