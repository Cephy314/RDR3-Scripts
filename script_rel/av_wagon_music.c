...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	switch (iLocal_45)
	{
		case 0:
			...
			break;
		case 1:
			iLocal_43 = -1575627109;
			break;
		case 2:
			iLocal_43 = -1421219581;
			break;
	}
	iVar0 = func_48(func_47(), 1, 0, 1, 1, 0, 0);
	func_49(uParam0, 0, "WBPP_MAN_1", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 1, "WBPP_MAN_2", iVar0, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -3f, 0f, 0f), vParam4.z, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 2, "WBPP_HORSE_1", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
	func_49(uParam0, 3, "WBPP_HORSE_2", 0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
			...
			if (func_69(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					switch (uParam0->f_489)
					{
						case 0:
						case 1:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), 281391541, 10f);
							break;
						case 2:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), -953151892, 10f);
							break;
						case 3:
							PED::_0xD65FDC686A031C83(&(uParam0->f_20[1 /*14*/]), 290320544, 10f);
							break;
					}
				}
				func_68(&uLocal_40);
