		...
		case 10:
			...
			else if (*uParam0 == 464413478)
			{
				...
				if (&iLocal_55[2])
				{
					if (!func_48(*uParam0))
					{
						if (ENTITY::DOES_ENTITY_EXIST(&(Local_66[1])) && PED::_GET_CARRIER_AS_PED(&(Local_66[1])) == Global_35)
						{
							func_68(uParam0);
							func_69(uParam0);
							func_49(&iLocal_62, 13, 1);
			...
			else if (*uParam0 == 733338689)
			{
				...
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(Local_66[0])) && PED::_GET_CARRIER_AS_PED(&(Local_66[0])) == Global_35)
					{
			...
			else if (*uParam0 == 2135153015)
			{
				if (!func_39(Global_40.f_8863.f_149, 1024))
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(Local_66[0])) && PED::_GET_CARRIER_AS_PED(&(Local_66[0])) == Global_35)
					{
						...
						func_73(func_72(uParam0), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
						if (TASK::_DOES_SCENARIO_POINT_EXIST(&(iLocal_47[0])) && !TASK::_0x0CC36D4156006509(&(iLocal_47[0])))
						{
			...
			else if (ENTITY::DOES_ENTITY_EXIST(&(Local_66[0])) && PED::_GET_CARRIER_AS_PED(&(Local_66[0])) == Global_35)
			{
				func_73(func_72(uParam0), 1, 0, 0, 0, 752097756, 0, 0, 0, 0);
				func_68(uParam0);
				func_69(uParam0);
		...
		case 11:
			...
			else if (*uParam0 == 247563739)
			{
				...
				if (TASK::_DOES_SCENARIO_POINT_EXIST(&(iLocal_47[0])))
				{
					...
					else if (((TASK::_DOES_SCENARIO_POINT_EXIST(&(iLocal_47[0])) && !PED::_0x9C54041BB66BCF9E(Global_35, &(iLocal_47[0]))) && !TASK::IS_PED_ACTIVE_IN_SCENARIO(Global_35, 0)) && func_11(*uParam0, 16))
					{
						func_68(uParam0);
						func_69(uParam0);
						func_49(&iLocal_62, 13, 1);
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(Local_66[0])))
		{
			...
			if (*uParam0 == -780455182)
			{
				if (!func_160(uParam0, 0) == -1)
				{
					...
					{
						OBJECT::_SET_APPLY_OBJECT_TXD(&(Local_66[0]), func_160(uParam0, 0), 0, 0);
					}
				}
			}
		}
		...
		if (func_183(iParam0))
		{
			...
			if (func_133() && func_192(4))
			{
				if (!Global_1914319->f_17376)
				{
					if (func_133() && (func_193(38) || func_188(38)))
					{
						func_197(38, COLLECTION::_0x13AAECDA43318BFE(joaat("CIGARETTE_CARDS"), iVar6), COLLECTION::_0xD52D20B0C76BB26D(joaat("CIGARETTE_CARDS"), iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
...
int func_250()
{
	...
	return func_334(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("CIGARETTE_CARDS"), 0));
}
...
void func_353(int iParam0)
{
	...
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_349("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), -2, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
void func_599(int iParam0, int iParam1, int iParam2)
{
	...
	func_280(sVar7, sVar1, iVar8, iVar9, joaat("STATS_MENU"), "INPUT_FEED_INTERACT_GENERIC", func_662(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
