			...
			if (func_58(Global_35, func_53(uParam0, 0), 75f, 1, 1))
			{
				if (func_164(uParam0, uLocal_52[0], &Local_66, 0, 11))
				{
					if (!ENTITY::IS_ENTITY_DEAD(&(Local_66[0])))
					{
						...
						if (!ENTITY::IS_ENTITY_DEAD(&(Local_66[1])))
						{
							ENTITY::ATTACH_ENTITY_TO_ENTITY(&(Local_66[1]), &(Local_66[0]), ENTITY::GET_ENTITY_BONE_INDEX_BY_NAME(&(Local_66[0]), "disWiskeyTreeBottle1"), 0f, 0f, -0.265f, 0f, 0f, 0f, true, true, false, false, 2, true, false, false);
							TASK::_0x78B4567E18B54480(&(Local_66[1]));
	...
	if (!bVar3)
	{
		...
		switch (iParam0)
		{
			...
			case joaat("UPGRADE_OFFHAND_HOLSTER"):
				...
				{
					func_231(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 99217379, 1, 1, 1, 0, 1, 0);
				}
				if (func_232(&iVar9, 0))
				{
			...
			case joaat("UPGRADE_BANDOLIER"):
				...
				{
					func_231(PLAYER::PLAYER_PED_ID(), joaat("UPGRADE_BANDOLIER"), 0, 673166414, 1, 1, 1, 0, 1, 0);
				}
				break;
...
void func_100(char* sParam0)
{
	...
	func_280(MISC::_CREATE_VAR_STRING(2, "DISCO_DREAM"), sParam0, joaat("hud_toasts"), -1316482209, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, "COL_CTX_PLAYER_LOG"), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
int func_117(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, bool bParam10, int iParam11, bool bParam12, int iParam13, int iParam14, bool bParam15, bool bParam16)
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < 48)
	{
		if (func_296(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_297(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, bParam10, iParam11, bParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, iParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
int func_131()
{
	...
	if (INVENTORY::_0x3D10D7179D7034AF(func_300(0), iVar0, false))
	{
		return 0;
	}
...
int func_136(bool bParam0, var uParam1)
{
	vector3 vVar0;
	vector3 vVar3;
	vector3 vVar6;
...
void func_157(var uParam0)
{
	...
	{
		case -1427565340:
			Local_66.f_6[0] = joaat("s_urndiscoverable01x");
			Local_66.f_6[1] = joaat("s_shrunkenhead01x");
			break;
		case -1859413640:
			Local_66.f_6[0] = joaat("s_inv_whiskey01x");
		...
		case -780455182:
			...
			break;
		case 1335921989:
			Local_66.f_6[0] = joaat("p_foldedbillssmall01x");
			break;
		case 2135153015:
			Local_66.f_6[1] = joaat("p_cs_rt_envelope01x");
			break;
		case -709811179:
			Local_66.f_6[0] = joaat("s_meteoriteshard01x");
			break;
		case -1061274876:
		...
		case 513110082:
			switch (uParam0->f_4)
			{
				...
				case 1:
					...
					break;
				case 2:
					Local_66.f_6[0] = joaat("p_cs_photonudie01x_4x6");
					Local_66.f_6[1] = joaat("p_cs_photonudie02x_4x6");
					Local_66.f_6[2] = joaat("p_cs_photonudie03x_4x6");
					Local_66.f_6[3] = joaat("p_cs_photonudie04x_4x6");
					Local_66.f_6[4] = joaat("p_cs_photonudie05x_4x6");
					break;
			}
			break;
		case 464413478:
			Local_66.f_6[0] = joaat("p_diswiskeytreebottlewind01x");
			Local_66.f_6[1] = joaat("p_goldnugget01x");
			break;
		case 373034311:
			Local_66.f_6[0] = joaat("p_ancientarrowhead02x");
			break;
		case 1284679164:
			...
			break;
		case -1494823099:
			Local_66.f_6[0] = joaat("s_jewlerybox_sm_plain01x");
			Local_66.f_6[1] = joaat("s_jewlerybox_lrg_plain01x");
			break;
		case 118535038:
			Local_66.f_6[0] = joaat("p_cs_newsclip01x");
			...
			break;
		case 247563739:
			Local_66.f_6[0] = joaat("p_lnnhouse_stash02");
			break;
		case -1481450947:
		case -1420566543:
		case -1208846034:
...
void func_197(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_280(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_280(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_330(iParam0, &uVar1, 1, 0, 0))
		{
			...
			else if (WEAPON::_0xD955FEE4B87AFA07(iVar0))
			{
				...
				if ((((func_260(iVar7) && !Global_43890) && iVar7 != iVar0) && !func_89(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_35, iVar7);
				}
				if (func_260(iVar7) && func_89(joaat("UPGRADE_OFFHAND_HOLSTER"), 1, 0))
				{
...
int func_218()
{
	if (((((func_373(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_373(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_373(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_373(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_373(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_373(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return 1;
	}
	return 0;
...
void func_239(int iParam0, bool bParam1)
{
	...
	func_280(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_259(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((iParam1 == 1 || func_199(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == -1424823393) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
int func_293(int iParam0)
{
	...
	else if (PED::IS_PED_IN_ANY_VEHICLE(Global_35, true))
	{
		...
		if ((!func_288(iParam0, 16) && !PED::IS_PED_ON_MOUNT(Global_35)) && VEHICLE::_0x2963B5C1637E8A27(bVar0) == Global_35)
		{
			return 0;
		}
	}
...
int func_381()
{
	...
	while (iVar1 < 30)
	{
		if (func_535(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("dino_bones"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_431(int iParam0)
{
	...
	if (!func_583(iParam0, &uVar0, joaat("inventory"), 0, 0, joaat("ui_itemviewer")))
	{
...
int func_473(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_328(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_495()
{
	...
	while (iVar1 < 30)
	{
		if (func_603(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("dino_bones"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_547(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	iVar0 = func_623(0);
	if (iParam2 != 0 && func_624(iParam0, iVar0, iParam2, bParam3) != -1)
	{
		return iParam2;
	}
...
void func_599(int iParam0, int iParam1, int iParam2)
{
	...
	func_280(sVar7, sVar1, iVar8, iVar9, -479097442, "INPUT_FEED_INTERACT_GENERIC", func_662(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
...
void func_607()
{
	...
	func_666(0);
	func_667(7);
	func_668(joaat("KIT_BANDANA"), 1, 1, 0);
	if (func_422() == 1160113249)
	{
		func_668(joaat("clothing_p3_player_three_ms1_hat_000_000"), 1, 1, 1);
...
bool func_701(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
