...
void __EntryFunction__()
{
	fLocal_7 = 1f;
	fLocal_8 = 1f;
	bLocal_45 = joaat("S_M_M_AMBIENTLAWRURAL_01");
...
void func_4()
{
	switch (iLocal_44)
	{
		case 1:
			...
			break;
		case 2:
			STREAMING::REQUEST_MODEL(bLocal_45, false);
			if (STREAMING::HAS_MODEL_LOADED(bLocal_45) && PED::_0x5E420FF293EE5472())
			{
				iLocal_44 = 4;
			}
			break;
...
int func_11()
{
	...
	iLocal_46++;
	iVar0 = func_15(bLocal_45, vLocal_41, 0, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
...
bool func_15(bool bParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_20(bVar0, bParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_20(bool bParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_25(bParam1))
		{
			func_26(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_26(bool bParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		...
		{
			if (func_32(bParam0, iParam1))
			{
				if (func_33(bParam0, iParam1))
				{
