...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_51(uParam0, 0, "MALE_A", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "MALE_B", uVar1, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
{
	if (!TASK::_0x841475AC96E794D1(iLocal_39) || !TASK::_0x841475AC96E794D1(iLocal_40))
	{
		return 0;
	}
	bLocal_41 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_0xA8452DD321607029(iLocal_39, 1), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED1_SCENARIO");
	bLocal_42 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(TASK::_0xA8452DD321607029(iLocal_40, 1), 0f, 0f, 0f, 1f, 1f, 3f, "AV_WAGON_BARREL_PED2_SCENARIO");
	return 1;
}
...
int func_28(var uParam0)
{
	...
	{
		POPULATION::_0xB56D41A694E42E86(bLocal_41, 10208, 0, 0, -1, -1, 0);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_42))
	{
		POPULATION::_0xB56D41A694E42E86(bLocal_42, 10208, 0, 0, -1, -1, 0);
	}
...
int func_173(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
