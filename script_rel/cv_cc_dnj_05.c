...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -1.04f, -1.28f, 0.4194f, 0f, 3f, 3.84f, 3f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, -4.131f, -7.1027f, 0.1523f, 0f, 1.2f, 1.2f, 4f, -1612834106, joaat("APMS_COMP_JOHN"), 1, 1, 1);
