...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "CRP_ANIMAL", iLocal_10, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_13)
	{
		case 0:
			...
			break;
		case 1:
			if (func_57(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
...
int func_57(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
...
int func_66(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_94(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_67(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_95(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_81(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_104(iParam1))
		{
			func_105(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_92(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_94((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_94(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
