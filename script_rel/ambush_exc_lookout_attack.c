		...
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			switch (iVar0)
			{
				case 0:
					...
					break;
				case 3:
					func_131(&(uLocal_15[iVar0]), joaat("GROUP_REVOLVER"), -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				case 1:
					func_131(&(uLocal_15[iVar0]), joaat("GROUP_REVOLVER"), -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				default:
					func_131(&(uLocal_15[iVar0]), joaat("GROUP_REPEATER"), -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
			}
...
void func_75()
{
	...
	if (uLocal_15.f_19 < uLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar0])))
		{
			...
			{
				if (func_218(&(uLocal_15[iVar0]), 200f, -1082130432 /* Float: -1f */, &(uLocal_15.f_9[iVar0]), -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < (uLocal_15.f_215 + uLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_40[iVar0])))
		{
			...
			{
				if (func_218(&(uLocal_15.f_40[iVar0]), 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_49[iVar0])))
		{
			if (!func_225(&uLocal_15, iVar0, 8))
			{
				...
				{
					if (func_226(&(uLocal_15.f_49[iVar0]), 200f, -1082130432 /* Float: -1f */))
					{
...
int func_83()
{
	...
	func_241();
	func_242();
	func_243(&(uLocal_15.f_182), 9, 0, 1065353216 /* Float: 1f */, 1067450368 /* Float: 1.25f */, 1071644672 /* Float: 1.75f */, 0);
	return 1;
}
...
void func_138()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				func_277(&(uLocal_15[iVar0]), Global_35, "CALLOUT_JUST_KILL_EM_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
				func_278(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
...
void func_147()
{
	AUDIO::_PLAY_SOUND_FROM_ENTITY("ALERT_WHISTLE_02", &(uLocal_15[0]), "GAROA_Sounds", false, 0, 0);
...
void func_149()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				if (PED::IS_PED_SHOOTING(&(uLocal_15[iVar0])) || func_218(&(uLocal_15[iVar0]), 1116471296 /* Float: 70f */, 10f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					func_278(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
				}
			}
...
int func_151()
{
	switch (Local_274.f_5)
	{
		...
		case 1:
			...
			{
				func_277(&(uLocal_15[0]), Global_35, "ITS_MALE_EXTREME", -1073741824 /* Float: -2f */, 1, -500314840, 1);
...
void func_171()
{
	...
	while (iVar0 <= 4)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			if (!bVar1)
			{
				func_277(&(uLocal_15[iVar0]), Global_35, "GANG_TAUNT_GEN", -1073741824 /* Float: -2f */, 1, 1744022339, 2);
				bVar1 = true;
			}
...
bool func_284(bool bParam0, vector3 vParam1)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return false;
...
void func_300()
{
	...
	while (iVar3 <= 4)
	{
		if (func_61(&(uLocal_15[iVar3]), 0, 0))
		{
			...
			if (!bVar5)
			{
				func_277(&(uLocal_15[iVar3]), Global_35, "MOVE_IN", -1073741824 /* Float: -2f */, 1, 1808677283, 2);
				bVar5 = true;
			}
...
bool func_312(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_413(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
...
void func_407(bool bParam0)
{
	...
	while (iVar0 < uLocal_15.f_216)
	{
		if (func_61(&(uLocal_15.f_40[iVar0]), 0, 0))
		{
			if (!bParam0)
			{
				if (PED::_GET_HORSE_RIDER(&(uLocal_15.f_40[iVar0]), true) != 0)
				{
				}
				else
				{
...
int func_538(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_593(int iParam0, var uParam1)
{
	...
	*uParam1 = func_669(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
int func_594(int iParam0, var uParam1)
{
	...
	*uParam1 = func_669(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_523(*uParam1, 0))
	{
		return 0;
	}
...
int func_675(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	int iVar1;
