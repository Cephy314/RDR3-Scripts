...
void func_142(int iParam0)
{
	...
	switch (iParam0)
	{
		case 1369162587: /* GXTEntry: "Hunting Request" */
			...
			func_105(437, 0);
			func_105(440, 0);
			func_302(joaat("TAXIDERMY_ORDER_01"), 444160793 /* GXTEntry: "Perfect Squirrel Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1610047510: /* GXTEntry: "Hunting Request" */
			...
			func_302(joaat("TAXIDERMY_ORDER_02"), -1969404854 /* GXTEntry: "Perfect Cardinal Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1317879106: /* GXTEntry: "Hunting Request" */
			...
			func_302(joaat("TAXIDERMY_ORDER_03"), -832850511 /* GXTEntry: "Perfect Chipmunk Carcass" */, &sVar0, 1, 0, 0);
		...
		case 1062444751: /* GXTEntry: "Hunting Request" */
			...
			func_302(joaat("TAXIDERMY_ORDER_04"), -100913452 /* GXTEntry: "Perfect Songbird Carcass" */, &sVar0, 1, 0, 0);
		...
		case 754186760: /* GXTEntry: "Hunting Request" */
			...
			func_105(438, 0);
			func_302(joaat("TAXIDERMY_ORDER_05"), 905173572 /* GXTEntry: "Perfect Cedar Waxwing Carcass" */, &sVar0, 1, 0, 0);
...
void func_567(int iParam0, int iParam1, int iParam2)
{
	...
	func_259(sVar7, sVar1, iVar8, iVar9, joaat("stats_menu"), "INPUT_FEED_INTERACT_GENERIC", func_656(iParam0), -2, sVar5, sVar6, 0, 0, 1, 1);
}
