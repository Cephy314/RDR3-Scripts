...
{
	func_33(uParam0, 10803, 10868, 11561);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "AV_GET_DIRECTIONS", "script@ambient@town@get_directions@Action", vParam1, vParam4);
	...
	switch (uParam0->f_489)
	{
		case 0:
			...
			break;
		case 1:
			uVar0 = func_51(func_50());
			break;
	}
	func_52(uParam0, 0, "IG_GenStoryMale", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_52(uParam0, 1, "IG_GenStoryMale^1", uVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_72(uParam0, 0.3f, 40f, 4, 15f, 1112014848 /* Float: 50f */))
		{
			func_70(*uParam0, 0);
	...
	if (&uParam0->f_469[2])
	{
		if (!&uParam0->f_469[5])
		{
			if (func_73(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
			{
				func_71(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[5] = 1;
			}
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])) && ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[1 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[1 /*14*/])->f_1))
			{
				if (!bLocal_37)
				{
					vVar0 = { ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uParam0->f_20[1 /*14*/]), 0f, 3f, 0f) };
					TASK::OPEN_SEQUENCE_TASK(&iVar3);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, vVar0, 1f, -1, 0.25f, 1048577, 40000f);
					TASK::TASK_WANDER_STANDARD(0, ENTITY::GET_ENTITY_HEADING(&(uParam0->f_20[1 /*14*/])), 1);
					TASK::CLOSE_SEQUENCE_TASK(iVar3);
					TASK::TASK_PERFORM_SEQUENCE(&(uParam0->f_20[1 /*14*/]), iVar3);
				}
				else
				{
					func_74(&(uParam0->f_20[1 /*14*/]), joaat("WORLD_HUMAN_LEAN_FENCE_FWD_CHECK_OUT_LIVESTOCK"), -227.1f, 668.65f, 112.31f, 137.565f, 48000, 1, 0, 0, -1082130432 /* Float: -1f */);
				}
		...
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])) && ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_20[0 /*14*/])))
		{
			if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
			{
				if (!bLocal_37)
				{
					...
					TASK::TASK_PERFORM_SEQUENCE(&(uParam0->f_20[0 /*14*/]), iVar4);
				}
				else
				{
					func_74(&(uParam0->f_20[0 /*14*/]), joaat("WORLD_HUMAN_SMOKE"), -180.37f, 617.68f, 113.03f, -158.689f, 35000, 1, 0, 0, -1082130432 /* Float: -1f */);
				}
...
void func_52(var uParam0, int iParam1, char* sParam2, var uParam3, vector3 vParam4, float fParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
void func_164(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
...
int func_187(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
