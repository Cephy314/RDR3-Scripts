...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_47(uParam0, 0, "REG_RAT_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 0f, 0f), (0f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 1, "REG_RAT_2", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.25f, 0.25f, 0f), (135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 2, "REG_RAT_3", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, 0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 3, "REG_RAT_4", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, 0f, 0f), (45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 4, "REG_RAT_5", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, 0f, 0f), (-100f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 5, "REG_RAT_6", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.5f, -0.25f, 0f), (-135f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 6, "REG_RAT_7", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, -0.5f, 0f), (-145f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 7, "REG_RAT_8", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -0.5f, 0f), (-15f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 8, "REG_RAT_9", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.5f, -0.25f, 0f), (-45f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
	func_47(uParam0, 9, "REG_RAT_10", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.25f, -0.75f, 0f), (50f + vParam4.z), 1, 1, 1, 1, 41788943, 1);
}
