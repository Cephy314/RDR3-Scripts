...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar1 = func_49(joaat("HORSE_CLASS_RIDING"), 1);
	func_50(uParam0, 0, "RGP_HORSE", uVar1, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_50(uParam0, 1, "RGP_MAN", uVar0, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
