...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if ((func_64(uParam0, &uLocal_10, 1) || func_65(&(uParam0->f_20[0 /*14*/]), Global_35, 1) <= 400f) || ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			func_66(uParam0);
			if (!&uParam0->f_469[5])
			{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (uParam0->f_469[2] && !&uParam0->f_469[3])
		{
			if (!&uParam0->f_469[5])
			{
				if (func_69(uParam0, 1.5f, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 1))
				{
					func_67(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[5] = 1;
				}
...
void func_89(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_125(iParam1))
		{
			func_126(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_97(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_137(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
void func_101(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_115((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
