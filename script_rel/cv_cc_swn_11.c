...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.0061f, -1.935f, 0f, -2.5f, 3.205f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_SWANSON"), 1, 1, 1);
	func_151(uParam0, 4.1189f, 2.365f, 0f, 0f, 1.2f, 1.2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_MICAH"), 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@swanson_11@base", 1, 1, 0, 0);
	func_153(uParam0, "script@vignette@swanson_11@action", 0, 0, 1, 0);
	...
	func_156(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_BOOK_TABLE_PUTDOWN"), "WORLD_HUMAN_BOOK_TABLE_PUTDOWN_MALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_156(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_WHITTLE"), "PROP_HUMAN_SEAT_CHAIR_WHITTLE_MALE_C", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
