...
{
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_ANIMAL_WOLF_EATING"), 1, 0, 0);
	func_57(&uLocal_28, 0);
	func_58(&uLocal_28, 1);
	func_59(&uLocal_28, 1);
	func_60(&uLocal_28, 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		if (!bLocal_23 == 1)
		{
			if (func_65(uParam0, &uLocal_28, 1) || func_66(Global_35, &(uParam0->f_20[0 /*14*/]), 1) <= 625f)
			{
				bLocal_23 = true;
			}
		}
	...
	if (!&uParam0->f_469[0] && !bLocal_23)
	{
		if (!&uParam0->f_469[1])
		{
			...
			{
				if (func_73(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
				{
					if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
					{
						if (ANIMSCENE::_0x477122B8D05E7968(uParam0->f_3.f_1, 1, 0))
		...
		if (&uParam0->f_469[2])
		{
			if (!&uParam0->f_469[4])
			{
				if (func_75(uParam0, 1.5f, 80f, 4, joaat("ACTION"), 1))
				{
					func_70(*uParam0, uParam0->f_483, 1);
					uParam0->f_469[4] = 1;
				}
...
void func_71(var uParam0)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		if (func_66(&(uParam0->f_20[0 /*14*/]), Global_35, 1) <= 3600f)
		{
			if (!func_111(&(uParam0->f_20[0 /*14*/]), 780511057))
			{
