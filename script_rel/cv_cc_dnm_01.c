...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7428f, 4.9238f, 1.0241f, 0f, 1.5f, 1.5f, 3f, -1612834106, joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 0.3647f, -2.9108f, 0.1498f, 0f, 3.06f, 1.6f, 3f, -1612834106, joaat("APMS_COMP_MOLLY"), 1, 1, 1);
...
int func_262(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool func_287(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
...
void func_428(bool bParam0, int iParam1)
{
	...
	func_381(bParam0, func_460(iParam1));
