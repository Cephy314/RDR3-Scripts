...
{
	func_33(uParam0, 11054, 11118, 11970);
}
...
{
	func_46(uParam0, "WOLVES_EAT_DEER", "", vParam1, vParam4);
	func_47(uParam0, 0, "WED1_DEER", iLocal_9, vParam1, vParam4.z, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 1, "WED1_WOLF_1", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0.9f, -0.3f, 0f), (90f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 2, "WED1_WOLF_2", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 3f, 2f, 0f), (135f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 3, "WED1_WOLF_3", iLocal_10, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -0.85f, -0.1f, 0f), (-70f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 4, "WED1_VULTURE_1", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -2f, 0f, 23f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 5, "WED1_VULTURE_2", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 4f, 28f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_47(uParam0, 6, "WED1_VULTURE_3", iLocal_11, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 2f, 0f, 25f), (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
	...
	switch (iLocal_12)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				func_66(&((uParam0->f_20[2 /*14*/])->f_5), 50, 10, 0);
				...
				func_66(&((uParam0->f_20[3 /*14*/])->f_5), 50, 10, 0);
...
void func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_122(iParam1))
		{
			func_123(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_98(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (!uParam2->f_1 & 128 != 0)
		{
			...
			{
				*uParam3 = 128;
				func_129(iParam0, uParam2, *uParam3);
				return 1;
			}
		}
		if (Global_1935630->f_27)
		{
			if (!uParam2->f_1 & 8 != 0)
			{
				...
				else if (func_131(iParam0, iParam1, uParam2))
				{
					*uParam3 = 8;
					func_129(iParam0, uParam2, *uParam3);
					return 1;
		...
		if (Global_1935630->f_26 && func_133(PLAYER::PLAYER_ID(), 0, 1, uParam2->f_1 & 524288 == 0))
		{
		...
		{
			if (func_134(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
		...
		if (!uParam2->f_1 & 16 != 0)
		{
			...
			{
				if (func_137(Global_35, iParam0, uParam2, 0))
				{
					*uParam3 = 16;
					func_129(iParam0, uParam2, *uParam3);
					return 1;
			...
			else if (func_137(Global_35, iParam0, uParam2, 1))
			{
				*uParam3 = 16;
				func_129(iParam0, uParam2, *uParam3);
				return 1;
		...
		if (Global_1935630->f_30 || Global_1935630->f_31)
		{
			if (!uParam2->f_1 & 2 != 0)
			{
				if (func_140(uParam2, 4000))
				{
					if ((func_141(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 0, *uParam2 & 256 != 0) && func_142(uParam2, iParam0)) && func_143(uParam2, iParam0))
					{
						*uParam3 = 2;
						func_129(iParam0, uParam2, *uParam3);
						return 1;
		...
		if (!uParam2->f_1 & 2 != 0)
		{
			if (uParam2->f_12 < 4f)
			{
				if ((func_141(iParam0, Global_1935630->f_41, *uParam2 & 128 != 0, 1, *uParam2 & 256 != 0) && func_142(uParam2, iParam0)) && func_143(uParam2, iParam0))
				{
					*uParam3 = 2;
					func_129(iParam0, uParam2, *uParam3);
					return 1;
				...
				if (Global_1935630->f_40 == 0)
				{
					if (Global_1935630->f_41 != 0)
					{
						if (*uParam2 & 131072 == 0)
						{
							if (func_144(iParam0, Global_1935630->f_41))
							{
								func_145();
								*uParam3 = 2;
								func_129(iParam0, uParam2, *uParam3);
			...
			if (uParam2->f_12 < 10f)
			{
				if (func_146(uParam2, iParam0) || (uParam2->f_9 > 0 && (func_147() - uParam2->f_9) < 2000))
				{
			...
			if (Global_1935630->f_42 != 0)
			{
				if (*uParam2 & 131072 == 0)
				{
					if (func_148())
					{
						if (func_144(iParam0, Global_1935630->f_42))
						{
							func_145();
							*uParam3 = 2;
							func_129(iParam0, uParam2, *uParam3);
		...
		if (uParam2->f_12 < uParam2->f_26)
		{
			...
			{
				if (func_150(iParam0, iParam1, uParam2))
				{
					*uParam3 = 2048;
					func_129(iParam0, uParam2, *uParam3);
					return 1;
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_167(1) || *uParam0 & 8192 != 0))
				{
...
int func_128(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case joaat("EVENT_DEAD_PED_FOUND"):
			...
			if (!func_170(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_171(iParam0, iVar2) <= func_172(uParam1))
			{
				return 1;
			}
			break;
...
int func_130(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_176(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_177(uParam1);
			if (func_178(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_131(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_180(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_177(uParam2);
		if (func_178(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_179(uParam2)
				{
					func_174(uParam2, 1);
					return 1;
				}
...
int func_132(int iParam0, var uParam1)
{
	...
	if (func_170(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_179(uParam1)
		{
			fVar3 = func_177(uParam1);
...
int func_136(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_183(uParam2)))
	{
...
int func_137(var uParam0, int iParam1, var uParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_185(iParam1, vVar0, vVar4))
					{
						func_174(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_185(iParam1, vVar0, vVar7))
					{
						func_174(uParam2, 1);
						return 1;
					}
...
int func_138(int iParam0, var uParam1)
{
	...
	{
		if (!func_170(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_186(&(Global_1935630->f_34[iVar0]));
			...
			if (func_187(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_188(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_189(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_141(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_144(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_193(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_146(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_194(iVar0, iParam1, vVar1))
		{
...
int func_149(var uParam0, int iParam1)
{
	...
	fVar0 = func_172(uParam0);
	if (uParam0->f_12 > func_196(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_197(iParam1);
	iVar1 = func_198(uParam0->f_14);
...
int func_150(int iParam0, int iParam1, var uParam2)
{
	...
	return func_199(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_201(uParam1, iParam0))
					{
						if (func_195(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_155(int iParam0, var uParam1)
{
	...
	else if (func_147() - uParam1->f_4) > func_203(uParam1)
	{
		return func_204(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_157(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_205(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_205(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_205(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
{
	return func_193(iParam0, iParam1, 1, 1);
}
...
int func_173(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	switch (iParam0)
	{
		case 8:
...
int func_176(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_193(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_178(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_180(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_185(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_189(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
float func_193(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_194(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_195(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_199(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_193(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_193(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_200(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_201(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_201(uParam1, iVar1))
				{
					if (func_195(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_204(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
void func_205(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
