...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.45f, 2.2f, 0f, -35f, 5f, 4f, 5f, -1612834106, joaat("APMS_COMP_ADLERS"), 1, 1, 1);
	func_151(uParam0, -1f, 8.5f, 0f, 0f, 3.5f, 3.5f, 5f, -1612834106, joaat("APMS_COMP_KIERAN"), 1, 1, 1);
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_240(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_242(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_413(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_238(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_238(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_238(iParam5, 32), true);
	...
	else if (func_238(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_238(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_238(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_432(bool bParam0, int iParam1)
{
	...
	{
		PED::_0x931B241409216C1F(func_240(iParam1), bParam0, 0);
		PED::_0xED1C764997A86D5A(func_240(iParam1), bParam0);
