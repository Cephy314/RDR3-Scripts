...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.7624f, -8.755f, 1.4875f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_JAVIER"), 1, 1, 1);
	func_151(uParam0, 0.891524f, -2.01747f, 1.00526f, 0f, 1.2f, 1.2f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_GRAB_POTATO_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_245(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_1898164->f_1[0 /*5*/])->f_2 == 8)
	{
		...
		if (func_262(iVar0) && func_324(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
void func_258(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_332(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
void func_432(bool bParam0, int iParam1)
{
	...
	func_384(bParam0, func_462(iParam1));
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_401(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_263(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_401(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_263(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_331(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_401(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
