...
int func_3(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_22(uParam0, iLocal_20)))
	{
		...
		ENTITY::SET_ENTITY_COORDS(func_22(uParam0, iLocal_20), vLocal_56, true, false, true, true);
...
int func_73(var uParam0)
{
	...
	func_152(uParam0, -5.8f, 6.8f, 0f, 0f, 2f, 2f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, 0f, 1f, 0f, 0f, 1.5f, 1.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	vLocal_53 = { func_153(uParam0, -0.039f, 1.165f, 0.0346f) };
	...
	func_156(uParam0, "script@vignette@bill_5@base", 1, 1, 0, 0);
	iLocal_16 = func_156(uParam0, "script@vignette@bill_5@action_a", 2, 0, 1, 0);
	iLocal_17 = func_156(uParam0, "script@vignette@bill_5@action_b_int_front", 0, 0, 0, 1);
	iLocal_18 = func_156(uParam0, "script@vignette@bill_5@action_b_int_left", 0, 0, 0, 1);
	iLocal_19 = func_156(uParam0, "script@vignette@bill_5@action_b_int_right", 0, 0, 0, 1);
	func_157(uParam0, "CBLL5AU");
	func_158(uParam0, iLocal_14, 1061142135 /* Float: 0.749f */);
	func_159(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_DESK_WRITING"), "PROP_HUMAN_SEAT_CHAIR_DESK_WRITING_MALE_A", iLocal_20, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_23 = { func_162(uParam0, 0.1564f, 1.1727f, 0.5404f, 138f, 7f, 0.4f, 0.4f) };
	Local_33 = { func_162(uParam0, 0.156f, 1.173f, 0.54f, -150f, 7f, 0.4f, 0.4f) };
	Local_43 = { func_162(uParam0, 0.156f, 1.173f, 0.54f, 66f, 7f, 0.4f, 0.4f) };
	return 1;
}
...
int func_87(var uParam0)
{
	if (ENTITY::DOES_ENTITY_EXIST(func_22(uParam0, iLocal_20)))
	{
		vLocal_56 = { ENTITY::GET_ENTITY_COORDS(func_22(uParam0, iLocal_20), true, false) };
		fLocal_59 = ENTITY::GET_ENTITY_HEADING(func_22(uParam0, iLocal_20));
		ENTITY::SET_ENTITY_COORDS(func_22(uParam0, iLocal_20), vLocal_53, true, false, true, true);
...
int func_94(var uParam0)
{
	if (!bLocal_60)
	{
		...
		{
			if (func_202(uParam0, Local_23, 1, 0))
			{
				func_192(uParam0, iLocal_17, 1);
			}
			else if (func_202(uParam0, Local_33, 1, 0))
			{
				func_192(uParam0, iLocal_18, 1);
			}
			else if (func_202(uParam0, Local_43, 1, 0))
			{
...
int func_96(var uParam0)
{
	...
	if (!CAM::IS_SPHERE_VISIBLE(vLocal_53, 1f))
	{
		return 1;
	}
	return 0;
...
int func_152(var uParam0, vector3 vParam1, float fParam4, vector3 vParam5, int iParam8, int iParam9, bool bParam10, int iParam11, int iParam12)
{
	...
	if (bParam10)
	{
		vParam1 = { func_153(uParam0, vParam1) };
...
void func_161(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, char* sParam5)
{
	int iVar0;
	...
	while (iVar0 < uParam0->f_1711)
	{
		...
		else
		{
			...
			if (!(uParam0->f_1711[iVar0 /*15*/])->f_5 && !ENTITY::DOES_ENTITY_EXIST((uParam0->f_1711[iVar0 /*15*/])->f_10))
			{
				...
				{
					vVar3 = { func_153(uParam0, (uParam0->f_1711[iVar0 /*15*/])->f_1) };
				}
				else
				{
...
void func_187(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_153(uParam0, uParam0->f_1976.f_1), 1, func_256(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
float func_213(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_310(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_269(var uParam0)
{
	...
	while (iVar1 < uParam0->f_1711)
	{
		...
		else if ((uParam0->f_1711[iVar1 /*15*/])->f_5)
		{
			...
			{
				vVar2 = { func_153(uParam0, (uParam0->f_1711[iVar1 /*15*/])->f_1) };
			}
			else
			{
		...
		else if (func_19(uParam0) == 355)
		{
			if (iVar3 == 5)
			{
				if (uParam0->f_3)
				{
					...
					else if (func_373(iVar3, func_100(uParam0->f_7), 1))
					{
					}
					else if (func_375(&uVar2, func_374(iVar3)))
					{
						...
						else
						{
							...
							if (bParam2)
							{
								...
								if (!func_376(iVar0, func_100(uParam0->f_7), 0, -1))
								{
									return -1;
								}
								return iVar0;
...
int func_367(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	if ((!ENTITY::DOES_ENTITY_EXIST(bVar0) || !func_121(bVar0, 0)) || (bParam3 && !func_52(iParam1)))
	{
		if (bParam2)
		{
			...
			{
				bVar0 = func_394(iParam1, bParam3, bParam8, iParam9, iParam10, iParam11, iParam12, bParam7, bParam15, bParam16, iParam17);
			}
			else
			{
				*uParam0 = 1;
...
void func_405(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bParam0 == func_442(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_443(bParam0))
	{
		if (func_444(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
	...
	if (func_229(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		...
		if (PED::IS_PED_ON_VEHICLE(bVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_405(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(bVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_405(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
...
void func_408(int iParam0, bool bParam1, int iParam2, bool bParam3)
{
	int iVar0;
...
int func_423(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_453(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_424(bool bParam0, int iParam1)
{
	...
	func_385(bParam0, func_454(iParam1));
...
void func_426(bool bParam0, float fParam1, bool bParam2)
{
	int iVar0;
...
void func_448(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1 > 0 && func_412(bParam1, 860729266))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 860729266);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4096 > 0 && func_412(bParam1, 879715242))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 879715242);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 128 > 0 && func_412(bParam1, 1606325429))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1606325429);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 256 > 0 && func_412(bParam1, 1743550585))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1743550585);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 512 > 0 && func_412(bParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1024 > 0 && func_412(bParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2048 > 0 && func_412(bParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & -2147483648 > 0 && func_412(bParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 65536 > 0 && func_412(bParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16384 > 0 && func_412(bParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 262144 > 0 && func_412(bParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 524288 > 0 && func_412(bParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1048576 > 0 && func_412(bParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2097152 > 0 && func_412(bParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 32768 > 0 && func_412(bParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 131072 > 0 && func_412(bParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4194304 > 0 && func_412(bParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8388608 > 0 && func_412(bParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16777216 > 0 && func_412(bParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 33554432 > 0 && func_412(bParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 67108864 > 0 && func_412(bParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 134217728 > 0 && func_412(bParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 268435456 > 0 && func_412(bParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 536870912 > 0 && func_412(bParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1073741824 > 0 && func_412(bParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8192 > 0 && func_412(bParam1, 1544915253))
	{
...
int func_473(bool bParam0, bool bParam1)
{
	if (ENTITY::DOES_ENTITY_EXIST(bParam0))
	{
		if (bParam1)
...
int func_490(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_503(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
