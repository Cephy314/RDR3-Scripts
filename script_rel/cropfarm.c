...
int func_11()
{
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_18 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1119.103f, 491.625f, 94.789f, 0f, 0f, 40.29281f, 4.983408f, 12.47093f, 20f);
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1116.402f, 489.3356f, 94.789f, 0f, 0f, 40.29281f, 11.85608f, 5.358582f, 20f);
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1178.083f, 428.8635f, 93.85277f, 0f, 0f, 53.30451f, 6.700057f, 7.386477f, 11.96838f);
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1122.726f, 433.0324f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1117.072f, 440.526f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		VOLUME::_0x39816F6F94F385AD(bLocal_18, 1111.182f, 447.2959f, 94.789f, 0f, 0f, 37.03593f, 4.563203f, 6.540945f, 8.78159f);
		bLocal_17 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_17, bLocal_18);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 1158.519f, 410.6769f, 92.74591f, 0f, 0f, -42.87345f, 53.38902f, 36.78405f, 32.92925f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 1183.084f, 409.2454f, 94.789f, 0f, 0f, 62.77261f, 47.98455f, 17.14376f, 15.40531f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 1155.914f, 449.3743f, 96.1861f, 0f, 0f, 47.14103f, 50.95671f, 69.55695f, 12.92893f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 1195.093f, 434.533f, 81.04297f, 0f, 0f, 0f, 7.797928f, 12.21736f, 21.62953f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 1170.392f, 385.8856f, 94.80865f, 0f, 0f, 21.33961f, 15.42121f, 9.785769f, 12.92893f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_17, 1125.095f, 489.7792f, 81.04297f, 0f, 0f, 0f, 22.93393f, 22.40263f, 21.62953f);
		VOLUME::_0x39816F6F94F385AD(bLocal_17, 1116.016f, 455.3546f, 94.789f, 0f, 0f, 39.8431f, 36.45f, 74.7347f, 15.40531f);
		bLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_19, bLocal_17);
		VOLUME::_0xBCE668AAF83608BE(bLocal_19, 1125.095f, 466.7386f, 81.04297f, 0f, 0f, 31.95184f, 48.08396f, 52.23304f, 21.62953f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_19, 1151.546f, 440.5756f, 81.04297f, 0f, 0f, -44.24499f, 55.60196f, 50.99452f, 21.62953f);
		VOLUME::_0xBCE668AAF83608BE(bLocal_19, 1158.093f, 392.0394f, 81.04297f, 0f, 0f, -24.17386f, 18.53472f, 13.09556f, 21.62953f);
		bLocal_16 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Guthrie Farm - m_volRancherRegistration Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_16, bLocal_19);
...
void func_28(int iParam0)
{
	...
	func_50(745, bLocal_17, 1);
	func_50(746, bLocal_17, 0);
	func_50(748, bLocal_17, 0);
	VOLUME::_0x4A8FEFC43FD8AC9B(bLocal_17, 3, 1);
	VOLUME::_0x53D05D60E5F5B40C(bLocal_17, 3, 1, func_51(746));
	VOLUME::_0x53D05D60E5F5B40C(bLocal_17, 3, 1, func_51(748));
	PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_52(745), func_52(748), 0);
}
...
void func_76(int iParam0)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_17))
	{
		...
		VOLUME::_DELETE_VOLUME(bLocal_17);
	}
}
