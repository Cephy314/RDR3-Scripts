...
int func_28(var uParam0)
{
	if (*uParam0 == 44)
	{
		...
		{
			bLocal_12 = VOLUME::_CREATE_VOLUME_CYLINDER((uParam0->f_20[1 /*14*/])->f_5 + Vector(0f, 3f, 2f), 0f, 0f, -54f, 7f, 4f, 10f);
		}
		...
		case 0:
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (*uParam0 == 44)
				{
					...
					TASK::TASK_ANIMAL_UNALERTED(&(uParam0->f_20[1 /*14*/]), -1, bLocal_12, 0, 0);
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])) && !ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				...
				if (*uParam0 == 44)
				{
					if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
					{
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 0, 0, 2f, 0f, 32, 2f, 0f, 1069547520, 1073741824);
					}
				}
				iLocal_10 = 4;
			}
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_12))
	{
		VOLUME::_DELETE_VOLUME(bLocal_12);
	}
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_13))
	{
