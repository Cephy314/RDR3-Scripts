...
int func_11()
{
	...
	bLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Ridgewood - m_volHorsePens");
	VOLUME::_0xBCE668AAF83608BE(bLocal_15, -4793.275f, -2684.797f, -12.52667f, 0f, 0f, 2.828959f, 21.53875f, 14.61882f, 2.730403f);
	VOLUME::_0x39816F6F94F385AD(bLocal_15, -4827.138f, -2733.15f, -13.91682f, 0f, 0f, 53.75946f, 20.16043f, 53.09112f, 4.69964f);
	return 1;
}
...
void func_28(int iParam0)
{
	...
	func_50(889, bLocal_15, 1);
	func_50(890, bLocal_15, 0);
	func_50(891, bLocal_15, 0);
	func_50(892, bLocal_15, 0);
}
...
int func_84(int iParam0, bool bParam1)
{
	...
	if (func_122(iParam0, 32) && !bParam1)
	{
		...
		if (func_20() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_86(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_86(iParam0)))
	{
...
bool func_85(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_86(iParam0));
}
...
int func_123(int iParam0, bool bParam1)
{
	...
	func_156(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_86(iParam0));
	func_125(iParam0, 0);
	return 1;
}
