...
int func_72(var uParam0)
{
	...
	iLocal_18 = func_151(uParam0, 17.59f, 0.12f, 0.9632f, 20.88f, 6.5f, 3.5f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, 1.015f, 0.616f, 0.9977f, 23.04f, 2f, 1.5f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
