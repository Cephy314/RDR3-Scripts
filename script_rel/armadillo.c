#region Local Var
	...
	var uLocal_148 = 0;
	int iLocal_149 = 0;
	struct<45> Local_150[2];
	bool bLocal_241 = false;
	bool bLocal_242 = false;
	int iLocal_243 = 0;
	int iLocal_244 = 0;
	int iLocal_245 = 0;
	int iLocal_246[3] = { 0, 0, 0 };
	int iLocal_250 = 0;
	int iLocal_251 = 0;
	int iLocal_252 = 0;
	int iLocal_253 = 0;
...
void __EntryFunction__()
{
	...
	while (func_3())
	{
		if (MISC::GET_GAME_TIMER() > iLocal_252)
		{
			iLocal_252 = 0;
			...
			switch (iLocal_251)
			{
				...
				case 1:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_9(iLocal_253));
					...
					Global_1897950 = -1;
					iLocal_254 = (MISC::GET_GAME_TIMER() + iLocal_250);
					iLocal_251 = 2;
					break;
				case 2:
					if (func_11() || iLocal_254 < MISC::GET_GAME_TIMER())
					{
						func_12(iLocal_253);
						iLocal_254 = (MISC::GET_GAME_TIMER() + iLocal_250);
						iLocal_251 = 3;
					...
					break;
				case 3:
					if (func_13(iLocal_253) || iLocal_254 < MISC::GET_GAME_TIMER())
					{
						func_14(iLocal_253);
						iLocal_254 = (MISC::GET_GAME_TIMER() + iLocal_250);
						iLocal_251 = 4;
					...
					break;
				case 4:
					if (func_15(iLocal_253) || iLocal_254 < MISC::GET_GAME_TIMER())
					{
						func_16(iLocal_253);
						iLocal_254 = (iLocal_250 + MISC::GET_GAME_TIMER());
						iLocal_251 = 6;
					}
					break;
				case 6:
					if (func_7(func_6(iLocal_253)))
					{
						if (func_17(func_6(iLocal_253), 4) && !iLocal_254 < MISC::GET_GAME_TIMER())
						{
						}
						else
						{
							if (func_18(iLocal_253) || iLocal_254 < MISC::GET_GAME_TIMER())
							{
							...
							Jump @788; //curOff = 456
							if (iLocal_254 < MISC::GET_GAME_TIMER() || (func_20() != 0 || Global_1051260->f_3790))
							{
								func_21(iLocal_253);
								func_22();
								if (!func_23(2057, 0))
							...
							{
								iLocal_252 = (1000 + MISC::GET_GAME_TIMER());
							}
							...
							PATHFIND::SET_AMBIENT_PED_RANGE_MULTIPLIER_THIS_FRAME(((*Global_1888801)[iLocal_253 /*35*/])->f_10);
							if (((*Global_1888801)[iLocal_253 /*35*/])->f_11 > 0f)
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1888801)[iLocal_253 /*35*/])->f_11);
							}
							Jump @788; //curOff = 769
							func_42(iVar0);
							iVar0++;
						}
						if (((*Global_1888801)[iLocal_253 /*35*/])->f_12 == 0)
						{
						}
						else
						{
							PED::_0x95423627A9CA598E(((*Global_1888801)[iLocal_253 /*35*/])->f_12);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_42(iVar0))
...
int func_11()
{
	bLocal_241 = ((*Global_1888801)[120 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(bLocal_241, 29);
	bLocal_242 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Armadillo - m_volGeneral Agg");
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3686.114f, -2623.858f, -12.89814f, 0f, 0f, 0f, 5.86845f, 3.98367f, 3.717603f);
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3681.782f, -2626.667f, -12.97999f, 0f, 0f, 0f, 3.247781f, 3.506042f, 3.000762f);
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3685.422f, -2627.413f, -12.92333f, 0f, 0f, 0f, 4.057125f, 5.521852f, 3.439446f);
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3682.85f, -2624.268f, -13.04125f, 0f, 0f, 42.27255f, 3.071827f, 4.479604f, 2.948806f);
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3689.445f, -2628.58f, -12.81253f, 0f, 0f, 0f, 4.103154f, 6.370532f, 3.388822f);
	VOLUME::_0x39816F6F94F385AD(bLocal_242, -3688.071f, -2623.283f, -9.7791f, 0f, 0f, 0f, 2.257698f, 2.906237f, 3.016091f);
	iLocal_243 = VOLUME::_CREATE_VOLUME_BOX(-3685.352f, -2623.258f, -13.4981f, 0f, 0f, 0f, 1.100183f, 2.220348f, 1.996734f);
	iLocal_244 = VOLUME::_CREATE_VOLUME_BOX(-3687.81f, -2623.527f, -13.30467f, 0f, 0f, 0f, 2.162535f, 3.2466f, 2.122298f);
	VOLUME::_0xB469CFD9E065EB99(bLocal_242, 10111);
	iLocal_245 = VOLUME::_CREATE_VOLUME_BOX(-3701.056f, -2595.456f, -14.37373f, 0f, 0f, 0f, 21.94766f, 22.09092f, 14.36038f);
	iLocal_246[0] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3715.032f, -2610.383f, -14.5792f, 0f, 0f, 0f, 6f, 6f, 5f, "Fire 1 blocking volume");
	iLocal_246[1] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3635.024f, -2587.306f, -14.9224f, 0f, 0f, 0f, 6f, 6f, 5f, "Fire 2 blocking volume");
	iLocal_246[2] = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-3619.826f, -2627.633f, -14.5396f, 0f, 0f, 0f, 6f, 6f, 5f, "Fire 3 blocking volume");
	PATHFIND::_0x19C7567D2F2287D6(&(iLocal_246[0]), 7);
	PATHFIND::_0x19C7567D2F2287D6(&(iLocal_246[1]), 7);
	PATHFIND::_0x19C7567D2F2287D6(&(iLocal_246[2]), 7);
	return 1;
}
...
int func_15(int iParam0)
{
	if (func_20() == -1)
	{
		HUD::_TEXT_DATABASE_REQUEST("SCVTFAU");
		HUD::_TEXT_DATABASE_REQUEST("ARRGNAU");
		HUD::_TEXT_DATABASE_REQUEST("ARMRDAU");
...
{
	func_58(3, 434, bLocal_242, iParam0, iLocal_243, iLocal_244, 12, -1082130432 /* Float: -1f */, 0, 0);
...
void func_47(int iParam0, bool bParam1, vector3 vParam2, int iParam5, bool bParam6, bool bParam7)
{
	...
	if (bParam1)
	{
		...
		func_98(8);
		func_99(Global_36, 1137180672 /* Float: 400f */);
	}
	if (bParam7)
	{
...
void func_57(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	(Global_1935369->f_5[iParam0 /*11*/])->f_6 = func_111(iParam5, iParam0);
}

void func_58(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, int iParam8, int iParam9)
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar4;
	...
	if (func_117(iVar0) || func_118(iVar0, iParam0))
	{
		...
		(Global_1914319->f_3[iParam0 /*446*/])->f_20 = func_119(5, (Global_1914319->f_3[iParam0 /*446*/])->f_10, 2, iVar7);
	}
	*(Global_1393529->f_114[iParam0 /*3*/]) = { 0f, 0f, 0f };
	...
	func_127((Global_1914319->f_3[iParam0 /*446*/])->f_10);
	func_128(iParam0, 16);
	func_129(iParam0, 4);
...
void func_62(var uParam0, bool bParam1, int iParam2)
{
	if (uParam0->f_61 >= 20)
	{
		return;
...
void func_76(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_155(func_154(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_155(func_154(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_155(func_154(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_155(func_154(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_155(func_154(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_155(func_154(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_86(int iParam0)
{
	...
	{
		if (VOLUME::_DOES_VOLUME_EXIST(&(iLocal_246[iVar0])))
		{
			PATHFIND::_0x2C87C3E1C7B96EE2(&(iLocal_246[iVar0]));
			VOLUME::_DELETE_VOLUME(&(iLocal_246[iVar0]));
		}
		iVar0++;
	}
...
void func_89(int iParam0)
{
	...
	while (iVar1 < 4)
	{
		func_164(&((Global_1392240->f_1[iVar0 /*18*/])->f_6[iVar1]));
...
int func_95(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < func_167(iParam0))
	{
		...
		if (func_169(vVar1, vParam1, 1056964608 /* Float: 0.5f */, 1))
		{
			return iVar0;
		}
		iVar0++;
...
void func_100(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_172(iParam0))
	{
		...
		if (bParam3)
		{
			func_173(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_102()
{
	...
	(Local_150[0 /*45*/])->f_43 = 30814;
	(Local_150[0 /*45*/])->f_44 = 30939;
	func_183(Local_150[0 /*45*/], 512);
	uVar6 = 5;
	func_180(&Local_150, 434, &uVar6, 1, 0);
	(Local_150[1 /*45*/])->f_43 = 31002;
	(Local_150[1 /*45*/])->f_44 = 30939;
	func_183(Local_150[1 /*45*/], 512);
}
...
int func_108(int iParam0, bool bParam1)
{
	...
	{
		func_186(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_185(iParam0)));
		if (func_20() == -1)
		{
			if (func_165(iParam0, 2048))
			{
				PERSCHAR::_0x49A8C2CD97815215(func_187(iParam0));
				func_188(iParam0, 2048);
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_187(iParam0));
		}
		return 0;
	}
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_187(iParam0)))
	{
		func_188(iParam0, 128);
		return 1;
	}
	func_186(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_185(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_187(iParam0));
	if (func_165(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_187(iParam0));
		func_188(iParam0, 2048);
...
{
	func_190((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_191((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
{
	return func_194((Global_1914319->f_3[iParam0 /*446*/])->f_5, iParam1);
}
...
void func_116(int iParam0)
{
	...
	if (func_106((Global_1914319->f_3[iParam0 /*446*/])->f_21) && func_195((Global_1914319->f_3[iParam0 /*446*/])->f_21))
	{
		func_196((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_197((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_164(&((Global_1914319->f_3[iParam0 /*446*/])->f_317[iVar0 /*6*/]));
...
int func_121(int iParam0, int iParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1914319->f_3[iParam0 /*446*/])->f_25))
	{
		...
		func_206(iParam1, (Global_1914319->f_3[iParam0 /*446*/])->f_25, 1);
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1914319->f_3[iParam0 /*446*/])->f_28))
	{
		...
		func_206(iParam1, (Global_1914319->f_3[iParam0 /*446*/])->f_28, 1);
		...
		case 8:
			...
			else
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
				{
					...
					if (StackVal)
					{
						uParam0->f_1 = func_218(uParam0->f_3, uParam0->f_4, ENTITY::GET_ENTITY_HEADING(Global_35), 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
						...
						else
						{
							...
							else
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_227(1))
									{
										iVar1 = TASK::_0xF533D68FF970D190(func_229(), joaat("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3f, 1, 0);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
void func_134(var uParam0)
{
	...
	{
		if (func_231((*uParam0)[iLocal_149 /*45*/], 1, 1))
		{
			func_232((*uParam0)[iLocal_149 /*45*/]);
		}
	}
	iLocal_149++;
	if (iLocal_149 >= 2)
...
char* func_149(char* sParam0, int iParam1)
{
	...
	return func_241(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}
...
int func_152(int iParam0)
{
	...
	if (func_242())
	{
		if (!func_243(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
void func_161(int iParam0)
{
	...
	if (!func_94(&(Global_1310750->f_13321[iParam0 /*9*/])))
	{
		return;
	}
...
void func_162()
{
	...
	while (iVar0 < 2)
	{
		if (func_224(&((Local_150[iVar0 /*45*/])->f_34)))
		{
			func_223(&((Local_150[iVar0 /*45*/])->f_34));
		}
		func_247((Local_150[iVar0 /*45*/])->f_38);
		func_247((Local_150[iVar0 /*45*/])->f_39);
		iVar0++;
	}
}
...
int func_166(int iParam0, bool bParam1)
{
	...
	func_250(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_187(iParam0));
	func_186(iParam0, 0);
	return 1;
}
...
int func_169(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_173(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_172(iParam0))
	{
...
{
	if (iParam1 == joaat("a_m_m_armtownfolk_01"))
	{
		uParam0->f_3 = iParam1;
		return 1;
	}
...
void func_180(var uParam0, int iParam1, var uParam2, int iParam3, bool bParam4)
{
	...
	if (bParam4)
	{
		...
		func_183((*uParam0)[iParam3 /*45*/], 128);
	}
	if (!func_224(&(((*uParam0)[iParam3 /*45*/])->f_34)))
	{
		func_225(&(((*uParam0)[iParam3 /*45*/])->f_34), 1);
	}
	func_183((*uParam0)[iParam3 /*45*/], 32768);
	func_183((*uParam0)[iParam3 /*45*/], 1024);
...
{
	func_260(&((Global_1935369->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_194((Global_1914319->f_3[iParam0 /*446*/])->f_6, iParam1);
}
...
bool func_208(int iParam0)
{
	...
	if (Global_1572887->f_12 == -1)
	{
		return func_243(((*Global_1835011)[iParam0 /*74*/])->f_1, 1);
	}
...
int func_209()
{
	if (!func_243(((*Global_1835011)[4 /*74*/])->f_1, 1))
	{
		return 0;
	}
	else if (!func_243(((*Global_1347702)[66 /*49*/])->f_15, 1))
	{
		return 1;
	}
	else if (!func_243(((*Global_1347702)[67 /*49*/])->f_15, 1))
	{
		return 2;
	}
	else if (!func_243(((*Global_1835011)[38 /*74*/])->f_1, 1))
	{
		return 3;
	}
	else if (!func_243(((*Global_1347702)[68 /*49*/])->f_15, 1))
	{
		return 4;
	}
	else if (!func_243(((*Global_1835011)[59 /*74*/])->f_1, 1))
	{
		return 5;
	}
	else if (!func_243(((*Global_1835011)[67 /*74*/])->f_1, 1))
	{
		return 7;
	}
	else
...
{
	return func_194((Global_1935369->f_5[iParam0 /*11*/])->f_7, iParam1);
}
...
int func_216(var uParam0)
{
	...
	iVar0 = ENTITY::_0x59B57C4B06531E1E(func_274(PLAYER::PLAYER_ID()), 2.5f, iVar3, 1);
	if (iVar0 <= 0)
	{
		...
		while (iVar5 < iVar0)
		{
			...
			if (((!ENTITY::IS_ENTITY_DEAD(iVar1) && PED::IS_PED_HUMAN(iVar1)) && PED::IS_PED_MALE(iVar1)) && TASK::IS_PED_ACTIVE_IN_SCENARIO(iVar1, 0))
			{
				...
				if (StackVal)
				{
					...
					{
						if (TASK::IS_PED_ACTIVE_IN_SCENARIO(iVar1, 0) && !((TASK::_0x2D0571BB55879DA2(iVar1) == joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING") || TASK::_0x2D0571BB55879DA2(iVar1) == joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_DRINKING_BADASS")) || TASK::_0x2D0571BB55879DA2(iVar1) == joaat("PROP_HUMAN_SEAT_CHAIR_TABLE_EATING_KNIFE_FORK")))
						{
...
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0) || func_281(iParam0, 0))
	{
		return 0;
	}
	if (func_282(iParam0))
...
int func_222(var uParam0, vector3 vParam1)
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&vParam1))
	{
		func_283(&uLocal_18, uParam0->f_1, uParam0->f_7, 0);
		if (func_284(&uLocal_18, vParam1, uParam0->f_1, Global_35, 1077936128 /* Float: 3f */))
		{
			return 1;
		}
	}
...
void func_232(var uParam0)
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(func_299(&vVar0)))
	{
		return;
	}
...
int func_253(int iParam0, int iParam1, int iParam2)
{
	...
	return func_194(&(Global_23117.f_1651[iVar1]), iParam2);
}
...
void func_254(int iParam0, int iParam1, int iParam2)
{
	...
	iVar1 = (iVar0 * 10 + iParam1);
	func_258(Global_23117.f_1651[iVar1], iParam2);
}
...
bool func_272(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_205(iParam0)))
	{
		return false;
	}
	return !PERSCHAR::_0xEB98B38CA60742D7(func_187(iParam0));
}
...
int func_276(int iParam0)
{
	...
	return func_243(((*Global_1347702)[iParam0 /*49*/])->f_15, 1);
}
...
{
	if (((func_227(1) || AUDIO::_0x2B101AD9F651243A()) || AUDIO::IS_SCRIPTED_SPEECH_PLAYING(iParam0)) || AUDIO::IS_ANY_SPEECH_PLAYING(iParam0))
	{
		return 1;
	}
	return 0;
...
int func_284(var uParam0, vector3 vParam1, int iParam4, int iParam5, float fParam6)
{
...
int func_292(var uParam0, bool bParam1)
{
	...
	if ((((func_340(PLAYER::PLAYER_ID(), 1, 0, 1) || func_341()) || LAW::_0xF46108C50A22B029()) || LAW::_0x69E181772886F48B(PLAYER::PLAYER_ID())) || PLAYER::_0xD1F6B912785BFD35(PLAYER::PLAYER_ID()))
	{
		return 0;
	}
...
int func_294(int iParam0)
{
	...
	return func_211(iParam0, 1073741824 /* Float: 2f */);
}

void func_295(int iParam0)
{
	func_263(iParam0, 1073741824 /* Float: 2f */);
}
...
void func_296(var uParam0)
{
	...
	if (uParam0->f_2)
	{
		...
		while (iVar1 < 5)
		{
			if (func_106(&(uParam0->f_3[iVar1 /*3*/])) && (uParam0->f_3[iVar1 /*3*/])->f_2)
			{
...
int func_302(var uParam0, vector3 vParam1, vector3 vParam4, bool bParam7, int iParam8)
{
	int iVar0;
	int iVar1;
	...
	else if (func_330(uParam0, vParam1, iParam8, -1, 0, 0))
	{
		iVar0 = uParam0[0 /*4*/];
		iVar1 = uParam0[1 /*4*/];
		if ((ENTITY::DOES_ENTITY_EXIST(iVar0) && !func_281(iVar0, 0)) && (ENTITY::DOES_ENTITY_EXIST(iVar1) && !func_281(iVar1, 0)))
		{
			if (!func_109(vParam4))
			{
...
int func_339(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
...
int func_347(int iParam0)
{
	...
	return func_273(((*Global_1347702)[iParam0 /*49*/])->f_15);
}
...
int func_348(int iParam0, int iParam1)
{
	...
	return func_211((Global_1914319->f_3[iParam0 /*446*/])->f_10, 1024);
}
