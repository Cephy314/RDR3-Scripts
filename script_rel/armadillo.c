						...
						else
						{
							...
							else
							{
								...
								if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1))
								{
									...
									if (!func_227(1))
									{
										iVar1 = TASK::_FIND_CLOSEST_ACTIVE_SCENARIO_POINT_OF_TYPE(func_229(), joaat("WORLD_HUMAN_LEAN_BACK_WALL_SMOKING_BAR_CA"), 3f, 1, false);
										TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
int func_341()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_372(Global_35))
	{
		return 1;
	}
	return 0;
