...
int func_72(var uParam0)
{
	...
	func_152(uParam0, "script@vignette@beecher@charles_1@base", 1, 1, 0, 0);
	iLocal_15 = func_152(uParam0, "script@vignette@beecher@charles_1@action", 2, 0, 1, 1);
	iLocal_16 = func_152(uParam0, "script@vignette@beecher@charles_1@EXIT_LOOP", 1, 0, 0, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@beecher@charles_1@EXIT_ACTION", 0, 0, 0, 0);
	func_153(uParam0, "BCHR1AU");
	func_154(uParam0, joaat("COMP_BCCHRCNV1"), joaat("PLAYER_BCCHRCNV1"));
	func_155(uParam0, iLocal_14, 1, -1);
	uLocal_18 = func_156(uParam0, 0f, 5.38f, 1.95f, 0f, 0f, -1f, 8.64f, 8.12f, 4f, "volTriggerBeecherCharles1", joaat("VOLBOX"));
	func_157(uParam0, 1);
...
{
	return func_189(uParam0, &uLocal_18, 1);
}
...
int func_93(var uParam0)
{
	...
	{
		if (func_199(Global_35, uParam0->f_29, 0) > (25f * 25f) && !CAM::IS_SPHERE_VISIBLE(uParam0->f_23, 5f))
		{
...
void func_183(var uParam0)
{
	...
	{
		uParam0->f_1976.f_6 = PROPSET::_CREATE_PROPSET_2(uParam0->f_1976, func_250(uParam0, uParam0->f_1976.f_1), 1, func_282(uParam0, uParam0->f_1976.f_4), 3f, false, true);
	}
}
...
int func_188(var uParam0, int iParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		while (iVar1 < uParam0->f_1984)
		{
			...
			else if (func_198(uParam0, iVar1) || func_197(uParam0, iVar1))
			{
...
int func_189(var uParam0, var uParam1, bool bParam2)
{
	if (bParam2)
	{
	...
	return func_290(Global_35, *uParam1, 1, 0);
}
...
float func_209(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_298(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_251(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
bool func_276(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
