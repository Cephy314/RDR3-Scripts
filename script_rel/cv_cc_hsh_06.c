...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 7.1014f, 0.614f, 1.2141f, 7.75f, 1.5f, 1.5f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_HOSEA"), 1, 1, 1);
	func_151(uParam0, 0.7125f, -0.375f, 0.5f, 3f, 2f, 2.25f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_JOHN"), 1, 1, 1);
	func_152(uParam0, 0.7125f, -0.375f, 0.5f, 0f, 1f, 1f, 3f, joaat("VOLCYLINDER"), 1);
	func_153(uParam0, joaat("P_CHAIRFOLDING02X"), 1.20486f, -1.61288f, 0.00105286f, "CHAIR", 1, 0, 1);
	func_154(uParam0, "script@vignette@hosea_6@base", 1, 1, 0, 0);
	iLocal_16 = func_154(uParam0, "script@vignette@hosea_6@action_a", 2, 0, 1, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@hosea_6@action_b", 0, 0, 0, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@hosea_6@action_b_alt", 0, 0, 0, 1);
	func_155(uParam0, "CHSH6AU");
	func_156(uParam0, iLocal_14, 1, 3, 0, 0, 0);
	func_157(uParam0, iLocal_15, 2, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_MALE_B", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_156(uParam0, iLocal_15, 1, 5, 0, 0, 0);
	Local_19 = { func_158(uParam0, 1.1444f, -0.9919f, 0.508f, 13.2352f, 6f, 0.7f, 0.7f) };
	return 1;
}
