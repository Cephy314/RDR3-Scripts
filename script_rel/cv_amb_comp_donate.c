...
int func_61(int iParam0, int iParam1, int iParam2, var uParam3, bool bParam4, bool bParam5)
{
	int iVar0;
...
int func_76(var uParam0)
{
	...
	func_161(uParam0, 0.5875f, -0.3f, 0f, -16.25f, 0.75f, 0.75f, 3f, joaat("VOLCYLINDER"), 1);
	func_162(uParam0, 0.7f, -0.375f, 0f, 64.5f, 1.0225f, 1.775f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
...
void func_241(int iParam0)
{
	...
	Var0 = { func_322(joaat("CAMP_FUNDS_CASH")) };
...
int func_371(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	bVar0 = func_108(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(bVar0) || !func_124(bVar0, 0)) || (bParam3 && !func_52(iParam1)))
	{
		if (bParam2)
		{
...
int func_412(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_448(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_106(iParam0, 44, 1);
			}
...
void func_414(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (bParam0 == func_453(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_454(bParam0))
	{
		if (func_455(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
...
void func_419(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_462(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_462(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
void func_437(bool bParam0, int iParam1)
{
	...
	func_389(bParam0, func_467(iParam1));
...
void func_460(int iParam0)
{
	...
	func_478(iParam0, 1073741824 /* Float: 2f */);
}
