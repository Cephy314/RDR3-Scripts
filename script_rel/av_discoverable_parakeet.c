...
{
	func_33(uParam0, 11805, 11814, 12221);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "DISCOVERABLE_PARAKEET", "", vParam1, vParam4);
	...
	*(vVar0[24 /*3*/]) = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -4f, 1.5f, 0f) };
	...
	iVar103 = func_47(joaat("CAROLINA_PARAKEETS"));
	Global_32073.f_2697.f_1536 = (25 - iVar103);
	iVar102 = 0;
	while (iVar102 < Global_32073.f_2697.f_1536)
	{
		func_48(uParam0, iVar102, "DPP_1", iLocal_9, *(vVar0[iVar102 /*3*/]), &(fVar76[iVar102]), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
		iVar102++;
	}
}
...
int func_31(var uParam0)
{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			iLocal_11++;
			if (iLocal_11 >= Global_32073.f_2697.f_1536)
			{
				iLocal_11 = 0;
				iLocal_10 = 1;
			}
			break;
		case 1:
			if (func_59(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				func_60(*uParam0, 0);
		...
		case 2:
			...
			while (iVar0 < uParam0->f_20)
			{
				...
				else if (func_62(&(uParam0->f_20[iVar0 /*14*/]), Global_35))
				{
					Global_32073.f_2697.f_1536 = (Global_32073.f_2697.f_1536 - 1);
					func_63(0, -1);
					iLocal_39[iVar0] = 1;
				}
				iVar0++;
			}
			if (Global_32073.f_2697.f_1536 == 0 && func_47(joaat("CAROLINA_PARAKEETS")) == 25)
			{
				func_64(159);
				return 1;
			}
...
int func_38(int iParam0, vector3 vParam1, float fParam4)
{
	...
	if (func_68(vVar0, vVar0 + vVar3, vParam1))
	{
		return 3;
	}
	return 2;
...
void func_48(var uParam0, int iParam1, char* sParam2, int iParam3, vector3 vParam4, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)
{
...
int func_49(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_80(&(Global_1898164->f_1[0 /*5*/]));
		if (func_81(iVar0) && func_82(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
bool func_52()
{
	return (Global_1894899 & 1 != 0 && func_66() != -1);
}
...
int func_54(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	...
	func_84(iVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return iVar0;
}
...
int func_56(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
int func_57(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
int func_59(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		fVar7 = func_89(Global_36, uParam0->f_483);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_90(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
void func_65(var uParam0, bool bParam1, bool bParam2, bool bParam3)
{
	int iVar0;
...
bool func_68(struct<2> Param0, var uParam2, struct<2> Param3, Vector3 vParam5, struct<2> Param6, var uParam8)
{
	return (((Param3 - Param0) * (Param6.f_1 - Param0.f_1)) - ((Param3.f_1 - Param0.f_1) * (Param6 - Param0))) > 0f;
}

int func_69(vector3 vParam0, float fParam3)
{
	int iVar0;
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_101(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_70(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_101(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_102(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
void func_84(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_111(iParam1))
		{
			func_112(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_93(var uParam0, float fParam1)
{
...
void func_95(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_120(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_120(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_120(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_96(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_101((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_101(vector3 vParam0, vector3 vParam3, float fParam6, bool bParam7)
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_120(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
