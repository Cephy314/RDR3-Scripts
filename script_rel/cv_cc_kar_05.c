...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -5.5f, 3f, 1f, -25f, 3f, 2f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_KAREN"), 1, 1, 1);
	func_151(uParam0, -9.9514f, 4.6061f, 1.0883f, -151.2834f, 1.5f, 1.5f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -4.72f, 2.56f, 1.0307f, 64.08f, 0.72f, 1.52f, 3f, joaat("VOLCYLINDER"), 1);
	iLocal_16 = func_153(uParam0, joaat("P_BOTTLEBEER01A"), 0f, 0f, 0f, "BOTTLE", 0, 1, 1);
	func_154(uParam0, "script@vignette@karen_5@base", 1, 1, 0, 0);
	iLocal_17 = func_154(uParam0, "script@vignette@karen_5@action_a", 2, 0, 1, 0);
	iLocal_18 = func_154(uParam0, "script@vignette@karen_5@action_b_alt_susan_wnt", 0, 0, 0, 1);
	iLocal_19 = func_154(uParam0, "script@vignette@karen_5@action_b_alt_karen", 0, 0, 0, 1);
	func_155(uParam0, "CKAR5AU");
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SIT_DRINK"), "WORLD_HUMAN_SIT_DRINK_FEMALE_A", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_20 = { func_160(uParam0, -4.745f, 3.39f, 1.4354f, 170f, 7f, 0.1475f, 0.54f) };
	Local_30 = { func_160(uParam0, -9.2575f, 3.5225f, 1.4354f, 73.08f, 5.8375f, 0.1475f, 0.54f) };
	return 1;
}
...
int func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_15))
	{
		if (bLocal_40)
		{
			func_56((uParam0->f_107[iLocal_15 /*113*/])->f_1, 0, 0, 0, (uParam0->f_107[iLocal_15 /*113*/])->f_32.f_4, 1, 1, 0, 0, 0, 0);
		}
		else if (func_199(uParam0, Local_30, 1, 0))
		{
			func_200(uParam0, iLocal_15, 0, 1);
...
int func_198(var uParam0, int iParam1)
{
	...
	{
		if (!func_300((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
