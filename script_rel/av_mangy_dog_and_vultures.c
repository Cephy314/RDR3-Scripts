...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_48(uParam0, 2, "VULTURE1", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 3, "VULTURE2", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 4, "VULTURE3", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 5, "VULTURE4", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
	func_48(uParam0, 6, "VULTURE5", iLocal_11, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 0);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[1])
	{
		if (!bLocal_48 == 1)
		{
			if (func_63(uParam0, &uLocal_13, 1) || func_64(Global_35, &(uParam0->f_20[1 /*14*/]), 1) <= 144f)
			{
				bLocal_48 = true;
			}
		}
	...
	if (!&uParam0->f_469[2])
	{
		if (PED::IS_PED_DEAD_OR_DYING(&(uParam0->f_20[0 /*14*/]), true))
		{
			...
			{
				_NAMESPACE49::_0x3CA5E58C9731A16B(&(uParam0->f_20[0 /*14*/]), iLocal_43);
				uParam0->f_469[2] = 1;
			}
		}
	}
	if (!&uParam0->f_469[1] && !bLocal_48)
	{
		if (!&uParam0->f_469[3])
		{
			if (func_73(uParam0, 1.5f, 40f, 4, joaat("ACTION"), 1))
			{
				func_68(*uParam0, uParam0->f_483, 0);
				uParam0->f_469[3] = 1;
			}
		...
		if (!bLocal_47)
		{
			...
			while (iVar0 < uParam0->f_19)
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					if (iVar0 != 1)
					{
						func_74(uParam0->f_20[iVar0 /*14*/], 1, 1);
					}
					if (ENTITY::GET_ENTITY_MODEL(&(uParam0->f_20[iVar0 /*14*/])) == iLocal_11)
					{
						PED::APPLY_PED_DAMAGE_PACK(&(uParam0->f_20[iVar0 /*14*/]), "PD_Vulture_bloody_head", 0f, 1f);
					}
				}
				iVar0++;
			}
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				vVar1 = { ENTITY::GET_ENTITY_COORDS(&(uParam0->f_20[0 /*14*/]), true, false) };
			}
			if (!VOLUME::_DOES_VOLUME_EXIST(bLocal_12))
			{
				bLocal_12 = VOLUME::_CREATE_VOLUME_CYLINDER(vVar1, 0f, 0f, 0f, 30f, 30f, 30f);
				POPULATION::_0xB56D41A694E42E86(bLocal_12, 224, 0, 0, -1, -1, 0);
				POPULATION::_0x18262CAFEBB5FBE1(bLocal_12, 224, 0, 0, -1, -1, 0);
			}
			iLocal_41 = GRAPHICS::_0xFA50F79257745E74(vVar1, 5f, 1, -1, 0);
			iLocal_42 = GRAPHICS::_0xFA50F79257745E74(vVar1, 5f, 2, -1, 0);
			bLocal_47 = true;
		}
	}
	return 0;
...
int func_32(var uParam0, var uParam1)
{
	...
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_12))
	{
		POPULATION::_0x74C2B3DC0B294102(bLocal_12);
		POPULATION::_0xA1CFB35069D23C23(bLocal_12);
		func_5(bLocal_12);
	}
	return 1;
}
...
void func_71(var uParam0)
{
	...
	while (iVar0 <= 6)
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
		{
			...
			func_74(uParam0->f_20[iVar0 /*14*/], 0, 1);
			PED::_0x2208438012482A1A(&(uParam0->f_20[iVar0 /*14*/]), false, false);
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_64(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
