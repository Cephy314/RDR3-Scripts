...
int func_72(var uParam0)
{
	...
	{
		func_154(uParam0, 1.66677f, -0.70263f, 1f, 80f, 2f, 2f, 2.5f, -1612834106, joaat("APMS_COMP_TILLY"), 1, 1, 1);
		func_154(uParam0, -0.07f, -5.018f, 1.0999f, 0f, 2.4f, 2.5f, 3f, -1612834106, joaat("APMS_COMP_KAREN"), 1, 1, 1);
	}
