...
void func_27(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (func_47(&(((*Global_1360165)[iParam0 /*1157*/])->f_12), 1))
		{
			func_28(iParam0, 1, 0);
		}
	}
...
void func_28(int iParam0, int iParam1, bool bParam2)
{
	...
	func_48(&(((*Global_1360165)[iParam0 /*1157*/])->f_13), iParam1, bParam2);
}
...
void func_35(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		PED::SET_PED_CONFIG_FLAG(func_51(iParam0), 137, true);
	}
}
...
void func_37(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		PED::SET_PED_CONFIG_FLAG(func_51(iParam0), 204, true);
	}
	else
	{
		PED::SET_PED_CONFIG_FLAG(func_51(iParam0), 204, false);
	}
}
...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_51(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_53(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_52(int iParam0)
{
	if (func_12(iParam0))
	{
		if (ENTITY::DOES_ENTITY_EXIST(func_51(iParam0)))
		{
...
int func_58(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_32(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_64(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_66(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_67(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_67(iParam0, 0));
					func_68(iParam0);
				}
			}
			else
...
float func_64(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_74(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_65(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_127 = func_75(iParam0);
		return ((*Global_1360165)[iParam0 /*1157*/])->f_127;
	}
	return 0;
}
...
int func_67(int iParam0, bool bParam1)
{
	...
	{
		((*Global_1360165)[iParam0 /*1157*/])->f_126 = func_76(iParam0);
	}
