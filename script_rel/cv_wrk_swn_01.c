...
int func_72(var uParam0)
{
	...
	func_154(uParam0, 0.8625f, -0.325f, 0f, -13.5f, 1.665f, 2.31f, 5f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_154(uParam0, -1.7625f, 2.9f, 0f, -13.5f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_159(uParam0, "script@vignette@wrk@swanson_work_1@base", 1, 1, 0, 0);
	func_159(uParam0, "script@vignette@wrk@swanson_work_1@action", 0, 0, 1, 0);
	return 1;
}
...
void func_247(var uParam0, int iParam1, float fParam2, float fParam3, float fParam4)
{
	uParam0->f_23 = { func_319(iParam1) + Vector(fParam4, fParam3, fParam2) };
