...
void func_75(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == -2076669067)
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_179(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_179(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar2), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
int func_97()
{
	if (((((func_209(839908568 /* GXTEntry: "Bounty Poster of Arthur" */, 400) || func_209(-1134030454 /* GXTEntry: "Bounty Notice" */, 400)) || func_209(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_1"), 400)) || func_209(joaat("DOCUMENT_ARTHUR_HIGH_BOUNTY_2"), 400)) || func_209(joaat("DOCUMENT_ARTHUR_HAS_POSTER_1"), 400)) || func_209(joaat("DOCUMENT_ARTHUR_HAS_POSTER_2"), 400))
	{
		return 1;
	}
	return 0;
		...
		else if (func_76(bParam0, 412399755))
		{
			...
			if (func_224() == 0)
			{
				...
				if (((bParam0 == 281887510 || bParam0 == -164081697) || bParam0 == -1161319399) || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
				{
					...
					{
						func_73(43, bParam0, iParam1, -1791518714, iVar1, 0, -1, 0);
		...
		else if (func_76(bParam0, 709057512))
		{
			...
			if (func_224() == 1)
			{
				...
				if ((bParam0 == -222563712 || bParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || bParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
				{
					if (func_226(bParam0) < func_227(bParam0))
					{
						func_73(43, bParam0, iParam1, -2087881550, iVar1, 0, -1, 0);
		...
		else if (func_76(bParam0, -1478961327))
		{
			...
			if (func_224() == 2)
			{
				...
				if (bParam0 == 2116770557)
				{
					...
					if (func_226(bParam0) < func_227(bParam0))
					{
						func_73(43, bParam0, iParam1, 1908068621, iVar1, 0, -1, 0);
		...
		else if (func_76(bParam0, -1238404098))
		{
			...
			if (func_224() == 3)
			{
				...
				if (((bParam0 == 2085530337 || bParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || bParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
				{
					if (func_226(bParam0) < func_227(bParam0))
					{
						func_73(43, bParam0, iParam1, 1611247019, iVar1, 0, -1, 0);
		...
		else if (func_76(bParam0, 1160548794))
		{
			...
			if (func_224() == 4)
			{
				...
				if (((bParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || bParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || bParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || bParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
				{
					if (func_226(bParam0) < func_227(bParam0))
					{
						func_73(43, bParam0, iParam1, 1319635688, iVar1, 0, -1, 0);
...
void func_118(int iParam0, bool bParam1)
{
	...
	func_179(MISC::_CREATE_VAR_STRING(2, sVar1), MISC::_CREATE_VAR_STRING(2, sVar2), MISC::GET_HASH_KEY("toast_log_blips"), MISC::GET_HASH_KEY("BLIP_RC_TREASURE_HUNTER"), joaat("player_menu"), MISC::_CREATE_VAR_STRING(2, sVar3), -1507719118, -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
}
...
void func_138(bool bParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((bParam1 == 1 || func_76(bParam0, 1443104131)) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || bParam0 == -1424823393) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || bParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
...
void func_212(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bVar1 > 0)
	{
		...
		func_93(func_264(1644987397), bVar1);
	}
}
