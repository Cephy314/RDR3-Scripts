...
bool func_6(var uParam0)
{
	if (func_21(251, 1))
	{
		bLocal_9 = func_22(251, 1, 0, 1, 1, 1);
	}
	return (ENTITY::DOES_ENTITY_EXIST(bLocal_9) && HUD::_TEXT_DATABASE_HAS_LOADED("IND3AUD"));
}
...
int func_21(int iParam0, bool bParam1)
{
	...
	if (func_48(iParam0, 32) && !bParam1)
	{
		...
		if (func_51() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_52(iParam0));
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_52(iParam0)))
	{
		func_53(iParam0, 128);
		return 1;
	}
...
{
	func_60(bLocal_9, vLocal_11, fLocal_14, 2, 1073741824 /* Float: 2f */);
	HUD::_TEXT_DATABASE_REQUEST("BRT3AUD");
	func_61(&uLocal_16, bLocal_9, "IND3_PAPERBOY", 0);
	iLocal_10 = func_62(joaat("WORLD_HUMAN_SELL_PAPER"), vLocal_11, fLocal_14, 0, -1f, 1);
	TASK::_TASK_USE_SCENARIO_POINT(bLocal_9, iLocal_10, 0, -1, false, true, 0, false, -1f, false);
	PED::SET_PED_CONFIG_FLAG(bLocal_9, 130, false);
...
int func_25(var uParam0)
{
	...
	if (!func_66(bLocal_9, Global_35, 100f, 1) || ENTITY::IS_ENTITY_DEAD(bLocal_9))
	{
		return 1;
	}
	return 0;
...
void func_60(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	bool bVar0;
	bool bVar1;
	bool bVar2;
	...
	if (bParam0 == func_92(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_93(bParam0))
	{
		if (func_94(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_81(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
		if (PED::IS_PED_ON_VEHICLE(bVar1, false))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(bVar0) && !ENTITY::IS_ENTITY_DEAD(bVar0))
			{
				...
				func_60(bVar0, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
		else if (PED::IS_PED_ON_MOUNT(bVar1))
		{
			...
			{
				iParam5 = (iParam5 - iParam5 & 4);
				func_60(bVar2, vParam1, fParam4, iParam5, iParam6);
			}
			return;
		}
	}
	...
	if (func_81(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_81(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_81(iParam5, 32), true);
	...
	else if (func_81(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_81(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_81(iParam5, 64))
		{
...
void func_61(var uParam0, bool bParam1, char* sParam2, bool bParam3)
{
	...
	if (func_95(uParam0, bParam1, sParam2))
	{
...
int func_62(int iParam0, vector3 vParam1, float fParam4, float fParam5, int iParam6, int iParam7)
{
...
int func_66(bool bParam0, int iParam1, float fParam2, bool bParam3)
{
...
int func_73(int iParam0, bool bParam1)
{
	...
	func_53(iParam0, 129);
	func_72(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_52(iParam0));
	func_50(iParam0, 0);
	return 1;
}
...
bool func_91(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_52(iParam0));
}
...
bool func_95(var uParam0, bool bParam1, char* sParam2)
{
	bool bVar0;
	int iVar1;
...
float func_111(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_122(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
