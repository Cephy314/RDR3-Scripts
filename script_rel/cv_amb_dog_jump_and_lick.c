...
int func_72(var uParam0)
{
	...
	func_152(uParam0, -0.1235f, 0.2914f, 1.0827f, -76.75f, 1.9375f, 1.5675f, 3f, joaat("VOLBOX"), joaat("APMS_COMP_BILL"), 1, 1, 1);
	func_152(uParam0, -1.086f, 8.8789f, 1.0827f, -76.75f, 1.2975f, 1.0125f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
...
{
	func_247(uParam0, iParam1, 0, 0, 0, -1, 0, 0f, 1065353216 /* Float: 1f */, 1);
}
...
int func_248(bool bParam0, int iParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
