...
void func_15(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	uVar1 = func_50(joaat("HORSE_CLASS_RIDING"), 1);
	func_51(uParam0, 0, "RR_HORSE", uVar1, vParam1, (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	func_51(uParam0, 1, "RR_MAN", uVar0, vParam1, (0f + vParam4.z), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
}
...
int func_32(var uParam0)
{
	...
	switch (iLocal_9)
	{
		case 0:
			...
			{
				func_68(&(uParam0->f_20[0 /*14*/]), (uParam0->f_20[1 /*14*/])->f_5, (uParam0->f_20[1 /*14*/])->f_8, 2, 1073741824 /* Float: 2f */);
		...
		case 1:
			if (func_72(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
				{
					...
					if (bLocal_15)
					{
						TASK::TASK_PLAY_ANIM(0, "AI_GESTURES@GEN_MALE@STANDING@SPEAKER", "NEUTRAL_WAVE_FL_001", 4f, -4f, 1000, 8, 0f, false, 0, false, 0, false);
					}
