...
int func_75(var uParam0)
{
	...
	func_155(uParam0, 36.4401f, -18.1472f, -0.0375f, -33.25f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_155(uParam0, 34.2901f, -18.2597f, -0.0375f, -33.25f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_ABIGAIL"), 1, 1, 1);
	func_155(uParam0, 32.8901f, -19.1347f, -0.0375f, -31.75f, 2.59f, 1.0825f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_161(uParam0, iLocal_14, 2, joaat("PROP_HUMAN_SEAT_CHAIR_KNITTING"), "PROP_HUMAN_SEAT_CHAIR_KNITTING_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 2f, 1);
	...
	func_161(uParam0, iLocal_15, 2, joaat("PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_LEFT"), "PROP_CAMP_JACK_ES_SLEEP_BED_PILLOW_MALE_A", -1, 0, 640f, 1065353216 /* Float: 1f */, 1);
...
int func_87(var uParam0)
{
	...
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
	{
		iLocal_19 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_181(1309495497, 1, 0));
	}
...
int func_199(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_116() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_291() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_216(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (((uParam0->f_107[iVar0 /*113*/])->f_32.f_60 > 0f && !(uParam0->f_107[iVar0 /*113*/])->f_32.f_62) && func_209(uParam0, (uParam0->f_107[iVar0 /*113*/])->f_32.f_61, (uParam0->f_107[iVar0 /*113*/])->f_32.f_60))
		{
