...
int func_72(var uParam0)
{
	...
	func_152(uParam0, "script@vignette@sadie_1@base", 1, 1, 0, 0);
	iLocal_16 = func_152(uParam0, "script@vignette@sadie_1@action_a", 2, 0, 1, 0);
	iLocal_17 = func_152(uParam0, "script@vignette@sadie_1@action_b", 2, 0, 0, 0);
	iLocal_18 = func_152(uParam0, "script@vignette@sadie_1@action_b_alt", 2, 0, 0, 1);
	iLocal_19 = func_152(uParam0, "script@vignette@sadie_1@exit", 0, 0, 0, 0);
	func_153(uParam0, "CSA1AUD");
	func_154(uParam0, joaat("COMP_SADCNV1"), joaat("PLAYER_SADCNV1"));
	func_155(uParam0, iLocal_14, -138.4f, 0);
	func_156(uParam0, iLocal_15, 1, -1);
	Local_20 = { func_157(uParam0, 2.3575f, 0.5175f, 1.099f, -155.25f, 6.06f, 0.77f, 0.4875f) };
	return 1;
}
