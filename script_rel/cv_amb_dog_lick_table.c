...
int func_72(var uParam0)
{
	...
	iLocal_15 = func_151(uParam0, "script@ambient@campfiregeneral@DOG_LICK_TABLE@action", 64, 0, 0, 0);
	func_152(uParam0, -0.7125f, 0.0289f, 1.4625f, -90.5f, 1.2125f, 1.1975f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	func_152(uParam0, -7.986f, 0.6039f, 1.0827f, -113.25f, 1.3f, 1.3f, 3f, joaat("VOLBOX"), -1, 1, 1, 1);
	iVar0 = MISC::GET_RANDOM_INT_IN_RANGE(0, 2);
	switch (iVar0)
	{
		case 0:
			iLocal_16 = func_153(uParam0, iLocal_15, "PL_idleAction", 1);
			func_154(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_DIGGING"), "WORLD_ANIMAL_DOG_DIGGING", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
		...
		case 1:
			...
			func_154(uParam0, iLocal_14, 3, joaat("WORLD_ANIMAL_DOG_DIGGING"), "WORLD_ANIMAL_DOG_DIGGING", -1, 0, 55f, 1065353216 /* Float: 1f */, 1);
			func_155(uParam0, iLocal_14, 3, 0);
			func_156(uParam0, iLocal_14, 1.6f, 1065353216 /* Float: 1f */, 5f);
			break;
		default:
			return 0;
	}
...
int func_85(var uParam0)
{
	...
	{
		func_187(uParam0);
		func_171(uParam0, uParam0->f_2047, 1);
	}
...
{
	func_189(uParam0, iLocal_15, "b_breakout", 1);
	return 1;
}
...
int func_91(var uParam0)
{
	...
	if (uParam0->f_2048 >= 0)
	{
		func_171(uParam0, uParam0->f_2048, 1);
	}
	func_195(uParam0);
...
int func_107(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_120(bVar0, 0))
	{
		...
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_205(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
...
void func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	bVar1 = func_223(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_225(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
void func_156(var uParam0, int iParam1, float fParam2, int iParam3, float fParam4)
{
...
float func_205(int iParam0, bool bParam1, bool bParam2)
{
...
void func_394(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_221(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_221(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_221(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_221(iParam5, 32), true);
	...
	else if (func_221(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_221(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_221(iParam5, 64))
		{
			if (!CAM::IS_SCREEN_FADED_OUT())
			{
			}
...
void func_417(bool bParam0, int iParam1)
{
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_223(iParam1), bParam0, 0);
		PED::_0xED1C764997A86D5A(func_223(iParam1), bParam0);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_321(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_386(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
