	...
	switch (iLocal_16)
	{
		...
		case 8:
			...
			if (!func_60(uLocal_24, 2))
			{
				...
				{
					TASK::TASK_GO_STRAIGHT_TO_COORD(&(uLocal_14[0]), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(&(uLocal_14[0]), 0f, 5f, 0f), 1f, 20000, 1193033728, 1056964608, 0);
...
void func_29(int iParam0, int iParam1)
{
	...
	{
		func_81(Global_35, -383172193 /* GXTEntry: "No Neckwear" */, 0, 1742327865, 0, 1, 0, 0, 1, 0);
...
int func_95(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_41(bVar0, 0))
	{
		if (func_41(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_128(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4)
{
	...
	if (!VOLUME::_DOES_VOLUME_EXIST(uParam0->f_4) && !func_242(uParam0->f_5, 0f, 0f, 0f))
	{
...
struct<5> func_206(int iParam0, bool bParam1, int iParam2)
{
	...
	switch (func_371(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_216(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			{
				Var5.f_9 = -1591664384;
				if (!func_374(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_374(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_375(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_216(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
float func_230(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_350(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_240(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_294(int iParam0, var uParam1)
{
	...
	*uParam1 = func_445(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
int func_295(int iParam0, var uParam1)
{
	...
	*uParam1 = func_445(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_394(*uParam1, 0))
	{
		return 0;
	}
...
void func_298(bool bParam0, var uParam1)
{
	...
	func_448(bParam0, *uParam1);
	func_448(bParam0, uParam1->f_1);
}
...
void func_300(bool bParam0, var uParam1)
{
	...
	func_448(bParam0, *uParam1);
	func_448(bParam0, uParam1->f_1);
	func_448(bParam0, uParam1->f_2);
	func_448(bParam0, uParam1->f_3);
	func_448(bParam0, uParam1->f_4);
	func_448(bParam0, uParam1->f_5);
}
...
int func_304(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_73(iParam0))
	{
		return 0;
...
void func_313(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_240(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_240(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_320(int iParam0, float fParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)
{
	...
	func_486(bVar0, iParam0, fParam1);
	func_487(iParam0, fParam1, bParam4, iParam5);
	if (!ENTITY::IS_ENTITY_DEAD(bVar0))
	{
		ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(bVar0, func_331(iParam0), BUILTIN::CEIL(fParam1));
		return 1;
	}
	else
	{
...
void func_322(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	iVar0 = (iVar0 - iParam6);
	func_495(iParam0, iVar5, iVar4, iVar3, iVar2, iVar1, iVar0);
}
...
int func_340(bool bParam0, bool bParam1)
{
	if (!func_503(Global_43800))
	{
		Global_43800 = func_507("CUTSCENE_SKIP", joaat("INPUT_SKIP_CUTSCENE"), 5, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, 1065353216 /* Float: 1f */, 0, 3, joaat("LONG_TIMED_EVENT"), 0);
	...
	else
	{
		...
		if (func_511(Global_43800, 1) != 0f && bParam0)
		{
	...
	if (func_517(&iVar0))
	{
		if (func_394(iVar0, 0))
		{
			if (func_377(iVar0) == -525676072)
			{
				...
				func_81(Global_35, -2065815962 /* GXTEntry: "No Hat" */, 0, 1108822547, 0, 1, 0, 0, 0, 0);
			}
			else
			{
...
void func_357(var uParam0)
{
	...
	if (func_113(uParam0, 2048) && !func_103(func_518(uParam0)))
	{
		...
		if ((!ENTITY::IS_ENTITY_DEAD(bVar1) && ((bVar0 && ENTITY::IS_ENTITY_IN_VOLUME(bVar1, uParam0->f_4, true, 0)) || func_113(uParam0, -2147483648))) && PED::GET_MOUNT(Global_35) != bVar1)
		{
			...
			func_306(bVar1, func_518(uParam0), func_519(uParam0), iVar2, 1073741824 /* Float: 2f */);
		}
		...
		{
			func_306(bVar3, func_518(uParam0), func_519(uParam0), 2, 1073741824 /* Float: 2f */);
		}
	}
}
...
void func_358(var uParam0)
{
	...
	if ((func_113(uParam0, 268435456) && !func_103(func_518(uParam0))) && PED::IS_PED_IN_ANY_VEHICLE(Global_35, false))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(bVar0))
		{
			...
			func_306(bVar0, vVar1, func_520(vVar1, Global_36, 1), 2, 1073741824 /* Float: 2f */);
...
{
	return func_216(joaat("CHARACTER"), func_524(), -1591664384, bParam0);
}
...
bool func_374(int iParam0, var uParam1, int iParam2, int iParam3)
{
...
int func_379(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
		...
		while (iVar28 < 4)
		{
			...
			if (func_374(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_543(0))
				{
					...
					func_544(WEAPON::_0x5C2EA6C44F515F34(iParam0), bParam1, iParam6);
					func_545(iParam0, bParam1);
					return 1;
				}
				if (!WEAPON::HAS_PED_GOT_WEAPON(Global_35, iParam0, 0, false))
				{
...
int func_403(var uParam0, int iParam1, int iParam2)
{
	...
	if (func_547("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		...
		while (iVar3 < iVar2)
		{
			...
			{
				if (((WEAPON::_0x0556E9D2ECF39D01(Var4.f_4) && (!WEAPON::_0xC75386174ECE95D5(Var4.f_4) || func_546(iParam1, 16))) && (!WEAPON::_0x6AD66548840472E5(Var4.f_4) || func_546(iParam1, 4))) && (!func_549(Var4.f_4) || func_546(iParam1, 8)))
				{
...
void func_404(int iParam0, float fParam1)
{
	...
	{
		bVar1 = fParam1 != 0f;
		bVar2 = func_551(fParam1 < 0f, "rpg_cold", "rpg_hot");
		func_552(1, bVar1, 1, bVar2);
...
int func_413(int iParam0, int iParam1)
{
	...
	Var29 = { func_216(iParam1, Var0, joaat("SLOTID_HORSE_MANE"), 0) };
...
int func_414(int iParam0, int iParam1)
{
	...
	Var29 = { func_216(iParam1, Var0, joaat("SLOTID_HORSE_TAIL"), 0) };
	return func_556(Var29, 1);
}
...
int func_445(struct<4> Param0, int iParam4, int iParam5)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_574(Param0, iParam4, &Var0, iParam5))
	{
		return Var0.f_4;
	}
	return 0;
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_577(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_135(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
void func_470(int iParam0)
{
	...
	func_590(iParam0, 1073741824 /* Float: 2f */);
}
...
void func_486(bool bParam0, int iParam1, float fParam2)
{
	char* sVar0;
	...
	{
		PED::_0x437C08DB4FEBE2BD(bParam0, func_601(iParam1), fParam2, -1);
	}
}
...
void func_495(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
...
int func_507(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4, int iParam5, bool bParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12)
{
	int iVar0;
	int iVar1;
...
float func_511(int iParam0, bool bParam1)
{
	int iVar0;
...
float func_520(struct<2> Param0, int iParam2, struct<2> Param3, var uParam5, int iParam6)
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_545(int iParam0, bool bParam1)
{
	...
	{
		iVar1 = func_640(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), bParam1);
...
int func_547(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_218(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
void func_553(bool bParam0, bool bParam1, bool bParam2)
{
	...
	bVar0 = func_502(0, 1, bParam0, bParam1);
...
int func_558(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_560(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> Var0;
	int iVar14;
	int iVar15;
...
int func_562(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	struct<16> Var28;
...
void func_564(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_650(func_649(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_246())
	{
...
int func_574(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
...
void func_595(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_602(int iParam0, float fParam1, int iParam2)
{
	if (iParam2 == 2)
	{
		iParam2 = func_484();
...
int func_644(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_672(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_674(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		Var61 = { func_646(&Var1) };
		Var61.f_10 = iParam4;
		iVar0 = func_647(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<28> func_671(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<28> Var0;
	struct<29> Var28;
...
struct<17> func_673(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<17> Var0;
	struct<15> Var17;
