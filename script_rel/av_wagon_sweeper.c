...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_52(uParam0, 0, "male", iVar0, 0f, 0f, 0f, 0f, 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
		{
			if (func_71(uParam0, 1065353216 /* Float: 1f */, 55f, 4, 15f, 1112014848 /* Float: 50f */))
			{
				if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
				{
					func_69(uParam0);
			...
			if (ANIMSCENE::_0x25557E324489393C(uParam0->f_3.f_1))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, (uParam0->f_20[0 /*14*/])->f_1))
					{
						...
						if (TASK::DOES_SCENARIO_EXIST_IN_AREA(vVar0, 0.5f, true, 0, false) && !TASK::_0xEA31F199A73801D3(TASK::_0xF533D68FF970D190(vVar0, joaat("WORLD_HUMAN_BROOM_PUTDOWN"), 0.5f, 0, 0)))
						{
