...
int func_78(var uParam0)
{
	...
	func_159(uParam0, 1.575f, -2.975f, 1.15f, 43.56f, 5.738f, 4f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_160(uParam0, 2.7376f, -2.875f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, joaat("VOLBOX"), 1);
	...
	func_164(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	iLocal_53 = func_167(uParam0, 2.7376f, -2.875f, 0f, 0f, 0f, -46.75f, 2.2275f, 1.5775f, 6f, "GRIEF", joaat("VOLBOX"));
	return 1;
}
...
int func_114(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_127(bVar0, 0))
	{
		if (func_127(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
void func_346(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_380(iParam1))
		{
			func_381(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
int func_430(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_462(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
...
void func_431(bool bParam0, int iParam1)
{
	...
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(func_239(iParam1), bParam0, 0);
