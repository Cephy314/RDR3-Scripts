	...
	switch (*uParam0)
	{
		case 30:
			...
			*(vLocal_41[0 /*3*/]) = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, -1.5f, 0f, 0f) };
			...
			uLocal_38[1] = func_49(joaat("HORSE_CLASS_RIDING"), 1);
			*(vLocal_41[1 /*3*/]) = { vParam1 };
			...
			func_51(uParam0, 0, "WWH_MAN", &(uLocal_38[0]), *(vLocal_41[0 /*3*/]), &(uLocal_48[0]), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			func_51(uParam0, 1, "WWH_HORSE", &(uLocal_38[1]), *(vLocal_41[1 /*3*/]), &(uLocal_48[1]), 1, 1, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
			break;
	}
}
			...
			if (!func_60(&(uParam0->f_20[0 /*14*/]), 985146578))
			{
				if (iLocal_74 < Local_51)
				{
					if (!func_7((Local_51[iLocal_74 /*11*/])->f_1))
					{
						TASK::CLEAR_PED_TASKS(&(uParam0->f_20[0 /*14*/]), 1, 0);
						TASK::CLEAR_PED_TASKS(&(uParam0->f_20[1 /*14*/]), 1, 0);
						TASK::TASK_LEAD_AND_CONVERSE(&(uParam0->f_20[0 /*14*/]), &(uParam0->f_20[1 /*14*/]), Local_51[iLocal_74 /*11*/], 1, 5f, 2.5f, 1.6f, 1092616192, 1f);
						TASK::TASK_FOLLOW_AND_CONVERSE_WITH_PED(&(uParam0->f_20[1 /*14*/]), &(uParam0->f_20[0 /*14*/]), 0, 0, -1082130432, -1f, 32, 1.5f, -0.5f, 1069547520, 1073741824);
						iLocal_74++;
						return 0;
					}
				}
