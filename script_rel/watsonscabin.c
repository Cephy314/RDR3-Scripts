...
int func_11()
{
	...
	iLocal_14 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1816.485f, 658.493f, 131.7874f, 0f, 0f, 0f, 8f, 8f, 5f, "Watson's Cabin - m_volWatsCats");
	iVar0 = POPULATION::_CREATE_POPZONE_FROM_VOLUME(iLocal_14);
	POPULATION::SET_POPZONE_POPULATION_SET(iVar0, -1481802551);
	POPULATION::_0x7E6BC0B94F5928F0(iVar0, 1, 1);
...
void func_25()
{
	...
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(63385776, false);
	}
	else
	{
		TASK::_SET_SCENARIO_GROUP_ENABLED_HASH(63385776, true);
	}
	if (func_50(7, 2048))
	{
		func_51(-334729750, 1, 0);
	}
	else
	{
		func_51(-334729750, 0, 0);
	}
	func_52(7);
	func_53(7, 1);
}
...
bool func_61(int iParam0)
{
	...
	return ((((*Global_1888801)[iParam0 /*35*/])->f_20 == 1 || ((*Global_1888801)[iParam0 /*35*/])->f_20 == 2) && !func_103(iParam0));
}
...
void func_64(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_105(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	if (!func_106(iParam4))
	{
		if (func_54(iParam0))
		{
			iParam4 = func_107(func_6(iParam0));
		}
		else
		{
	...
	if (func_106(iParam4))
	{
		iVar3 = func_108(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_110(func_109(iParam2));
	}
	...
	{
		iVar4 = func_114(func_113());
		iVar5 = func_115(func_113());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_116(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_117(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_117(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_117(&cVar6, joaat("COLOR_PURE_WHITE")), func_117(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1894899->f_9 = 0;
	}
	Global_1934266->f_148 = func_118(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_66(int iParam0, bool bParam1)
{
	...
	switch (func_6(iParam0))
	{
		...
		case 2:
		case 11:
			func_123(func_122(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_123(func_122(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_123(func_122(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_123(func_122(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_123(func_122(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_123(func_122(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_67()
{
	return (Global_1894899 & 1 != 0 && func_124() != -1);
}
...
void func_69(int iParam0, bool bParam1, int iParam2, bool bParam3, bool bParam4)
{
	...
	while (iVar0 < 4)
	{
		...
		if (((func_125(iVar1) && !func_128(iVar1, iParam2)) && (!bParam3 || !func_129(iVar1))) && (!bParam4 || !func_130(iVar1)))
		{
			if (iVar1 != iParam0)
			{
				func_131(iVar0);
...
int func_96(int iParam0)
{
	...
	if (((!func_149(94) && !func_150(94)) && !func_149(95)) && !func_150(95))
	{
	}
	func_144(iParam0, 1);
	return 1;
...
{
	if ((iParam0 == 22 || iParam0 == 37) && !func_153())
	{
		return 1;
	}
	if (iParam0 == 61)
...
char* func_105(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;
	...
	{
		sVar0 = func_158(func_157(Global_36));
	}
...
char* func_117(char* sParam0, int iParam1)
{
	...
	return func_161(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_118(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
int func_120(int iParam0)
{
	...
	if (func_162())
	{
		if (!func_163(((*Global_1835011)[3 /*74*/])->f_1, 1))
		{
...
{
	func_167((Global_1935369->f_5[iParam0 /*11*/])->f_6, 1);
	func_168((Global_1935369->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_133(int iParam0)
{
	...
	{
		func_171((Global_1914319->f_3[iParam0 /*446*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_172((Global_1914319->f_3[iParam0 /*446*/])->f_10, 0);
...
void func_146(int iParam0, int iParam1, vector3 vParam2, char* sParam5)
{
	int iVar0;
	int iVar1;

	iVar0 = func_180(vParam2);
	iVar1 = 0;
	while (iVar1 < Global_36307)
	{
		if ((func_181(iVar1) == iParam0 && func_182(iVar1) == iParam1) && func_183(iVar1) == iVar0)
		{
...
int func_155(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		iVar0 = func_188(&(Global_1898164->f_1[0 /*5*/]));
		if (func_184(iVar0) && func_189(((*Global_1347702)[iVar0 /*49*/])->f_12, 131072))
		{
			return 0;
		}
	}
...
char* func_156(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
char* func_161(char* sParam0, int iParam1)
{
...
int func_180(struct<2> Param0, var uParam2)
{
	int iVar0;
...
int func_191(vector3 vParam0, int iParam3)
{
	...
	func_209(iParam3, &vVar0, &Var3, &uVar6);
	if (func_210(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
...
void func_209(int iParam0, var uParam1, var uParam2, var uParam3)
{
	switch (iParam0)
	{
		case 0:
...
bool func_210(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
