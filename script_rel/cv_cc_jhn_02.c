...
bool func_394(bool bParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
		...
		while (iVar28 < 4)
		{
			...
			if (func_556(iParam0, &Var0, iVar5, 0))
			{
				...
				if (func_560(0))
				{
					...
					func_561(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
