...
int func_326(var uParam0, var uParam1, bool bParam2)
{
	...
	if (!bParam2)
	{
		if (func_384(iVar1, Global_35, 16, -1, 0, 0, 5))
		{
...
int func_347()
{
	if (PED::_IS_PED_CARRYING(Global_35) || func_416(Global_35))
	{
		return 1;
	}
	return 0;
...
int func_384(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<15> Var0;
...
int func_500(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_531(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
