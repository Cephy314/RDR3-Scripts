...
int func_11()
{
	bLocal_14 = ((*Global_1888801)[82 /*35*/])->f_4;
	VOLUME::_0xB469CFD9E065EB99(bLocal_14, 22);
	bLocal_15 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Butcher - m_volGeneral Agg");
	VOLUME::_0x39816F6F94F385AD(bLocal_15, 2595.509f, 778.3701f, 87.90205f, 0f, 0f, 70f, 2.456799f, 2.667848f, 2.166918f);
	VOLUME::_0x39816F6F94F385AD(bLocal_15, 2593.104f, 779.3081f, 87.87495f, 0f, 0f, 70.00001f, 5.401831f, 2.666181f, 2.080325f);
	VOLUME::_0xB469CFD9E065EB99(bLocal_15, 10082);
	iLocal_16 = POPULATION::_CREATE_POPZONE_FROM_VOLUME(bLocal_14);
...
void func_46()
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		bLocal_18 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 50.23434f, 27.58518f, 8.132094f, "Butcher Creek - m_volFarmerRegistration");
		bLocal_20 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Butcher Creek - m_volFarmerThreat Agg");
		VOLUME::_0x39816F6F94F385AD(bLocal_20, 2696.193f, 704.9335f, 76.68376f, 0f, 0f, 88.96565f, 4.466922f, 1.336465f, 4.423785f);
		VOLUME::_0x39816F6F94F385AD(bLocal_20, 2698.47f, 703.6447f, 76.68376f, 0f, 0f, -30.46352f, 4.936317f, 2.843117f, 4.423785f);
		VOLUME::_0x39816F6F94F385AD(bLocal_20, 2717.371f, 710.274f, 77.27374f, 0f, 0f, 178.9532f, 3.930448f, 4.35889f, 8.132094f);
		bLocal_19 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Butcher Creek - m_volFarmerRestricted Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_19, bLocal_20);
		VOLUME::_0xBCE668AAF83608BE(bLocal_19, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 34.23434f, 22.58518f, 8.132094f);
		bLocal_21 = VOLUME::_CREATE_VOLUME_AGGREGATE_WITH_CUSTOM_NAME("Butcher Creek - m_volFarmerWarning Agg");
		VOLUME::_0x6E0D3C3F828DA773(bLocal_21, bLocal_19);
		VOLUME::_0xBCE668AAF83608BE(bLocal_21, 2711.161f, 710.3177f, 77.27374f, 0f, 0f, -151.2205f, 46.23434f, 26.58518f, 8.132094f);
		sLocal_17 = "BUTCHER_CREEK";
		LAW::_CREATE_GUARD_ZONE(sLocal_17);
		LAW::_0x8C598A930F471938(sLocal_17, bLocal_18);
		LAW::_0xA1B0E6301E2E02A6(sLocal_17, bLocal_20);
		LAW::_0x35815F372D43E1E5(sLocal_17, bLocal_19);
		LAW::_0xAD3E07C37A7C1ADC(sLocal_17, bLocal_21);
		LAW::_SET_GUARD_ZONE_POSITION(sLocal_17, 2717.486f, 709.7006f, 79.6157f);
		LAW::_0xA8A74AA79FB67159(sLocal_17, bLocal_18);
	}
}
...
void func_58()
{
	...
	bVar1 = func_96(680);
	bVar2 = func_96(681);
	if (func_97(bVar0, 0) && FLOCK::GET_ANIMAL_TUNING_FLOAT_PARAM(bVar0, 73) != 0.15f)
	{
		FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(bVar0, 73, 0.15f);
	}
	if (func_97(bVar1, 0) && FLOCK::GET_ANIMAL_TUNING_FLOAT_PARAM(bVar1, 73) != 0.15f)
	{
		FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(bVar1, 73, 0.15f);
	}
	if (func_97(bVar2, 0) && FLOCK::GET_ANIMAL_TUNING_FLOAT_PARAM(bVar2, 73) != 0.15f)
	{
		FLOCK::SET_ANIMAL_TUNING_FLOAT_PARAM(bVar2, 73, 0.15f);
	}
}
...
void func_78(int iParam0)
{
	...
	{
		VOLUME::_0x6D5F9E69BA1BE783(bLocal_19);
	}
	func_54(0.775f, 0.2f, 0.025f, 0f);
}
...
bool func_84(int iParam0, vector3 vParam1, float fParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14)
{
	bool bVar0;
	...
	func_133(bVar0, iParam0, iParam7, bParam8, bParam9, bParam10, bParam11, bParam12);
	return bVar0;
}
...
void func_93(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, int iParam6, bool bParam7)
{
	...
	if (func_140(iParam0))
	{
		...
		if (bParam3)
		{
			func_141(iParam0, fParam2, 1, iParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
void func_133(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	bool bVar0;
	...
	if (!bParam7)
	{
		if (func_174(iParam1))
		{
			func_175(bParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_141(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	if (func_140(iParam0))
	{
...
void func_176(bool bParam0, int iParam1, bool bParam2)
{
	if (ENTITY::IS_ENTITY_DEAD(bParam0))
	{
		return;
...
bool func_198(bool bParam0, int iParam1)
{
	bool bVar0;
