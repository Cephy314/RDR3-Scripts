...
int func_11()
{
	bLocal_14 = ((*Global_1888801)[93 /*35*/])->f_4;
...
int func_38(int iParam0)
{
	if (iLocal_15 != -1)
	{
		...
		{
			if (func_60(Global_35, bLocal_14, 0, 0))
			{
...
bool func_60(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
{
	func_54(0.775f, 0.2f, 0.025f, 0f);
	if (VOLUME::_DOES_VOLUME_EXIST(bLocal_14))
	{
