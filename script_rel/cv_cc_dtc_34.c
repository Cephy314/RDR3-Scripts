...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.125f, -0.4001f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	uLocal_15 = func_152(uParam0, joaat("P_CHAIRFOLDING02X"), 0f, 0f, 0f, "Chair", 1, 0, 1);
	func_153(uParam0, "script@vignette@dutch_34@base", 1, 1, 0, 0);
	uLocal_16 = func_153(uParam0, "script@vignette@dutch_34@action", 0, 0, 1, 1);
	func_154(uParam0, "CDT34AU");
	func_155(uParam0, joaat("COMP_DTCCNV34"), joaat("PLAYER_DTCCNV34"));
	func_156(uParam0, uLocal_16, -1, 0.78f);
	func_157(uParam0, iLocal_14, 3, joaat("PROP_CAMP_FIRE_SEATED"), "PROP_CAMP_FIRE_SEAT_CHAIR_MALE_C", uLocal_15, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	Local_17 = { func_162(uParam0, 0f, -0.3f, 0.9877f, 169f, 6.5f, 0.705f, 0.4425f) };
	return 1;
}
