...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 0.0501f, -2.8875f, 1.4875f, 0f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	...
	func_155(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, -1, 0, MISC::GET_RANDOM_FLOAT_IN_RANGE(30f, 50f), 1065353216 /* Float: 1f */, 1);
