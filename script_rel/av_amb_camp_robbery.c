...
{
	func_33(uParam0, 10807, 10844, 12059);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "AMB_CAMP_ROBBERY", "", vParam1, vParam4);
	if (uParam0->f_489 == 0)
	{
	...
	if (uParam0->f_489 == 1)
	{
		iVar1 = joaat("A_C_DOGCHESBAYRETRIEVER_01");
	}
	iVar2 = func_47();
	if (uParam0->f_489 == 3)
	{
		iVar0 = func_48(iVar2, 0, 0, 0, 0, 0, 1);
	}
	else
	{
		iVar0 = func_48(iVar2, 1, 0, 1, 0, 0, 0);
	}
	func_49(uParam0, 0, "ACR_MAN", iVar0, vParam1, vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	if (uParam0->f_489 == 1)
	{
		func_49(uParam0, 1, "ACR_ANIMAL", iVar1, vParam1 + Vector(0f, 2f, 2f), vParam4.z, 1, 0, 1, 1, joaat("META_OUTFIT_DEFAULT"), 1);
	}
}
...
int func_31(var uParam0)
{
	...
	if (!bLocal_43)
	{
		if (func_61(uParam0, &uLocal_15, 0))
		{
			...
			{
				TASK::_TASK_SMART_FLEE_STYLE_PED(&(uParam0->f_20[1 /*14*/]), Global_35, 3, 0, -1082130432, -1, 0);
			}
			if (!bLocal_44)
			{
				func_62(*uParam0, uParam0->f_483, 1);
				bLocal_44 = true;
			}
			if (!bLocal_45)
			{
	...
	switch (iLocal_14)
	{
		case 0:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				...
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])) && uParam0->f_489 == 1)
				{
					...
					PED::SET_PED_AS_GROUP_LEADER(&(uParam0->f_20[0 /*14*/]), iLocal_49, false);
					PED::SET_PED_AS_GROUP_MEMBER(&(uParam0->f_20[1 /*14*/]), iLocal_49);
					PED::_0x24C82EF607105FAA(&(uParam0->f_20[0 /*14*/]), joaat("AVOID"));
				}
				if (uParam0->f_489 == 3)
				{
					PED::_0x24C82EF607105FAA(&(uParam0->f_20[0 /*14*/]), joaat("SCRIPTEDOUTLAW"));
					func_64(&(uParam0->f_20[0 /*14*/]), joaat("WEAPON_REVOLVER_CATTLEMAN"), 1, 0, 0, 0, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				}
				else
				{
					PED::_0x24C82EF607105FAA(&(uParam0->f_20[0 /*14*/]), joaat("AVOID"));
			...
			break;
		case 1:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])) && func_65(&(uParam0->f_20[0 /*14*/]), Global_35, 0, 50f, 0))
			{
				PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[0 /*14*/]), 297, true);
				PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[0 /*14*/]), 146, false);
				PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[0 /*14*/]), 6, false);
				PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[0 /*14*/]), 130, false);
				if (uParam0->f_489 == 3)
				{
					PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[0 /*14*/]), 148, true);
				}
				func_66(uParam0->f_20[0 /*14*/], 0, 1);
				PED::SET_PED_KEEP_TASK(&(uParam0->f_20[0 /*14*/]), true);
				func_68(&(uParam0->f_20[0 /*14*/]), func_67(joaat("REWARD_PED_SMALL"), 0, -1));
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])) && uParam0->f_489 == 1)
				{
					...
					PED::_0x8B3B71C80A29A4BB(&(uParam0->f_20[1 /*14*/]), joaat("MOODANGRY"), 6);
					PED::SET_PED_USING_ACTION_MODE(&(uParam0->f_20[1 /*14*/]), true, -1, 0);
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_GO_TO_ENTITY(0, Global_35, -1, 10f, 1.5f, 2f, 0);
					...
					PED::SET_PED_CONFIG_FLAG(&(uParam0->f_20[1 /*14*/]), 178, true);
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				if (!PED::IS_PED_USING_ACTION_MODE(&(uParam0->f_20[1 /*14*/])))
				{
					PED::SET_PED_USING_ACTION_MODE(&(uParam0->f_20[1 /*14*/]), true, -1, 0);
				}
			}
			if (!bLocal_44)
			{
				if (func_72(uParam0, 1065353216 /* Float: 1f */, 1116471296 /* Float: 70f */, 4, joaat("ACTION"), 0))
				{
					func_62(*uParam0, uParam0->f_483, 1);
					bLocal_44 = true;
				}
			}
			if (func_73(&uLocal_46, 5f))
			{
				if (!LAW::_0xC0DF161950FB101E(&(uParam0->f_20[0 /*14*/])) && !LAW::_0x0EAF918F751F27BA(&(uParam0->f_20[0 /*14*/])))
				{
		...
		case 3:
			...
			if (func_74(Global_35, &(uParam0->f_20[0 /*14*/]), 0, 1) > 1600f)
			{
				return 1;
			}
			break;
...
void func_62(int iParam0, vector3 vParam1, bool bParam4)
{
	if (func_40() > (Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5)
	{
		(Global_32073.f_2697.f_6[iParam0 /*6*/])->f_5 = func_40();
...
int func_64(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(iVar0) || WEAPON::_IS_WEAPON_MELEE(iVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_105(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	else if (iVar0 == joaat("WEAPON_UNARMED"))
	{
		switch (iParam1)
		{
			...
			case joaat("GROUP_SHOTGUN"):
			case joaat("GROUP_RIFLE"):
				if (func_107(joaat("WEAPON_REPEATER_CARBINE")))
				{
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_105(iVar0))
		{
	...
	{
		func_108(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_109(iParam0, &iVar0, &fVar25);
...
bool func_65(int iParam0, int iParam1, bool bParam2, float fParam3, bool bParam4)
{
	if (bParam2)
	{
		if (!func_111(iParam0, iParam1, 0f))
		{
			return false;
		}
	}
	if (!func_112(iParam0, iParam1, fParam3, 1))
	{
		return false;
	}
...
int func_67(int iParam0, int iParam1, int iParam2)
{
	...
	fVar0 = 1f;
	if (iParam1 && func_113(joaat("PROVISION_TRINKET_ELK_ANTLER"), 1, 0))
	{
		fVar0 = (fVar0 + 0.1f);
	}
	Var1.f_1 = 10;
	...
	while (iVar24 < Var1)
	{
		...
		else
		{
			...
			if (func_114(iVar25, 0) && func_115(iVar25, -1921346699))
			{
				return BUILTIN::CEIL((IntToFloat(&Var1.f_12[iVar24]) * fVar0));
			}
		}
...
bool func_68(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_117(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
...
int func_72(var uParam0, float fParam1, float fParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_126(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_127(&(uParam0->f_490)))
							{
								func_128(&(uParam0->f_490), 0);
							}
							if (func_129(&(uParam0->f_490)))
							{
		...
		if (func_127(&(uParam0->f_490)) && !func_129(&(uParam0->f_490)))
		{
			func_131(&(uParam0->f_490));
		}
	}
	return 0;
}
...
float func_74(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
...
int func_78(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_133(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_79(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_134(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
{
	func_135(uParam0, iParam6);
	func_136(uParam0, iParam5);
...
void func_93(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	...
	if (!bParam7)
	{
		if (func_143(iParam1))
		{
			func_144(iParam0, joaat("META_OUTFIT_DEFAULT"));
		}
		else if (bParam5)
		{
...
void func_103(int iParam0)
{
	if (func_43(iParam0))
	{
		...
		{
			case 1:
				func_178(0, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				func_178(1, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
			case 37:
				func_178(60, 1, 0, 0, ((Global_1415419->f_19[iParam0 /*12*/])->f_7 / 4), 0, 0, 1);
				break;
		}
	}
}
...
void func_104(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_133((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
...
int func_108(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	{
		Var0 = { func_179(iParam0, 0, 1) };
		iVar5 = 1728382685; /* GXTEntry: "Right" */
		Var6.f_9 = -1591664384;
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_180((375 + iVar28), 1);
			if (func_181(iParam0, &Var0, iVar5, 0))
			{
				if (func_182(iParam0, &Var6, iVar5))
				{
					Var29 = { func_183(iParam0, Var0, iVar5, 0) };
					func_184(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_185(0))
				{
					...
					func_186(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
bool func_111(int iParam0, int iParam1, float fParam2)
{
	return func_188(iParam0, ENTITY::GET_ENTITY_COORDS(iParam1, false, false), fParam2);
}
...
bool func_113(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_191(iParam0, 0, bParam2) >= iParam1;
}
...
var func_117(int iParam0, int iParam1, var uParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
int func_118(int iParam0)
{
	...
	return func_193(iParam0, 33554432);
}
...
float func_126(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_200(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}

bool func_127(var uParam0)
{
	return func_201(*uParam0, 1);
}
...
void func_130(var uParam0)
{
	...
	if (func_129(uParam0))
	{
		uParam0->f_1 = (func_197() - uParam0->f_2);
		uParam0->f_2 = 0f;
		func_199(uParam0, 2);
	}
}
...
void func_131(var uParam0)
{
	...
	if (!func_129(uParam0))
	{
		uParam0->f_2 = (func_197() - uParam0->f_1);
		func_198(uParam0, 2);
	}
}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_208(1) || *uParam0 & 8192 != 0))
				{
...
int func_149(int iParam0, var uParam1)
{
	...
	switch (iVar0)
	{
		...
		case joaat("EVENT_DEAD_PED_FOUND"):
			...
			if (!func_211(iParam0, uParam1, iVar2))
			{
				return 0;
			}
			if (func_212(iParam0, iVar2) <= func_213(uParam1))
			{
				return 1;
			}
			break;
...
int func_151(int iParam0, var uParam1)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_217(iParam0, !*uParam1 & 268435456 != 0, !*uParam1 & 536870912 != 0, !*uParam1 & 1073741824 != 0, 0, 0))
		{
			if (uParam1->f_12 < 5f)
			{
				fVar0 = 95f;
			...
			fVar1 = func_218(uParam1);
			if (func_219(uParam1, iParam0, fVar0, fVar1))
			{
				if (uParam1->f_2 == 0)
				{
...
int func_152(int iParam0, int iParam1, var uParam2)
{
	...
	fVar0 = 85f;
	if (func_221(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		if (uParam2->f_12 < 5f)
		{
			fVar0 = 95f;
		...
		fVar1 = func_218(uParam2);
		if (func_219(uParam2, iParam0, fVar0, fVar1))
		{
			if (uParam2->f_2 == 0)
			{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_220(uParam2)
				{
					func_215(uParam2, 1);
					return 1;
				}
...
int func_153(int iParam0, var uParam1)
{
	...
	if (func_211(iParam0, uParam1, iVar1))
	{
		if (uParam1->f_3 == 0)
		{
			uParam1->f_3 = MISC::GET_GAME_TIMER();
		}
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_220(uParam1)
		{
			fVar3 = func_218(uParam1);
...
int func_154(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		return func_222(bParam1, bParam2, bParam3);
	}
	if (Global_1572887->f_12 != -1)
	{
...
int func_157(var uParam0, int iParam1, var uParam2)
{
	...
	if (uParam2->f_12 < IntToFloat(func_224(uParam2)))
	{
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_226(iParam1, vVar0, vVar4))
					{
						func_215(uParam2, 1);
						return 1;
					}
		...
		switch (iVar3)
		{
			...
			case 2:
				if (EVENT::IS_SHOCKING_EVENT_IN_SPHERE(joaat("EVENT_SHOCKING_POTENTIAL_BLAST"), vVar0, uParam2->f_22))
				{
					...
					if (func_226(iParam1, vVar0, vVar7))
					{
						func_215(uParam2, 1);
						return 1;
					}
...
int func_159(int iParam0, var uParam1)
{
	...
	{
		if (!func_211(iParam0, uParam1, &(Global_1935630->f_34[iVar0])) || iParam0 == &Global_1935630->f_34[iVar0])
		{
		}
		else
		{
			bVar13 = func_227(&(Global_1935630->f_34[iVar0]));
			...
			if (func_228(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_229(uParam1, iParam0, fVar1, bVar12, bVar13))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
			...
			else if (func_230(uParam1, iParam0, fVar1, iVar0))
			{
				*(vVar2[0 /*3*/]) = { ENTITY::GET_ENTITY_COORDS(&(Global_1935630->f_34[iVar0]), false, false) };
				*(vVar2[1 /*3*/]) = { vVar9 };
				uParam1->f_10 = iParam0;
...
int func_165(int iParam0, int iParam1)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		if (func_74(iParam0, iParam1, 1, 1) < 4f)
		{
...
int func_167(var uParam0, int iParam1)
{
	...
	if (iVar0 != 0 && !VEHICLE::IS_THIS_MODEL_A_TRAIN(ENTITY::GET_ENTITY_MODEL(iVar0)))
	{
		...
		if (func_234(iVar0, iParam1, vVar1))
		{
...
int func_170(var uParam0, int iParam1)
{
	...
	fVar0 = func_213(uParam0);
	if (uParam0->f_12 > func_236(uParam0) && uParam0->f_12 > fVar0)
	{
		return 0;
	}
	iVar2 = func_237(iParam1);
	iVar1 = func_238(uParam0->f_14);
...
int func_171(int iParam0, int iParam1, var uParam2)
{
	...
	return func_239(iParam0, iParam1, bVar0, bVar2, uParam2->f_12, bVar1);
}
	...
	switch (iVar1)
	{
		...
		case joaat("EVENT_SHOCKING_ENTITY_HOGTIED"):
			...
			if (PED::_0x06087579E7AA85A9(iParam0, iVar4, -1f, -1f, -1f, -1f) && PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				...
				{
					if (!func_241(uParam1, iParam0))
					{
						if (func_235(iVar4, Global_36, 1) < 7f)
						{
							return 1;
						}
					}
...
int func_176(int iParam0, var uParam1)
{
	...
	else if (func_168() - uParam1->f_4) > func_243(uParam1)
	{
		return func_244(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
void func_178(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;

	iVar0 = (((iParam2 + (60 * iParam3)) + (3600 * iParam4)) + (86400 * iParam5));
	if (func_245(iParam0) == 1 && bParam7)
	{
		return;
	}
	if (bParam6)
...
struct<5> func_179(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_189(iParam0))
	{
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_248(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_181(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_181(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_182(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
...
bool func_181(int iParam0, var uParam1, int iParam2, int iParam3)
{
	return func_253(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_182(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_254(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_183(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	...
	INVENTORY::_0x886DFD3E185C8A89(func_255(bParam6), &uParam1, iParam0, iParam5, &Var0);
	return Var0;
}

int func_184(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
	...
	Var0.f_9 = -1591664384;
	if (!func_252(*uParam1, &Var0, bParam6, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_255(bParam6), uParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_185(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_255(bParam0));
}
...
void func_187(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_258(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
		WEAPON::SET_AMMO_IN_CLIP(Global_35, iParam0, iVar1);
	}
}

bool func_188(int iParam0, vector3 vParam1, float fParam4)
{
	vector3 vVar0;
	vector3 vVar3;
...
int func_190(int iParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_260("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_261(&Var4, iVar3, iVar1, iVar2))
			{
			}
...
int func_191(int iParam0, bool bParam1, bool bParam2)
{
	...
	iVar2 = INVENTORY::_0xE787F05DFC977BDE(func_255(bParam2), iParam0, 0);
	return iVar2;
}
...
void func_206(int iParam0)
{
	...
	{
		case 0:
			func_266(&(Global_1935630->f_34), &(Global_1935630->f_39));
...
int func_208(bool bParam0)
{
	...
	if (func_267(bParam0, &uVar0, &uVar1))
	{
		return 1;
	}
	return 0;
...
int func_211(int iParam0, var uParam1, int iParam2)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
{
	return func_74(iParam0, iParam1, 1, 1);
}
...
int func_217(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_74(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
	...
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_270(iVar0, 0)))
		{
			if (func_271(iParam0, 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_IS_WEAPON_SNIPER(func_270(iVar0, 0)))
		{
			if (func_272(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_226(int iParam0, vector3 vParam1, vector3 vParam4)
{
	if (func_188(iParam0, vParam4, 0.5f))
	{
...
int func_230(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_234(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;

	fVar0 = func_235(iParam0, vParam2, 1);
	if (fVar0 < 4f)
	{
...
int func_239(int iParam0, int iParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5)
{
	bool bVar0;
	int iVar1;
	float fVar2;
	...
	if (fParam4 <= 0f)
	{
		fVar2 = func_74(iParam0, PLAYER::PLAYER_PED_ID(), 0, 1);
	}
	else
	{
		fVar2 = fParam4;
	...
	if (bVar0)
	{
		if (func_74(iParam0, Global_1935630->f_40, 0, 1) < 2.5f)
		{
...
int func_240(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;

	func_267(1, &iVar0, &iVar1);
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (iVar0 != iParam0)
		{
			if (PED::_0x06087579E7AA85A9(iParam0, Global_35, -1f, -1f, -1f, -1f))
			{
				if (ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iParam0, Global_35, 17))
				{
					if (!bParam2 || !func_241(uParam1, iVar0))
					{
						return 1;
					}
				}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		if (iVar1 != iParam0)
		{
			...
			{
				if (!bParam2 || !func_241(uParam1, iVar1))
				{
					if (func_235(iVar1, Global_36, 1) < 5f)
					{
						return 1;
					}
				}
...
int func_244(int iParam0, var uParam1, bool bParam2, float fParam3)
{
	if (!bParam2)
	{
		if (uParam1->f_4 == 0)
...
{
	return func_183(joaat("CHARACTER"), func_277(), -1591664384, bParam0);
}
...
struct<4> func_247(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_183(923904168, func_246(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_183(923904168, func_246(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_183(923904168, func_246(bParam0), -740156546, 0);
}

int func_248(int iParam0, bool bParam1)
{
	if (func_250(iParam0) == 1779021115)
	{
		return 0;
	}
	if (WEAPON::_IS_WEAPON_ONE_HANDED(iParam0))
	{
		if (bParam1)
		{
			return func_278(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
struct<4> func_249(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_183(271701509, func_246(bParam0), 12999093, 0) };
		}
		return *Global_1224218;
	}
	return func_183(271701509, func_246(bParam0), 12999093, 0);
}
...
int func_252(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_255(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_253(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_183(iParam0, Param1, iParam5, bParam6) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var0))
	{
		return 0;
	}
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_255(bParam6), &Var0, 0);
	return uVar4;
}
...
int func_254(int iParam0, var uParam1, var uParam2, int iParam3)
{
	...
	iVar0 = func_255(0);
	*uParam1 = { func_183(iParam0, func_247(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_259(int iParam0, int iParam1)
{
	...
	if (func_115(iParam0, 1399091007))
	{
		func_279(iParam0, &uVar1, &uVar2);
		return uVar2;
	}
	return 0;
}

int func_260(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_255(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_261(var uParam0, int iParam1, int iParam2, int iParam3)
{
	if (iParam2 < 0)
	{
		return 0;
...
int func_263(int iParam0, bool bParam1)
{
	...
	Var0 = { func_280(iParam0, -1591664384, -1591664384, -1591664384, 0, 0) };
	if (bParam1)
	{
		func_281(&Var0, func_247(0));
	}
	if (!func_282(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_262(iVar14);
...
int func_271(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_272(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_272(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
...
int func_278(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_255(bParam1), iParam0, 0);
}
...
struct<14> func_280(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	struct<14> Var0;
...
void func_281(var uParam0, struct<4> Param1)
{
...
int func_282(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_255(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
