...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 0.0125f, -0.325f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1, 1, 1, 1);
	func_151(uParam0, -5.025f, -0.8375f, 0f, 0f, 1.2f, 1.2f, 5f, -1612834106, -1, 1, 1, 1);
	...
	func_154(uParam0, iLocal_15, 3, joaat("PROP_HUMAN_SEAT_CHAIR_SEWING"), "PROP_HUMAN_SEAT_CHAIR_SEWING_FEMALE_B", iLocal_17, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	func_155(uParam0, iLocal_15, iLocal_16, "p_cs_sock01x_PH_L_HAND", 0, 0);
	func_156(uParam0, "script@vignette@susan_speech_low_food@base", 1, 1, 0, 0);
	uLocal_18 = func_156(uParam0, "script@vignette@susan_speech_low_food@action", 0, 0, 1, 0);
	func_157(uParam0, "CSLF1AU");
	func_158(uParam0, -573619360, -237434826);
	func_159(uParam0, uLocal_18, -1, 0.7f);
