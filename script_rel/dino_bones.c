		...
		if (func_101(iParam0))
		{
			...
			if (func_6() && func_110(4))
			{
				if (!Global_1914319->f_17376)
				{
					if (func_6() && (func_111(38) || func_106(38)))
					{
						func_45(38, COLLECTION::_0x13AAECDA43318BFE(joaat("CIGARETTE_CARDS"), iVar6), COLLECTION::_0xD52D20B0C76BB26D(joaat("CIGARETTE_CARDS"), iVar6), iVar7, 12, 0, iVar6);
					}
					else
					{
...
int func_165()
{
	...
	return func_232(COLLECTION::_0x126CBEBBA46693CF(iVar0, joaat("CIGARETTE_CARDS"), 0));
}
