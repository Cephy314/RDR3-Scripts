...
int func_72(var uParam0)
{
	...
	func_152(uParam0, 1.4424f, -0.6369f, 0.6758f, 0f, 1.1f, 1.1f, 2f, -1612834106, joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	func_152(uParam0, -0.053f, -0.2284f, 0.5413f, 0f, 1.1f, 1.1f, 2f, -1612834106, joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
...
{
	return STREAMING::_0x9427C94D2E4094A4(joaat("PROP_CAMP_FIRE_SEATED"), 0);
}
