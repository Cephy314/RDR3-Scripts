...
void __EntryFunction__()
{
	...
	iLocal_11 = joaat("WORLD_ANIMAL_FOX_SITTING");
	iLocal_12 = 41788943;
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 11201, 11328, 11879);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "FOX_SIT", "", vParam1, vParam4);
	iVar0 = 1;
	iVar1 = func_47();
	switch (*uParam0)
	{
		case 130:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_VULTURE_ON_PERCH");
			break;
		case 172:
			iLocal_9 = joaat("a_c_fox_01");
			iLocal_11 = joaat("WORLD_ANIMAL_FOX_SITTING");
		...
		case 187:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_EAGLE_ON_PERCH");
			break;
		case 168:
		...
		case 124:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_BIRD_ON_PERCH");
			break;
		case 132:
		...
		case 189:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_PELICAN_ON_PERCH");
			break;
		case 201:
		...
		case 232:
			...
			iLocal_11 = joaat("WORLD_ANIMAL_VULTURE_ON_PERCH");
			if ((((iVar1 == 0 || iVar1 == 2) || iVar1 == 10) || iVar1 == 11) || iVar1 == 9)
			{
				iVar0 = 0;
				iLocal_12 = -872382606;
			}
	...
	func_49(uParam0, 0, "FS_ANIMAL", iLocal_9, vParam1, (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_12, 1);
}
...
int func_31(var uParam0)
{
	if (!&uParam0->f_469[1])
	{
		if (func_66(uParam0, &uLocal_17, 1))
		{
			if (*uParam0 == 172)
			{
	...
	switch (iLocal_10)
	{
		case 0:
			...
			break;
		case 1:
			if (func_71(uParam0, uParam0->f_493, uParam0->f_494, 4, uParam0->f_495, 1112014848 /* Float: 50f */) || func_72(&uLocal_13, 20f))
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
				{
					...
					if (*uParam0 != 172)
					{
						TASK::_TASK_SMART_FLEE_STYLE_COORD(&(uParam0->f_20[0 /*14*/]), (uParam0->f_20[0 /*14*/])->f_5, 3, 256, -1f, -1, 0);
					}
					else
					{
			...
			else if (*uParam0 == 172)
			{
				if (!bLocal_16)
				{
					TASK::_0xE7FA07624574B79A(&(uParam0->f_20[0 /*14*/]), Global_35, 1, 1, 30000f, 1, 0, 0, 0);
					Local_45.f_3 = Global_35;
					Local_45.f_7 = 0;
					func_70(&uLocal_13);
					bLocal_16 = true;
				}
				...
				{
					_NAMESPACE29::_0x66F9EB44342BB4C5(&(uParam0->f_20[0 /*14*/]), &Local_45);
				}
			}
			break;
		case 2:
...
int func_69(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
int func_184(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_213(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	int iVar0;
