...
int func_18(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (func_53((uParam0->f_107[iVar0 /*113*/])->f_7))
		{
			if (!func_54((uParam0->f_107[iVar0 /*113*/])->f_7))
			{
			}
			else
			{
				func_55((uParam0->f_107[iVar0 /*113*/])->f_5, (uParam0->f_107[iVar0 /*113*/])->f_7, 1, 0, 0);
				Jump @294; //curOff = 110
				if (func_53((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					...
					else if (TASK::_0x9FF5F9B24E870748((uParam0->f_107[iVar0 /*113*/])->f_5) && !func_45(uParam0))
					{
						...
						func_58((uParam0->f_107[iVar0 /*113*/])->f_1, 68, 1);
						func_59((uParam0->f_107[iVar0 /*113*/])->f_1, 0, 0, 0, fVar1, 1, 1, 0, 0, 0, 0);
					}
					else
					{
						func_59((uParam0->f_107[iVar0 /*113*/])->f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
				}
			}
			iVar0++;
...
int func_19(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (!func_60((uParam0->f_107[iVar0 /*113*/])->f_2))
		{
		}
		else if (!func_61((uParam0->f_107[iVar0 /*113*/])->f_2))
		{
		}
		else
		{
			func_62((uParam0->f_107[iVar0 /*113*/])->f_2, 0, 1, 0, 0);
		}
		iVar0++;
	}
	return 1;
...
{
	return MISC::GET_HASH_KEY(func_71(iParam0));
}
...
void func_59(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	if (bParam3)
	{
		...
		func_127(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
...
{
	return (BUILTIN::SHIFT_RIGHT(iParam0, 26) & 31 * func_140(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 1898;
}
...
int func_75(var uParam0)
{
	...
	func_155(uParam0, 6.1551f, 11.532f, -1.7f, -2.75f, 0.75f, 0.75f, 2.265f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	...
	func_161(uParam0, iLocal_14, 4, joaat("PROP_HUMAN_SEAT_BENCH"), "PROP_HUMAN_SEAT_BENCH_FEMALE_A", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
int func_87(var uParam0)
{
	...
	if (OBJECT::IS_DOOR_REGISTERED_WITH_SYSTEM(1309495497))
	{
		iLocal_33 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(func_181(1309495497, 1, 0));
	}
...
int func_88(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		if (func_53((uParam0->f_107[iVar0 /*113*/])->f_1))
		{
			func_58((uParam0->f_107[iVar0 /*113*/])->f_1, 46, 1);
		}
		iVar0++;
	}
	if (!uParam0->f_4)
...
int func_111(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (func_124(bVar0, 0))
	{
		if (func_124(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
...
int func_147(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else
		{
			...
			{
				if (func_126((uParam0->f_107[iVar0 /*113*/])->f_1, 29, 1) || func_255((uParam0->f_107[iVar0 /*113*/])->f_1))
				{
					return 1;
				}
				if (!uParam0->f_3)
				{
					if (func_117((uParam0->f_107[iVar0 /*113*/])->f_1) && !func_57((uParam0->f_107[iVar0 /*113*/])->f_1))
					{
						func_34(func_20(uParam0), 30);
						return 1;
					}
...
void func_150(var uParam0)
{
	...
	while (iVar0 < uParam0->f_106)
	{
		...
		else if (!func_53((uParam0->f_107[iVar0 /*113*/])->f_1))
		{
		}
...
void func_162(var uParam0, int iParam1, int iParam2, int iParam3)
{
	...
	{
		case 4:
			(uParam0->f_107[iParam1 /*113*/])->f_32.f_5 = { func_266(func_152(uParam0), func_265(uParam0, iParam1), func_20(uParam0), 1) };
			break;
		default:
...
void func_191(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (func_53((uParam0->f_107[iVar1 /*113*/])->f_1))
		{
...
int func_199(var uParam0, int iParam1, bool bParam2)
{
	...
	if (uParam0->f_2270)
	{
		uParam0->f_2274 = 0;
		uParam0->f_2275 = 0;
		if ((func_116() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "ARTHUR")) || (func_295() && ANIMSCENE::_0x6F1F0B17109309DA(uParam0->f_2046, "JOHN")))
		{
			uParam0->f_2274 = 1;
		}
	}
...
void func_210(var uParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam2)
	{
		...
		{
			func_59((uParam0->f_107[iParam1 /*113*/])->f_1, 0, 0, 0, (uParam0->f_107[iParam1 /*113*/])->f_32.f_4, 1, 1, 0, 0, 1, 0);
		}
		else
		{
			func_59((uParam0->f_107[iParam1 /*113*/])->f_1, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
		}
	}
}
...
float func_221(int iParam0, bool bParam1, bool bParam2)
{
	...
	return func_319(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_260(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(func_51(uParam0, iVar1)))
		{
		}
		else if (!ENTITY::IS_ENTITY_OCCLUDED(func_51(uParam0, iVar1)))
		{
			iVar0 = 0;
		}
		else
...
void func_264(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_314(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
...
int func_270(var uParam0)
{
	...
	while (iVar1 < uParam0->f_106)
	{
		...
		{
			if (func_53((uParam0->f_107[iVar1 /*113*/])->f_7))
			{
				if (func_54((uParam0->f_107[iVar1 /*113*/])->f_7) && !ENTITY::IS_ENTITY_DEAD((uParam0->f_107[iVar1 /*113*/])->f_5))
				{
				}
				else
				{
...
int func_361(var uParam0, int iParam1)
{
	...
	while (iVar2 <= iVar1)
	{
		...
		else
		{
			...
			vVar13 = { func_399(ENTITY::GET_ENTITY_COORDS((uParam0->f_107[iParam1 /*113*/])->f_5, true, false), vVar3, 1065353216 /* Float: 1f */) };
...
int func_376(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, int iParam5, int iParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17)
{
	...
	bVar0 = func_108(iParam1);
	if ((!ENTITY::DOES_ENTITY_EXIST(bVar0) || !func_124(bVar0, 0)) || (bParam3 && !func_54(iParam1)))
	{
		if (bParam2)
		{
	...
	if (ENTITY::DOES_ENTITY_EXIST(bVar0) && func_124(bVar0, 0))
	{
		*uParam0 = 2;
		...
		case 0:
			...
			if (func_226(iParam0, 16, 1))
			{
				if ((*Global_1360165)[iParam0 /*1157*/])->f_129 != SCRIPTS::GET_ID_OF_THIS_THREAD()
				{
					...
					{
						func_59(iParam0, 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					}
					return 0;
				}
...
void func_410(int iParam0, bool bParam1, char* sParam2)
{
	...
	bVar0 = func_239(iParam0);
	if (!func_53(iParam0) || ENTITY::IS_ENTITY_DEAD(bVar0))
	{
		return;
	}
...
void func_433(bool bParam0, int iParam1)
{
	...
	func_394(bParam0, func_463(iParam1));
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_336(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_406(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
