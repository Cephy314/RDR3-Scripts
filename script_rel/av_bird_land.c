...
void __EntryFunction__()
{
	...
	iLocal_10 = 41788943;
	iLocal_40 = joaat("WORLD_ANIMAL_BIRD_ON_PERCH");
	Var0.f_1 = -1;
	Var0.f_3.f_9 = 3;
	Var0.f_20 = 25;
...
{
	func_33(uParam0, 11010, 11061, 11744);
}
...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_46(uParam0, "BIRD_LAND", "", vParam1, vParam4);
	iVar0 = 1;
	switch (*uParam0)
	{
		case 103:
		...
		case 105:
			...
			iLocal_40 = joaat("stand");
			break;
		case 106:
			iLocal_9 = joaat("a_c_Eagle_01");
			iLocal_40 = joaat("WORLD_ANIMAL_EAGLE_ON_PERCH");
			break;
		case 107:
		...
		case 108:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_HERON_ON_PERCH");
			break;
		case 109:
		...
		case 111:
			...
			iLocal_40 = joaat("WORLD_ANIMAL_SEAGULL_ON_PERCH");
			break;
		case 112:
			iLocal_9 = joaat("A_C_SongBird_01");
			iLocal_40 = joaat("WORLD_ANIMAL_SPARROW_ON_PERCH");
			if (func_47())
			{
				iLocal_10 = -220316070;
				iVar0 = 0;
	...
	func_48(uParam0, 0, "BL_BIRD_1", iLocal_9, OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(vParam1, vParam4.z, 0f, 5f, -20f), (0f + vParam4.z), iVar0, 1, 1, 1, iLocal_10, 1);
}
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[2])
	{
		if (func_62(uParam0, &uLocal_11, 0) || func_63(Global_35, uParam0->f_483, 1) < 64f)
		{
	...
	switch (iLocal_39)
	{
		...
		case 2:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
			{
				if (func_63(Global_35, uParam0->f_483, 1) < func_67(PED::IS_PED_ON_MOUNT(Global_35), 1600f, 400f))
				{
					if (CAM::IS_SPHERE_VISIBLE(uParam0->f_483, 1f))
					{
						if (!ENTITY::WOULD_ENTITY_BE_OCCLUDED((uParam0->f_20[0 /*14*/])->f_2, uParam0->f_483, true))
						{
							vVar0 = { OBJECT::_GET_OBJECT_OFFSET_FROM_COORDS(uParam0->f_483, uParam0->f_486.f_2, 0f, -35f, 1f) };
							if (!CAM::IS_SPHERE_VISIBLE(vVar0, 0.25f))
							{
								...
								func_64(uParam0);
								func_69(&(uParam0->f_20[0 /*14*/]), vVar0, func_68(vVar0, uParam0->f_483), 0, 1073741824 /* Float: 2f */);
								PED::FORCE_PED_MOTION_STATE(&(uParam0->f_20[0 /*14*/]), -1299979036, false, 0, false);
								TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), iLocal_40, uParam0->f_483, (uParam0->f_20[0 /*14*/])->f_8, 0, true, false, 0, -1f, false);
		...
		case 4:
			if (!&uParam0->f_469[0])
			{
				if (func_63(&(uParam0->f_20[0 /*14*/]), uParam0->f_483, 1) < 1f)
				{
...
float func_68(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)
{
...
void func_69(int iParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (func_107(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(iParam0, vParam1, fParam4, true, func_107(iParam5, 32), true);
