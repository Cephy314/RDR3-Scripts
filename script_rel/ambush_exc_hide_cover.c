		...
		if (func_61(&(uLocal_15[iVar0]), 0, 0))
		{
			...
			switch (iVar0)
			{
				case 0:
					...
					func_127(&(uLocal_15[iVar0]), joaat("GROUP_REVOLVER"), -1, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
				case 1:
	...
	switch (Local_274.f_4)
	{
		case 0:
			...
			else
			{
				...
				{
					func_135();
					func_144(&(uLocal_15[0]), uLocal_15.f_22[0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
					func_145();
					func_25(&uLocal_15, 1);
					func_32(&uLocal_15, 1);
					func_146();
		...
		case 3:
			if (func_47(Local_274.f_8[1 /*3*/], (0.1f + 1.5f)))
			{
				...
				{
					sVar1 = func_150();
					func_151(&(uLocal_15[0]), Global_35, sVar1, -1073741824 /* Float: -2f */, 0, -500314840, 1);
...
void func_75()
{
	...
	if (uLocal_15.f_19 < uLocal_15.f_215)
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[iVar0])))
		{
			...
			{
				if (func_220(&(uLocal_15[iVar0]), 200f, -1082130432 /* Float: -1f */, &(uLocal_15.f_9[iVar0]), -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < (uLocal_15.f_215 + uLocal_15.f_216))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_40[iVar0])))
		{
			...
			{
				if (func_220(&(uLocal_15.f_40[iVar0]), 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
	...
	else if (uLocal_15.f_19 < ((uLocal_15.f_215 + uLocal_15.f_216) + uLocal_15.f_217))
	{
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15.f_49[iVar0])))
		{
			if (!func_227(&uLocal_15, iVar0, 8))
			{
				...
				{
					if (func_228(&(uLocal_15.f_49[iVar0]), 200f, -1082130432 /* Float: -1f */))
					{
...
void func_136()
{
	...
	while (iVar1 <= 5)
	{
		if (func_61(&(uLocal_15[iVar1]), 0, 0))
		{
			if (!bVar0)
			{
				func_151(&(uLocal_15[iVar1]), Global_35, "CALLOUT_JUST_KILL_EM_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
				bVar0 = true;
			}
		}
		iVar1++;
...
void func_145()
{
	AUDIO::_PLAY_SOUND_FROM_ENTITY("ALERT_WHISTLE_01", &(uLocal_15[1]), "GAROA_Sounds", false, 0, 0);
	...
	switch (Local_274.f_6)
	{
		...
		case 3:
			...
			if (func_47(Local_274.f_8[1 /*3*/], 0.1f))
			{
				...
				TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(&(uLocal_15[0]), vVar1, Global_35, 3f, 1, 1056964608, 2f, 1, 2097152, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000, 0);
				...
				TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(&(uLocal_15[2]), vVar1, Global_35, 3f, 1, 1056964608, 1.5f, 1, 2097152, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000, 0);
				func_188(Local_274.f_8[1 /*3*/]);
...
void func_148()
{
	...
	while (iVar0 <= 5)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			{
				func_144(&(uLocal_15[iVar0]), uLocal_15.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
		...
		case 0:
			if (func_47(Local_274.f_8[0 /*3*/], 4f) && func_310(-2f, 1, 0, 0))
			{
				...
				if (func_312(iVar0))
				{
					...
					{
						func_151(&(uLocal_15[iVar0]), Global_35, "GANG_TAUNT_GEN", -1073741824 /* Float: -2f */, 1, 1744022339, 2);
		...
		case 1:
			if (func_47(Local_274.f_8[2 /*3*/], 12f))
			{
				...
				if (func_312(iVar0))
				{
					...
					func_151(&(uLocal_15[iVar0]), Global_35, "TAUNT_GEN_LOCATION", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
					func_313(&Local_274, 3);
				}
				else
				{
...
void func_272()
{
	...
	func_385(&uVar6, joaat("EVENT_SHOCKING_BEAT_DANGEROUS"), "", uLocal_15.f_209, 0, 15f, -1082130432 /* Float: -1f */, 150f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1127481344 /* Float: 180f */, 0);
...
void func_276()
{
	...
	while (iVar0 < uLocal_15.f_215)
	{
		if (func_61(&(uLocal_15[iVar0]), 0, 1))
		{
			...
			if (!bVar2)
			{
				func_151(&(uLocal_15[iVar0]), Global_35, "CALLOUT_JUST_KILL_EM_MALE", -1073741824 /* Float: -2f */, 1, 1744022339, 0);
				bVar2 = true;
			}
		}
		iVar0++;
...
bool func_281(bool bParam0, vector3 vParam1)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return false;
...
bool func_302(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_400(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
...
int func_362(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
...
int func_513(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_620(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_534(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_589(int iParam0, var uParam1)
{
	...
	*uParam1 = func_665(Var0, joaat("SLOTID_HORSE_MANE"), 0);
...
int func_590(int iParam0, var uParam1)
{
	...
	*uParam1 = func_665(Var0, joaat("SLOTID_HORSE_TAIL"), 0);
	if (!func_520(*uParam1, 0))
	{
		return 0;
	}
...
int func_670(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	int iVar1;
