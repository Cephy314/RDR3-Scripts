	...
	if (!func_21(iLocal_4, 16))
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_8) && !ENTITY::IS_ENTITY_DEAD(iLocal_8))
		{
			if (!PED::IS_PED_INJURED(&(uLocal_12[1])))
			{
				if (!func_48(134))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, 1) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, 1) == 1 && func_49(&(uLocal_12[1]), 675.2244f, -1246.993f, 42.726f, (0.25f * 6f), 1, 1)))
					{
						if (ANIMSCENE::_0x25557E324489393C(iLocal_3) && ANIMSCENE::_0x477122B8D05E7968(iLocal_3, 1, 0))
						{
				...
				else if (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, 1) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, 1) == 1 && func_49(&(uLocal_12[1]), 673.747f, -1252.87f, 43.01056f, 0.25f, 1, 1)))
				{
					func_50(477);
...
void func_162(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_178(WEAPON::_0xD3750CCC00635FC2(iParam0), iParam1);
