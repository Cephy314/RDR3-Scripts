...
int func_6(var uParam0)
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_HUMAN_STERNGUY_IDLES"), 15, 0, 0);
	if (!func_21(iLocal_4, 4))
	{
		if (!ANIMSCENE::_0x25557E324489393C(iLocal_3))
		{
			iLocal_3 = ANIMSCENE::_CREATE_ANIM_SCENE("script@story@fud1@ig@ig25_bag_drop@ig25_bag_drop", 0, "pbl_drop", false, true);
			ANIMSCENE::LOAD_ANIM_SCENE(iLocal_3);
			func_22(&iLocal_4, 4);
		}
	}
	if (!func_21(iLocal_4, 8))
	{
		if (ANIMSCENE::_0x25557E324489393C(iLocal_3) && ANIMSCENE::_0x477122B8D05E7968(iLocal_3, 1, 0))
		{
			func_22(&iLocal_4, 8);
		}
	}
	if (STREAMING::HAS_MODEL_LOADED(joaat("P_CS_FISHBAG01X")))
	{
		...
		{
			if (ANIMSCENE::_0x25557E324489393C(Global_43799) && ANIMSCENE::_0xCBFC7725DE6CE2E0(Global_43799, 0))
			{
				return 0;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(iLocal_8))
			{
				iLocal_8 = Global_43837;
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_8))
				{
					ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_8, true, true);
					func_22(&iLocal_4, 2);
				}
			}
		}
...
{
	func_15(&(iLocal_9[0]), 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	func_15(&(iLocal_9[1]), 0, 0, 1, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
	if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[0])))
	{
		func_28(&(uLocal_15[0]), &(iLocal_9[0]), 1, 0, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(&(uLocal_15[1])))
	{
		func_28(&(uLocal_15[1]), &(iLocal_9[1]), 1, 0, 0);
	}
	ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&iLocal_8);
	ANIMSCENE::_DELETE_ANIM_SCENE(iLocal_3);
	return 1;
}
...
void func_15(int iParam0, bool bParam1, bool bParam2, bool bParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)
{
	...
	func_32(iParam0);
	func_33(iParam0);
	func_34(iParam0, 37, 1);
	bVar0 = func_35(Global_1360165[iParam0 /*1157*/], 0);
	iVar1 = func_36(iParam0, 0);
	bVar2 = PERSCHAR::_0x800DF3FC913355F3(iVar1);
	if (PED::GET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, true) && Global_1359489->f_16 & 8388608 == 0)
	{
		PED::SET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 503, false);
	}
	if (func_37(iParam0, 64, 1))
	{
		func_34(iParam0, 64, 1);
	}
	if (bParam3)
	{
		func_34(iParam0, 33, 1);
		func_34(iParam0, 34, 1);
		func_38(iParam0, 1056964608 /* Float: 0.5f */, -1, 1061158912 /* Float: 0.75f */);
		func_39(iParam0, 1, 1, 0);
		if (bParam6)
		{
	...
	if (bParam1 || bParam2)
	{
		...
		{
			func_42(iParam0, bParam2, bParam2, bParam2, 0);
		}
	}
	else if (bVar0)
	{
	...
	if (func_37(iParam0, 45, 1))
	{
		func_34(iParam0, 45, 1);
	}
	func_43(iParam0, 16, 1);
	func_34(iParam0, 44, 1);
...
int func_23(var uParam0)
{
	...
	if (func_46(&iLocal_9, &uLocal_12, 1, 1, 0, 0, 0, 0))
	{
		if (!PED::IS_PED_INJURED(&(uLocal_12[0])))
		{
			func_39(0, 1, 1, 0);
			if (!PED::_0x34D6AC1157C8226C(&(uLocal_12[0]), joaat("WORLD_HUMAN_STERNGUY_IDLES")))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(&(uLocal_12[0]), true);
				ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(uLocal_12[0]), 628.2734f, -1246.48f, 40.6f, 125f, true, false, true);
				func_47(&(uLocal_12[0]), joaat("WORLD_HUMAN_STERNGUY_IDLES"), 0, 0, 0, -1082130432 /* Float: -1f */);
			}
		}
		if (!PED::IS_PED_INJURED(&(uLocal_12[1])))
		{
			...
			if (func_48(134))
			{
				...
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 651.8143f, -1238.561f, 42.8871f, 1f, 40000, (0.25f * 2f), 5242885, 40000f);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 673.747f, -1252.87f, 43.01056f, 1f, 40000, (0.25f * 2f), 5242885, 40000f);
				TASK::TASK_ACHIEVE_HEADING(0, 341.6562f, 0);
			...
			else
			{
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 651.8143f, -1238.561f, 42.8871f, 1f, 40000, (0.25f * 2f), 5242885, 40000f);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 675.2244f, -1246.993f, 42.726f, 1f, 40000, (0.25f * 2f), 5242885, 40000f);
				TASK::CLOSE_SEQUENCE_TASK(iVar0);
			}
			TASK::TASK_PERFORM_SEQUENCE(&(uLocal_12[1]), iVar0);
			TASK::CLEAR_SEQUENCE_TASK(&iVar0);
...
int func_25(var uParam0)
{
	...
	{
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_8) && !ENTITY::IS_ENTITY_DEAD(iLocal_8))
		{
			if (!PED::IS_PED_INJURED(&(uLocal_12[1])))
			{
				if (!func_48(134))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, true) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, true) == 1 && func_49(&(uLocal_12[1]), 675.2244f, -1246.993f, 42.726f, (0.25f * 6f), 1, 1)))
					{
						if (ANIMSCENE::_0x25557E324489393C(iLocal_3) && ANIMSCENE::_0x477122B8D05E7968(iLocal_3, 1, 0))
						{
							ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_3, "cs_hoseamatthews", &(uLocal_12[1]), 0);
							ANIMSCENE::SET_ANIM_SCENE_ENTITY(iLocal_3, "p_cs_fishbag01x", iLocal_8, 0);
							TASK::TASK_ENTER_ANIM_SCENE(&(uLocal_12[1]), iLocal_3, "cs_hoseamatthews", "pbl_drop", 1.48f, true, 9, 20000, -1082130432);
							func_22(&iLocal_4, 16);
						}
					}
				}
				else if (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, true) == 8 || (TASK::GET_SCRIPT_TASK_STATUS(&(uLocal_12[1]), 242628503, true) == 1 && func_49(&(uLocal_12[1]), 673.747f, -1252.87f, 43.01056f, 0.25f, 1, 1)))
				{
					func_50(477);
					func_15(&(iLocal_9[1]), 0, 0, 0, -1082130432 /* Float: -1f */, 1, 1, 0, 0, 0, 0);
					func_22(&iLocal_4, 16);
					func_22(&iLocal_4, 32);
				}
			}
	...
	{
		if (ANIMSCENE::_0x25557E324489393C(iLocal_3) && ANIMSCENE::_0xD8254CB2C586412B(iLocal_3, 0))
		{
			func_22(&iLocal_4, 32);
		}
	}
...
void func_28(int iParam0, int iParam1, bool bParam2, int iParam3, bool bParam4)
{
	bool bVar0;
	...
	func_34(iParam1, 39, 1);
	func_58(iParam1, 64, 0);
...
void func_39(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	if (bParam1)
	{
		func_34(iParam0, 50, 1);
		func_34(iParam0, 48, 1);
		func_34(iParam0, 49, 1);
		func_34(iParam0, 51, 1);
		func_34(iParam0, 52, 1);
		func_34(iParam0, 54, 1);
		func_34(iParam0, 55, 1);
	}
	else
	{
...
void func_42(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	iVar0 = func_36(iParam0, 0);
	if (!MISC::_IS_BASE_A_PERSISTENT_CHARACTER(iVar0))
	{
		return;
	}
	bVar1 = func_63(iParam0);
	if (((ENTITY::DOES_ENTITY_EXIST(bVar1) && func_65(iParam0) < 10000f) && !bParam3) && !CAM::IS_SCREEN_FADED_OUT())
	{
		return;
	}
...
int func_46(int iParam0, var uParam1, bool bParam2, int iParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 < *iParam0)
	{
		...
		{
			(*uParam1)[iVar1] = func_67(iParam0[iVar1], bParam2, iParam3, 0, 0, 0, 0, bParam4, 1, 0, bParam5, 0, 0, 0, 0, bParam6, 0, 1, 1, 1, 0, 0, 1, bParam7, 1);
		}
		iVar1++;
	}
	iVar1 = 0;
...
void func_47(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, float fParam5)
{
...
int func_48(int iParam0)
{
	...
	return func_70(((*Global_1347702)[iParam0 /*49*/])->f_15, 1);
}
...
int func_59(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (func_35(bVar0, 0))
	{
		if (func_35(PED::_GET_HORSE_RIDER(bVar0, false), 0) && !bParam4)
		{
			return 0;
		}
		if ((bParam1 || !func_56(iParam0)) || func_57(iParam0))
		{
			if (bParam2 || !(ENTITY::IS_ENTITY_ON_SCREEN(bVar0) && func_76(PLAYER::PLAYER_PED_ID(), bVar0, 1) < 10000f))
			{
				...
				if (iVar1 != 0)
				{
					...
					func_78(iParam0);
					PERSCHAR::_0x7B204F88F6C3D287(func_79(iParam0, 0));
					PERSCHAR::_0xFCC6DB8DBE709BC8(func_79(iParam0, 0));
					func_80(iParam0);
				}
			}
			else
			{
				if (func_29(iParam0, 32768, 1))
				{
...
int func_67(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, bool bParam9, bool bParam10, bool bParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, int iParam17, bool bParam18, bool bParam19, bool bParam20, bool bParam21, bool bParam22, bool bParam23, bool bParam24)
{
	vector3 vVar0;
	bool bVar3;
	int iVar4;
	...
	{
		case 0:
			if (func_37(iParam0, 2, 1))
			{
				func_34(iParam0, 2, 1);
			}
			if (func_29(iParam0, 16, 1))
			{
		...
		case 1:
			...
			if (!func_37(iParam0, 44, 0))
			{
				func_26(iParam0, 44, 0);
			}
			if (func_87(iParam0, vVar0, iParam13, 0, 1, iParam17, bParam20, -1, 1, 0))
			{
				func_86(iParam0, 2);
			}
			break;
		case 2:
			...
			func_34(iParam0, 18, 1);
			ENTITY::SET_ENTITY_VISIBLE(Global_1360165[iParam0 /*1157*/], true);
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_1360165[iParam0 /*1157*/], joaat("REL_GANG_DUTCHS"));
			POPULATION::_0xF74E134F40192884(Global_1360165[iParam0 /*1157*/], 0);
			PERSCHAR::_0x6759BEE6762E140B(((*Global_1360165)[iParam0 /*1157*/])->f_1);
			PED::SET_PED_CONFIG_FLAG(Global_1360165[iParam0 /*1157*/], 130, false);
			func_39(iParam0, bParam9, 1, 0);
			if (bParam22)
			{
			...
			func_34(iParam0, 33, 1);
			func_34(iParam0, 34, 1);
			func_34(iParam0, 29, 1);
			if (!func_89(vVar0) && bParam7)
			{
				func_86(iParam0, 3);
			}
			else if (iParam13 != 0)
		...
		case 3:
			if (!ENTITY::IS_ENTITY_DEAD(Global_1360165[iParam0 /*1157*/]) && !ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_1360165[iParam0 /*1157*/], -1))
			{
				...
				func_90(Global_1360165[iParam0 /*1157*/], vVar0, iParam6, 2, 1073741824 /* Float: 2f */);
			}
			else if (bParam16)
			{
			...
			if (iParam13 != 0 || bVar3)
			{
				...
				if (func_91(iParam0, iParam13))
				{
					if (PED::_0xA0BC8FAED8CFEB3C(Global_1360165[iParam0 /*1157*/]))
					{
						...
						if (func_37(iParam0, 25, 0))
						{
							func_34(iParam0, 25, 0);
						}
		...
		case 6:
			...
			func_86(iParam0, 7);
		case 7:
			func_39(iParam0, bParam9, bParam15, 0);
...
float func_76(int iParam0, bool bParam1, bool bParam2)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		return 0f;
	...
	return func_71(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(bParam1, false, false));
}
...
int func_87(int iParam0, vector3 vParam1, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, int iParam10, bool bParam11)
{
	if (!func_53(iParam0))
	{
		return 0;
	...
	switch (((*Global_1360165)[iParam0 /*1157*/])->f_3)
	{
		...
		case 1:
			...
			if (iParam4 == 0)
			{
				if (iParam9 != -1)
				{
					iParam4 = func_104(iParam0, iParam9, bParam7, 1);
				}
				...
				{
					iParam4 = func_104(iParam0, Global_40.f_4283, bParam7, 1);
				}
			...
			((*Global_1360165)[iParam0 /*1157*/])->f_4 = { func_109(iParam0, iParam4, vParam1, iParam5, bParam6, bParam8, (Global_40.f_4942[iParam0 /*60*/])->f_59, bParam11) };
			if (!bParam6)
			{
				func_34(iParam0, 44, 1);
			}
...
void func_90(bool bParam0, vector3 vParam1, float fParam4, int iParam5, int iParam6)
{
	...
	if (bParam0 == func_114(Global_35) && PLAYER::IS_PLAYER_TELEPORT_ACTIVE())
	{
	}
	if (func_115(bParam0))
	{
		if (func_116(ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0)))
		{
			PHYSICS::_0x0348469DAA17576C(bParam0);
		}
	}
	if (func_21(iParam5, 4) && ENTITY::IS_ENTITY_A_PED(bParam0))
	{
		bVar1 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0);
	...
	if (func_21(iParam5, 2))
	{
		...
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_21(iParam5, 32), true);
		}
		else
		{
			ENTITY::_SET_ENTITY_COORDS_AND_HEADING(bParam0, vParam1, fParam4, true, func_21(iParam5, 32), true);
	...
	else if (func_21(iParam5, 129))
	{
		...
		ENTITY::SET_ENTITY_COORDS_NO_OFFSET(bParam0, vParam1, func_21(iParam5, 32), true, true);
	...
	if (bVar4)
	{
		...
		if (ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(bParam0) == Global_35 && !func_21(iParam5, 64))
		{
...
void func_97(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		case 11:
			...
			{
				func_127(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE"), 0, 0, 2, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 0, 0, 0);
				func_127(iParam1, joaat("WEAPON_REVOLVER_CATTLEMAN_SADIE_DUALWIELD"), 0, 0, 3, 1, 1, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, -1, 0, 1, 0, 0);
			}
			break;
	}
}
...
int func_104(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	switch (iParam1)
	{
		case 0:
			...
			{
				case 1:
					if (func_70(((*Global_1835011)[4 /*74*/])->f_1, 1))
					{
						iVar1[0] = -695701225;
					}
					else
		...
		case 1:
			switch (iParam0)
			{
				...
				case 9:
					...
					break;
				case 10:
					if (func_70(((*Global_1347702)[63 /*49*/])->f_15, 1) || func_106(((*Global_1347702)[63 /*49*/])->f_15))
					{
						iVar1[0] = -268604689;
					}
					else
				...
				case 17:
					...
					break;
				case 18:
					if (!func_70(((*Global_1835011)[14 /*74*/])->f_1, 1))
					{
						iVar1[0] = -268604689;
						iVar1[1] = -1632589543;
						iVar7 = 2;
					}
					else if (func_29(18, 134217728, 1))
					{
						iVar1[0] = 961676983;
					}
					else
		...
		case 3:
			switch (iParam0)
			{
				...
				case 10:
					...
					break;
				case 11:
					if (func_70(((*Global_1347702)[134 /*49*/])->f_15, 1) || func_106(((*Global_1347702)[134 /*49*/])->f_15))
					{
						iVar1[0] = -2040275819;
						iVar1[1] = 1205492208;
						iVar7 = 2;
		...
		case 4:
			...
			{
				case 2:
					if (func_70(((*Global_1835011)[38 /*74*/])->f_1, 1))
					{
						iVar1[0] = -1559986688;
					}
					else
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_131(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_70(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
...
bool func_108(int iParam0, bool bParam1)
{
	...
	if (!bParam1)
	{
		if (func_13(iParam0) || func_37(iParam0, 44, 1))
		{
			return false;
		}
	}
...
struct<7> func_109(int iParam0, int iParam1, vector3 vParam2, bool bParam5, bool bParam6, bool bParam7, var uParam8, bool bParam9)
{
	struct<7> Var0;
...
int func_119(int iParam0, int iParam1)
{
	...
	switch (iParam0)
	{
		...
		case -1862464078:
			return 1895628185;
		case 296923297:
			iVar0 = func_142(296923297, iParam1);
		...
		case -1414977761:
			return 1059434053;
		case 1237718549:
			iVar0 = func_142(1237718549, iParam1);
			return func_143(iVar0);
		case -23947011:
			return -456769142;
		case 1295334688:
...
void func_124(int iParam0, bool bParam1, bool bParam2)
{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1 > 0 && func_120(bParam1, 860729266))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 860729266);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4096 > 0 && func_120(bParam1, 879715242))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 879715242);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 128 > 0 && func_120(bParam1, 1606325429))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1606325429);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 256 > 0 && func_120(bParam1, 1743550585))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1743550585);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 512 > 0 && func_120(bParam1, 1064646155))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1064646155);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1024 > 0 && func_120(bParam1, -536694793))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -536694793);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2048 > 0 && func_120(bParam1, -1304053509))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1304053509);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & -2147483648 > 0 && func_120(bParam1, 718939204))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 718939204);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 65536 > 0 && func_120(bParam1, -972364774))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -972364774);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16384 > 0 && func_120(bParam1, -1100875244))
	{
	...
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 262144 > 0 && func_120(bParam1, 1153596794))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1153596794);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 524288 > 0 && func_120(bParam1, 1016389820))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1016389820);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1048576 > 0 && func_120(bParam1, -726966617))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -726966617);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 2097152 > 0 && func_120(bParam1, 1365901568))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 1365901568);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 32768 > 0 && func_120(bParam1, -1658942149))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1658942149);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 131072 > 0 && func_120(bParam1, -1980913856))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1980913856);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 4194304 > 0 && func_120(bParam1, 491764525))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 491764525);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8388608 > 0 && func_120(bParam1, -76015264))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -76015264);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 16777216 > 0 && func_120(bParam1, 622113465))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 622113465);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 33554432 > 0 && func_120(bParam1, 781533162))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 781533162);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 67108864 > 0 && func_120(bParam1, -271415321))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -271415321);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 134217728 > 0 && func_120(bParam1, -1683207356))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1683207356);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 268435456 > 0 && func_120(bParam1, -254794762))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -254794762);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 536870912 > 0 && func_120(bParam1, 609066278))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, 609066278);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 1073741824 > 0 && func_120(bParam1, -1712783565))
	{
		PED::_SET_PED_BODY_COMPONENT(bParam1, -1712783565);
	}
	if ((Global_40.f_4942[iParam0 /*60*/])->f_5 & 8192 > 0 && func_120(bParam1, 1544915253))
	{
...
int func_127(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, bool bParam6, int iParam7, int iParam8, int iParam9, bool bParam10, bool bParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		default:
			...
			if ((WEAPON::_0x705BE297EEBDB95D(iVar0) || WEAPON::_0x959383DCD42040DA(iVar0)) && PED::GET_PED_RELATIONSHIP_GROUP_HASH(iParam0) == joaat("REL_GANG_DUTCHS"))
			{
				...
				if (!Global_43890 && MISC::_DOES_STRING_EXIST_IN_STRING(&cVar5, "_DUALWIELD"))
				{
					...
					if (func_145(iVar3) && WEAPON::_0xF252A85B8F3F8C58(iVar2, iVar3))
					{
						bVar21 = true;
					}
				}
	...
	if (iParam9 < 0)
	{
		if (iParam0 != Global_35 && func_145(iVar0))
		{
	...
	{
		func_147(iVar0, iParam9, bParam2, bParam5, iParam4, bParam11, 752097756, 0);
	}
	else if (!bParam13)
	{
		fVar25 = 0f;
		func_148(iParam0, &iVar0, &fVar25);
...
int func_147(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<4> Var0;
	int iVar5;
	struct<10> Var6;
	...
	{
		Var0 = { func_154(iParam0, 0, 1) };
		iVar5 = 1728382685; /* GXTEntry: "Right" */
		Var6.f_9 = -1591664384;
		iVar28 = 0;
		while (iVar28 < 4)
		{
			iVar5 = func_155((375 + iVar28), 1);
			if (func_156(iParam0, &Var0, iVar5, 0))
			{
				if (func_157(iParam0, &Var6, iVar5))
				{
					Var29 = { func_158(iParam0, Var0, iVar5, 0) };
					func_159(iParam0, &Var29, &Var0, 1, -142743235, 1, 0);
				}
				else
				{
					iVar28++;
				...
				if (func_160(0))
				{
					...
					func_161(WEAPON::_0x5C2EA6C44F515F34(iParam0), iParam1, iParam6);
...
void func_148(int iParam0, int iParam1, float fParam2)
{
	bool bVar0;
	int iVar1;
...
struct<5> func_154(int iParam0, bool bParam1, int iParam2)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<10> Var27;
	...
	switch (func_165(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_158(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("WEAPON"):
			...
			if (iParam2 && func_167(iParam0, 1))
			{
				Var5.f_9 = -1591664384;
				if (!func_156(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_156(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_157(iParam0, &Var5, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("EMOTE"):
			...
			break;
		case joaat("UPGRADE"):
			if (func_170(iParam0, -1823706425))
			{
				Var0 = { func_158(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_170(iParam0, -1483207246))
			{
				Var0 = { func_158(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("WARDROBE"));
			}
		...
		default:
			...
			else if (INVENTORY::_0x780C5B9AE2819807(iParam0, -833319691))
			{
				...
				if (!func_171(Var0, &Var27, bParam1, 0))
				{
					Var0.f_4 = 0;
				}
				else
...
{
	return func_172(iParam0, *uParam1, iParam2, iParam3) > 0;
}
...
int func_157(int iParam0, var uParam1, int iParam2)
{
	...
	if (func_173(iParam0, &uVar0, uParam1, iParam2))
	{
...
struct<4> func_158(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, int iParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_159(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	...
	Var0.f_9 = -1591664384;
	if (!func_171(*uParam1, &Var0, bParam6, 0))
	{
		return 0;
	}
	if (iParam3 < 0)
...
int func_160(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_175(bParam0));
}
...
void func_162(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_178(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
{
	return func_158(joaat("CHARACTER"), func_180(), -1591664384, bParam0);
}
...
struct<4> func_166(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			*Global_1224214 = { func_158(923904168, func_164(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			*Global_1224222 = { func_158(923904168, func_164(bParam0), -740156546, 0) };
		}
		return *Global_1224222;
	}
	return func_158(923904168, func_164(bParam0), -740156546, 0);
}
...
int func_167(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_181(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
struct<4> func_168(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			*Global_1224218 = { func_158(271701509, func_164(bParam0), 12999093, 0) };
		}
		return *Global_1224218;
	}
	return func_158(271701509, func_164(bParam0), 12999093, 0);
}
...
int func_171(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
	if (!INVENTORY::_0xB881CA836CC4B6D4(&uParam0))
	{
		return 0;
	}
	if (!INVENTORY::_0x9700E8EFC4AB9089(func_175(bParam5), &uParam0, uParam4, !bParam6))
	{
		return 0;
	}
	return 1;
...
int func_172(int iParam0, struct<4> Param1, int iParam5, bool bParam6)
{
	struct<4> Var0;
	var uVar4;
	...
	Var0 = { func_158(iParam0, Param1, iParam5, bParam6) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(&Var0))
	{
		return 0;
	}
	uVar4 = INVENTORY::_0xC97E0D2302382211(func_175(bParam6), &Var0, 0);
	return uVar4;
}

int func_173(int iParam0, var uParam1, var uParam2, int iParam3)
{
	int iVar0;

	iVar0 = func_175(0);
	*uParam1 = { func_158(iParam0, func_166(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(uParam1))
	{
		return 0;
	}
...
int func_181(int iParam0, bool bParam1)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_175(bParam1), iParam0, 0);
}
