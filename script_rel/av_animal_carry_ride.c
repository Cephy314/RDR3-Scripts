...
int func_31(var uParam0)
{
	...
	switch (iLocal_9)
	{
		...
		case 7:
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[1 /*14*/])))
			{
				if (PED::_GET_HORSE_CARRIER_OF_PED(&(uParam0->f_20[2 /*14*/])) == &uParam0->f_20[0 /*14*/])
				{
...
int func_221(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_254(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_286(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
