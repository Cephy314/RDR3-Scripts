		...
		else
		{
			...
			switch (iLocal_16.f_95)
			{
				...
				case 7:
					if (func_17())
					{
						(Global_40.f_9632[iLocal_16.f_151 /*4*/])->f_2 = (1 + (Global_40.f_9632[iLocal_16.f_151 /*4*/])->f_2);
...
void func_1()
{
	...
	if (((!func_46() && !func_47(&(iLocal_16.f_250), fVar0)) && !CAM::IS_SCREEN_FADED_OUT()) && !func_48())
	{
		func_40(&(iLocal_16.f_250), 0);
		return;
	}
	if (func_47(&(iLocal_16.f_250), fVar0))
	{
	}
	func_37(&iLocal_16);
	func_49();
	...
	if (VOLUME::_DOES_VOLUME_EXIST(iLocal_16.f_237))
	{
		func_54(&iLocal_16);
	...
	if (iLocal_16.f_95 >= 9 && iLocal_16.f_95 < 11)
	{
		...
		else if (func_57(iLocal_16.f_151, 1) || func_58(iLocal_16.f_151, 1))
		{
...
int func_3(var uParam0)
{
	...
	else
	{
		...
		if (func_72(&uVar5))
		{
			fVar4 = func_73();
			iVar3 = 0;
			while (iVar3 < iLocal_16.f_215)
			{
				if (&iLocal_16.f_9[iVar3] < fVar4)
				{
					if (func_61(&(iLocal_16[iVar3]), 0, 1))
					{
						return 0;
					}
				}
...
int func_8(struct<8> Param0, var uParam8)
{
	...
	if (func_69(iLocal_16.f_209))
	{
		...
		func_78(&(iLocal_16.f_152), 0);
		func_79(&(iLocal_16.f_152), 1);
		func_80(&(iLocal_16.f_152), 6f);
		iLocal_16.f_209 = { Param0 };
		iLocal_16.f_151 = Param0.f_3;
		iLocal_16.f_221 = Param0.f_4;
	...
	fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(Global_36, iLocal_16.f_209, true);
	if (CAM::IS_SCREEN_FADED_IN())
	{
		if (fVar0 < 200f)
		{
			if (func_83())
			{
				vVar1 = { func_84(iLocal_16.f_151, 0, iLocal_16.f_221) };
				vVar1 = { func_84(iLocal_16.f_151, 1, iLocal_16.f_221) };
				if (func_85())
				{
				...
				else
				{
					...
					PED::_0xED9582B3DA8F02B4((((iLocal_16.f_215 + iLocal_16.f_216) + iLocal_16.f_217 * 2) + iLocal_16.f_219) + 1);
					return 1;
				}
			}
		}
...
bool func_9()
{
	...
	if (bVar0)
	{
		...
		while (iVar1 < iLocal_16.f_216)
		{
			iVar3 = func_92(iVar1);
			iVar2 = func_93(iVar1);
			if (!PED::_IS_METAPED_OUTFIT_REQUEST_VALID(&(iLocal_16.f_66[iVar1])))
			{
				if (iVar2 == func_94())
				{
				}
				...
				{
					iLocal_16.f_66[iVar1] = PED::_REQUEST_METAPED_OUTFIT(iVar3, iVar2);
					bVar0 = false;
					Jump @162; //curOff = 137
					if (!PED::_0x610438375E5D1801(&(iLocal_16.f_66[iVar1])))
					{
						bVar0 = false;
					}
				}
				...
				iVar1 = 0;
				while (iVar1 < iLocal_16.f_215)
				{
					iVar2 = func_96(iVar1);
					iVar4 = func_97(iVar1);
					if (!PED::_IS_METAPED_OUTFIT_REQUEST_VALID(&(iLocal_16.f_31[iVar1])))
					{
						if (iVar2 == func_94())
						{
						}
						...
						{
							iLocal_16.f_31[iVar1] = PED::_REQUEST_METAPED_OUTFIT(iVar4, iVar2);
							bVar0 = false;
							Jump @293; //curOff = 268
							if (!PED::_0x610438375E5D1801(&(iLocal_16.f_31[iVar1])))
							{
								bVar0 = false;
							}
						}
...
int func_12()
{
	...
	if (iVar1 != 0)
	{
		...
		iLocal_16.f_49[iVar0] = VEHICLE::CREATE_VEHICLE(iVar1, vVar2, fVar5, true, true, false, false);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(&(iLocal_16.f_49[iVar0]), 0f);
		ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_49[iVar0]), true);
		ENTITY::_0x3F08C6163A4AB1D6(&(iLocal_16.f_49[iVar0]));
		func_103(&(iLocal_16.f_49[iVar0]));
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(&(iLocal_16.f_49[iVar0]), false))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(&(iLocal_16.f_49[iVar0]), true, false);
		}
	}
	iLocal_16.f_220++;
...
int func_14()
{
	...
	if (iVar1 != 0)
	{
		...
		iLocal_16.f_52[iVar0] = OBJECT::CREATE_OBJECT(iVar1, vVar2, true, true, false, false, true);
		ENTITY::SET_ENTITY_ROTATION(&(iLocal_16.f_52[iVar0]), 0f, 0f, fVar5, 2, true);
		ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_52[iVar0]), false);
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(&(iLocal_16.f_52[iVar0]), false))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(&(iLocal_16.f_52[iVar0]), true, false);
		}
		if (func_107(iVar0))
		{
			OBJECT::PLACE_OBJECT_ON_GROUND_PROPERLY(&(iLocal_16.f_52[iVar0]), 0);
		}
	}
	iLocal_16.f_220++;
...
int func_15()
{
	...
	iVar6 = func_93(iVar0);
	if (!ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
	{
		if (iVar1 != 0)
		{
			if (func_110(iVar0))
			...
			{
				iLocal_16.f_40[iVar0] = func_111(iVar1, vVar2, uVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
			else
			{
				iLocal_16.f_40[iVar0] = func_111(iVar1, vVar2, uVar5, 1, 1, 0, 1, 0, 1, 0, 0, 0, 0);
				PED::_SET_PED_BODY_COMPONENT(&(iLocal_16.f_40[iVar0]), func_93(iVar0));
				PED::_UPDATE_PED_VARIATION(&(iLocal_16.f_40[iVar0]), false, true, true, true, false);
			}
		}
	}
	if (func_61(&(iLocal_16.f_40[iVar0]), 0, 1))
	{
		func_112(&(iLocal_16.f_40[iVar0]), 0);
		if (func_30(&iLocal_16, 1))
		{
			iVar7 = func_113(iVar0);
			if (iVar7 != 3)
			{
				if (!ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_84[iVar0])))
				{
					iLocal_16.f_84[iVar0] = OBJECT::CREATE_OBJECT(joaat("P_LANTERN09X"), vVar2, true, true, false, false, true);
					func_114(iVar0, iVar7, &vVar9, &vVar12, &iVar8);
					ENTITY::ATTACH_ENTITY_TO_ENTITY(&(iLocal_16.f_84[iVar0]), &(iLocal_16.f_40[iVar0]), iVar8, vVar9, vVar12, false, false, false, false, 1, true, false, false);
					return 0;
				}
			}
		}
		func_115(&(iLocal_16.f_152), &(iLocal_16.f_40[iVar0]), 0);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(&(iLocal_16.f_40[iVar0]), true);
		PED::SET_PED_CONFIG_FLAG(&(iLocal_16.f_40[iVar0]), 277, true);
		PED::REQUEST_PED_VISIBILITY_TRACKING(&(iLocal_16.f_40[iVar0]));
		ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_40[iVar0]), false);
		if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(&(iLocal_16.f_40[iVar0]), false))
		{
			ENTITY::SET_ENTITY_AS_MISSION_ENTITY(&(iLocal_16.f_40[iVar0]), true, false);
		}
		iLocal_16.f_220++;
...
int func_17()
{
	...
	iVar6 = func_96(iVar0);
	uVar7 = func_118(iLocal_16.f_181);
	if (iVar1 != 0)
	{
		if (func_119(iVar0))
		{
		...
		if (iVar6 == func_94())
		{
			iLocal_16[iVar0] = func_111(iVar1, vVar2, uVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
		}
		else
		{
			iLocal_16[iVar0] = PED::_0xEAF682A14F8E5F53(&(iLocal_16.f_31[iVar0]), vVar2, uVar5, 1, 1, 1, 0);
			if (!ENTITY::DOES_ENTITY_EXIST(&(iLocal_16[iVar0])))
			{
				iLocal_16[iVar0] = func_111(iVar1, vVar2, uVar5, 1, 1, 0, 1, 1, 1, 0, 0, 0, 0);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16[iVar0])))
		{
			...
			PED::SET_PED_CONFIG_FLAG(&(iLocal_16[iVar0]), 277, false);
			PED::SET_PED_CONFIG_FLAG(&(iLocal_16[iVar0]), 6, true);
			PED::SET_PED_CONFIG_FLAG(&(iLocal_16[iVar0]), 233, true);
			PED::REQUEST_PED_VISIBILITY_TRACKING(&(iLocal_16[iVar0]));
			func_120(&(iLocal_16.f_152), &(iLocal_16[iVar0]));
			func_121(&(iLocal_16.f_152), &(iLocal_16[iVar0]), 0);
			ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16[iVar0]), false);
			if (!ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(&(iLocal_16[iVar0]), false))
			{
				ENTITY::SET_ENTITY_AS_MISSION_ENTITY(&(iLocal_16[iVar0]), true, false);
			}
			if (iLocal_16.f_181 == -1)
			{
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(&(iLocal_16[iVar0]), joaat("REL_PLAYER_DISLIKE"));
			}
			func_122(&(iLocal_16[iVar0]), 1);
			PED::_0xBD75500141E4725C(&(iLocal_16[iVar0]), uVar7);
			DECORATOR::DECOR_SET_BOOL(&(iLocal_16[iVar0]), "bBeatPed", true);
			func_124(func_123(&(iLocal_16[iVar0])), &(iLocal_16[iVar0]));
		}
		else
		{
...
int func_20()
{
	...
	while (iVar0 <= 2)
	{
		if (!func_61(&(iLocal_16[iVar0]), 0, 0))
		{
		}
		else
		{
			func_125(&iLocal_16, iVar0, 0);
			func_126(&iLocal_16, iVar0, -1, -1);
			PED::SET_PED_HEARING_RANGE(&(iLocal_16[iVar0]), 5f);
			PED::_0x7DE9692C6F64CFE8(&(iLocal_16[iVar0]), true, 0, 0);
			WEAPON::REMOVE_ALL_PED_WEAPONS(&(iLocal_16[iVar0]), true, true);
			PED::SET_PED_CONFIG_FLAG(&(iLocal_16[iVar0]), 6, true);
			PED::_0x8ACC0506743A8A5C(&(iLocal_16[iVar0]), joaat("SCRIPT_CLASSICMOVEANDAIM"), 1, -1082130432);
			func_128(&(iLocal_16[iVar0]), func_127(iVar0), 0);
			switch (iVar0)
			{
				case 0:
					func_129(&(iLocal_16[0]), joaat("GROUP_REPEATER"), 99, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					TASK::TASK_PLAY_ANIM(&(iLocal_16[0]), func_130(), func_131(2), 1000f, -8f, -1, 1, 0f, false, 0, false, 0, false);
					break;
				case 1:
					func_129(&(iLocal_16[1]), joaat("GROUP_REVOLVER"), 99, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					TASK::TASK_PLAY_ANIM(&(iLocal_16[1]), func_130(), func_131(3), 1000f, -8f, -1, 1, 0f, false, 0, false, 0, false);
					break;
				case 2:
					func_129(&(iLocal_16[2]), joaat("GROUP_REVOLVER"), 99, 1, 0, 1056964608 /* Float: 0.5f */, 1065353216 /* Float: 1f */, 0);
					break;
			}
		}
		iVar0++;
...
void func_21()
{
	...
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16[iVar0])))
		{
			ENTITY::_0xA91E6CF94404E8C9(&(iLocal_16[iVar0]));
			if (!func_132(&iLocal_16, iVar0, 4))
			{
				ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16[iVar0]), true);
			}
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_216)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
		{
			ENTITY::_0xA91E6CF94404E8C9(&(iLocal_16.f_40[iVar0]));
			if (!func_133(&iLocal_16, iVar0, 4))
			{
				ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_40[iVar0]), true);
			}
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_217)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_49[iVar0])))
		{
			ENTITY::_0xA91E6CF94404E8C9(&(iLocal_16.f_49[iVar0]));
			ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_49[iVar0]), true);
		}
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_218)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_52[iVar0])))
		{
			ENTITY::SET_ENTITY_VISIBLE(&(iLocal_16.f_52[iVar0]), true);
		}
		iVar0++;
	}
}
...
int func_23()
{
	...
	if (iLocal_275 < 10)
	{
		...
		{
			vVar1 = { func_137(1) };
			if (func_138(&(iLocal_16[1]), vVar1, 1f, 1, 1))
			{
				TASK::CLEAR_PED_TASKS(&(iLocal_16[1]), 1, 0);
				TASK::TASK_AIM_GUN_AT_ENTITY(&(iLocal_16[1]), Global_35, -1, 0, 1);
			}
		}
		if (func_139() || ((iLocal_275 > 0 && iLocal_275 < 4) && Global_1935630->f_40 == 0))
		{
			func_140(&uLocal_484, &(iLocal_16[2]), 0, 30f);
			func_141();
			func_142();
			func_143(10);
		}
	...
	switch (iLocal_275)
	{
		...
		case 1:
			...
			func_157();
			func_158(&iLocal_16);
			if (func_61(&(iLocal_16[0]), 0, 1))
			{
				if (!func_145(&uLocal_279, 2))
				{
					if (func_159(&(iLocal_16[0]), &(iLocal_361[0]), "PEDB", joaat("BREAKOUT"), 0, 1, 0))
					{
						if (!ANIMSCENE::_0xD8254CB2C586412B(&(iLocal_361[0]), 0))
						{
							ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(&(iLocal_361[0]), "PEDB", &(iLocal_16[0]));
						}
						func_160(&(iLocal_16[0]), iLocal_16.f_22[0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[0]), joaat("MOTIONSTATE_AIMING"), false, 1, false);
						TASK::TASK_AIM_GUN_AT_ENTITY(&(iLocal_16[0]), Global_35, -1, 1, 0);
						func_136(&uLocal_279, 2);
					}
				}
			}
			if (func_61(&(iLocal_16[1]), 0, 1))
			{
				if (!func_145(&uLocal_279, 4))
				{
					if (func_159(&(iLocal_16[1]), &(iLocal_361[0]), "PEDC", joaat("BREAKOUT"), 0, 1, 0))
					{
						if (!ANIMSCENE::_0xD8254CB2C586412B(&(iLocal_361[0]), 0))
						{
							ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(&(iLocal_361[0]), "PEDC", &(iLocal_16[1]));
						}
						func_160(&(iLocal_16[1]), iLocal_16.f_22[1], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[1]), joaat("MOTIONSTATE_AIMING"), false, 1, false);
						TASK::TASK_AIM_GUN_AT_ENTITY(&(iLocal_16[1]), Global_35, -1, 1, 0);
		...
		case 3:
			...
			if (func_157())
			{
				...
				func_171(Global_35, &(iLocal_16[2]), 2, 1, 10000, 0);
				func_143(4);
			}
			break;
		case 4:
			...
			if (PED::IS_PED_ON_MOUNT(Global_35))
			{
				...
				if (((!func_145(&uLocal_279, 65536) && func_47(&uLocal_295, (15f - 3f))) && func_173(0, 1, 0, 0)) || func_145(&uLocal_279, 2097152))
				{
					if (!func_174())
					{
						...
						TASK::TASK_PLAY_ANIM(0, func_130(), func_131(5), 8f, -8f, -1, 0, 0f, true, 0, false, 0, false);
						TASK::TASK_PLAY_ANIM(0, func_130(), func_131(0), 8f, -8f, -1, 65537, 0f, true, 0, false, 0, false);
						func_176(&(iLocal_16[2]), &iVar0, 0, 0, 1, 1);
						func_177(&iLocal_16);
						func_143(5);
					}
				}
			...
			if (!PED::IS_PED_ON_MOUNT(Global_35))
			{
				...
				if (!func_145(&uLocal_279, 8))
				{
					if (func_61(&(iLocal_16[2]), 0, 1))
					{
						...
						PED::_0x2208438012482A1A(&(iLocal_16[2]), true, false);
		...
		case 6:
			...
			{
				func_186(&iLocal_16, &(iLocal_282[8]), func_185(), 1067450368 /* Float: 1.25f */, 2f, 0.5f, 0);
				if (((!func_145(&uLocal_279, 131072) && func_61(&(iLocal_16[1]), 0, 1)) && func_173(0, 1, 0, 0)) && func_173(0f, 1, Global_35, 1))
				{
					TASK::OPEN_SEQUENCE_TASK(&iVar0);
					TASK::TASK_AIM_GUN_AT_ENTITY(0, Global_35, -1, 1, 1);
					func_176(&(iLocal_16[1]), &iVar0, 0, 0, 1, 1);
					switch (iLocal_477)
					{
						case 0:
					...
					func_187(&(iLocal_16[1]), Global_35, sVar5, "", -1082130432 /* Float: -1f */, iVar8, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					func_188(&(iLocal_16.f_152), 0);
		...
		case 7:
			...
			else
			{
				...
				if (func_194(&(iLocal_16[2]), 1, 1) > 3f && func_145(&uLocal_279, 8192))
				{
					if (VOLUME::_DOES_VOLUME_EXIST(&(iLocal_282[7])))
					{
...
void func_26()
{
	...
	while (iVar1 < iLocal_16.f_216)
	{
		if (func_61(&(iLocal_16.f_40[iVar1]), 0, 0))
		{
			iVar0 = PED::_GET_HORSE_RIDER(&(iLocal_16.f_40[iVar1]), false);
			if (func_61(iVar0, 0, 0))
			{
				PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(iVar0, &(iLocal_16.f_40[iVar1]), 0);
				func_209(&iLocal_16, iVar1, 32);
			}
		}
		iVar1++;
	}
...
void func_29()
{
	...
	if (!func_30(&iLocal_16, 8388608))
	{
		...
		if (func_30(&iLocal_16, 4194304))
		{
			...
			if ((iVar0 < (iLocal_16.f_225 - 60) || IntToFloat(iVar0) < (IntToFloat(iLocal_16.f_225) * 0.7f)) || iVar0 < 80)
			{
...
int func_31()
{
	...
	func_214(&Local_319);
	func_215();
	func_216(&iLocal_16, &Local_376, &Local_440);
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_215)
	{
		func_217(&iLocal_16, iVar0, &(iLocal_16.f_40[iVar0]));
		iVar0++;
	}
	switch (iLocal_276)
	{
		...
		case 2:
			...
			break;
		case 3:
			if (func_223(&uLocal_479, &iLocal_16, 0, -1, 1073741824 /* Float: 2f */, 4))
			{
				func_224();
				iLocal_276 = 4;
			}
...
void func_38()
{
	...
	while (iVar0 < iLocal_16.f_216)
	{
		if (!func_133(&iLocal_16, iVar0, 16))
		{
			if (func_61(&(iLocal_16.f_40[iVar0]), 0, 0))
			{
				if (func_238(iVar0))
				{
					TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_16.f_40[iVar0]), iLocal_16.f_209, 4, 0, -1f, -1, 0);
					PED::SET_PED_KEEP_TASK(&(iLocal_16.f_40[iVar0]), true);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(&(iLocal_16.f_40[iVar0]), false);
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(iLocal_16.f_40[iVar0]);
					func_209(&iLocal_16, iVar0, 16);
				}
			}
		}
		iVar0++;
...
void func_49()
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_16.f_56))
	{
		...
		PED::_0x2EB75FB86C41F026(iLocal_16.f_56, 3, 1);
		PED::_0x58F7DB5BD8FA2288(iLocal_16.f_56);
		TASK::CLEAR_PED_SECONDARY_TASK(iLocal_16.f_56);
		func_244(iLocal_16.f_56, 0);
	}
	func_182(&iLocal_15, 1, 1);
...
void func_51()
{
	...
	while (iVar0 < iLocal_16.f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16[iVar0])))
		{
			if (func_246(iVar0))
			{
				iVar2[iVar0] = PED::GET_MOUNT(&(iLocal_16[iVar0]));
				PED::DELETE_PED(iLocal_16[iVar0]);
			}
			else
			{
				if (func_61(&(iLocal_16[iVar0]), 0, 0))
				{
					...
					{
						func_247(iLocal_16[iVar0]);
					}
					func_122(&(iLocal_16[iVar0]), 0);
					PED::SET_PED_COMBAT_ATTRIBUTES(&(iLocal_16[iVar0]), 5, true);
					PED::_0x24C82EF607105FAA(&(iLocal_16[iVar0]), joaat("AGGRESSIVE"));
					PED::_0xB8B6430EAD2D2437(&(iLocal_16[iVar0]), 993130593);
					if (func_248(&(iLocal_16[iVar0])))
					{
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(&(iLocal_16[iVar0]), joaat("REL_PLAYER_DISLIKE"));
					}
					PED::_0x7DE9692C6F64CFE8(&(iLocal_16[iVar0]), false, 0, 0);
					if ((PED::IS_PED_IN_COMBAT(&(iLocal_16[iVar0]), Global_35) || PED::IS_PED_FLEEING(&(iLocal_16[iVar0]))) || func_132(&iLocal_16, iVar0, 256))
					{
						if (PED::IS_PED_IN_COMBAT(&(iLocal_16[iVar0]), 0))
						{
							TASK::CLEAR_PED_TASKS(&(iLocal_16[iVar0]), 0, 0);
							TASK::_TASK_SMART_FLEE_STYLE_PED(&(iLocal_16[iVar0]), Global_35, 4, iVar1, -1082130432, -1, 0);
						}
						PED::SET_PED_KEEP_TASK(&(iLocal_16[iVar0]), true);
					}
					else if ((iLocal_16.f_215 == iLocal_16.f_216 && func_61(&(iLocal_16.f_40[iVar0]), 0, 1)) && !PED::IS_PED_IN_ANY_VEHICLE(&(iLocal_16[iVar0]), true))
					{
						iVar11 = &iLocal_16.f_40[iVar0];
						PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(&(iLocal_16.f_40[iVar0]), iVar11, 0);
					...
					{
						iVar11 = 0;
						if (PED::IS_PED_IN_ANY_VEHICLE(&(iLocal_16[iVar0]), true) && ENTITY::DOES_ENTITY_EXIST(PED::GET_VEHICLE_PED_IS_IN(&(iLocal_16[iVar0]), true)))
						{
							if (PED::_0x4E76CB57222A00E5(&(iLocal_16[iVar0])) == -1)
							{
								iVar13 = PED::GET_VEHICLE_PED_IS_IN(&(iLocal_16[iVar0]), true);
								TASK::OPEN_SEQUENCE_TASK(&iVar12);
								if (!func_69((iLocal_16.f_118[iVar0 /*4*/])->f_1))
								{
									TASK::_TASK_VEHICLE_DRIVE_TO_DESTINATION(0, iVar13, (iLocal_16.f_118[iVar0 /*4*/])->f_1, 7f, 524419, 6, 5f, 7f, 0);
								}
								TASK::_TASK_MOVE_IN_TRAFFIC_3(0, Global_35, -1f, 0, 0);
								func_176(&(iLocal_16[iVar0]), &iVar12, 0, 0, 1, 1);
							}
						}
						else if (PED::IS_PED_ON_MOUNT(&(iLocal_16[iVar0])))
						{
							TASK::OPEN_SEQUENCE_TASK(&iVar12);
							if (!func_69((iLocal_16.f_118[iVar0 /*4*/])->f_1))
							{
						...
						else
						{
							if (func_249(iVar0))
							{
								...
								func_176(&(iLocal_16[iVar0]), &iVar12, 0, 0, 1, 1);
								PED::_0x39A2FC5AF55A52B1(&(iLocal_16[iVar0]), 2000);
							}
							else
							{
								TASK::OPEN_SEQUENCE_TASK(&iVar12);
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(&(iLocal_16[iVar0]), false) && VEHICLE::GET_PED_IN_VEHICLE_SEAT(PED::GET_VEHICLE_PED_IS_USING(&(iLocal_16[iVar0])), -1) == &iLocal_16[iVar0])
				{
					ENTITY::SET_PED_AS_NO_LONGER_NEEDED(iLocal_16[iVar0]);
				}
				else if ((!PED::IS_PED_FLEEING(&(iLocal_16[iVar0])) && !PED::IS_PED_IN_COMBAT(&(iLocal_16[iVar0]), Global_35)) && !func_132(&iLocal_16, iVar0, 128))
				{
					PED::_0x39A2FC5AF55A52B1(&(iLocal_16[iVar0]), -1);
				}
				ENTITY::SET_PED_AS_NO_LONGER_NEEDED(iLocal_16[iVar0]);
			}
		}
	...
	while (iVar0 < iLocal_16.f_216)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
		{
			if (func_250(iVar0, &iVar2))
			{
				if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_84[iVar0])))
				{
					OBJECT::DELETE_OBJECT(iLocal_16.f_84[iVar0]);
				}
				PED::DELETE_PED(iLocal_16.f_40[iVar0]);
			}
			else
			{
				if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_84[iVar0])))
				{
					...
					{
						ENTITY::DETACH_ENTITY(&(iLocal_16.f_84[iVar0]), true, true);
						PHYSICS::ACTIVATE_PHYSICS(&(iLocal_16.f_84[iVar0]));
						ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(iLocal_16.f_84[iVar0]);
					}
				}
				if (func_61(&(iLocal_16.f_40[iVar0]), 0, 1))
				{
					...
					{
						if (!func_61(PED::_GET_HORSE_RIDER(&(iLocal_16.f_40[iVar0]), false), 0, 0))
						{
							TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_16.f_40[iVar0]), iLocal_16.f_209, 4, 0, -1f, -1, 0);
							PED::SET_PED_KEEP_TASK(&(iLocal_16.f_40[iVar0]), true);
						}
					}
					else if (!ENTITY::DOES_ENTITY_EXIST(PED::_0xF103823FFE72BB49(&(iLocal_16.f_40[iVar0]))) && !ENTITY::DOES_ENTITY_EXIST(PED::_GET_HORSE_RIDER(&(iLocal_16.f_40[iVar0]), true)))
					{
						TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_16.f_40[iVar0]), iLocal_16.f_209, 4, 0, -1f, -1, 0);
						PED::SET_PED_KEEP_TASK(&(iLocal_16.f_40[iVar0]), true);
					}
	...
	while (iVar0 < iLocal_16.f_217)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_49[iVar0])))
		{
			if (func_252(iVar0))
			{
				VEHICLE::DELETE_VEHICLE(iLocal_16.f_49[iVar0]);
			}
			else if (PLAYER::GET_PLAYERS_LAST_VEHICLE() == &iLocal_16.f_49[iVar0] && PED::GET_VEHICLE_PED_IS_IN(Global_35, true) == &iLocal_16.f_49[iVar0])
			{
			}
			else
			{
				ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(iLocal_16.f_49[iVar0]);
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_16.f_218)
	{
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_52[iVar0])))
		{
			if (func_253(&iLocal_16, &(iLocal_16.f_52[iVar0])))
			{
				OBJECT::DELETE_OBJECT(iLocal_16.f_52[iVar0]);
			}
			else
			{
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(iLocal_16.f_52[iVar0]);
			}
		}
		iVar0++;
	}
...
bool func_57(int iParam0, bool bParam1)
{
	...
	if (bParam1)
	{
		if (&Global_40.f_9632[iParam0 /*4*/] > 0)
		{
			...
			Var2 = { func_205(joaat("TOTAL_PLAYING_TIME")) };
...
int func_67(int iParam0)
{
	...
	while (iVar0 < iParam0->f_215)
	{
		if (ENTITY::DOES_ENTITY_EXIST(iParam0[iVar0]))
		{
			...
			{
				if (func_269(iParam0[iVar0], Global_36, 1) < (70f * 70f) || func_270(iParam0[iVar0], 70f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					return 1;
				}
			}
...
void func_75()
{
	...
	{
		iVar0 = iLocal_16.f_19;
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16[iVar0])))
		{
			if (!func_132(&iLocal_16, iVar0, 8))
			{
				if (func_270(&(iLocal_16[iVar0]), 200f, -1082130432 /* Float: -1f */, &(iLocal_16.f_9[iVar0]), -1082130432 /* Float: -1f */))
				{
					func_276(&iLocal_16, iVar0, 8);
				}
			}
		}
	}
	...
	{
		iVar0 = (iLocal_16.f_19 - iLocal_16.f_215);
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
		{
			if (!func_133(&iLocal_16, iVar0, 8))
			{
				if (func_270(&(iLocal_16.f_40[iVar0]), 200f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
				{
					func_209(&iLocal_16, iVar0, 8);
				}
			}
		}
	}
	...
	{
		iVar0 = ((iLocal_16.f_19 - iLocal_16.f_215) - iLocal_16.f_216);
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_49[iVar0])))
		{
			if (!func_277(&iLocal_16, iVar0, 8))
			{
				if (ENTITY::IS_ENTITY_A_VEHICLE(&(iLocal_16.f_49[iVar0])) && !ENTITY::IS_ENTITY_DEAD(&(iLocal_16.f_49[iVar0])))
				{
					if (func_278(&(iLocal_16.f_49[iVar0]), 200f, -1082130432 /* Float: -1f */))
					{
						func_279(&iLocal_16, iVar0, 8);
					}
				}
			}
		}
...
int func_83()
{
	...
	VOLUME::_0x39816F6F94F385AD(iLocal_16.f_239, -1105.991f, 63.23259f, 56.91f, 0f, 0f, 28.83601f, 7.558568f, 67.51287f, 22.0105f);
	VOLUME::_0x39816F6F94F385AD(iLocal_16.f_239, -1110.042f, 125.8571f, 56.91f, 0f, 0f, -15.164f, 7.558568f, 75.08723f, 22.0105f);
...
int func_92(int iParam0)
{
	...
	{
		if (!func_87(iLocal_16.f_181, 1))
		{
			iLocal_16.f_57[iParam0] = func_301(joaat("HORSE_CLASS_RIDING"), 1);
		}
		else
		{
...
void func_114(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)
{
	...
	*iParam4 = PED::GET_PED_BONE_INDEX(&(iLocal_16.f_40[iParam0]), 62111);
}
...
int func_134(var uParam0)
{
	...
	*uParam0 = 1;
	...
	while (iVar3 < 3)
	{
		iVar0 = func_317(iLocal_16[iVar3], Local_376[iVar3 /*21*/], 30f, &Local_440, &iVar2, 2f, 1, 0, "", 524288 | func_316(1, 0, 0), 0, 0, 2, 1, -1082130432 /* Float: -1f */, 0);
...
int func_139()
{
	...
	while (iVar0 < iLocal_16.f_215)
	{
		if (func_323(&(iLocal_16[iVar0]), 0, &(iLocal_16.f_152), &(iLocal_16.f_180), 0, 0))
		{
...
void func_141()
{
	...
	if (!bVar2)
	{
		if (func_61(&(iLocal_16[0]), 0, 1))
		{
			...
			func_187(&(iLocal_16[0]), Global_35, sVar3, 0, 70f, iVar4, 0, 0, 1, 1, 1, 1744022339, 1, 0, 0);
			bVar2 = true;
		}
	}
	iVar0 = 0;
	while (iVar0 < iLocal_16.f_215)
	{
		if (func_61(&(iLocal_16[iVar0]), 0, 1))
		{
			PED::_0x7DE9692C6F64CFE8(&(iLocal_16[iVar0]), false, 0, 0);
			PED::SET_PED_COMBAT_RANGE(&(iLocal_16[iVar0]), 0);
			PED::SET_PED_TARGET_LOSS_RESPONSE(&(iLocal_16[iVar0]), 1);
			if (iVar0 == 0)
			{
				PED::SET_COMBAT_FLOAT(&(iLocal_16[iVar0]), 32, 1f);
			}
			else if (iVar0 == 1)
			{
				PED::SET_COMBAT_FLOAT(&(iLocal_16[iVar0]), 32, 1.5f);
			}
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			TASK::TASK_COMBAT_PED(0, Global_35, 33554432, 0);
			func_176(&(iLocal_16[iVar0]), &iVar1, 0f, 0.15f, 1, 1);
			if (!bVar2)
			{
				switch (iLocal_477)
				{
				...
				func_187(&(iLocal_16[iVar0]), Global_35, sVar3, 0, 70f, iVar4, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
				bVar2 = true;
			}
			func_125(&iLocal_16, iVar0, 1);
			func_160(&(iLocal_16[iVar0]), iLocal_16.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
		}
		iVar0++;
	}
	PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0, false);
...
void func_142()
{
	...
	while (iVar0 < 3)
	{
		func_327(iLocal_16[iVar0], Local_376[iVar0 /*21*/], &Local_440, 1, 1);
		iVar0++;
	}
}
...
void func_144()
{
	...
	switch (iLocal_281)
	{
		case 0:
			...
			break;
		case 1:
			if (func_329(&(iLocal_16[1]), joaat("AMBUSH_BRT_RFRONT"), "AMBUSH_BRT_RFRONT", func_328(), 1.3f, 1))
			{
				switch (iLocal_477)
				{
					case 2:
				...
				func_187(&(iLocal_16[0]), Global_35, sVar2, "", -1f, iVar1, 0, 0, 1, 1, 0, 1808677283, 1, 0, 0);
				iLocal_281++;
			}
			break;
		case 2:
			if (func_329(&(iLocal_16[2]), joaat("AMBUSH_BRT_HRBACK"), "AMBUSH_BRT_HRBACK", func_328(), 1.3f, 1))
			{
				switch (iLocal_477)
				{
					case 2:
				...
				func_187(&(iLocal_16[2]), Global_35, "ACQUIRED_TARGET", "", -1f, iVar1, 0, 0, 1, 1, 0, 291934926, 1, 0, 0);
				iLocal_281++;
			}
			break;
		case 3:
			if (func_329(&(iLocal_16[2]), joaat("AMBUSH_BRT_HRBACKB"), "AMBUSH_BRT_HRBACKB", func_328(), 1.3f, 1) || ENTITY::IS_ENTITY_PLAYING_ANIM(&(iLocal_16[2]), "script_proc@robberies@bridge@odriscoll@ambush_trap", "dia_01_peda", 1))
			{
				iLocal_281++;
			}
			break;
		case 4:
			if (func_173(0f, 1, &(iLocal_16[2]), 1))
			{
				switch (iLocal_477)
				{
					case 3:
				...
				func_187(&(iLocal_16[2]), Global_35, sVar2, "", -1f, iVar1, 0, 0, 1, 1, 0, 291934926, 1, 0, 0);
				iLocal_281++;
			}
			break;
		case 5:
			if (func_329(&(iLocal_16[2]), joaat("AMBUSH_BRT_HRBACK2"), "AMBUSH_BRT_HRBACK2", func_328(), 1.3f, 1) || ENTITY::IS_ENTITY_PLAYING_ANIM(&(iLocal_16[2]), "script_proc@robberies@bridge@odriscoll@ambush_trap", "dia_02_peda", 1))
			{
				iLocal_281++;
			}
			break;
		case 6:
			if (func_173(0f, 1, &(iLocal_16[2]), 1))
			{
				func_187(&(iLocal_16[2]), Global_35, "ORDER_DISMOUNT_HORSE_ESCALATED", "", -1f, 1, 0, 0, 1, 1, 0, 291934926, 1, 0, 0);
				iLocal_281++;
			}
			break;
	}
...
bool func_147(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
...
int func_148()
{
	...
	if (func_147(Global_35, bVar4, 1, 0) || func_331(bVar4, vVar0))
	{
		return 1;
	}
	return 0;
...
void func_149()
{
	...
	{
		iLocal_15 = func_333("LEAVE", joaat("INPUT_CONTEXT_A"), Global_35, 1, 0, 0, 0, 7, 1070386381 /* Float: 1.6f */, 570, 4000, 4, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	...
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(&(iLocal_361[0]), "PEDB", &(iLocal_16[0]), 0);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(&(iLocal_361[0]), "PEDC", &(iLocal_16[1]), 0);
...
int func_151()
{
	...
	if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(&(iLocal_16.f_40[iLocal_476]), Global_35, 1, 1))
	{
		return 1;
	}
	iLocal_476++;
...
void func_155()
{
	if (!func_145(&uLocal_279, 32))
	{
		if (func_61(&(iLocal_16[2]), 0, 1))
		{
			if (func_145(&uLocal_279, 16))
			{
				TASK::TASK_LOOK_AT_ENTITY(Global_35, &(iLocal_16[2]), 5000, 48, 31, 0);
...
int func_157()
{
	...
	switch (iLocal_277)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (((ENTITY::IS_ENTITY_ON_SCREEN(&(iLocal_16[2])) || PED::_0xA0BC8FAED8CFEB3C(&(iLocal_16[2]))) || WEAPON::_0xFF07CF465F48B830(func_361(&(iLocal_16[2]), 0, 0))) || ENTITY::IS_ENTITY_ON_SCREEN(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(&(iLocal_16[2]), 0)))
			{
			...
			if (func_159(&(iLocal_16[2]), &(iLocal_361[1]), "PEDA", 0, 0, 1, 0))
			{
				if (!ANIMSCENE::_0xD8254CB2C586412B(&(iLocal_361[1]), 0))
				{
					ANIMSCENE::REMOVE_ANIM_SCENE_ENTITY(&(iLocal_361[1]), "PEDA", &(iLocal_16[2]));
				}
				TASK::TASK_PLAY_ANIM(&(iLocal_16[2]), func_130(), func_131(0), 16f, -8f, -1, 1, 0f, false, 0, false, 0, false);
		...
		case 3:
			...
			{
				func_150(&uLocal_307);
				func_160(&(iLocal_16[2]), iLocal_16.f_22[2], joaat("BLIP_STYLE_ENEMY"), joaat("BLIP_MODIFIER_URGENT_ALERT"), 0, 0);
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
				TASK::TASK_PLAY_ANIM(0, func_130(), func_131(4), 8f, -8f, -1, 0, 0f, true, 0, false, 0, false);
				TASK::TASK_PLAY_ANIM(0, func_130(), func_131(0), 8f, -8f, -1, 1, 0f, true, 0, false, 0, false);
				func_176(&(iLocal_16[2]), &iVar0, 0, 0, 1, 1);
				PED::SET_PED_USING_ACTION_MODE(&(iLocal_16[2]), true, -1, 0);
				func_162(1);
				iLocal_277 = 6;
...
int func_159(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, bool bParam5, int iParam6)
{
...
void func_161(bool bParam0)
{
	...
	func_366(Local_440[0 /*17*/], "INTERACT_DEFUSE", sVar0, joaat("INPUT_INTERACT_LOCKON_POS"), 0, 0, 0, 0, iVar2);
	func_366(Local_440[1 /*17*/], "INTERACT_INSULT", sVar1, joaat("INPUT_INTERACT_LOCKON_NEG"), 0, 0, 0, 0, iVar2);
	if (func_365())
	{
		func_175(Local_440[0 /*17*/], 1, 1);
	}
...
void func_168()
{
	...
	if (func_61(&(iLocal_16[0]), 0, 0))
	{
		vVar1 = { func_137(0) };
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
		TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, vVar1, Global_35, 1f, 0, 1056964608, 2f, 1, 0, 0, joaat("FIRING_PATTERN_BURST_FIRE"), 20000, 0);
		TASK::TASK_AIM_GUN_AT_ENTITY(0, Global_35, -1, 1, 1);
		func_176(&(iLocal_16[0]), &iVar0, 4f, 0, 1, 1);
	}
	if (func_61(&(iLocal_16[1]), 0, 0))
	{
		vVar1 = { func_137(1) };
		TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
void func_170()
{
	...
	if ((PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, joaat("INPUT_HORSE_EXIT")) || PAD::IS_DISABLED_CONTROL_JUST_PRESSED(0, joaat("INPUT_ENTER"))) || func_145(&uLocal_279, 1048576))
	{
		if (!PED::_IS_PED_GETTING_INTO_A_MOUNT_SEAT(Global_35, true))
		{
			...
			TASK::OPEN_SEQUENCE_TASK(&iVar0);
			TASK::TASK_PLAY_ANIM(0, func_130(), func_131(7), 8f, -8f, -1, 0, 0f, false, 0, false, 0, false);
			TASK::TASK_AIM_GUN_AT_ENTITY(0, Global_35, -1, 1, 1);
			func_176(&(iLocal_16[2]), &iVar0, 0, 0, 1, 1);
			vLocal_292 = { Global_36 };
		}
...
void func_172()
{
	...
	switch (iLocal_278)
	{
		case 0:
			if (!func_173(0f, 1, &(iLocal_16[2]), 1))
			{
				func_140(&uLocal_484, &(iLocal_16[2]), 1, 30f);
		...
		case 1:
			if (PLAYER::_0x621D1B289CAF5978(PLAYER::PLAYER_ID()) || !func_374(Global_35))
			{
				...
				if (!PLAYER::_0x621D1B289CAF5978(PLAYER::PLAYER_ID()))
				{
					...
					if (!MISC::IS_STRING_NULL_OR_EMPTY(cVar0))
					{
						func_187(Global_35, &(iLocal_16[2]), cVar0, 0, 70f, 0, 0, 0, 1, 1, 1, 291934926, 1, 0, 0);
					}
				}
...
void func_186(int iParam0, bool bParam1, vector3 vParam2, float fParam5, float fParam6, float fParam7, bool bParam8)
{
	int iVar0;
	...
	if (!func_30(iParam0, 32))
	{
		if (!func_183(Global_35))
		{
			...
			if (func_61(iParam0->f_56, 0, 1))
			{
				...
				{
					TASK::CLEAR_PED_TASKS(iParam0->f_56, 1, 0);
				}
...
int func_189()
{
	switch (iLocal_490)
	{
		...
		case 2:
			...
			{
				if (func_385(&(iLocal_16[2]), &Local_319, 0.25f, 0, -2.5f, 2, 0, 0, 0, -1, 0, 1))
				{
					iLocal_490 = 4;
					return 1;
				}
...
void func_193()
{
	...
	if (!func_145(&uLocal_279, 33554432))
	{
		...
		if (func_187(&(iLocal_16[2]), Global_35, sVar2, 0, 15f, iVar3, 0, 0, 1, 1, 1, 291934926, 1, 0, 0))
		{
	...
	else if (func_47(&uLocal_295, 3.5f))
	{
		...
		while (iVar0 < 3)
		{
			...
			func_176(&(iLocal_16[iVar0]), &iVar1, fVar4, 0, 1, 1);
			func_389(&(iLocal_16[iVar0]));
			PED::SET_PED_KEEP_TASK(&(iLocal_16[iVar0]), true);
			iVar0++;
		}
...
void func_197()
{
	...
	while (iVar0 < 3)
	{
		if (func_61(&(iLocal_16[iVar0]), 0, 1))
		{
			if (MAP::DOES_BLIP_EXIST(&(iLocal_16.f_22[iVar0])) && PED::IS_PED_ON_MOUNT(&(iLocal_16[iVar0])))
			{
				MAP::REMOVE_BLIP(iLocal_16.f_22[iVar0]);
			}
		}
		iVar0++;
	}
...
int func_198(int iParam0)
{
	...
	if (!func_147(Global_35, &(iLocal_282[3]), 1, 0) && func_391(Global_36, iLocal_16.f_209) > 28f)
	{
		fVar0 = func_392(&iLocal_16, 0, 2);
	...
	while (iVar0 < iLocal_16.f_215)
	{
		if (func_61(&(iLocal_16[iVar0]), 0, 1))
		{
			if (!bVar5)
			{
				...
				func_187(&(iLocal_16[iVar0]), Global_35, sVar6, 0, 70f, iVar7, 0, 0, 1, 1, 1, 1744022339, 1, 0, 0);
				bVar5 = true;
			}
			if (!Local_319.f_4 && !func_145(&uLocal_279, 32768))
			{
				...
				if (!func_69(vVar2))
				{
					PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(iLocal_16[iVar0]), vVar2, 3f, 0, false, 0);
				}
			}
			PED::SET_PED_TARGET_LOSS_RESPONSE(&(iLocal_16[iVar0]), 1);
			TASK::OPEN_SEQUENCE_TASK(&iVar1);
			...
			if (Local_319.f_4)
			{
				func_176(&(iLocal_16[iVar0]), &iVar1, (IntToFloat(iVar0) * 1f), 0, 1, 1);
			}
			else
			{
				func_176(&(iLocal_16[iVar0]), &iVar1, (IntToFloat(iVar0) * 1f), (IntToFloat(iVar0) * 1f), 1, 1);
			}
			if (!MAP::DOES_BLIP_EXIST(&(iLocal_16.f_22[iVar0])))
			{
				func_160(&(iLocal_16[iVar0]), iLocal_16.f_22[iVar0], joaat("BLIP_STYLE_ENEMY"), 0, 0, 0);
			}
		}
...
void func_215()
{
	...
	while (iVar0 < iLocal_16.f_215)
	{
		if (func_418(iVar0))
		{
			PED::SET_PED_RESET_FLAG(&(iLocal_16[iVar0]), 27, true);
		}
		iVar0++;
	}
}
...
void func_219()
{
	...
	if (func_61(&(iLocal_16[0]), 0, 0))
	{
		PED::_0x78815FC52832B690(&(iLocal_16[0]), 1);
		vVar0 = { func_395(0) };
		fVar3 = func_421(0);
		iLocal_357[0] = TASK::ADD_COVER_POINT(vVar0, fVar3, 1, 1, 5, false);
		if (!func_145(&uLocal_279, 128) && !func_145(&uLocal_279, 256))
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(&(iLocal_16[0]), vVar0, 1.25f, 1, false, 0);
		}
		PED::SET_COMBAT_FLOAT(&(iLocal_16[0]), 32, 2f);
	}
	if (func_61(&(iLocal_16[1]), 0, 0))
	{
		PED::_0x78815FC52832B690(&(iLocal_16[1]), 1);
		vVar0 = { func_395(1) };
		fVar3 = func_421(1);
		iLocal_357[1] = TASK::ADD_COVER_POINT(vVar0, fVar3, 0, 1, 4, false);
		PED::_0xFC3DB99C8144CD81(&(iLocal_16[1]), &(iLocal_282[1]), 0, false, 0);
		PED::SET_PED_TARGET_LOSS_RESPONSE(&(iLocal_16[1]), 1);
		TASK::OPEN_SEQUENCE_TASK(&iVar4);
		TASK::TASK_COMBAT_PED(0, Global_35, 33554432, 0);
		func_176(&(iLocal_16[1]), &iVar4, 1.5f, 0, 1, 1);
	}
	if (func_61(&(iLocal_16[2]), 0, 0))
	{
		PED::_0x78815FC52832B690(&(iLocal_16[2]), 1);
		PED::SET_PED_TARGET_LOSS_RESPONSE(&(iLocal_16[2]), 1);
		TASK::OPEN_SEQUENCE_TASK(&iVar4);
		TASK::TASK_COMBAT_PED(0, Global_35, 33554432, 0);
		func_176(&(iLocal_16[2]), &iVar4, 0.5f, 0, 1, 1);
	}
}
...
int func_221()
{
	...
	if (func_47(&uLocal_295, 5f))
	{
		...
		while (iVar0 <= 1)
		{
			if (func_61(&(iLocal_16[iVar0]), 0, 0))
			{
				if (func_239(&(iLocal_16[iVar0]), Global_36, 0) < 5f || func_239(&(iLocal_16[iVar0]), Global_36, 0) > 23f)
				{
					return 1;
				}
			}
...
void func_222()
{
	...
	while (iVar0 < iLocal_16.f_215)
	{
		...
		{
			func_389(&(iLocal_16[iVar0]));
			PED::SET_PED_COMBAT_MOVEMENT(&(iLocal_16[iVar0]), 2);
			PED::SET_PED_COMBAT_RANGE(&(iLocal_16[iVar0]), 0);
		}
		iVar0++;
	}
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3, float fParam4, int iParam5)
{
	int iVar0;
...
void func_224()
{
	...
	if (!func_365())
	{
		switch (iLocal_477)
		{
			...
			case 2:
			case 3:
				iVar1 = func_425(&uLocal_479, iLocal_16.f_225, iLocal_16.f_226);
				sVar0 = func_426(&uLocal_479, iLocal_16.f_181, 0, iVar1);
				break;
		}
	}
	else
...
int func_238(int iParam0)
{
	...
	{
		if (!func_61(PED::_GET_HORSE_RIDER(&(iLocal_16.f_40[iParam0]), false), 0, 1))
		{
			return 1;
		}
		else
	...
	if (func_61(PED::_GET_HORSE_RIDER(&(iLocal_16.f_40[iParam0]), true), 0, 1))
	{
		return 0;
	}
	if (iLocal_16.f_216 == iLocal_16.f_215)
	{
		if (!func_61(&(iLocal_16[iParam0]), 0, 1))
		{
			return 1;
		}
	}
	...
	{
		fVar0 = func_242(&(iLocal_16.f_247));
...
int func_250(int iParam0, int iParam1)
{
	...
	if (func_456(&(iLocal_16.f_40[iParam0]), iParam1))
	{
		return 1;
	}
...
int func_251(int iParam0)
{
	...
	if (func_458(&(iLocal_16.f_84[iParam0]), fVar0))
	{
		return 0;
	}
	if (func_239(&(iLocal_16.f_84[iParam0]), Global_36, 1) < 10f)
	{
		return 0;
	}
	return 1;
...
{
	if (func_458(iParam1, 1114636288 /* Float: 60f */) || func_194(iParam1, 1, 1) <= 30f)
	{
		return 0;
	}
	return 1;
...
void func_287(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		func_288(iParam0, 1073741824 /* Float: 2f */);
	}
	if (!bParam3)
	{
...
void func_299(var uParam0, float fParam1)
{
	...
	func_471(uParam0->f_237, "ambush_restriction", 1, 0, 512, 0, -1082130432 /* Float: -1f */);
	vVar0 = { uParam0->f_209 + Vector(-40f, -fParam1, -fParam1) };
	vVar3 = { uParam0->f_209 + Vector(40f, fParam1, fParam1) };
	vVar6 = { func_460(vVar0, vVar3, 0) };
	vVar9 = { func_461(vVar0, vVar3, 0) };
...
void func_300(bool bParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	if (!VOLUME::_DOES_VOLUME_EXIST(bParam0))
	{
		return;
...
int func_323(int iParam0, int iParam1, int iParam2, var uParam3, int iParam4, float fParam5)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_500(iParam2, 1065353216 /* Float: 1f */))
			{
				if (!iParam2->f_1 & 4 != 0)
				{
...
int func_333(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, bool bParam5, int iParam6, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16)
{
	...
	while (iVar0 < 48)
	{
		if (func_531(iVar0, 2))
		{
			...
			if (iVar1 != 0)
			{
				func_532(iVar1, iParam1, sParam0, 5, iParam3, iParam4, 0f, 0f, 0f, fParam8, 0, iParam2, 3, iParam6, iParam7, iParam9, iParam10, iParam11, iParam12, iParam13, 1065353216 /* Float: 1f */, 0, bParam5, 0, bParam14, bParam16);
				return iVar1;
			}
			return 0;
		}
...
void func_357(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, int iParam9, int iParam10, int iParam11, float fParam12)
{
	...
	{
		func_551(iParam3);
		if (func_552(vParam0, fParam8, 2.5f, fParam12, 1084227584 /* Float: 5f */))
		{
			func_369();
		}
	}
...
void func_358()
{
	func_555(&(iLocal_16[2]), &Local_367, 0f, 0f, 0.25f, 1, 37f, 1092616192 /* Float: 10f */, 4000, 4000, 1000, 0f, 1, 1, 1084227584 /* Float: 5f */);
}
...
int func_359()
{
	if (func_30(&iLocal_16, 4096) && ENTITY::GET_ENTITY_SPEED(PED::GET_MOUNT(Global_35)) < 0.1f)
	{
		if (!func_60(&uLocal_313))
		{
			...
			PED::_0x2EB75FB86C41F026(iLocal_16.f_56, 3, 0);
			PED::_0x89F5E7ADECCCB49C(iLocal_16.f_56, "normal_basic_idle");
			PED::SET_PED_CONFIG_FLAG(iLocal_16.f_56, 301, true);
			TASK::TASK_PLAY_ANIM(iLocal_16.f_56, "CREATURES_MAMMAL@HORSE@NORMAL@IDLE", "idle", 2f, -8f, -1, 24, 0f, false, 0, false, 0, false);
...
int func_360()
{
	...
	ENTITY::_SET_ENTITY_COORDS_AND_HEADING(&(iLocal_16[2]), func_557(iLocal_366), fVar0, true, false, true);
	PED::_0x7DE9692C6F64CFE8(&(iLocal_16[2]), false, 0, 0);
	func_125(&iLocal_16, 2, 1);
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(&(iLocal_361[1]), ENTITY::GET_ENTITY_COORDS(iLocal_16.f_56, true, false), 0f, 0f, ENTITY::GET_ENTITY_HEADING(iLocal_16.f_56), 2);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(&(iLocal_361[1]), "PEDA", &(iLocal_16[2]), 0);
	ANIMSCENE::START_ANIM_SCENE(&(iLocal_361[1]));
	ANIMSCENE::SET_ANIM_SCENE_ORIGIN(&(iLocal_361[2]), ENTITY::GET_ENTITY_COORDS(iLocal_16.f_56, true, false), 0f, 0f, ENTITY::GET_ENTITY_HEADING(iLocal_16.f_56), 2);
	ANIMSCENE::SET_ANIM_SCENE_ENTITY(&(iLocal_361[2]), "HORSE", iLocal_16.f_56, 0);
...
int func_364(int iParam0, int iParam1, char* sParam2, int iParam3, float fParam4, bool bParam5, bool bParam6)
{
...
int func_385(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10, bool bParam11)
{
	var uVar0;
	var uVar1;
	bool bVar2;
	...
	switch (*iParam1)
	{
		case 0:
			...
			if ((((((!PED::IS_PED_RAGDOLL(Global_35) && !PED::IS_PED_FALLING(Global_35)) && !PED::_0x3E592D0486DEC0F6(Global_35)) && !ENTITY::IS_ENTITY_IN_AIR(Global_35, 1)) && !func_569(Global_35, 501393341)) && !func_569(Global_35, 1553520516)) && !func_569(Global_35, joaat("SCRIPT_TASK_LEAVE_VEHICLE")))
			{
			...
			break;
		case 2:
			if (((!iParam1->f_12 && !iParam1->f_13) && func_47(&(iParam1->f_32), 2f)) && func_329(iParam0, joaat("BSTARTSUCCESS"), "bStartSuccess", 1, 1.8f, 1))
			{
			...
			else if ((func_233(iParam5, 16) && !func_569(iParam0, 1435919172)) && !ENTITY::HAS_ANIM_EVENT_FIRED(iParam0, joaat("OBJECTEXCHANGE")))
			{
				bVar2 = true;
			}
			if (!iParam1->f_15)
			...
			if (func_329(iParam0, joaat("BLENDOUT"), "Blendout", iParam8, 0.8f, 0) || !func_569(iParam0, 2137044382))
			{
				return 1;
			}
			break;
...
int func_394(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4)
{
	int iVar0;
...
bool func_407(int iParam0, int iParam1)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && ENTITY::IS_ENTITY_A_PED(iParam0))
	{
		...
		return func_591(iParam0, joaat("CURRENCY_CASH"), iParam1, uVar0);
	}
...
int func_418(int iParam0)
{
	...
	if (!func_61(&(iLocal_16[iParam0]), 0, 0))
	{
		return 0;
	}
	...
	if (func_239(&(iLocal_16[iParam0]), Global_36, 1) < 4f)
	{
		return 0;
	}
	switch (iParam0)
...
int func_454(int iParam0, int iParam1)
{
	...
	{
		if (func_270(iParam1, 200f, (30f * 3f), -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
		{
			return 0;
		}
	}
	else if (func_270(iParam1, 200f, 30f, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */))
	{
		return 0;
	}
	if (!PED::IS_PED_HUMAN(iParam1))
...
int func_471(bool bParam0, char* sParam1, float fParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)
{
	vector3 vVar0;
	vector3 vVar3;
	var uVar6;
	...
	uVar6 = func_606(vVar0, vVar3.x, sParam1, fParam2, iParam3, bParam4, iParam5, bParam6);
	return uVar6;
}
	...
	switch (iParam0->f_6)
	{
		case 0:
			if (*iParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_642(1) || *iParam0 & 8192 != 0))
				{
...
int func_503(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	vector3 vVar0;
	int iVar3;
	vector3 vVar4;
...
int func_520(int iParam0, int iParam1)
{
	...
	{
		return func_675(iParam0, iParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_552(vector3 vParam0, float fParam3, float fParam4, bool bParam5, float fParam6)
{
	float fVar0;
...
int func_553(vector3 vParam0, int iParam3, float fParam4)
{
	float fVar0;
...
int func_574(int iParam0, char* sParam1, vector3 vParam2, int iParam5, int iParam6, float fParam7, float fParam8, int iParam9, int iParam10, char* sParam11, bool bParam12, int iParam13, bool bParam14, int iParam15, bool bParam16, bool bParam17, bool bParam18, bool bParam19)
{
	int iVar0;
	...
	if (!func_332(*iParam0))
	{
		...
		{
			*iParam0 = func_333(sParam1, iParam6, iParam5, iParam10, iParam9, 0, iParam15, iVar0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, bParam18, 0, 0);
			func_702(*iParam0, fParam7, 1);
		}
		else if (iParam13 != 0)
		{
			*iParam0 = func_703(sParam1, iParam6, iParam13, iParam10, iParam9, iParam15, iVar0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, bParam18, 0);
		}
		else
		{
			if (func_69(vParam2))
			...
			*iParam0 = func_704(sParam1, iParam6, vParam2, fParam7, iParam10, iParam9, iParam15, iVar0, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, bParam18, 0);
		}
		if (fParam8 != 0f)
		{
	...
	if ((!bParam17 && func_706(*iParam0, 1)) || (bParam17 && func_345(*iParam0, 1)))
	{
		if (!bParam14)
		{
			...
			{
				func_707(BUILTIN::CEIL(MISC::ABSF(fParam8)), 0, 1065353216 /* Float: 1f */, 1, 0, 0, 1, 752097756);
			}
		}
		func_182(iParam0, 1, 1);
		return 1;
...
float func_584(var uParam0, int iParam1, int iParam2)
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_586(int iParam0, int iParam1, var uParam2, float fParam3)
{
	int iVar0;
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		if (Global_1935630->f_25)
		{
			if (func_500(iParam1, 1065353216 /* Float: 1f */))
			{
				if (!iParam1->f_1 & 4 != 0)
				{
...
var func_591(int iParam0, int iParam1, int iParam2, var uParam3)
{
	struct<13> Var0;
	int iVar23;
...
int func_592(int iParam0, int iParam1)
{
	...
	fVar1 = MISC::GET_DISTANCE_BETWEEN_COORDS(func_330(iParam0[iParam1], 1065353216 /* Float: 1f */), func_330(Global_35, 1065353216 /* Float: 1f */), true);
	if (fVar0 < 10f)
	{
		return 0;
	}
...
struct<5> func_612(int iParam0, bool bParam1, int iParam2)
{
	...
	switch (func_716(iParam0))
	{
		case joaat("CLOTHING"):
			...
			{
				Var0 = { func_616(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
		...
		case joaat("UPGRADE"):
			...
			{
				Var0 = { func_616(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
...
int func_617(int iParam0, var uParam1, var uParam2, int iParam3, int iParam4, bool bParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
...
void func_620(int iParam0, int iParam1)
{
	...
	{
		iVar1 = func_743(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_623(var uParam0, int* iParam1, var uParam2, float fParam3, int iParam4, char* sParam5, int iParam6, float fParam7)
{
	char cVar0[32];
	bool bVar4;
	int iVar5;
...
bool func_629(var uParam0, int* iParam1, float fParam2, float fParam3, var uParam4, bool bParam5, float fParam6, int iParam7, int iParam8, char* sParam9, int iParam10, int iParam11, int iParam12, int iParam13, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)
{
	...
	bVar11 = (((PED::_IS_PED_CARRYING(Global_35) || func_752(Global_35)) || func_753(Global_35)) || func_754(Global_35));
	fVar12 = -1f;
...
int func_650(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_652(int iParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_661(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_662(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_663(int iParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
bool func_685(int iParam0, float fParam1, int iParam2)
{
	int iVar0[3];
	int iVar4;
	int iVar5;
	...
	return func_783(&iVar0, iParam0->f_209, fParam1, 0, 0, 1084227584 /* Float: 5f */, bVar6, iParam2);
}

int func_686(int iParam0, float fParam1, int iParam2)
{
	var uVar0[5];
	var uVar6[9];
	int iVar16;
	...
	while (iVar16 < iVar18)
	{
		...
		if (iVar27 != 0 && iVar27 != Global_35)
		{
			...
			if (!func_69(vVar21))
			{
				...
				{
					if (func_464(vVar21, vVar24, 5f, 0) && PED::IS_PED_HEADING_TOWARDS_POSITION(iVar27, iParam0->f_209, 40f))
					{
						iVar19 = 1;
						iVar20 = 1;
					}
...
int func_693(int iParam0)
{
	...
	return (func_231() - BUILTIN::ROUND((iParam0->f_1 * 1000f)));
}
...
int func_695(vector3 vParam0, int iParam3)
{
...
int func_698(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5)
{
...
var func_699(int iParam0, var uParam1)
{
...
int func_703(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, bool bParam12, bool bParam13)
{
	int iVar0;
	int iVar1;
	...
	if (iVar1 != 0)
	{
		func_532(iVar1, iParam1, sParam0, 2, iParam3, iParam4, 0f, 0f, 0f, 0f, iParam2, 0, 1, iParam5, iParam6, iParam7, iParam8, iParam9, iParam10, iParam11, 1065353216 /* Float: 1f */, 0, 0, 0, bParam12, bParam13);
		return iVar1;
	}
	return 0;
}
...
int func_704(char* sParam0, int iParam1, vector3 vParam2, float fParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, bool bParam13, int iParam14, bool bParam15, int iParam16)
{
	...
	if (iVar1 != 0)
	{
		func_532(iVar1, iParam1, sParam0, 4, iParam6, iParam7, vParam2, fParam5, 0, 0, 2, iParam8, iParam9, iParam10, iParam11, iParam12, bParam13, iParam14, 1065353216 /* Float: 1f */, 0, 0, 0, bParam15, iParam16);
		return iVar1;
	}
	return 0;
}
...
void func_712(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	else if (!func_831(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	func_834(sVar15, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar14, iVar12, "Transaction_Feed_Sounds", sVar13, 0, 1);
}
...
void func_720(int iParam0)
{
	...
	Var0 = { func_205(joaat("CAREER_CASH")) };
...
void func_721(int iParam0, char* sParam1, int iParam2)
{
	...
	func_834(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 1, joaat("COLOR_RED"), 0, 0, 0, 1);
}
...
{
	return func_616(joaat("CHARACTER"), func_859(), -1591664384, bParam0);
}
...
int func_733(int iParam0, bool bParam1)
{
	...
	if (WEAPON::_0xD955FEE4B87AFA07(iParam0))
	{
		if (bParam1)
		{
			return func_860(joaat("UPGRADE_OFFHAND_HOLSTER"), 0) > 0;
		}
		else
		{
			return 1;
...
int func_737(var uParam0, var uParam1, bool bParam2, int iParam3, var uParam4, bool bParam5, bool bParam6)
{
...
void func_751(int iParam0, var uParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	...
	while (iVar0 < *uParam1)
	{
		func_862(iParam0, (*uParam1)[iVar0 /*17*/], fParam2, iParam3, iParam4, iParam5, bParam6, bParam7);
		if (bParam8)
		{
...
int func_759(int* iParam0, float fParam1, bool bParam2)
{
	if (iParam0->f_2 != 3)
	{
...
int func_783(int iParam0, vector3 vParam1, int iParam4, bool bParam5, bool bParam6, int iParam7, bool bParam8, int iParam9)
{
	...
	{
		iVar12 = func_871(&iVar0, iParam0, iVar0, vParam1, iParam4);
	}
	iVar13 = 0;
	while (iVar13 < iVar12)
	{
...
struct<6> func_813()
{
	...
	if (func_907(joaat("SLOTID_HORSE_BEDROLL"), &uVar6))
	{
		Var0.f_4 = uVar6;
	}
	if (func_907(joaat("SLOTID_HORSE_BLANKET"), &uVar7))
	{
		Var0 = uVar7;
	}
	if (func_907(joaat("SLOTID_HORSE_HORN"), &uVar8))
	{
		Var0.f_2 = uVar8;
	}
	if (func_907(joaat("SLOTID_HORSE_SADDLEBAG"), &uVar9))
	{
		Var0.f_5 = uVar9;
	}
	if (func_907(joaat("SLOTID_HORSE_STIRRUP"), &uVar10))
	{
		Var0.f_3 = uVar10;
	}
	if (func_907(joaat("SLOTID_HORSE_SADDLE"), &uVar11))
	{
		Var0.f_1 = uVar11;
	}
	return Var0;
...
int func_819(float fParam0, float fParam1, bool bParam2)
{
	...
	func_913(&uVar0, &uVar1, &iVar2, &iVar3, joaat("INPUT_SCRIPT_LEFT_AXIS_X"), joaat("INPUT_SCRIPT_LEFT_AXIS_Y"), joaat("INPUT_SCRIPT_RIGHT_AXIS_X"), joaat("INPUT_SCRIPT_RIGHT_AXIS_Y"), 2);
	if (!bParam2)
	{
		if (iVar2 != 0 || iVar3 != 0)
		{
...
int func_821(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5)
{
...
void func_822(int iParam0, char* sParam1, int iParam2)
{
	...
	func_834(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_823(int iParam0, bool bParam1, float fParam2, int iParam3, int iParam4)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_834(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		...
		func_834(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
...
int func_839(var uParam0, int iParam1, int iParam2, bool bParam3)
{
...
int func_842(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	...
	if (!INVENTORY::_0xB4158C8C9A3B5DCE(func_740(bParam4), iParam0, iParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
void func_843(int iParam0, int iParam1)
{
	...
	if (func_411() == -1)
	{
		if (func_919(43))
		{
			...
			{
				func_920(joaat("EXOTIC_STAGE_01"));
				if (func_921() == 0)
				{
					func_208(0, 10);
					iVar0 = func_922(iParam0, iParam1, 1);
					if (((iParam0 == joaat("PROVISION_EGRET_PLUME_LITTLE") || iParam0 == joaat("PROVISION_EGRET_PLUME_REDDISH")) || iParam0 == joaat("PROVISION_EGRET_PLUME_SNOWY")) || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_OF_NIGHT"))
					{
						if (func_923(iParam0) < func_924(iParam0))
						{
							func_925(43, iParam0, iParam1, joaat("EXOTIC_STAGE_01"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (func_919(44))
		{
			...
			{
				func_920(joaat("EXOTIC_STAGE_02"));
				if (func_921() == 1)
				{
					func_208(0, 10);
					iVar0 = func_922(iParam0, iParam1, 2);
					if ((iParam0 == joaat("PROVISION_HERON_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_LADY_SLIPPER")) || iParam0 == joaat("PROVISION_RO_FLOWER_MOCCASIN"))
					{
						if (func_923(iParam0) < func_924(iParam0))
						{
							func_925(43, iParam0, iParam1, joaat("EXOTIC_STAGE_02"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_919(45))
		{
			...
			{
				func_920(joaat("EXOTIC_STAGE_03"));
				if (func_921() == 2)
				{
					func_208(0, 10);
					iVar0 = func_922(iParam0, iParam1, 4);
					if (((iParam0 == joaat("PROVISION_GATOR_EGG") || iParam0 == joaat("PROVISION_RO_FLOWER_ACUNAS_STAR")) || iParam0 == joaat("PROVISION_RO_FLOWER_CIGAR")) || iParam0 == joaat("PROVISION_RO_FLOWER_GHOST"))
					{
						if (func_923(iParam0) < func_924(iParam0))
						{
							func_925(43, iParam0, iParam1, joaat("EXOTIC_STAGE_03"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_919(46))
		{
			...
			{
				func_920(joaat("EXOTIC_STAGE_04"));
				if (func_921() == 3)
				{
					func_208(0, 10);
					iVar0 = func_922(iParam0, iParam1, 8);
					if (((iParam0 == joaat("PROVISION_SPOONBILL_FEATHER") || iParam0 == joaat("PROVISION_RO_FLOWER_NIGHT_SCENTED")) || iParam0 == joaat("PROVISION_RO_FLOWER_RAT_TAIL")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPIDER"))
					{
						if (func_923(iParam0) < func_924(iParam0))
						{
							func_925(43, iParam0, iParam1, joaat("EXOTIC_STAGE_04"), iVar0, 1, -1, 0);
						}
					}
				}
			}
		...
		if (!func_919(47))
		{
			...
			{
				func_920(joaat("EXOTIC_STAGE_05"));
				if (func_921() == 4)
				{
					func_208(0, 10);
					iVar0 = func_922(iParam0, iParam1, 16);
					if (((iParam0 == joaat("PROVISION_RO_FLOWER_CLAMSHELL") || iParam0 == joaat("PROVISION_RO_FLOWER_DRAGONS")) || iParam0 == joaat("PROVISION_RO_FLOWER_SPARROWS")) || iParam0 == joaat("PROVISION_RO_FLOWER_QUEENS"))
					{
						if (func_923(iParam0) < func_924(iParam0))
						{
							func_925(43, iParam0, iParam1, joaat("EXOTIC_STAGE_05"), iVar0, 1, -1, 0);
						}
					}
				}
			}
...
void func_850(var uParam0)
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		MAP::_SET_BLIP_NAME_FROM_PLAYER_STRING(*uParam0, func_934(func_933(255), joaat("COLOR_PURE_WHITE")));
	}
	else if (func_423())
	{
...
void func_862(int iParam0, int* iParam1, float fParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)
{
	char* sVar0;
	int iVar1;
	...
	if (!func_332(iParam1->f_6) && !MISC::IS_BIT_SET(*iParam1, 4))
	{
		...
		if (func_761(iParam1))
		{
			...
			iParam1->f_6 = func_333(sVar0, iParam1->f_7, iParam0, iParam1->f_9, iParam4, 0, 0, iParam5, fParam2, iParam1->f_2, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), iParam1->f_10, 0);
			if (func_332(iParam1->f_6))
			{
				if (!bParam6)
				{
...
int func_870(int iParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_871(int iParam0, int iParam1, int iParam2, vector3 vParam3, float fParam6)
{
	int iVar0;
	int iVar1;

	iVar0 = VOLUME::_CREATE_VOLUME_SPHERE(vParam3, 0f, 0f, 0f, fParam6, fParam6, fParam6);
	iVar1 = func_870(iParam0, iParam1, iVar0, iParam2);
	func_873(iVar0);
	return iVar1;
}
...
void func_913(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)
{
...
void func_916(int iParam0, char* sParam1, int iParam2)
{
	...
	if (func_914())
	{
		func_834(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS_SPECIAL"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
	else
	{
		func_834(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_GANG_SAVINGS"), 0, joaat("COLOR_GOLD"), 0, 0, 0, 1);
	}
}
...
int func_918(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
...
void func_939(int iParam0, char* sParam1, char* sParam2, char* sParam3, bool bParam4)
{
	int iVar0;
...
int func_944(int iParam0, int iParam1)
{
	...
	Var29 = { func_616(iParam1, Var0, joaat("SLOTID_HORSE_MANE"), 0) };
...
int func_945(int iParam0, int iParam1)
{
	...
	Var29 = { func_616(iParam1, Var0, joaat("SLOTID_HORSE_TAIL"), 0) };
	return func_994(Var29, 1);
}
...
int func_972(struct<4> Param0, int iParam4, int iParam5)
{
	...
	Var0.f_9 = -1591664384;
	if (func_1004(Param0, iParam4, &Var0, iParam5))
	{
		return Var0.f_4;
	}
	return 0;
...
void func_977(int iParam0)
{
	...
	Var0 = { func_205(joaat("GANG_SAVINGS_CASH")) };
...
int func_987(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	while (iVar0 < iParam6)
	{
		if (iParam2 == joaat("CIGARETTE_CARDS"))
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1018(func_1015(iVar0))), func_1018(func_1015(iVar0)), bVar1, true, false);
		}
		if (iParam2 == joaat("DINO_BONES"))
		{
			if (iVar0 == 0)
			{
				...
				UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1019(iVar0)), func_1019(iVar0), bVar1, true, false);
			}
			else if (iVar0 == 1)
			{
		...
		if (iParam2 == -1531394072)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1022(iVar2)), func_1022(iVar2), bVar1, true, false);
		}
		if (iParam2 == 1995362678)
		{
			...
			UILOG::_UILOG_ADD_OR_UPDATE_OBJECTIVE(3, iParam1, MISC::GET_HASH_KEY(func_1024(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0))), func_1024(COLLECTION::_0x126CBEBBA46693CF(iVar0, iParam2, 0)), bVar1, true, false);
		}
...
void func_992(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	...
	if (iVar7 == joaat("CIGARETTE_CARDS"))
	{
		...
		if (iParam5 == 2)
		{
			...
			iParam3 = 12;
			iParam4 = 12;
			func_1031(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar1), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 1)
		{
			sVar3 = "COL_CC_CARD_POSTED_OBJ";
			func_1031(MISC::_CREATE_VAR_STRING(2, sVar0), MISC::_CREATE_VAR_STRING(2, sVar3, iParam3, iParam4), iVar5, iVar4, joaat("PLAYER_MENU"), MISC::_CREATE_VAR_STRING(2, sVar2), joaat("SP_MISSIONS"), -2, "Mission_Complete_Sounds", "Mission_Complete_Enter", 0, 0, 1, 1);
		}
		else if (iParam5 == 0)
		{
...
int func_996(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, int iParam6, bool bParam7)
{
	int iVar0;
...
int func_998(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9, bool bParam10, bool bParam11)
{
	struct<12> Var0;
	int iVar14;
	int iVar15;
...
int func_1000(struct<4> Param0, struct<4> Param4, int iParam8, bool bParam9)
{
	struct<11> Var0;
	struct<11> Var14;
	struct<16> Var28;
...
int func_1004(var uParam0, int iParam1, var uParam2, int iParam3, int iParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
	...
	if (!INVENTORY::_0x22E590F108289A9D(func_740(bParam6), &uParam0, iParam4, &Var0))
	{
		return 0;
	}
...
int func_1010()
{
	...
	while (iVar1 < 30)
	{
		if (func_1043(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1011()
{
	...
	while (iVar1 < 30)
	{
		if (func_1044(COLLECTION::_0x126CBEBBA46693CF(iVar1, joaat("DINO_BONES"), 0)))
		{
			iVar0++;
		}
		iVar1++;
...
int func_1036(struct<4> Param0, int iParam4, bool bParam5)
{
	...
	if (iVar15 == joaat("HORSE"))
	{
		...
		Var16.f_10 = iParam4;
		iVar0 = func_1049(joaat("UPDATE"), &Var16, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else if (iVar15 == joaat("CLOTHING"))
	{
		...
		Var44.f_10 = iParam4;
		iVar0 = func_1051(joaat("UPDATE"), &Var44, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
	...
	else
	{
		...
		Var61.f_10 = iParam4;
		iVar0 = func_1039(joaat("UPDATE"), &Var61, bParam5);
		if (iVar0 == -1)
		{
			return iVar0;
		}
...
struct<28> func_1048(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<28> Var0;
	struct<29> Var28;
...
struct<17> func_1050(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4)
{
	struct<17> Var0;
	struct<15> Var17;
...
int func_1053(int iParam0, int iParam1, int iParam2, var uParam3)
{
	int iVar0;
	struct<4> Var1;
	int iVar5;
...
bool func_1056(var uParam0, int iParam1, int iParam2, int iParam3)
{
	int iVar0;
	int iVar1;
	var uVar2;
