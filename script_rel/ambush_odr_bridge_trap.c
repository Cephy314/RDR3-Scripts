...
void func_26()
{
	...
	while (iVar1 < iLocal_16.f_216)
	{
		...
		{
			iVar0 = PED::_0xB676EFDA03DADA52(&(iLocal_16.f_40[iVar1]), 0);
			if (func_61(iVar0, 0, 0))
			{
				PED::_0x931B241409216C1F(iVar0, &(iLocal_16.f_40[iVar1]), 0);
			...
			else
			{
				if (func_61(&(iLocal_16[iVar0]), 0, 0))
				{
					...
					else if ((iLocal_16.f_215 == iLocal_16.f_216 && func_61(&(iLocal_16.f_40[iVar0]), 0, 1)) && !PED::IS_PED_IN_ANY_VEHICLE(&(iLocal_16[iVar0]), true))
					{
						...
						PED::_0x931B241409216C1F(&(iLocal_16.f_40[iVar0]), iVar11, 0);
		...
		if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
		{
			...
			else
			{
				...
				if (func_61(&(iLocal_16.f_40[iVar0]), 0, 1))
				{
					...
					{
						if (!func_61(PED::_0xB676EFDA03DADA52(&(iLocal_16.f_40[iVar0]), 0), 0, 0))
						{
							TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_16.f_40[iVar0]), iLocal_16.f_209, 4, 0, -1f, -1, 0);
							PED::SET_PED_KEEP_TASK(&(iLocal_16.f_40[iVar0]), true);
						}
					}
					else if (!ENTITY::DOES_ENTITY_EXIST(PED::_0xF103823FFE72BB49(&(iLocal_16.f_40[iVar0]))) && !ENTITY::DOES_ENTITY_EXIST(PED::_0xB676EFDA03DADA52(&(iLocal_16.f_40[iVar0]), 1)))
					{
						TASK::_TASK_SMART_FLEE_STYLE_COORD(&(iLocal_16.f_40[iVar0]), iLocal_16.f_209, 4, 0, -1f, -1, 0);
						PED::SET_PED_KEEP_TASK(&(iLocal_16.f_40[iVar0]), true);
					}
...
int func_238(int iParam0)
{
	...
	{
		if (!func_61(PED::_0xB676EFDA03DADA52(&(iLocal_16.f_40[iParam0]), 0), 0, 1))
		{
			return 1;
		}
		else
	...
	if (func_61(PED::_0xB676EFDA03DADA52(&(iLocal_16.f_40[iParam0]), 1), 0, 1))
	{
		return 0;
	}
