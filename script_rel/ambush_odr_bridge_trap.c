	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(iLocal_16.f_40[iVar0])))
	{
		if (iVar1 != 0)
		{
			...
			else
			{
				...
				PED::_0x1902C4CFCC5BE57C(&(iLocal_16.f_40[iVar0]), func_93(iVar0));
				PED::_0xCC8CA3E88256E58F(&(iLocal_16.f_40[iVar0]), false, true, true, true, false);
			}
		}
	}
			...
			if (func_61(&(iLocal_16[0]), 0, 1))
			{
				if (!func_145(&uLocal_279, 2))
				{
					if (func_159(&(iLocal_16[0]), &(iLocal_361[0]), "PEDB", joaat("BREAKOUT"), 0, 1, 0))
					{
						...
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[0]), 1063765679, false, 1, false);
			...
			if (func_61(&(iLocal_16[1]), 0, 1))
			{
				if (!func_145(&uLocal_279, 4))
				{
					if (func_159(&(iLocal_16[1]), &(iLocal_361[0]), "PEDC", joaat("BREAKOUT"), 0, 1, 0))
					{
						...
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[1]), 1063765679, false, 1, false);
			...
			if (!PED::IS_PED_ON_MOUNT(Global_35))
			{
				...
				if (!func_145(&uLocal_279, 8))
				{
					if (func_61(&(iLocal_16[2]), 0, 1))
					{
						...
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[2]), 1063765679, false, 1, true);
			...
			else
			{
				...
				if (!func_145(&uLocal_279, 65536) && func_179(&uLocal_295, 23f))
				{
					if (!func_174())
					{
						...
						PED::FORCE_PED_MOTION_STATE(&(iLocal_16[2]), 1063765679, false, 0, false);
...
int func_93(int iParam0)
{
	if (&iLocal_16.f_75[iParam0] == 0)
	{
		...
		if (&iLocal_16.f_75[iParam0] == 1268180497)
		{
			iLocal_16.f_75[iParam0] = func_94();
		}
	}
...
int func_157()
{
	...
	switch (iLocal_277)
	{
		...
		case 3:
			...
			{
				func_150(&uLocal_307);
				func_160(&(iLocal_16[2]), iLocal_16.f_22[2], joaat("BLIP_STYLE_ENEMY"), 580546400, 0, 0);
				TASK::OPEN_SEQUENCE_TASK(&iVar0);
...
void func_712(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (((((iParam1 == 1 || func_825(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == -1424823393) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
