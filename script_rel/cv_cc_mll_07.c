...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -10.5949f, 2.2941f, 1.1367f, -29f, 4.5f, 4.5f, 4f, joaat("VOLBOX"), joaat("APMS_COMP_MOLLY"), 1, 1, 1);
...
int func_93(var uParam0)
{
	if (func_198(uParam0, iLocal_15))
	{
		...
		{
			func_200(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_SMOKE"), "WORLD_HUMAN_SMOKE_FEMALE_C", -1, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
			func_201(uParam0);
		}
	}
	if (!bLocal_39)
	{
		...
		{
			TASK::_0x673A8779D229BA5A(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 0, 0);
			bLocal_39 = true;
		}
	}
	if (func_203(uParam0, iLocal_14))
	{
		...
		TASK::_TASK_SMART_FLEE_STYLE_COORD(func_48(uParam0, iLocal_14), 1907.99f, -1817.852f, 40.86853f, 2, 256, 100f, -1, 0);
		PED::_0x2208438012482A1A(func_48(uParam0, iLocal_14), false, false);
		func_56((uParam0->f_107[iLocal_14 /*113*/])->f_1, 0, 0, 0, 15f, 1, 1, 0, 0, 0, 0);
	}
	return 1;
}
...
int func_203(var uParam0, int iParam1)
{
	...
	{
		if (!func_305((uParam0->f_107[iParam1 /*113*/])->f_5, 1435919172))
		{
			return 1;
		}
	}
...
void func_302(var uParam0, int iParam1, float fParam2)
{
	if (fParam2 == -2f)
	{
		fParam2 = func_343(1101004800 /* Float: 20f */, 1123024896 /* Float: 120f */);
	}
	else if (fParam2 < 0f)
	{
		fParam2 = -1f;
