...
void func_19(var uParam0)
{
	...
	if (bLocal_14)
	{
		...
		uLocal_17 = func_48(bLocal_16, 0, 0, 0);
		CAM::_0x8370D34BD2E60B73();
		CAM::_DISABLE_FIRST_PERSON_CAM_THIS_FRAME();
	}
}
...
int func_23(var uParam0)
{
	...
	if (!bLocal_14)
	{
		if ((!PED::_0x50F124E6EF188B22(Global_35) || PED::_0x6FB76442469ABD68(Global_35) != bLocal_13) || PED::_0xA29FD00D45311EB7(Global_35, "Drunkness") != bLocal_13)
		{
			AUDIO::SET_PED_IS_DRUNK(Global_35, true);
			PED::_0x406CCF555B04FAD3(Global_35, 1, bLocal_13);
			PED::_0x437C08DB4FEBE2BD(Global_35, "Drunkness", bLocal_13, -1);
		}
		switch (iLocal_9)
		{
			case 0:
			...
			case 1:
				...
				bLocal_13 = (0.75f - (0.75f * fVar1));
				bLocal_13 = func_51(bLocal_13, 0f, 0.75f);
				PED::_0x406CCF555B04FAD3(Global_35, 1, bLocal_13);
				PED::_0x437C08DB4FEBE2BD(Global_35, "Drunkness", bLocal_13, -1);
				if (bLocal_13 <= 0f)
				{
