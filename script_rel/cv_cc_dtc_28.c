...
int func_72(var uParam0)
{
	...
	func_151(uParam0, -0.6318f, -3.0952f, 1.4875f, 0f, 4f, 7f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_DUTCH"), 1, 1, 1);
	func_151(uParam0, 10.4607f, 7.138f, 1.4875f, -22.5f, 1.1f, 1.1f, 3.2075f, joaat("VOLBOX"), joaat("APMS_COMP_PEARSON"), 1, 1, 1);
	...
	func_153(uParam0, "script@vignette@dutch_28@base", 1, 1, 0, 0);
	uLocal_20 = func_153(uParam0, "script@vignette@dutch_28@action", 0, 0, 1, 0);
	func_154(uParam0, "CDT28AU");
	func_155(uParam0, joaat("COMP_DTCCNV28"), joaat("PLAYER_DTCCNV28"));
	func_156(uParam0, uLocal_20, -1, 0.88f);
	func_157(uParam0, iLocal_14, 3, joaat("WORLD_CAMP_DUTCH_SMOKE_CIGAR"), "WORLD_CAMP_DUTCH_SMOKE_CIGAR_MALE_A", iLocal_16, 0);
	func_158(uParam0, iLocal_14, 3, joaat("SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING"), "SC_PROP_CAMP_DUTCH_SEAT_CHAIR_READING_MALE_A", iLocal_16, 0, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
	...
	func_158(uParam0, iLocal_15, 4, joaat("PROP_HUMAN_FOODPREP_STEW"), "PROP_HUMAN_FOODPREP_STEW_SEASONING_MALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
{
	func_193(func_192(uParam0, iLocal_19), 0);
	return 1;
}
...
int func_418(int iParam0, bool bParam1, bool bParam2)
{
	...
	PED::_SET_PED_BODY_COMPONENT(bParam1, func_450(iParam0));
	PED::_UPDATE_PED_VARIATION(bParam1, false, true, true, true, false);
		...
		case 7:
			switch (iParam0)
			{
				...
				case 14:
					...
					break;
				case 4:
					if (func_324(joaat("CSTAG_FLOW_MAR8_POST"), 1) && !func_388(((*Global_1347702)[1 /*49*/])->f_15, 1))
					{
						iVar1[0] = -1155031950;
					}
					else
