...
int func_72(var uParam0)
{
	...
	func_150(uParam0, -3.55f, -5.1475f, 0f, 0f, 1f, 1f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_JACK"), 1, 1, 1);
	func_150(uParam0, -0.5375f, 0.3275f, 0f, -25f, 2.1825f, 4.2175f, 5f, joaat("VOLBOX"), joaat("APMS_COMP_GRIMSHAW"), 1, 1, 1);
	iLocal_16 = func_151(uParam0, joaat("P_CS_RAG02X"), 0f, 0f, 0f, "RAG", 0, 0, 1);
	func_152(uParam0, "script@vignette@dog_6@base", 1, 1, 0, 0);
	uLocal_17 = func_152(uParam0, "script@vignette@dog_6@action", 0, 0, 1, 0);
	func_153(uParam0, joaat("COMP_DOGCNV6"), joaat("PLAYER_DOGCNV6"));
	func_154(uParam0, uLocal_17, -1, 0.88f);
	func_155(uParam0, iLocal_14, 3, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1);
	func_156(uParam0, iLocal_14, 2, joaat("WORLD_HUMAN_CLEAN_TABLE"), "WORLD_HUMAN_CLEAN_TABLE_FEMALE_B", -1, 1, -1073741824 /* Float: -2f */, 1065353216 /* Float: 1f */, 1);
...
void func_154(var uParam0, var uParam1, int iParam2, float fParam3)
{
	if (iParam2 == -1)
	{
		iParam2 = 0;
