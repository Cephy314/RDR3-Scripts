...
int func_72(var uParam0)
{
	...
	func_151(uParam0, 1.7875f, -1.3375f, 0.85f, 0f, 4.4575f, 3.4825f, 3.2075f, -1612834106, joaat("APMS_COMP_MARYBETH"), 1, 1, 1);
	iLocal_24 = func_152(uParam0, 0.192943f, -2.19054f, 1.00161f, 0f, 1.3f, 1.3f, 3.2f, 665633627, 1);
