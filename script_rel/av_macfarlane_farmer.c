...
void func_14(var uParam0, vector3 vParam1, vector3 vParam4)
{
	...
	func_49(uParam0, 0, "IG_GenStoryMale", joaat("cs_genstorymale"), 0f, 0f, 0f, 0f, 1, 1, 1, 1, 41788943, 1);
}
...
int func_18(var uParam0)
{
	if (ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		{
			uParam0->f_20[0 /*14*/] = func_50(iLocal_38, 0, 0, 1, 1, 1);
		}
		else
		{
...
int func_28(var uParam0)
{
	if (!&uParam0->f_469[2])
	{
		...
		TASK::TASK_START_SCENARIO_AT_POSITION(&(uParam0->f_20[0 /*14*/]), joaat("WORLD_HUMAN_SMOKE"), uParam0->f_483, uParam0->f_486.f_2, 0, false, true, 0, -1f, false);
		uParam0->f_469[2] = 1;
	}
	if (!&uParam0->f_469[0])
	{
	...
	if ((!&uParam0->f_469[3] && ENTITY::GET_ENTITY_SPEED(Global_35) < 8f) && func_60(uParam0, 1065353216 /* Float: 1f */, 25f, 4, 5f, 15f))
	{
		func_61(*uParam0, 0);
		uParam0->f_469[3] = 1;
		func_62(uParam0);
...
int func_31(var uParam0)
{
	...
	if (!&uParam0->f_469[0])
	{
		...
		if (func_71(Global_35, &(uParam0->f_20[0 /*14*/]), 1, 1) > 30f)
		{
			TASK::TASK_SMART_FLEE_PED(&(uParam0->f_20[0 /*14*/]), Global_35, -1f, -1, 0, 3f, 0);
			uParam0->f_469[0] = 1;
			return 1;
	...
	if (&uParam0->f_469[3])
	{
		if (!&uParam0->f_469[5])
		{
			if (func_72(uParam0, 1f, 45f, 4, joaat("action"), 0))
			{
	...
	if (&uParam0->f_469[3])
	{
		...
		if (ANIMSCENE::_0x005E6F28DD7ED58D(uParam0->f_3.f_1, "IG_JohnMarston"))
		{
			bLocal_37 = true;
		}
	}
...
int func_50(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)
{
	...
	if ((bParam4 && !func_77(iParam0)) && !ENTITY::IS_ENTITY_DEAD(iVar0))
	{
...
int func_51(int iParam0, bool bParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	...
	if (!func_7(vVar0))
	{
		PERSCHAR::_0x59C7AD6FEA2AC449(func_100(iParam0), vVar0);
	}
	if (bParam5)
	{
		iVar3 = PERSCHAR::_0x08FC896D2CB31FCC(func_100(iParam0), 0);
	}
	else
	{
		iVar3 = PERSCHAR::_0x0CADC3A977997472(func_100(iParam0), 0);
	}
	if (!func_7(vVar0))
	{
...
int func_59(var uParam0, var uParam1, bool bParam2)
{
...
int func_60(var uParam0, float fParam1, float fParam2, int iParam3, float fParam4, float fParam5)
{
	int iVar0;
	float fVar1;
	int iVar2;
	...
	if ((MISC::GET_FRAME_COUNT() % 8) == 0)
	{
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
			{
				...
				fVar8 = func_117(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1);
				if (fVar8 < fVar1)
				{
					return 1;
				}
...
{
	func_122(Global_35, &(uParam0->f_20[0 /*14*/]), &uLocal_39, 0f, 0f, 0f, 0, 0, 1, 1069547520 /* Float: 1.5f */, -1082130432 /* Float: -1f */, 1073069561, 1056964608 /* Float: 0.5f */, 1092616192 /* Float: 10f */, -1, 1, 0, 0, 0, 1);
	func_123(&(uParam0->f_20[0 /*14*/]), Global_35, &uLocal_39, -1082130432 /* Float: -1f */, 0, 0, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 8, 0, 0, 1069547520 /* Float: 1.5f */, 1073741824 /* Float: 2f */, 1050253722 /* Float: 0.3f */, 1067030938 /* Float: 1.2f */, 0, 0, -1, 1, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1);
	func_124(&uLocal_77);
}
		...
		while (iVar0 < uParam0->f_19)
		{
			...
			else
			{
				if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[iVar0 /*14*/])))
				{
					...
					{
						if ((func_117(Global_35, &(uParam0->f_20[iVar0 /*14*/]), 1) < fParam2 && PED::_0x5102307CE88798EB(&(uParam0->f_20[iVar0 /*14*/]))) && PED::IS_TRACKED_PED_VISIBLE(&(uParam0->f_20[iVar0 /*14*/])))
						{
							if (!func_118(&(uParam0->f_490)))
							{
...
{
	func_141(Global_35, &(uParam0->f_20[0 /*14*/]), 1, 1, 1, 0, 1, 1, 0, 1, 1);
	func_142(&(uParam0->f_20[0 /*14*/]), Global_35, 1, 1, 1, 0, 1, 1, 0, 1, 1);
...
int func_82(vector3 vParam0, float fParam3)
{
	...
	while (iVar0 < 4)
	{
		...
		{
			if (func_151(vParam0, (Global_1415419->f_9721[iVar0 /*8*/])->f_4, fParam3, 0))
			{
				return 1;
			}
		}
...
int func_83(vector3 vParam0)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_151(vParam0, (Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, 1f, 0))
			{
				return 1;
			}
		}
...
int func_103(int iParam0, bool bParam1)
{
	...
	if (func_94(iParam0, 32) && !bParam1)
	{
		...
		if (func_92() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_100(iParam0));
...
int func_105(int iParam0)
{
	...
	{
		PERSCHAR::_0x49A8C2CD97815215(func_100(iParam0));
		if (!ENTITY::DOES_ENTITY_EXIST(PERSCHAR::_0x0CADC3A977997472(func_100(iParam0), 0)))
		{
			return 0;
		}
	}
...
int func_112(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, float fParam5)
{
	...
	if (!Global_1935630->f_12 && !ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		...
		{
			if (func_175(uParam2, 1065353216 /* Float: 1f */))
			{
				if (!uParam2->f_1 & 4 != 0)
				{
...
float func_117(int iParam0, int iParam1, bool bParam2)
{
	...
	return func_198(ENTITY::GET_ENTITY_COORDS(iParam0, false, false), ENTITY::GET_ENTITY_COORDS(iParam1, false, false));
}
...
void func_122(int iParam0, int iParam1, var uParam2, vector3 vParam3, char* sParam6, int iParam7, int iParam8, float fParam9, float fParam10, float fParam11, float fParam12, int iParam13, int iParam14, bool bParam15, int iParam16, int iParam17, int iParam18, bool bParam19)
{
	struct<10> Var0;
	struct<10> Var11;
...
void func_123(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, float fParam7, bool bParam8, int iParam9, float fParam10, float fParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, bool bParam19, int iParam20, int iParam21, bool bParam22)
{
	struct<7> Var0;
...
void func_140(int iParam0, vector3 vParam1)
{
	...
	while (iVar0 < 10)
	{
		...
		{
			if (func_151((Global_32073.f_2697.f_1495[iVar0 /*4*/])->f_1, vParam1, 1056964608 /* Float: 0.5f */, 1))
			{
				return;
			}
		}
	...
	switch (uParam0->f_6)
	{
		case 0:
			if (*uParam0 & 16 != 0)
			{
				...
				else if (!PED::IS_PED_PLANTING_BOMB(Global_35) && (!func_215(1) || *uParam0 & 8192 != 0))
				{
...
int func_172(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_228(iParam1, !*uParam2 & 268435456 != 0, !*uParam2 & 536870912 != 0, !*uParam2 & 1073741824 != 0, 0))
	{
		...
		if (func_226(uParam2, iParam0, fVar0, fVar1))
		{
			...
			if (uParam2->f_2 != 0)
			{
				if (MISC::GET_GAME_TIMER() - uParam2->f_2) > func_227(uParam2)
				{
					func_222(uParam2, 1);
					return 1;
				}
...
int func_173(int iParam0, var uParam1)
{
	...
	if (func_218(iParam0, uParam1, iVar1))
	{
		...
		else if (MISC::GET_GAME_TIMER() - uParam1->f_3) > func_227(uParam1)
		{
...
int func_196(int iParam0, var uParam1)
{
	...
	{
		return func_251(iParam0, uParam1, 0, -1082130432 /* Float: -1f */);
	}
	return 0;
}
...
int func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	{
		if (WEAPON::_0x6AD66548840472E5(func_259(iVar0, 0)))
		{
...
int func_226(var uParam0, int iParam1, float fParam2, float fParam3)
{
	float fVar0;
...
int func_228(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4)
{
	int iVar0;
	int iVar1;
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING(iVar1))
	{
		if (WEAPON::_0x6AD66548840472E5(func_259(iVar0, 0)))
		{
			if (func_261(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), 0.4f, 0.6f, 0.3f, 0.7f))
			{
				return 1;
			}
		}
...
int func_233(int iParam0, vector3 vParam1, vector3 vParam4)
{
...
int func_235(var uParam0, int iParam1, float fParam2, bool bParam3, bool bParam4)
{
	float fVar0;
...
int func_237(var uParam0, int iParam1, float fParam2, int iParam3)
{
	float fVar0;
...
int func_239(int iParam0, int iParam1)
{
	...
	if (func_265(iParam0, 1, 0, 0) != joaat("WEAPON_LASSO"))
	{
		return 0;
	}
...
int func_241(int iParam0, int iParam1, vector3 vParam2)
{
	float fVar0;
...
int func_247(int iParam0, var uParam1, bool bParam2)
{
	int iVar0;
	int iVar1;
...
int func_249(int iParam0)
{
	...
	return func_267(((*Global_1347702)[58 /*49*/])->f_15, 1);
}
...
int func_260(int iParam0, float fParam1, float fParam2, float fParam3, float fParam4)
{
	if (!ENTITY::IS_ENTITY_DEAD(iParam0))
	{
		if (func_261(ENTITY::GET_ENTITY_COORDS(iParam0, true, false), fParam1, fParam2, fParam3, fParam4))
		{
			return 1;
		}
	}
...
int func_261(vector3 vParam0, float fParam3, float fParam4, float fParam5, float fParam6)
{
	float fVar0;
	float fVar1;
	bool bVar2;
