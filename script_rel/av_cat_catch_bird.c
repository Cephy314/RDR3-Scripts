...
int func_32(var uParam0, bool bParam1)
{
	...
	if (uParam0->f_469[4] && !&uParam0->f_469[5])
	{
		...
		else if (TASK::IS_PED_ACTIVE_IN_SCENARIO(&(uParam0->f_20[0 /*14*/]), 0) && TASK::_GET_SCENARIO_POINT_PED_IS_ACTIVE(&(uParam0->f_20[0 /*14*/])) == joaat("WORLD_ANIMAL_CAT_RESTING"))
		{
...
void func_67(var uParam0)
{
	if (!ENTITY::IS_ENTITY_DEAD(&(uParam0->f_20[0 /*14*/])))
	{
		...
		else if (!func_111(&(uParam0->f_20[0 /*14*/]), 1139527981))
		{
			...
			TASK::TASK_ANIMAL_UNALERTED(&(uParam0->f_20[0 /*14*/]), -1, false, 0, 0);
			func_72(uParam0->f_20[0 /*14*/], 0, 1);
		}
	}
}
