		...
		if (MISC::GET_GAME_TIMER() > iLocal_41)
		{
			...
			switch (iLocal_40)
			{
				...
				case 2:
					...
					LAW::_0x9BBDCB8DF789EBC1(PLAYER::PLAYER_ID(), func_12(iLocal_42));
					Global_1896608 = -1;
				...
				case 7:
					if (func_10(func_9(iLocal_42)))
					{
						...
						else
						{
							...
							{
								PED::_0xA77FA7BE9312F8C0(((*Global_1887327)[iLocal_42 /*36*/])->f_12);
							}
							Jump @813; //curOff = 790
							func_8();
							func_44(iVar0);
						...
						{
							PED::_0x95423627A9CA598E(((*Global_1887327)[iLocal_42 /*36*/])->f_13);
						}
						BUILTIN::WAIT(0);
						iVar0 = 0;
						while (!func_44(iVar0))
...
{
	func_77();
	func_78(&uLocal_37, &iLocal_38, 3018.27f, 558.1332f, 44.5092f, joaat("P_DOORCATJAK_01X"));
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_81(&Global_1939178, 32768)) || func_81(&Global_1939178, 16777216))
	{
		return;
	}
...
void func_62(int iParam0, vector3 vParam1, int iParam4, int iParam5)
{
	...
	(Global_1938942->f_5[iParam0 /*11*/])->f_6 = func_117(iParam5, iParam0);
}
...
void func_63(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_18 = func_122(iParam2, iParam0);
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_64 = func_123((Global_1051388->f_69[iParam0 /*76*/])->f_18);
...
void func_64(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0] = func_128(iParam1, 0, 0);
	if (func_129(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		if (!func_130(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
		{
			func_80(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, fParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
{
	func_131(&((Global_1051388->f_69[iParam0 /*76*/])->f_50), iParam1);
}
...
int func_66(int iParam0, bool bParam1)
{
	...
	if ((func_132(iParam0, 16384) || func_132(iParam0, 32768)) || func_115((Global_1051388->f_69[iParam0 /*76*/])->f_3))
	{
...
void func_70(int iParam0)
{
	...
	if (func_134(&(Global_1051388->f_3582[iVar0 /*19*/]), &iVar1, &uVar2, &vVar3))
	{
		(Global_1051388->f_3582[iVar0 /*19*/])->f_6 = func_144(iVar1, vVar3, uVar2, 0, 0, 0);
	...
	iVar6 = func_145(&(Global_1051388->f_3582[iVar0 /*19*/]));
	bVar7 = iVar6 != -1;
	if (bVar7)
	{
		...
		{
			(Global_1051388->f_3582[iVar0 /*19*/])->f_13 = func_144(iVar1, vVar3, uVar2, 0, 0, 0);
	...
	(Global_1051388->f_3582[iVar0 /*19*/])->f_5 = func_123(&(Global_1051388->f_3582[iVar0 /*19*/]));
	if (!func_142(30, 4))
	{
		func_125(30, 4);
		func_126(30);
...
bool func_83()
{
	return func_81(&Global_1939178, 8192);
}
...
void func_88(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938085->f_145 = func_173(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_90(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_175(Global_1939178, 16384);
	func_177(func_176(joaat("DISCOVERED"), joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_177(func_176(joaat("DISCOVERED"), joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_177(func_176(joaat("DISCOVERED"), joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_177(func_176(joaat("DISCOVERED"), joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_177(func_176(joaat("DISCOVERED"), joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_177(func_176(joaat("DISCOVERED"), joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_177(func_176(joaat("DISCOVERED"), joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
bool func_107(int iParam0)
{
	...
	if (func_185(iVar1))
	{
		if (Global_1070356->f_17915.f_24 && !func_186(iParam0))
		{
			return false;
		}
...
int func_114(int iParam0, bool bParam1)
{
	...
	if (func_179(iParam0, 32) && !bParam1)
	{
		...
		if (func_45() == -1)
		{
			...
			{
				PERSCHAR::_0x49A8C2CD97815215(func_147(iParam0));
				func_190(iParam0, 2048);
			}
			PERSCHAR::_0xFCC6DB8DBE709BC8(func_147(iParam0));
		}
		return 0;
	}
	...
	if (PERSCHAR::_0x800DF3FC913355F3(func_147(iParam0)))
	{
		func_190(iParam0, 128);
		return 1;
	}
	func_189(iParam0, PERSCHAR::_CREATE_PERSISTENT_CHARACTER(func_188(iParam0)));
	PERSCHAR::_0x4F81EAD1DE8FA19B(func_147(iParam0));
	if (func_179(iParam0, 2048))
	{
		PERSCHAR::_0x49A8C2CD97815215(func_147(iParam0));
		func_190(iParam0, 2048);
...
{
	func_192((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_193((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_120(bool bParam0, bool bParam1)
{
	...
	func_203(Global_1099294->f_516, 36);
	func_204(Global_1099294->f_555, 36);
}
...
void func_121(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_108(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
	...
	if (VOLUME::_DOES_VOLUME_EXIST((Global_1051388->f_69[iParam0 /*76*/])->f_25) && func_207(iParam0, 2))
	{
...
int func_123(int iParam0)
{
	...
	{
		Global_1051388->f_4360[iParam0] = func_209(iParam0);
	}
...
void func_136(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_6 = func_144(iParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_146(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_147(iParam0));
}
...
void func_178(int iParam0)
{
	...
	if (func_112((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_224((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_225((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_226((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_108(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
int func_180(int iParam0, bool bParam1)
{
	...
	func_231(iParam0);
	PERSCHAR::_0xFC77C5B44D5FF7C0(func_147(iParam0));
	func_189(iParam0, 0);
	return 1;
}
...
{
	func_233(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	if (func_235(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_242(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_243((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_209(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1132968->f_7) && !func_245(12, func_244(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_234(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_263(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_264())
	{
		return func_263(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_263(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
