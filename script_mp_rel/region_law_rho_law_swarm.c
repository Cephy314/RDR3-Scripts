...
void __EntryFunction__()
{
	...
	func_2();
	while (func_3(uScriptParam_0) && iLocal_48 < 7)
	{
		func_4();
		BUILTIN::WAIT(0);
	}
...
int func_6()
{
	...
	iLocal_50++;
	iVar0 = func_8(iLocal_49, vLocal_45, 0, 1, 1, 0, 1, 1, 1, 0, 0);
	PED::SET_PED_AS_COP(iVar0, true);
	func_9(&iVar0, 1, 0, 1);
	func_10(&Local_51, 1, 0);
	if (iLocal_50 >= 5)
	{
		return 1;
	}
...
int func_7()
{
	...
	fVar0 = 55f;
	fVar1 = 90f;
	iVar2 = func_11(iLocal_50, Local_51.f_2);
	...
	if (!func_12(Global_35, &Local_51, &uVar5, 1, 1, fVar4, 50f, fVar0, fVar1, fVar3))
	{
		return 0;
	}
...
int func_12(vector3 vParam0, int iParam3, int iParam4, int iParam5, bool bParam6, float fParam7, int iParam8, float fParam9, int iParam10, float fParam11)
{
	int iVar0;
	...
	switch (*iParam3)
	{
		case 0:
			...
			func_14(&(iParam3->f_1), iParam3->f_2, vParam0, iParam5, fParam7, iParam8, fParam9, iParam10, fParam11);
...
int func_28(vector3 vParam0)
{
	...
	return func_29(vParam0, ((*Global_1892728)[iVar0 /*3*/])->f_1, ((*Global_1892728)[iVar0 /*3*/])->f_2, Global_1892728[iVar0 /*3*/], 4);
}
