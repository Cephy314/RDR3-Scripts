...
int func_13()
{
	iLocal_23 = ((*Global_1887327)[39 /*36*/])->f_5;
	VOLUME::_0xB469CFD9E065EB99(iLocal_23, 9);
	iLocal_21 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(-1859.829f, -1332.492f, 97.368f, 0f, 0f, -140f, 14.456f, 10.148f, 8.8f, "Tall Trees TravellingSalesman - m_volTravellingSalesman");
	iLocal_22 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(-1862.152f, -1335.058f, 97.368f, 0f, 0f, -140f, 3.7f, 3.7f, 4.2f, "Tall Trees TravellingSalesman - m_volTravellingSalesmanPrompt");
	return 1;
}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_18 = func_97(iParam2, iParam0);
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_64 = func_98((Global_1051388->f_69[iParam0 /*76*/])->f_18);
...
int func_59(int iParam0, bool bParam1)
{
	...
	if ((func_102(iParam0, 16384) || func_102(iParam0, 32768)) || func_103((Global_1051388->f_69[iParam0 /*76*/])->f_3))
	{
...
void func_73(int iParam0, bool bParam1)
{
	...
	switch (func_9(iParam0))
	{
		...
		case 2:
		case 11:
			func_129(func_128(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_129(func_128(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_129(func_128(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_129(func_128(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_129(func_128(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_129(func_128(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
void func_95(bool bParam0, bool bParam1)
{
	...
	func_151(Global_1099294->f_516, 36);
	func_152(Global_1099294->f_555, 36);
}
...
void func_96(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_157(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
int func_98(int iParam0)
{
	...
	{
		Global_1051388->f_4360[iParam0] = func_164(iParam0);
	}
...
{
	return func_165(iParam0, "sHash", uParam1, "fHeading", uParam2, "vPos", uParam3);
}

bool func_106(int iParam0, var uParam1, var uParam2, var uParam3)
{
	return func_165(iParam0, "sClosedHash", uParam1, "fClosedHeading", uParam2, "vClosedPos", uParam3);
}
...
void func_107(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_6 = func_166(iParam1, vParam2, uParam5, 0, 0, 0);
...
char* func_112(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_172(func_171(Global_35));
	}
...
{
	func_177((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_178((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_131(int iParam0)
{
	...
	if (func_89((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_180((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_181((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_182((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_157(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	if (func_191(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_198(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	return func_201((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_164(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1132968->f_7) && !func_203(12, func_202(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_165(int iParam0, char* sParam1, var uParam2, char* sParam3, var uParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;
...
var func_166(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
var func_170(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_212(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
int func_190(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_222(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_223())
	{
		return func_222(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_222(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_236(struct<2> Param0, var uParam2)
{
	if (!func_207(Param0))
	{
		return 0;
