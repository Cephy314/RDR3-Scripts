...
void __EntryFunction__()
{
	...
	{
		if (func_2(Global_34, 0) != joaat("WEAPON_UNARMED"))
		{
	...
	while (true)
	{
		...
		switch (func_3(&Var1))
		{
			...
			case 2:
				...
				if (Global_1939231->f_10477 != 1061777683 || Global_1939231->f_10478 != iVar0)
				{
					func_1(&Var1, 3);
				}
				break;
...
void func_6(var uParam0)
{
	...
	if (iVar0 > 0)
	{
		uParam0->f_3[0] = func_17("IB_POS_RESP", joaat("INPUT_INTERACT_LOCKON_POS"), Global_34, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
	if (iVar1 > 0)
	{
		uParam0->f_3[1] = func_17("IB_NEG_RESP", joaat("INPUT_INTERACT_LOCKON_NEG"), Global_34, 1, 0, 0, 1, 0, 1070386381 /* Float: 1.6f */, 570, 4000, 10, 1073741824 /* Float: 2f */, 0, joaat("SHORT_TIMED_EVENT"), 0, 0);
	}
}
...
void func_8(var uParam0, bool bParam1)
{
	...
	func_20(Global_39.f_4514[iVar1 /*6*/], iVar0);
...
int func_14(int iParam0)
{
	...
	return (func_23(Global_39.f_4514[iVar0 /*6*/], 1) || func_23(Global_39.f_4514[iVar0 /*6*/], 2));
}
...
int func_19(int iParam0)
{
	...
	while (iVar1 < 180)
	{
		if (&Global_39.f_4514[iVar1 /*6*/] == iParam0)
		{
			iVar0 = iVar1;
		}
		else
...
int func_28(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5, float fParam6, int iParam7, int iParam8, bool bParam9)
{
	...
	iVar2 = 0;
	if (func_39(iParam0) == joaat("CLOTHING"))
	{
	...
	if (!bVar3)
	{
		...
		else if (func_39(iParam0) == joaat("WEAPON"))
		{
		...
		else if (func_39(iParam0) == joaat("AMMO") && func_54(iParam0))
		{
		...
		else if (func_40(iParam0, 866047851))
		{
		}
		else if (func_40(iParam0, 2000026003))
		{
		}
		else if (func_40(iParam0, -103750053))
		{
			func_57(func_56(joaat("CLAWS_COLLECTED")), iVar0);
		}
		else if (iParam0 == joaat("PROVISION_ALLIGATOR_TOOTH"))
		{
			func_57(func_58(joaat("COLLECTED"), joaat("ALLIGATOR_TOOTH")), iVar0);
		}
		...
		switch (iParam0)
		{
			...
			case joaat("CONSUMABLE_AGED_PIRATE_RUM"):
				func_70(271, func_69(joaat("CONSUMABLE_AGED_PIRATE_RUM")), 0);
				break;
			case joaat("CONSUMABLE_GINSENG_ELIXIER"):
				func_70(269, func_69(joaat("CONSUMABLE_GINSENG_ELIXIER")), 0);
				break;
			case joaat("CONSUMABLE_VALERIAN_ROOT"):
				func_70(270, func_69(joaat("CONSUMABLE_VALERIAN_ROOT")), 0);
				break;
			...
			case joaat("CONSUMABLE_MOONSHINE"):
				...
				{
					func_71(683, 1934060482 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Health Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_RESTORATIVE"):
				if (MISC::GET_GAME_TIMER() >= (Global_1939231->f_10487 + 60000))
				{
					func_71(683, 1110018439 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Stamina Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_CHEWING_TOBACCO_USED"):
				if (MISC::GET_GAME_TIMER() >= (Global_1939231->f_10487 + 60000))
				{
					func_71(683, 1408511260 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    "rt period without draining. This Tonic will Fortify your Dead Eye Bar." */, 1, 1);
			...
			case joaat("CONSUMABLE_POTENT_TONIC"):
				if (MISC::GET_GAME_TIMER() >= (Global_1939231->f_10487 + 60000))
				{
					func_71(683, -1228016946 /* GXTEntry: "Consume yellow Tonics to Fortify your Bars. A Fortified Bar can be used for a sho" +
    ...
    "d Eye Bars." */, 1, 1);
			...
			case 1955751248: /* GXTEntry: "Roast Beef" */
				if (MISC::GET_GAME_TIMER() >= (Global_1939231->f_10487 + 60000))
				{
					func_71(684, -103579 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
    "for a short period of time. This Provision will Fortify your Health Core." */, 1, 1);
			...
			case -399865011: /* GXTEntry: "Regional Beef and Eggs Stew" */
				if (MISC::GET_GAME_TIMER() >= (Global_1939231->f_10487 + 60000))
				{
					func_71(684, -1531530025 /* GXTEntry: "Consume yellow Provisions to Fortify your Cores. A Fortified Core will not drain " +
...
void func_32(int iParam0, bool bParam1)
{
	if (HUD::_UIPROMPT_IS_VALID(((*Global_1949759)[iParam0 /*23*/])->f_3))
	{
		if (((*Global_1949759)[iParam0 /*23*/])->f_5 == 5 && !func_24(iParam0, 8))
		{
...
int func_49(bool bParam0)
{
	...
	return INVENTORY::_0x0FBBFFC891A97C81(func_103(bParam0));
}

int func_50(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5, int iParam6, bool bParam7)
{
	struct<5> Var0;
	struct<10> Var5;
	struct<4> Var27;
	...
	if (func_49(0))
	{
		...
		func_51(WEAPON::_GET_AMMO_TYPE_FOR_WEAPON(iParam0), iParam1, iParam6);
...
int func_53(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	if (WEAPON::IS_WEAPON_VALID(iVar0))
	{
		...
		if (!func_90(iParam0, &uVar1, 1, 0, 0, -1, 0))
		{
			...
			{
				if (iVar0 == joaat("WEAPON_MELEE_KNIFE_JOHN") && !func_114())
				{
					return 0;
				}
				...
				{
					func_50(iVar0, WEAPON::_GET_WEAPON_CLIP_SIZE(iVar0) * 4, bParam3, bParam4, 0, 0, iParam1, 0);
				}
			}
			else if (WEAPON::_IS_WEAPON_ONE_HANDED(iVar0))
			{
				iVar7 = func_116(Global_34, 2, 0, 1);
				if ((((func_102(iVar7) && !Global_26386) && iVar7 != iVar0) && !func_67(joaat("UPGRADE_OFFHAND_HOLSTER"), 1)) && bParam4)
				{
					WEAPON::_0xE9BD19F8121ADE3E(Global_34, iVar7);
				}
				if (func_102(iVar7) && func_67(joaat("UPGRADE_OFFHAND_HOLSTER"), 1))
				{
...
int func_75(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_130(&Var4, joaat("LOOT_TYPE_NORMAL"));
	return func_131(iParam0, &Var4, &uVar0, iParam1);
}
...
void func_78(int iParam0, char* sParam1)
{
	...
	sVar0 = func_133(Global_1902942->f_37);
	func_135(MISC::_CREATE_VAR_STRING(38, "ITEM_CAUGHT_PUMP", sParam1, sVar0), "inventory_items", func_134(iParam0), 0, joaat("COLOR_PURE_WHITE"), "Transaction_Feed_Sounds", "Transaction_Positive", 0, 1);
}
...
void func_79(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5, bool bParam6)
{
	...
	else if (!func_140(iParam0, &Var7, iVar11, iVar10, 0, joaat("UI_ITEMVIEWER")))
	{
		Var7 = "_PLACEHOLDER";
	...
	if ((func_142(iVar12) && func_40(iParam0, -306684263)) && iVar18 != 0)
	{
		iVar18 = func_143(iParam0);
	}
	sVar19 = func_144(MISC::_CREATE_VAR_STRING(10, &cVar2, MISC::_CREATE_VAR_STRING(0, iVar18), iVar1), iVar13);
	if (((((iParam1 == 1 || func_40(iParam0, 1443104131)) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_USED")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP")) || iParam0 == joaat("CONSUMABLE_CIGARETTE_BOX_CHEAP_USED"))
	{
	...
	{
		sVar19 = MISC::_CREATE_VAR_STRING(0, func_145(iParam0, -442898163));
	}
	if (iVar12 == -126813555 || iVar12 == 1946043663)
	{
		if (!func_40(iParam0, 920823793))
		{
			StringCopy(&cVar20, "", 128);
			if (func_146(iParam0, &cVar20))
			{
				sVar19 = func_148(func_147(cVar20), joaat("COLOR_PURE_WHITE"));
			}
		}
	}
	func_135(sVar19, Var7.f_1, MISC::GET_HASH_KEY(Var7), iVar16, iVar13, sVar15, sVar14, 0, 1);
}

int func_80()
{
	if ((Global_1939231->f_10485 != (Global_1939231->f_38.f_203 - 1) || func_150(func_149(0), Global_1939231->f_10478, 0, 1, 1) > 0) || Global_1939231->f_10485 == 15)
	{
		return 1;
	}
	func_151();
...
{
	return func_39(iParam0) == joaat("WEAPON");
}
...
void func_85(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
	...
	if (func_39(iParam0) != joaat("WEAPON"))
	{
		return;
	}
	iVar0 = func_46(iParam0, 0);
	...
	{
		if (bParam2 || (!WEAPON::HAS_PED_GOT_WEAPON(Global_34, iVar0, 0, false) && func_126(iParam0, 0, 0, 0) == 0))
		{
			if (func_47() == -1)
			{
				func_48(iVar0);
...
void func_86(int iParam0, int iParam1)
{
	...
	{
		func_152(iParam0, -915411861, iParam1, 1);
	}
}
...
struct<5> func_87(int iParam0, bool bParam1, bool bParam2)
{
	...
	{
		case joaat("CLOTHING"):
			Var0 = { func_106(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
			Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("WARDROBE"));
			break;
		case joaat("WEAPON"):
			Var0 = { func_154(bParam1) };
			if (bParam2 && func_155(iParam0, 1))
			{
				Var6.f_9 = -1591664384;
				if (!func_104(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else if (!func_104(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
				{
					Var0.f_4 = -649335959; /* GXTEntry: "Left" */
				}
				else if (func_105(iParam0, &Var6, 1728382685 /* GXTEntry: "Right" */))
				{
					Var0.f_4 = 1728382685; /* GXTEntry: "Right" */
				}
				else
		...
		case joaat("UPGRADE"):
		case joaat("DOG"):
			if (func_157(iParam0, -1823706425))
			{
				Var0 = { func_106(joaat("KIT_CAMP"), Var0, 1084182731, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("KIT_CAMP"));
			}
			else if (func_157(iParam0, -1483207246))
			{
				Var0 = { func_106(joaat("WARDROBE"), Var0, 1034665895, bParam1) };
				Var0.f_4 = INVENTORY::_0x6452B1D357D81742(iParam0, joaat("WARDROBE"));
			}
			...
			else if (func_157(iParam0, -1653629781))
			{
		...
		default:
			...
			else if (INVENTORY::_0x780C5B9AE2819807(iParam0, -833319691))
			{
				...
				if (!func_158(Var0, &Var28, bParam1, 0, -1))
				{
					Var0.f_4 = 0;
				}
				else
...
{
	if (!func_35(iParam0, 0) && !func_159(func_93(iParam0), 2))
	{
		return 0;
	}
	if (func_39(iParam0) == joaat("FEE"))
	{
		return -1;
	}
	if (!bParam2 && func_109(iParam0, joaat("DEFAULT")) == 0)
	{
		bParam2 = true;
	}
	if (bParam2)
	...
	return INVENTORY::_0xADDD1E7C0ECF7D95(func_103(bParam3), iParam0);
}
...
int func_89(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_103(bParam1), iParam0, bParam3);
}

int func_90(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5, int iParam6)
{
	struct<4> Var0;
	struct<10> Var4;
	int iVar26;
	...
	if (!bParam3 && func_109(iParam0, joaat("DEFAULT")) == 0)
	{
		bParam3 = true;
	}
	if (func_83(iParam0) && WEAPON::_0x705BE297EEBDB95D(iParam0))
	{
		Var0 = { func_154(0) };
		Var4.f_9 = -1591664384;
		if (!func_104(iParam0, &Var0, 1728382685 /* GXTEntry: "Right" */, 0, 0))
		...
		else if (func_105(iParam0, &Var4, 1728382685 /* GXTEntry: "Right" */))
		{
			return 0;
		}
		if (func_155(iParam0, 1))
		{
			if (!func_104(iParam0, &Var0, -649335959 /* GXTEntry: "Left" */, 0, 0))
			{
				return 0;
			}
			else if (func_105(iParam0, &Var4, -649335959 /* GXTEntry: "Left" */))
			{
				return 0;
			}
		}
	...
	if (iParam5 < 0)
	{
		iVar26 = func_88(iParam0, iParam1, bParam3, bParam4);
	}
	if (iVar26 < 0)
	{
		return 0;
	...
	iVar27 = func_161(iParam0, *iParam1, iParam1->f_4, bParam4, bParam3, iParam6);
...
int func_91()
{
	if (((((!ANIMSCENE::_0x3AB6C7B0BB0DF4B1(Global_34, -1) && !PED::IS_PED_USING_ANY_SCENARIO(Global_34)) && !func_162(Global_34, 1369124074)) && !func_162(Global_34, 713668775)) && !TASK::_0xEC7E480FF8BD0BED(Global_34)) && !PED::IS_PED_IN_ANY_VEHICLE(Global_34, false))
	{
		return 1;
	}
	return 0;
...
void func_98(int iParam0)
{
	switch (iParam0)
	{
		...
		case 1:
			...
			break;
		case 2:
			if (func_171() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			...
			break;
		case 3:
			if (func_171() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			...
			break;
		case 4:
			if (func_171() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 4))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
			...
			break;
		case 5:
			if (func_171() && PLAYER::_IS_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 5))
			{
				func_172("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
{
	return func_161(iParam0, *uParam1, iParam2, bParam3, 1, iParam4) > 0;
}
...
int func_105(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_174(iParam0, &uVar0, iParam1, iParam2))
	{
...
struct<4> func_106(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_103(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}

int func_107(int iParam0, int iParam1, var uParam2, int iParam3, int iParam4, int iParam5, bool bParam6)
{
	struct<12> Var0;
	int iVar14;
	struct<13> Var15;
	...
	Var0.f_9 = -1591664384;
	if (!func_158(*iParam1, &Var0, bParam6, 0, -1))
	{
		return 0;
	}
	if (iParam3 < 0)
	...
	if (!INVENTORY::_0x3E4E811480B3AE79(func_103(bParam6), iParam1, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
void func_108(int iParam0, int iParam1)
{
	...
	{
		iVar2 = func_178(WEAPON::_GET_WEAPON_CLIP_SIZE(iParam0), iParam1);
...
int func_110(int iParam0, int iParam1, int iParam2)
{
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_103(0), &uVar6, &Var1, iParam0, Var1.f_4, iParam1, iParam2))
	{
		return 0;
	}
	return 1;
...
int func_111(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, bool bParam5)
{
	if (!func_35(iParam0, 0))
	{
		return 0;
	...
	if (func_90(iParam0, iParam2, iParam3, bParam5, 0, -1, 0))
	{
		return 0;
	}
	if (!func_49(0))
	...
	if (!INVENTORY::_0xCB5D11F9508A928D(func_103(0), uParam1, iParam2, iParam0, iParam2->f_4, iParam3, iParam4))
	{
		return 0;
	}
	return 1;
...
int func_119(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if ((Global_1900718->f_67 && !func_129(iParam0, 1)) || func_185(32768))
	{
		if (!func_129(iParam0, 262144) || !Global_1904613->f_8198)
		{
			return 0;
		}
	}
...
void func_122(int iParam0, char* sParam1, int iParam2, bool bParam3)
{
	...
	if (MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
	{
		if (bParam3)
		{
			func_187(iParam0, 1000);
			return;
		}
		sParam1 = "FEED_MONEY_EARN";
	}
	func_135(MISC::_CREATE_VAR_STRING(2, sParam1, iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
}
...
void func_123(int iParam0, bool bParam1, float fParam2, int iParam3)
{
	...
	if (bParam1)
	{
		...
		iVar1 = (iVar1 + iVar2);
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_TOTAL_EARN", iParam0), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_TOTAL_TAKE"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
		iParam0 = (iParam0 - iVar0);
		if (iVar0 > 0)
		{
		}
		func_135(MISC::_CREATE_VAR_STRING(2, "FEED_GANG_PLAYER_EARN", iVar1), "ITEMTYPE_TEXTURES", joaat("ITEMTYPE_CASH"), 0, joaat("COLOR_PURE_WHITE"), 0, 0, 0, 1);
	}
	else
	{
		iVar1 = iParam0;
	...
	if (iVar1 > 0)
	{
		...
		func_57(func_132(joaat("CAREER_CASH")), iVar1);
	}
}
...
int func_124(int iParam0, int iParam1)
{
	...
	Var4.f_9 = -1591664384;
	if (func_191("ALL WEAPONS", &iVar1, &iVar2, -1591664384, 0))
	{
		iVar3 = 0;
		while (iVar3 < iVar2)
		{
			if (!func_192(&Var4, iVar3, iVar1, iVar2))
			{
			}
...
bool func_125(int iParam0)
{
	...
	if (!iVar1 == 0)
	{
		iVar2 = func_195(&(Global_17172.f_54.f_644.f_1353.f_5), iVar1);
		if (iVar2 == -1)
		{
			return true;
		}
...
int func_126(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam2), iParam0, bParam3);
	}
	else
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_103(bParam2), &Var3, bParam3);
	}
	return iVar0;
}
...
int func_134(int iParam0)
{
	...
	if (!func_201(iParam0, &uVar0, joaat("INVENTORY"), 0, 0, joaat("UI_ITEMVIEWER")))
	{
...
var func_135(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, char* sParam5, char* sParam6, int iParam7, int iParam8)
{
	...
	func_202(sParam0, sParam1, iParam2);
	return uVar20;
}
...
int func_140(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_146(int iParam0, char* sParam1)
{
	int iVar0;
	char cVar1[128];
	...
	StringCopy(sParam1, func_204(iParam0), 128);
	iVar0 = HUD::GET_LENGTH_OF_LITERAL_STRING(sParam1);
	if (!func_205(iParam0))
	{
		return 0;
	}
	StringCopy(&cVar1, func_206(iParam0), 128);
...
char* func_147(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)
{
...
int func_150(int iParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)
{
	...
	{
		iVar0 = (iVar0 + func_207(INVENTORY::_0x13D234A2A3F66E63(iParam0), iParam1));
	}
	if (bParam3)
	{
		iVar0 = (iVar0 + func_208(iParam1, bParam4));
	}
	return iVar0;
}
...
void func_151()
{
	if (!func_35(Global_1939231->f_10478, 0))
	{
		Global_1939231->f_6 = 0;
	}
	else if ((((func_92(Global_1939231->f_10478, 1224357681) != 0 && Global_1939231->f_10477 != 0) && Global_1939231->f_10477 != -2074770370) && !Global_1915180->f_20136) && !Global_1915180->f_21989.f_1)
	{
...
struct<4> func_153(bool bParam0)
{
	...
	if (Global_1572887->f_13 == 0)
	{
		...
		if (iVar0 == 2)
		{
			...
			{
				*Global_1272170 = { func_106(joaat("CHARACTER"), func_209(), -1591664384, bParam0) };
			}
		...
		else if (iVar0 == 3)
		{
			...
			{
				Global_1272170->f_12 = { func_106(joaat("CHARACTER"), func_209(), -1591664384, 0) };
			}
			return Global_1272170->f_12;
		}
	}
	return func_106(joaat("CHARACTER"), func_209(), -1591664384, bParam0);
}
...
struct<4> func_154(bool bParam0)
{
	...
	if (iVar0 == 2)
	{
		...
		{
			Global_1272170->f_4 = { func_106(923904168, func_153(bParam0), -740156546, bParam0) };
		}
	...
	else if (iVar0 == 3)
	{
		...
		{
			Global_1272170->f_16 = { func_106(923904168, func_153(bParam0), -740156546, 0) };
		}
		return Global_1272170->f_16;
	}
	return func_106(923904168, func_153(bParam0), -740156546, 0);
}
...
struct<4> func_156(bool bParam0)
{
	...
	if (iVar0 == 2 || iVar0 == 3)
	{
		...
		{
			Global_1272170->f_8 = { func_106(271701509, func_153(bParam0), 12999093, 0) };
		}
		return Global_1272170->f_8;
	}
	return func_106(271701509, func_153(bParam0), 12999093, 0);
}
...
int func_157(int iParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_211(iParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
bool func_158(var uParam0, var uParam1, bool bParam2, int iParam3, int iParam4, bool bParam5, bool bParam6, int iParam7)
{
	return func_212(&uParam0, iParam4, bParam5, bParam6, iParam7);
}
...
int func_161(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	if (bParam7)
	{
		...
		iVar0 = INVENTORY::_0xC97E0D2302382211(func_103(bParam6), &Var1, bParam8);
	}
	else
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_103(bParam6), iParam0, bParam8);
	}
	return iVar0;
}
...
var func_172(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)
{
	struct<4> Var0;
	struct<8> Var13;
	var uVar21;
...
int func_174(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = func_103(0);
	*iParam1 = { func_106(iParam0, func_154(0), iParam3, 0) };
	if (!INVENTORY::_0xB881CA836CC4B6D4(iParam1))
	{
		return 0;
	}
...
int func_176(int iParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		{
			return func_217(NETSHOPPING::_CASHINVENTORY_TRANSACTION_ADD_ITEM(iVar0, uParam1, 16), iVar0, uParam1);
		}
	}
	else
	{
		return func_218(NETSHOPPING::_CASHINVENTORY_TRANSACTION_FIRE_AND_FORGET_ITEM(iParam0, &iVar0, uParam1, 16), iVar0, uParam1);
	}
	return -1;
}
...
void func_180(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_191(char* sParam0, int iParam1, int iParam2, int iParam3, bool bParam4)
{
	*iParam1 = INVENTORY::_0x80D78BDC9D88EF07(func_103(bParam4), sParam0, iParam3, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
int func_197(int iParam0, bool bParam1)
{
	...
	Var0 = { func_229(iParam0, -1591664384, -1591664384, -1591664384, 0, 0, 0) };
	if (bParam1)
	{
		func_230(&Var0, func_154(0));
	}
	if (!func_231(&Var0, &iVar14, &uVar15, 0))
	{
		return 0;
	}
	func_193(iVar14);
...
void func_199(var uParam0)
{
	...
	if (func_232() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
...
void func_200(var uParam0, int iParam1, struct<14> Param2)
{
	int iVar0;
	struct<21> Var1;
...
int func_201(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_202(char* sParam0, char* sParam1, int iParam2)
{
...
int func_208(int iParam0, bool bParam1)
{
	if (!bParam1 || func_235())
	{
		return func_161(iParam0, func_153(1), -2015960939, 1, 1, 0);
	}
	return 0;
}
...
bool func_210()
{
	return (func_89(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_236(func_106(joaat("WARDROBE"), func_153(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_212(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)
{
...
void func_215(var uParam0, int iParam1, struct<17> Param2)
{
	int iVar0;
	struct<24> Var1;
...
int func_216(int iParam0, var uParam1)
{
	...
	{
		if (func_237(iVar0, 2048))
		{
			return 0;
		}
	}
	else if (func_237(iVar0, 8))
	{
		return 0;
	}
	else if (func_237(iVar0, 16))
	{
		return 0;
	}
	else if (func_237(iVar0, 65536))
	{
		return 0;
	}
	return 1;
...
int func_217(bool bParam0, int iParam1, var uParam2)
{
	if (bParam0)
	{
		if (NETSHOPPING::_CASHINVENTORY_TRANSACTION_CHECKOUT(iParam1))
		{
			func_238(iParam1, 1, 0, 0);
			return iParam1;
		}
	...
	func_238(iParam1, 2, 0, 0);
	return -1;
}

int func_218(bool bParam0, int iParam1, var uParam2)
{
	if (bParam0)
	{
		func_238(iParam1, 1, 0, 0);
...
struct<14> func_229(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)
{
	struct<14> Var0;
...
void func_230(var uParam0, struct<4> Param1)
{
...
int func_231(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_103(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_234(int iParam0, int iParam1)
{
	struct<5> Var0;

	Var0 = { func_246(iParam0) };
	return func_247(iParam0, iParam1, Var0, Var0.f_4);
}
...
int func_236(var uParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, int iParam6)
{
	return func_249(&uParam0, bParam4, bParam5, iParam6);
}
...
void func_238(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	func_250(iParam0, iParam1, iParam2, iParam3);
}
...
struct<5> func_246(int iParam0)
{
	...
	Var0 = { func_247(iParam0, joaat("CHARACTER"), func_209(), -1591664384) };
	Var0.f_4 = 1084182731;
	return Var0;
}

struct<4> func_247(int iParam0, int iParam1, var uParam2, int iParam3, var uParam4, var uParam5, bool bParam6)
{
	struct<4> Var0;
...
int func_249(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	struct<10> Var0;

	Var0.f_9 = -1591664384;
	if (func_251(iParam0, bParam1, &Var0, bParam2, iParam3))
	{
		return Var0.f_4;
	}
	return 0;
...
int func_251(int iParam0, bool bParam1, int iParam2, bool bParam3, int iParam4)
{
	var uVar0;
	...
	if (!func_212(&uVar0, iParam2, bParam3, 0, iParam4))
	{
		return 0;
	}
	return 1;
