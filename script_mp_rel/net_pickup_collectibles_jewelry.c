...
void func_1(var uParam0, struct<2> Param1, var uParam3)
{
	...
	while (iVar2 < 56)
	{
		...
		{
			case 0:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_MNSTN");
				break;
			case 1:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_PTRN_DMD");
				break;
			case 2:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_GLD_DMD");
				break;
			case 3:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_FRN_DMD");
				break;
			case 4:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_TRQ_MOT");
				break;
			case 5:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_TOP_WED");
				break;
			case 6:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_DMND_ONYX");
				break;
			case 7:
				uParam0->f_80[iVar2] = joaat("MP005_S_RNG_TRQ_GLD");
				break;
			case 8:
				uParam0->f_80[iVar2] = joaat("MP005_S_ERRNG_TRQ_STUD");
				break;
			case 9:
				uParam0->f_80[iVar2] = joaat("MP005_S_ERRNG_GLD_PRL");
				break;
			case 10:
				uParam0->f_80[iVar2] = joaat("MP005_S_BRCLT_GLD_BNGL");
				break;
			case 11:
				uParam0->f_80[iVar2] = joaat("MP005_S_BRCLT_EDW_PRL");
				break;
			case 12:
				uParam0->f_80[iVar2] = joaat("MP005_S_BRCLT_SAP");
				break;
			case 13:
				uParam0->f_80[iVar2] = joaat("MP005_S_BRCLT_DMD_GLD");
				break;
			case 14:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_PLT_TPZ");
				break;
			case 15:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_MTHR_PRL");
				break;
			case 16:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_GLD_LAV");
				break;
			case 17:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_PNT_POR");
				break;
			case 18:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_SLV_PRL");
				break;
			case 19:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_GLD_CROSS");
				break;
			case 20:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_ORI_PRL");
				break;
			default:
				uParam0->f_80[iVar2] = joaat("MP005_S_NKLC_ORI_PRL");
				break;
...
int func_46(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam2), iParam0, bParam3);
	}
	else
	{
...
int func_74(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_64(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
struct<4> func_76(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_64(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}
...
int func_82(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_90(iParam0, &uVar0, iParam1, iParam2))
	{
...
int func_84(int iParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_91(iParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
bool func_88()
{
	return (func_93(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_94(func_76(joaat("WARDROBE"), func_79(1), 1034665895, 1), -234132662, 1, -1) != 0);
}

int func_89(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_64(bParam6), iParam0, bParam8);
	}
	return iVar0;
}
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)
{
	...
	iVar0 = func_64(0);
	*iParam1 = { func_76(iParam0, func_72(0), iParam3, 0) };
...
int func_93(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	if (func_95(iParam0) && !bParam2)
	{
		return WEAPON::GET_PED_AMMO_BY_TYPE(Global_34, iParam0);
	}
	return INVENTORY::_0xE787F05DFC977BDE(func_64(bParam1), iParam0, bParam3);
}
