...
int func_24(bool bParam0)
{
	...
	if (WEAPON::_0x9E2D5D6BC97A5F1E(Global_34, joaat("WEAPON_THROWN_POISONBOTTLE"), 500))
	{
		return 1;
	}
...
{
	return func_260(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
