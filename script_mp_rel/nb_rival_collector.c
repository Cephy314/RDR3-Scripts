...
int func_109()
{
	...
	iVar0 = func_177(0);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar0) || (ENTITY::IS_ENTITY_DEAD(iVar0) && ENTITY::_GET_IS_LOOTED(iVar0)))
	{
		return 1;
	}
	return 0;
...
int func_173()
{
	...
	iVar0 = func_177(0);
	if (!ENTITY::DOES_ENTITY_EXIST(iVar0) || ((ENTITY::IS_ENTITY_DEAD(iVar0) && !PED::GET_PED_CONFIG_FLAG(iVar0, 11, true)) && ENTITY::_GET_IS_LOOTED(iVar0)))
	{
		return 1;
	}
	return 0;
...
int func_186(int iParam0, int iParam1)
{
	...
	Var0 = { func_215(iParam0, joaat("LAST_INTERACTION_TIMESTAMP")) };
...
void func_193()
{
	...
	{
		func_221(805, 0);
		func_222(joaat("PERSONA_HONOR_ACTION__NB_RIVAL_COLLECTOR_KILL"), PLAYER::GET_PLAYER_INDEX());
		func_217(4);
	}
	if (func_223(Global_34) == func_224(iVar0) && !func_220(8))
	{
		func_225();
		func_222(joaat("PERSONA_HONOR_ACTION__NB_RIVAL_COLLECTOR_LOOT"), PLAYER::GET_PLAYER_INDEX());
		func_217(8);
	}
}
...
void func_274(int iParam0)
{
	...
	if (iVar19 != 0)
	{
		Var20 = { func_333(joaat("MP_FETCH_LAST_ATTEMPTED_DYNAMIC_MISSION_UNLOCK")) };
		STATS::STAT_ID_SET_INT(&Var20, iVar19, true);
		Var20 = { func_333(joaat("MP_FETCH_LAST_ATTEMPTED_DYNAMIC_MISSION_TIMESTAMP")) };
		STATS::STAT_ID_SET_INT(&Var20, Global_1275573->f_21, true);
	}
	iVar22 = Var2.f_9;
	if (iVar22 != 0)
	{
		Var23 = { func_333(joaat("MP_FETCH_LAST_ATTEMPTED_COOLDOWN_TAG_ID")) };
		STATS::STAT_ID_SET_INT(&Var23, iVar22, true);
		Var23 = { func_333(joaat("MP_FETCH_LAST_ATTEMPTED_COOLDOWN_TAG_TIMESTAMP")) };
...
void func_282(int iParam0, int iParam1)
{
	...
	Var17 = { func_215(iParam0, joaat("VARIATIONS_SEEN")) };
...
void func_284(int iParam0)
{
	...
	Var0 = { func_215(iParam0, joaat("NUM_TIMES_SEEN")) };
...
int func_299(int iParam0, bool bParam1, bool bParam2, bool bParam3, int iParam4, bool bParam5)
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (bParam3)
	{
		if (((WEAPON::_0xCB690F680A3EA971(iVar0, 1) && PLAYER::IS_PLAYER_TARGETTING_ENTITY(iVar1, iParam0, bParam5)) && PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(iVar1, iParam0)) && func_318(iVar0, iParam0, 1, 1) <= 4f)
		{
			return 1;
		}
	}
...
int func_316(int iParam0, int iParam1)
{
	...
	if (!WEAPON::_0x6E4E1A82081EABED(func_360(iParam0, 1, 0, 0)) && !func_360(iParam0, 1, 0, 0) == joaat("WEAPON_THROWN_BOLAS"))
	{
		return 0;
	}
...
void func_335(int iParam0)
{
	...
	Var1 = { func_215(iParam0, joaat("LAST_INTERACTION_TIMESTAMP")) };
...
void func_338(int iParam0, int iParam1)
{
	...
	Var0 = { func_215(iParam1, joaat("CHARACTER_MEMORY")) };
	if (!STATS::STAT_ID_GET_INT(&Var0, &iVar2))
	{
		return;
	}
