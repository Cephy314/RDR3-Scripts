...
int func_13()
{
	iLocal_13 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(1880f, -1860f, 35f, 0f, 0f, 0f, 75f, 75f, 20f, "Shady Belle - volTown");
	return 1;
}
...
int func_17(int iParam0)
{
	...
	{
		iLocal_14 = AUDIO::_0x0556C784FA056628("shady_belle", "es_camp_memory_sounds");
