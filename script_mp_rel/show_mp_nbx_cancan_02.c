	...
	else
	{
		switch (iParam9)
		{
			...
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_223());
				break;
			case joaat("VOLBOX"):
...
int func_230(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_233(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_234())
	{
		return func_233(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_233(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
