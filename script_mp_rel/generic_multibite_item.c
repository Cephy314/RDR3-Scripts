...
void func_16(float fParam0, bool bParam1)
{
	...
	if (func_33())
	{
		...
		if (iVar1 != iVar2)
		{
			Global_1954472->f_1331.f_107 = func_35();
			func_36(&(Global_1954472->f_1331.f_107), 0, 0, 1, 0, 0, 0, 0);
		}
...
void func_19(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1934214136: /* GXTEntry: "Drunkard\'s Lunch" */
			func_41(1614000521, joaat("CONSUMABLE__DAILY_STEW"), 8100);
			break;
	}
}

void func_20(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	if (bParam2 || func_8(iParam0, -537818634))
	{
...
int func_33()
{
	...
	return func_62(Global_1954472->f_1331.f_107, 0);
}
...
int func_40(int iParam0, float fParam1, bool bParam2, int iParam3)
{
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			func_79(joaat("STATUS_EFFECT__TRACKING"));
			func_80(-1);
			ATTRIBUTE::_0xF6A7C08DF2E28B28(iVar1, iParam0, fParam1, iParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_79(joaat("STATUS_EFFECT__POISON"));
			func_82(0, 1, 1);
			ATTRIBUTE::_0xF6A7C08DF2E28B28(iVar1, iParam0, fParam1, iParam3);
...
void func_45(int iParam0, int iParam1)
{
	...
	Var0 = { func_46(joaat("EATEN"), func_91(iParam0)) };
	STATS::_0x6A0184E904CDF25E(&Var0, iParam1);
	func_43(func_92(joaat("HERBS_EATEN")), iParam1);
}
...
void func_48(int iParam0, int iParam1)
{
	...
	if (func_47() == 0)
	{
		iVar0 = func_93(iParam0, -949239683);
		...
		if (((func_8(iParam0, joaat("CI_TAG_ITEM_MEAT_ANIMAL")) || func_8(iParam0, -839724752)) || func_8(iParam0, 1264218912)) || iParam0 == joaat("CONSUMABLE_OFFAL"))
		{
...
int func_58(int iParam0, int iParam1, float fParam2)
{
	...
	ATTRIBUTE::_SET_ATTRIBUTE_CORE_VALUE(iParam0, func_98(iParam1), BUILTIN::CEIL(fParam2));
	return 1;
}
...
int func_74(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	{
		if (!func_114(iParam0, 262144) || !Global_1904613->f_8198)
		{
			return 0;
		}
	}
...
bool func_87(int iParam0)
{
	...
	return &Global_1140484->f_30603.f_847[func_117(iParam0, 1) /*12*/] == -1;
}
...
int func_88(int iParam0)
{
	...
	iVar0 = func_117(iParam0, 1);
	if (!func_84(&(Global_1140484->f_30603.f_847[iVar0 /*12*/])))
	{
		return 1;
	}
	iVar3 = func_118(&(Global_1140484->f_30603.f_847[iVar0 /*12*/]), 1);
	iVar4 = 0;
		...
		switch (func_119(iParam0, iVar1))
		{
			...
			case 1:
				...
				while (iVar5 < Global_1140484->f_30603.f_10924)
				{
					...
					{
						func_120(iVar1, iParam0, iVar4);
						func_121(Global_1140484->f_30603.f_8871[iVar5 /*3*/]);
						...
						*(Global_1140484->f_30603.f_8871[iVar5 /*3*/]) = { *(Global_1140484->f_30603.f_8871[Global_1140484->f_30603.f_10924 /*3*/]) };
						func_121(Global_1140484->f_30603.f_8871[Global_1140484->f_30603.f_10924 /*3*/]);
					}
					else
					{
						iVar5++;
			...
			func_125(Global_1140484->f_30603.f_847[iVar0 /*12*/]);
			return 1;
		}
...
{
	return func_133(&(Global_1954472->f_1465), iParam0, 1);
}
...
int func_120(int iParam0, int iParam1, int iParam2)
{
	...
	if (func_139(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/])) && func_140(iParam0, (Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4))
	{
		vVar1 = { func_141((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4) };
		if (func_142(vVar1))
		{
			if (func_143(vVar1.x, vVar1.y, vVar1.z))
			{
				func_144((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4, vVar1.x, vVar1.y, vVar1.z);
			}
			else
			{
				func_145((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4);
			}
		}
		else
		{
...
int func_127(int iParam0, int iParam1, int iParam2)
{
	...
	bVar1 = func_139(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/]));
	if (bVar1 && func_147((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4))
	{
		vVar2 = { func_148((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4) };
	...
	if (func_143(iParam0, iParam1, iParam2))
	{
		if (bVar1)
		{
			func_144((Global_1140484->f_30603.f_2900[iVar0 /*31*/])->f_4, iParam0, iParam1, iParam2);
		}
		return 1;
	}
	return 0;
...
int func_138(int iParam0, int iParam1, int iParam2)
{
	...
	iVar2 = func_118(&(Global_1140484->f_30603.f_847[iVar0 /*12*/]), 1);
	...
	while (iVar4 < (Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_16)
	{
		...
		else
		{
			...
			(Global_1140484->f_2001[iVar5 /*192*/])->f_188 = ((Global_1140484->f_2001[iVar5 /*192*/])->f_188 - func_151((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_6[iVar4 /*3*/]));
			func_152(iVar3);
		}
		iVar4++;
	}
...
int func_143(int iParam0, int iParam1, int iParam2)
{
	...
	while (iVar7 < (Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_28)
	{
		...
		else if (!func_160((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_17[iVar7 /*2*/]))
		{
		}
		else
		{
	...
	func_162((Global_1140484->f_30603.f_2900[iVar1 /*31*/])->f_2);
	return 1;
}
...
void func_152(int iParam0)
{
	...
	iVar0 = func_149(iParam0, 1);
	if (!func_165(&(Global_1140484->f_2001[iVar0 /*192*/])))
	{
		return;
	}
	...
	if (!func_166((Global_1140484->f_2001[iVar0 /*192*/])->f_190))
	{
		return;
	}
	iVar1 = func_167((Global_1140484->f_2001[iVar0 /*192*/])->f_190, 1);
...
int func_158(int iParam0)
{
	...
	{
		iVar64 = func_122(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/]), 1);
		...
		else if (!func_174(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/]), (Global_1140484->f_30603.f_8871[iVar65 /*3*/])->f_1))
		{
		}
		else
		{
			Var1 = { func_175(&(Global_1140484->f_30603.f_8871[iVar65 /*3*/])) };
...
int func_174(int iParam0, int iParam1)
{
	...
	if (func_139(*(Global_1140484->f_30603.f_2900[iVar0 /*31*/])))
	{
		iVar3 = &Global_1140484->f_30603.f_8667[func_157(iVar2, 1) /*3*/];
		Var4 = { func_175(iVar3) };
	...
	switch (&Global_1140484->f_30603.f_2900[iVar0 /*31*/])
	{
		...
		case joaat("ALLY_ENTER_DEADEYE"):
			...
			if (iVar1 != &Global_1275573 && !func_185(&(Global_1275573->f_154[iVar1])))
			{
				return 0;
			}
