...
void __EntryFunction__()
{
	...
	func_5(&uLocal_44, joaat("COLLECTIBLE_EGG_SPOONBILL"), joaat("PROVISION_SPOONBILL_EGG"), joaat("MP005_S_BDEG_SPOONBILLNEST01X"), joaat("MP005_S_BDEG_SPOONBILL_EGG01X"), 9, 1);
		...
		case 4:
			...
			if (ENTITY::DOES_ENTITY_EXIST(iLocal_40))
			{
				if (!PLAYER::_0x0E6846476906C9DD(PLAYER::PLAYER_ID(), iLocal_40))
				{
					...
					MAP::_0x7563CBCA99253D1A(iLocal_40, joaat("BLIP_MP_ROLE_COLLECTOR_ILO"));
					func_35(uParam0, 5);
				}
			}
			break;
			...
			if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_26[0])))
			{
				if (!TASK::_0x0CCFE72B43C9CF96(&(iLocal_26[0])))
				{
					if (!uParam0->f_23)
					{
						...
						MAP::_0x7563CBCA99253D1A(&(iLocal_26[0]), joaat("BLIP_MP_ROLE_COLLECTOR_ILO"));
			...
			if (func_51(&iLocal_26, &iLocal_32, func_12(&(uParam0->f_3)), vLocal_18, 5f) > 0)
			{
				...
				while (iVar1 < func_12(&(uParam0->f_3)))
				{
					if (ENTITY::DOES_ENTITY_EXIST(&(iLocal_26[iVar1])))
					{
						...
						MAP::_0x7563CBCA99253D1A(&(iLocal_26[iVar1]), joaat("BLIP_MP_ROLE_COLLECTOR_ILO"));
					}
					iVar1++;
				}
			}
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_69(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != joaat("WEAPON_KIT_METAL_DETECTOR"))
						{
...
void func_40(var uParam0)
{
	...
	while (iVar0 < 5)
	{
		...
		{
			case joaat("PROVISION_VULTURE_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_VULTURE_EGG01X");
				break;
			case joaat("PROVISION_LOON_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_LOON_EGG01X");
				break;
			case joaat("PROVISION_DUCK_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_DUCK_EGG01X");
				break;
			case joaat("PROVISION_GOOSE_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_GOOSE_EGG01X");
				break;
			case joaat("PROVISION_EAGLE_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_EAGLENEST01X");
				break;
			case joaat("PROVISION_EGRET_EGG"):
			...
			case joaat("PROVISION_CONDOR_EGG"):
				...
				break;
			case joaat("PROVISION_HERON_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_HERONNEST01X");
				break;
			case joaat("PROVISION_SPOONBILL_EGG"):
				iLocal_32[iVar0] = joaat("MP005_S_BDEG_SPOONBILLNEST01X");
				break;
		}
		iVar0++;
	}
...
int func_78(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)
{
	var uVar0;
	int iVar1;
	bool bVar2;
...
struct<4> func_91(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_134(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}
...
int func_98(int iParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_138(iParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
int func_107(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_134(bParam6), iParam0, bParam8);
	}
	return iVar0;
}
...
int func_110(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_134(bParam2), iParam0, bParam3);
	}
	else
	{
...
bool func_136()
{
	return (func_159(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_160(func_91(joaat("WARDROBE"), func_89(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_159(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_134(bParam1), iParam0, bParam3);
}
...
int func_165(var uParam0, int iParam1, int iParam2, bool bParam3)
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_134(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
