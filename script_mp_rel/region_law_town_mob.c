...
void func_13()
{
	...
	while (iVar0 < iLocal_50)
	{
		...
		if (func_5(&(iLocal_50[iVar0]), 0))
		{
			...
			MAP::_0x662D364ABF16DE2F(iVar4, joaat("BLIP_MODIFIER_ENEMY_DISAPPEARING"));
			MAP::_0x662D364ABF16DE2F(iVar4, joaat("BLIP_MODIFIER_TOWN_POSSE_MEMBER"));
...
void func_16(int iParam0)
{
	...
	TASK::TASK_SMART_FLEE_PED(iParam0, Global_34, 500f, -1, 0, 3f, 0);
	func_30(iParam0);
