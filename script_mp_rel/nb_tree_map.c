...
void func_41()
{
	...
	iVar0 = (Global_1186267->f_231.f_1066[Local_107.f_12 /*17*/])->f_5;
...
int func_114()
{
	...
	STREAMING::_0x19A6BE7D9C6884D3(joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X"), 15, 0, 0);
	if (!STREAMING::_0x9427C94D2E4094A4(joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X"), 0))
	{
		iVar1 = 0;
	}
	iVar2 = 0;
...
bool func_119()
{
	if (!TASK::_DOES_SCENARIO_POINT_EXIST(Local_107.f_18.f_4))
	{
		Local_107.f_18.f_4 = TASK::CREATE_SCENARIO_POINT(joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X"), Local_107.f_15, func_177(), 0, 0, 0);
	}
	return TASK::_DOES_SCENARIO_POINT_EXIST(Local_107.f_18.f_4);
}
...
void func_178(struct<2> Param0)
{
	...
	{
		STATS::_0x99230691875FC218(func_190(Param0), func_192(Param0), Global_35);
	}
}
...
int func_180(int iParam0, int iParam1)
{
	...
	Var0 = { func_209(iParam0, joaat("LAST_INTERACTION_TIMESTAMP")) };
...
void func_188()
{
	...
	if (PED::_0x34D6AC1157C8226C(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X")) && ENTITY::HAS_ANIM_EVENT_FIRED(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), joaat("ATTACH")))
	{
		func_212(1);
		func_213(1);
	}
...
void func_189()
{
	...
	if (func_214(1))
	{
		if (!PED::_0x34D6AC1157C8226C(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X")) && !func_215())
		{
...
{
	func_242(iParam0, func_241(4, 117));
}
...
void func_235(int iParam0, int iParam1)
{
	...
	Var17 = { func_209(iParam0, joaat("VARIATIONS_SEEN")) };
...
void func_237(int iParam0)
{
	...
	if (func_93(Global_1245803[iParam0 /*4*/]))
	{
		return;
	}
	...
	func_94((*Global_1245803)[iParam0 /*4*/]);
	iVar19 = Var2.f_5;
	if (iVar19 != 0)
	{
		Var20 = { func_252(joaat("MP_FETCH_LAST_ATTEMPTED_DYNAMIC_MISSION_UNLOCK")) };
		STATS::STAT_ID_SET_INT(&Var20, iVar19, true);
		Var20 = { func_252(joaat("MP_FETCH_LAST_ATTEMPTED_DYNAMIC_MISSION_TIMESTAMP")) };
		STATS::STAT_ID_SET_INT(&Var20, Global_1275573->f_21, true);
	}
	iVar22 = Var2.f_9;
	if (iVar22 != 0)
	{
		Var23 = { func_252(joaat("MP_FETCH_LAST_ATTEMPTED_COOLDOWN_TAG_ID")) };
		STATS::STAT_ID_SET_INT(&Var23, iVar22, true);
		Var23 = { func_252(joaat("MP_FETCH_LAST_ATTEMPTED_COOLDOWN_TAG_TIMESTAMP")) };
...
void func_240(int iParam0)
{
	...
	Var0 = { func_209(iParam0, joaat("NUM_TIMES_SEEN")) };
	STATS::_0x6A0184E904CDF25E(&Var0, 1);
}

var func_241(int iParam0, int iParam1)
{
	return func_254(0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, 0f, joaat("VOLCYLINDER"), iParam0, iParam1);
}
...
int func_244(int iParam0, int iParam1)
{
	...
	Var4.f_1 = 10;
	func_256(&Var4, joaat("LOOT_TYPE_NORMAL"));
...
void func_250(int iParam0)
{
	...
	Var1 = { func_209(iParam0, joaat("LAST_INTERACTION_TIMESTAMP")) };
...
{
	func_256(uParam0, joaat("MULTIPLAYER_GAME"));
	if (func_275() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_256(uParam0, joaat("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_256(uParam0, joaat("LOOTER_PED_IS_FEMALE"));
	}
}
...
int func_272(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_284(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_285())
	{
		return func_284(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_284(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
