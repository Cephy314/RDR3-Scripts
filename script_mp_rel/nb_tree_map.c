...
void func_189()
{
	...
	if (func_214(1))
	{
		if (!PED::_IS_PED_USING_SCENARIO_HASH(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), joaat("WORLD_PLAYER_INSPECT_MAP_144CM_W48_8_H32_2_FOLDVERTICALHORIZONTAL_S_TWOFOLDMAP01X")) && !func_215())
		{
