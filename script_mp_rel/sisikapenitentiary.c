...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_68(&Global_1939178, 32768)) || func_68(&Global_1939178, 16777216))
	{
		return;
	}
...
void func_66(int iParam0, int iParam1, bool bParam2, bool bParam3)
{
	...
	if (!ENTITY::IS_ENTITY_DEAD(Global_1275573->f_8))
	{
		...
		func_101(&Var0, &(Global_1099294->f_267));
...
void func_67(int iParam0, bool bParam1)
{
	...
	func_107(Var30.f_6, Var30, -1082130432 /* Float: -1f */, -1082130432 /* Float: -1f */, 1, 1, 1);
	if (bParam1)
	{
		func_106(0);
	}
...
bool func_70()
{
	return func_68(&Global_1939178, 8192);
}
...
void func_75(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	Global_1938085->f_145 = func_123(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
int func_102(var uParam0, bool bParam1, bool bParam2)
{
	...
	else
	{
		...
		if (func_146(iVar0, iVar6, uParam0, bParam1))
		{
			return 1;
		}
	}
...
{
	if (func_147(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_154(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_107(vector3 vParam0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, float fParam8)
{
	...
	iVar3 = iParam3;
	if (!func_102(&vVar0, &iVar3, 1))
	{
		vVar0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), false, false) };
		iVar3 = iParam3;
	}
	func_155(vParam0, iParam3, vVar0, iVar3, iParam4, iParam5, iParam6, iParam7, fParam8, 1);
}
...
char* func_110(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	...
	{
		sVar0 = func_161(func_160(Global_35));
	}
...
{
	func_166((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_167((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_129(int iParam0)
{
	...
	if (func_93((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_169((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_170((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_171((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_174(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
void func_136(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_174(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
int func_142(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_189(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_190())
	{
		return func_189(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_189(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
...
int func_146(int iParam0, int iParam1, var uParam2, bool bParam3)
{
	struct<5> Var0;
...
void func_155(vector3 vParam0, int iParam3, vector3 vParam4, int iParam7, float fParam8, float fParam9, bool bParam10, int iParam11, float fParam12, int iParam13)
{
	if (func_148(255) == 4)
	{
		return;
...
{
	func_206(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
{
	return func_98((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_194(var uParam0, var uParam1)
{
	...
	{
		case 3:
			return func_193(PED::_GET_HORSE_RIDER(uParam0->f_2, false), uParam1);
		case 4:
...
int func_203(vector3 vParam0, int iParam3)
{
	...
	func_228(iParam3, &vVar0, &Var3, &uVar6);
	if (func_229(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
