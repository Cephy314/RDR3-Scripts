...
void func_22(var uParam0, var uParam1, bool bParam2)
{
	...
	if (bParam2)
	{
		...
		Var8.f_4 = 103;
		func_74(Var8, func_73(Global_35, 0f, 0f, 0f, 300f, 300f, 300f, joaat("VOLSPHERE"), 0, 8), 0, 0);
	}
	func_75(&Var1, &uVar0);
}
			...
			if (fVar1 < fVar2)
			{
				if (bParam5)
				{
					if (AUDIO::_0xD9130842D7226045("RDRO_Collectible_Sounds_Travelling_Saleswoman", 0))
					{
						...
						if (func_56(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) != joaat("WEAPON_KIT_METAL_DETECTOR"))
						{
...
int func_45(var uParam0, float fParam1)
{
	if (func_82(joaat("KIT_COLLECTOR_SPADE"), 1))
	{
		...
		if (func_9(uParam0, 2))
		{
			if (func_56(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), 0, 1, 0) == joaat("WEAPON_KIT_METAL_DETECTOR") && func_54(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), uParam0->f_6, 1) <= 1.6f)
			{
				return 1;
			}
		}
...
bool func_104(int iParam0, var uParam1)
{
	...
	Var0.f_1 = 10;
	func_132(&Var0, joaat("LOOT_TYPE_NORMAL"));
...
int func_123(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_150(bParam2), iParam0, bParam3);
	}
	else
	{
...
struct<4> func_156(int iParam0, var uParam1, int iParam2, bool bParam3, var uParam4, bool bParam5, bool bParam6)
{
	struct<4> Var0;
	...
	INVENTORY::_0x886DFD3E185C8A89(func_150(bParam6), &uParam1, iParam0, bParam5, &Var0);
	return Var0;
}
...
int func_166(int iParam0, struct<4> Param1, int iParam5, bool bParam6, bool bParam7, bool bParam8)
{
	int iVar0;
	struct<4> Var1;
	...
	{
		iVar0 = INVENTORY::_0xE787F05DFC977BDE(func_150(bParam6), iParam0, bParam8);
	}
	return iVar0;
}
...
{
	func_132(uParam0, joaat("MULTIPLAYER_GAME"));
	if (func_184() == joaat("MPC_PLAYER_TYPE_MP_MALE"))
	{
		func_132(uParam0, joaat("LOOTER_PED_IS_MALE"));
	}
	else
	{
		func_132(uParam0, joaat("LOOTER_PED_IS_FEMALE"));
	}
}
...
{
	*iParam1 = INVENTORY::_0x640F890C3E5A3FFD(func_150(bParam3), uParam0, iParam2);
	if (*iParam1 >= 0)
	{
		return 1;
	}
...
bool func_183()
{
	return (func_190(joaat("UPGRADE_OFFHAND_HOLSTER"), 0, 0, 0) > 0 && func_191(func_156(joaat("WARDROBE"), func_130(1), 1034665895, 1), -234132662, 1, -1) != 0);
}
...
int func_188(int iParam0, int iParam1)
{
	...
	while (iVar2 < iVar3)
	{
		...
		{
			if (func_192(iParam0, iParam1, bVar0))
			{
				return 1;
			}
		}
...
int func_190(int iParam0, bool bParam1, bool bParam2, bool bParam3)
{
	...
	return INVENTORY::_0xE787F05DFC977BDE(func_150(bParam1), iParam0, bParam3);
}
