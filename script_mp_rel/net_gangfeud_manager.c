...
void func_62()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(Global_1266395->f_40[iVar0]), func_90(0), false);
		}
		iVar0++;
	}
}
...
void func_63()
{
	...
	while (iVar0 <= 31)
	{
		...
		{
			DATABINDING::_DATABINDING_WRITE_DATA_BOOL_FROM_PARENT(&(Global_1266395->f_40[iVar0]), func_90(0), true);
		}
		iVar0++;
	}
}
