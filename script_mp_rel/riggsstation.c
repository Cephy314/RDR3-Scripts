...
{
	func_58(2, iLocal_21, iParam0, iLocal_22, iLocal_23, 1277952, 0, 0, -1082130432 /* Float: -1f */, 0);
	func_59(2, 1217836331, 0, 0);
	func_60(2, 0);
}

void func_30(int iParam0)
{
	func_61(795, iLocal_21, 1);
}
...
{
	func_65(28, iLocal_21, &uLocal_24);
	return 1;
}
...
void func_41(var uParam0, int iParam1)
{
	...
	if ((BUILTIN::VDIST(Global_35, 0f, 0f, 0f) <= 5f || func_66(&Global_1939178, 32768)) || func_66(&Global_1939178, 16777216))
	{
		return;
	}
...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_Travel"), joaat("MPAC_Travel_012")))
		{
			switch (iLocal_28)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_79(iLocal_28, 0), 1);
					break;
			}
		}
		if (func_10(func_72()))
	...
	else if (func_45() == -1)
	{
		func_83(iLocal_28);
		func_84(iLocal_28);
		if (!func_85(iLocal_28, 0))
		{
			return 0;
		}
	}
	else if (!func_86(iLocal_28))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
int func_53(int iParam0, int iParam1, int iParam2, bool bParam3)
{
	...
	if (func_90(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if ((!func_88(iParam0) || func_89(iParam0)) || func_92(&Global_1896608))
			{
				func_93(&Global_1896608, 0);
			}
...
void func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, float fParam8, int iParam9)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_18 = func_99(iParam2, iParam0);
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_64 = func_100((Global_1051388->f_69[iParam0 /*76*/])->f_18);
...
void func_59(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	...
	(Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0] = func_105(iParam1, 0, 0);
	if (func_106(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
	{
		if (!func_107(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0])))
		{
			func_108(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar0]), 0, fParam2, bParam3, 1, 0, 0, 0);
		}
	}
...
int func_60(int iParam0, bool bParam1)
{
	...
	if ((func_109(iParam0, 16384) || func_109(iParam0, 32768)) || func_110((Global_1051388->f_69[iParam0 /*76*/])->f_3))
	{
	...
	iVar0 = func_99(func_111(), iParam0);
	if ((!bParam1 && func_112(iVar0, &iVar1, &uVar2, &vVar3)) || (bParam1 && func_113(iVar0, &iVar1, &uVar2, &vVar3)))
	{
		func_114(iParam0, iVar1, vVar3, uVar2, 0);
...
void func_65(int iParam0, int iParam1, var uParam2)
{
	if (!*uParam2)
	{
		if (func_119(Global_34, iParam1, 1, 0))
		{
			func_121(func_120(iParam0), 1);
			*uParam2 = 1;
		}
	}
	else if (!func_119(Global_34, iParam1, 1, 0))
	{
		*uParam2 = 0;
	}
}
...
bool func_68()
{
	return func_66(&Global_1939178, 8192);
}
...
bool func_70(int iParam0)
{
	...
	return ((((*Global_1887327)[iParam0 /*36*/])->f_21 == 1 || ((*Global_1887327)[iParam0 /*36*/])->f_21 == 2) && !func_122(iParam0));
}
...
void func_73(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, bool bParam5)
{
	...
	sVar1 = func_124(iParam0, iParam1, iParam2, iParam4, bParam5, bParam3, &bVar0);
	...
	if (func_125(iParam4))
	{
		iVar3 = func_127(iParam4);
	}
	if (bVar0 && bParam3)
	{
		sVar2 = func_129(func_128(iParam2));
	}
	else if ((func_130(iParam1, 2) || func_131(iParam4, 2)) && !Global_1893575->f_9)
	{
	...
	else if ((func_63(iParam0) && func_87(iParam0, 16777216)) && !Global_1893575->f_9)
	{
	...
	{
		iVar4 = func_133(func_132());
		iVar5 = func_134(func_132());
		if (iVar5 < 10)
		{
		...
		if (!MISC::_SHOULD_USE_24_HOUR_CLOCK())
		{
			...
			{
				fVar7 = func_135(fVar7);
				sVar8 = "TIME_AND_TEMP_F";
			}
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(674, sVar8, iVar4, func_136(&cVar6, joaat("COLOR_PURE_WHITE")), sVar9, func_136(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		else
		{
			...
			IntToString(&cVar10, BUILTIN::ROUND(fVar7), 8);
			sVar2 = MISC::_CREATE_VAR_STRING(162, sVar8, iVar4, func_136(&cVar6, joaat("COLOR_PURE_WHITE")), func_136(&cVar10, joaat("COLOR_PURE_WHITE")));
		}
		Global_1893575->f_9 = 0;
	}
	Global_1938085->f_145 = func_137(sVar1, sVar2, 4000, 0, 0, 0, 0, 1);
}
...
void func_75(int iParam0, bool bParam1)
{
	...
	func_21(iParam0, 32);
	func_139(Global_1939178, 16384);
	func_121(func_140(-1532769513, joaat("AREAS")), 1);
	switch (func_9(iParam0))
	{
		case 0:
		case 2:
		case 11:
			func_121(func_140(-1532769513, joaat("LOWLANDS_AREAS")), 1);
			break;
		case 1:
		case 5:
		case 6:
		case 7:
		case 12:
			func_121(func_140(-1532769513, joaat("MOUNTAIN_AREAS")), 1);
			break;
		case 3:
		case 10:
			func_121(func_140(-1532769513, joaat("FOOTHILLS_AREAS")), 1);
			break;
		case 4:
		case 9:
			func_121(func_140(-1532769513, joaat("PLAINS_AREAS")), 1);
			break;
		case 8:
			func_121(func_140(-1532769513, joaat("GUAMA_AREAS")), 1);
			break;
		case 13:
		case 14:
		case 15:
		case 16:
			func_121(func_140(-1532769513, joaat("NEW_AUSTIN_AREAS")), 1);
			break;
	}
	switch (iParam0)
	{
...
int func_85(int iParam0, bool bParam1)
{
	...
	if (func_90(iParam0, &iVar0, &iVar1, 0, 0))
	{
		...
		while (true)
		{
			if (!func_143(Global_1896608->f_1, 16))
			{
				func_144(Global_1896608->f_1, 0);
			}
			Global_1896608->f_1++;
			iVar2++;
...
void func_97(bool bParam0, bool bParam1)
{
	...
	if (func_110(ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID()), false, false)))
	{
		return;
	}
	if (!bParam0)
	...
	func_161(Global_1099294->f_516, 36);
	func_162(Global_1099294->f_555, 36);
}
...
void func_98(int iParam0)
{
	...
	else
	{
		...
		while (iVar2 < iVar3)
		{
			func_166(&((Global_1051388->f_69[iParam0 /*76*/])->f_32[iVar2]));
...
int func_100(int iParam0)
{
	...
	{
		Global_1051388->f_4360[iParam0] = func_173(iParam0);
	}
...
bool func_112(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_180(iParam0, "sHash", iParam1, "fHeading", bParam2, "vPos", uParam3);
}

bool func_113(int iParam0, int iParam1, bool bParam2, var uParam3)
{
	return func_180(iParam0, "sClosedHash", iParam1, "fClosedHeading", bParam2, "vClosedPos", uParam3);
}

void func_114(int iParam0, int iParam1, vector3 vParam2, var uParam5, bool bParam6)
{
	if (bParam6)
	{
		MISC::GET_GROUND_Z_FOR_3D_COORD(vParam2, &(vParam2.f_2), false);
	}
	(Global_1051388->f_69[iParam0 /*76*/])->f_6 = func_181(iParam1, vParam2, uParam5, 0, 0, 0);
...
bool func_115(int iParam0, bool bParam1)
{
	...
	if (bParam1 && !ENTITY::DOES_ENTITY_EXIST(func_182(iParam0)))
	{
		return false;
	}
...
bool func_119(int iParam0, int iParam1, bool bParam2, int iParam3)
{
...
struct<2> func_120(int iParam0)
{
	...
	return func_140(joaat("VISITED"), iVar0);
}
...
{
	if ((iParam0 == 22 || iParam0 == 39) && !func_184())
	{
		return 1;
	}
	if (iParam0 == 66)
...
char* func_124(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5, var uParam6)
{
	char* sVar0;

	if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Global_1893575->f_162)))
	{
		sVar0 = func_187(Global_1893575->f_162);
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0) && bParam4)
	{
		sVar0 = func_189(func_188(Global_35));
	}
	if (MISC::IS_STRING_NULL_OR_EMPTY(sVar0))
	{
		if (!func_190(iParam0) || func_191(44))
		{
			switch (iParam0)
			{
				case 2:
...
int func_127(int iParam0)
{
	...
	iVar0 = 0;
	Var1 = { func_192(PLAYER::PLAYER_ID()) };
...
char* func_136(char* sParam0, int iParam1)
{
	...
	return func_193(MISC::_CREATE_VAR_STRING(10, "LITERAL_STRING", sParam0), iParam1);
}

var func_137(char* sParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<4> Var0;
	vector3 vVar13;
	var uVar16;
...
{
	func_194((Global_1938942->f_5[iParam0 /*11*/])->f_6, 1);
	func_195((Global_1938942->f_5[iParam0 /*11*/])->f_6, 0);
...
void func_142(int iParam0)
{
	...
	if (func_91((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_197((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
		func_198((Global_1915180->f_3[iParam0 /*447*/])->f_21, 0, 1, 0, 0);
	}
	...
	func_199((Global_1915180->f_3[iParam0 /*447*/])->f_9, 0);
	...
	else
	{
		...
		while (iVar0 < iVar1)
		{
			func_166(&((Global_1915180->f_3[iParam0 /*447*/])->f_318[iVar0 /*6*/]));
...
{
	if (func_208(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
{
	if (func_215(&(Global_1099294->f_4), iParam0, 5))
	{
		return 1;
	}
	return 0;
...
void func_161(struct<29> Param0, var uParam29, int iParam30)
{
	switch (Param0.f_5)
	{
		case 1:
...
void func_162(struct<6> Param0, var uParam6, var uParam7, var uParam8, int iParam9)
{
	switch (Param0.f_5)
	{
		case 1:
...
{
	return func_217((Global_1051388->f_69[iParam0 /*76*/])->f_51, iParam1);
}
...
int func_173(int iParam0)
{
	...
	if (DATAFILE::_0x603AC35FD4602C76(Global_1132968->f_7) && !func_219(12, func_218(iParam0), &vVar0))
	{
		return 0;
	}
	return vVar0.z;
...
int func_180(int iParam0, char* sParam1, int iParam2, char* sParam3, bool bParam4, char* sParam5, var uParam6)
{
	struct<4> Var0;

	Var0 = func_220();
	Var0.f_2 = -738708473;
	Var0.f_3 = func_218(iParam0);
...
int func_181(int iParam0, vector3 vParam1, int iParam4, int iParam5, int iParam6, int iParam7)
{
...
char* func_187(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)
{
...
{
	func_228(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
void func_198(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)
{
	int iVar0;
	int iVar1;
	...
	if ((!bParam4 && !func_197(iParam0)) && func_229(iParam0))
	{
		return;
	}
	func_151(iParam0, 1);
...
int func_219(int iParam0, int iParam1, var uParam2)
{
	...
	if (func_240(iParam0, iParam1, &uVar0))
	{
		func_241(&uVar0, iParam0, uParam2);
	}
	else
	{
		return 0;
...
int func_225(vector3 vParam0, int iParam3)
{
	...
	func_244(iParam3, &vVar0, &Var3, &uVar6);
	if (func_245(vParam0, vVar0, Var3, Var3.f_1, uVar6))
	{
		return 1;
	}
	return 0;
...
bool func_245(vector3 vParam0, vector3 vParam3, float fParam6, float fParam7, float fParam8)
{
	vector3 vVar0;
	struct<2> Var3;
	float fVar6;
