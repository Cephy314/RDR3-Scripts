	...
	*iParam1 = 0;
	...
	if (func_66(iParam0))
	{
		...
		*iParam1 = func_78(iParam0);
		...
		iParam1->f_9 = PED::_GET_HORSE_RIDER(*iParam1, false);
...
void func_41(struct<4> Param0, var uParam4, var uParam5, var uParam6, struct<5> Param7, var uParam12, var uParam13, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, int iParam19)
{
	...
	iVar0 = PED::_GET_HORSE_RIDER(Param7, false);
...
void func_43(struct<5> Param0, var uParam5, var uParam6)
{
	...
	if (iVar0 == 2)
	{
		...
		if (vVar1.z)
		{
			...
			{
				iVar13 = PED::_GET_HORSE_RIDER(vVar1.x, false);
		...
		if (!bVar205)
		{
			if (!PED::_0x608BC6A6AACD5036(Global_1270530->f_1002.f_245[iVar207 /*4*/], iVar0, iVar191, 0))
			{
				...
				else
				{
					...
					if (!bVar205)
					{
						iVar212 = ENTITY::_GET_ENTITY_STATUS(iVar196);
						if (iVar212 != 7)
						{
							bVar205 = true;
					...
					if (!bVar205)
					{
						...
						Var1.f_3 = ENTITY::_GET_ENTITY_CARRY_CONFIG(iVar196);
					...
					else
					{
						if (STREAMING::IS_MODEL_A_PED(Var1))
						{
							...
							if (PED::_IS_METAPED_USING_COMPONENT(iVar198, 43391475) || ENTITY::_GET_IS_LOOTED(iVar196))
							{
								Var1.f_92 = 1;
							}
							else
							...
							Var1.f_94 = ENTITY::_GET_IS_BURNED(iVar196);
...
void func_61(int iParam0)
{
	...
	if (bVar1)
	{
		...
		if (iVar0 == PLAYER::_GET_SADDLE_HORSE_FOR_PLAYER(PLAYER::PLAYER_ID()) && bVar3)
		{
			...
			{
				((*Global_1903007)[iParam0 /*43*/])->f_26 = MAP::_BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_PLAYER_HORSE_SADDLE"), iVar0);
	...
	if (iVar17 != 0)
	{
		...
		{
			MAP::_0x662D364ABF16DE2F(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_COMPASS_OBJECTIVE"));
		}
	}
	if (iVar18 != 0)
	{
	...
	{
		MAP::_SET_BLIP_FLASH_STYLE(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_OVERLAY_SADDLE"));
	}
	...
	{
		MAP::_SET_BLIP_FLASH_STYLE(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_PLAYER_HORSE_HITCHED"));
		MAP::_SET_BLIP_FLASH_STYLE(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_TEMP_HORSE_HITCHED"));
	}
...
void func_62()
{
	...
	{
		Global_1903007->f_379.f_1 = MAP::_BLIP_ADD_FOR_ENTITY(joaat("BLIP_STYLE_PLAYER_HORSE_SADDLE"), iVar0);
...
void func_121()
{
	...
	bVar3 = ENTITY::HAS_ANIM_EVENT_FIRED(iVar2, joaat("BRUSHING"));
	if (bVar3)
	{
		if (!func_378())
		{
...
void func_123(int iParam0)
{
	...
	bVar3 = false;
	if (PED::_GET_HORSE_RIDER(iVar1, false) != Global_34)
	{
		bVar3 = true;
	}
	bVar4 = false;
...
void func_125(int iParam0)
{
	...
	bVar2 = PED::_GET_HORSE_RIDER(iVar1, false) == Global_34;
	if (!bVar2)
	{
		return;
	}
...
void func_207(struct<5> Param0, var uParam5, var uParam6)
{
	...
	MAP::_0x662D364ABF16DE2F(iVar4, joaat("BLIP_MODIFIER_URGENT_ALERT"));
	MAP::_0x662D364ABF16DE2F(iVar4, joaat("BLIP_MODIFIER_RADAR_EDGE_ALWAYS"));
	func_448(&iVar4);
}
...
void func_276(int iParam0)
{
	...
	PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(Global_34, iParam0, 0);
...
void func_314(int iParam0)
{
	...
	if (MAP::DOES_BLIP_EXIST(((*Global_1903007)[iParam0 /*43*/])->f_25))
	{
		if (((*Global_1903007)[iParam0 /*43*/])->f_24 == 2)
		{
			MAP::_SET_BLIP_FLASH_STYLE(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_PLAYER_HORSE_OUT_OF_RANGE_WHISTLE"));
			MAP::_0x662D364ABF16DE2F(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_PLAYER_HORSE_OUT_OF_RANGE_WHISTLE"));
		}
		else if (((*Global_1903007)[iParam0 /*43*/])->f_24 == 1)
		{
			MAP::_SET_BLIP_FLASH_STYLE(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_PLAYER_HORSE_IN_RANGE_WHISTLE"));
			MAP::_0x662D364ABF16DE2F(((*Global_1903007)[iParam0 /*43*/])->f_25, joaat("BLIP_MODIFIER_PLAYER_HORSE_IN_RANGE_WHISTLE"));
		}
	}
}
					...
					if ((iVar42 == 1 || iVar42 == 3) || iVar42 == 4)
					{
						...
						if (iVar56 != 0)
						{
							...
							if (!MAP::DOES_BLIP_EXIST(iVar57))
							{
								...
								MAP::_0x662D364ABF16DE2F(iVar57, joaat("BLIP_MODIFIER_PLAYER_HORSE_OUT_OF_RANGE"));
								if (iParam0 == 0)
								{
									func_553(&iVar57);
								}
...
void func_394(int iParam0)
{
	switch (iParam0)
	{
		...
		case 2:
			...
			{
				func_647("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_MANUAL_PAINT", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
		...
		case 3:
			...
			{
				func_647("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_STAY_ACTIVE", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
		...
		case 4:
			...
			{
				func_647("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_FATAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
		...
		case 5:
			...
			{
				func_647("DEADEYE_ABILITY_UNLOCK", "DEADEYE_ABILITY_CRITICAL", joaat("HUD_TOASTS"), joaat("TOAST_PLAYER_DEADEYE"), 8000, 0, 0, 0, 0, 1, 1);
			}
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 1, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 2, false);
			PLAYER::_SET_DEADEYE_ABILITY_LOCKED(PLAYER::GET_PLAYER_INDEX(), 3, false);
...
void func_531(int iParam0, var uParam1, int iParam2)
{
	...
	else if (STREAMING::IS_MODEL_A_PED(*uParam1))
	{
		...
		if (uParam1->f_92)
		{
			...
			ENTITY::_SET_IS_LOOTED(iVar7, true);
		}
		iVar8 = func_729(iParam2);
...
bool func_559(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)
{
	struct<7> Var0;
...
void func_565(int iParam0, bool bParam1)
{
	...
	iVar1 = PED::_GET_HORSE_RIDER(iVar0, false);
	iVar2 = PED::_GET_HORSE_RIDER(iVar0, true);
	if (iVar1 != iVar2)
	{
		return;
	}
...
void func_820(int iParam0, int iParam1)
{
	...
	func_647(sVar2, MISC::_CREATE_VAR_STRING(2, "HORSE_BONDING_LEVEL", iParam1), joaat("HUD_TOASTS"), joaat("TOAST_HORSE_BOND"), 8000, "HUD_Toast_Soundset", "horse_bonding", 0, 0, 1, 1);
}
...
int func_884(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (!ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
	...
	return func_932(iParam0, iParam1, fParam2, bParam3);
}
...
void func_901(int iParam0, int iParam1, float fParam2)
{
	...
	{
		ATTRIBUTE::_SET_ATTRIBUTE_OVERPOWER_AMOUNT(iParam0, iVar0, fParam2, false);
	}
}
...
int func_932(int iParam0, int iParam1, float fParam2, bool bParam3)
{
	if (iParam0 == Global_1275573->f_8)
	{
		return func_948(iParam1, fParam2, 1, bParam3);
	}
	if (fParam2 == -1f)
	{
		if (func_949(iParam1))
	...
	switch (iParam1)
	{
		case 0:
			...
			ATTRIBUTE::_SET_ATTRIBUTE_OVERPOWER_AMOUNT(iParam0, iParam1, fParam2, bParam3);
			break;
		case 1:
			func_950(iParam1, iParam0);
			ATTRIBUTE::_SET_ATTRIBUTE_OVERPOWER_AMOUNT(iParam0, iParam1, fParam2, bParam3);
...
void func_937(int iParam0, int iParam1)
{
	...
	func_647(sVar2, MISC::_CREATE_VAR_STRING(2, "HORSE_BONDING_LEVEL", iParam0), joaat("HUD_TOASTS"), joaat("TOAST_HORSE_BOND"), 8000, "HUD_Toast_Soundset", "horse_bonding", 0, 0, 1, 1);
}
...
int func_948(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	char* sVar0;
	int iVar1;
