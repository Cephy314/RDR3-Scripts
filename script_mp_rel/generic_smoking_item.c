...
int func_22(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	...
	return func_45(iParam0, fParam1, bParam2, bParam3);
}
...
void func_23(var uParam0)
{
	switch (*uParam0)
	{
		...
		case 1934214136: /* GXTEntry: "Drunkard\'s Lunch" */
			func_46(1614000521, joaat("CONSUMABLE__DAILY_STEW"), 8100);
			break;
	}
}
...
void func_24(int iParam0, bool bParam1, bool bParam2, int iParam3)
{
	...
	{
		func_48(func_47(joaat("PROVISION_ITEMS_USED")), 1);
	}
	...
	if (bParam1)
	{
		func_48(func_47(joaat("DEADEYE_ITEMS_USED")), 1);
	}
...
int func_45(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	char* sVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 1:
			...
			func_83(joaat("STATUS_EFFECT__TRACKING"));
			func_84(-1);
			ATTRIBUTE::_SET_ATTRIBUTE_OVERPOWER_AMOUNT(iVar1, iParam0, fParam1, bParam3);
		...
		case 2:
			...
			break;
		case 19:
			func_83(joaat("STATUS_EFFECT__POISON"));
			func_86(0, 1, 1);
			ATTRIBUTE::_SET_ATTRIBUTE_OVERPOWER_AMOUNT(iVar1, iParam0, fParam1, bParam3);
