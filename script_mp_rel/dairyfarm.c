...
int func_44(int iParam0)
{
	if (iParam0 == 0)
	{
		...
		if (STATS::CHAL_IS_GOAL_ACTIVE(joaat("MPAC_TRAVEL"), joaat("MPAC_TRAVEL_012")))
		{
			switch (iLocal_29)
			{
				...
				case 127:
				case 135:
					STATS::CHAL_ADD_GOAL_PROGRESS_INT_BY_SCORE_ID(func_75(iLocal_29, 0), 1);
					break;
			}
		}
		if (func_10(func_68()))
	...
	else if (func_45() == -1)
	{
		func_79(iLocal_29);
		func_80(iLocal_29);
		if (!func_81(iLocal_29, 0))
		{
			return 0;
		}
	}
	else if (!func_82(iLocal_29))
	{
		return 0;
	}
	SCRIPTS::TERMINATE_THIS_THREAD();
...
void func_92()
{
	...
	VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_127(755));
	VOLUME::_0x53D05D60E5F5B40C(iLocal_15, 3, 1, func_127(756));
}
...
void func_94(int iParam0)
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar1))
	{
		PED::_SET_PED_ACCESS_TO_HORSE_INTERACTION(iVar1, iParam0, 0);
	}
}
...
void func_117(int iParam0)
{
	...
	if (func_87((Global_1915180->f_3[iParam0 /*447*/])->f_21) && func_144((Global_1915180->f_3[iParam0 /*447*/])->f_21))
	{
...
{
	func_172(&((Global_1938942->f_5[iParam0 /*11*/])->f_7), iParam1);
}
...
bool func_164(int iParam0, bool bParam1)
{
	...
	return !PERSCHAR::_0xEB98B38CA60742D7(func_127(iParam0));
}
...
int func_165()
{
	...
	if (!func_167(*Global_1051163) && Global_1572887->f_7 & 1 != 0)
	{
		return 1;
	}
	return 0;
...
int func_169(vector3 vParam0, int iParam3)
{
	vector3 vVar0;
	struct<2> Var3;
	var uVar6;
