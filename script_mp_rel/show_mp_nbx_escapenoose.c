#region Local Var
	...
	struct<18> Local_1602[32];
	struct<2> Local_2179 = { 0, 0 } ;
	var uLocal_2181 = 6;
	var uLocal_2182 = 0;
	var uLocal_2183 = 0;
	var uLocal_2184 = 0;
...
void __EntryFunction__()
{
	...
	Local_2179.f_1 = NETWORK::PARTICIPANT_ID_TO_INT();
	while (!func_3(Local_1602[Local_2179.f_1 /*18*/]))
	{
		if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
		{
			func_4(&uLocal_18, &Local_1602, &Local_2179);
		}
		func_5(&uLocal_18, &Local_1602, &Local_2179);
		BUILTIN::WAIT(0);
	}
	if (NETWORK::NETWORK_IS_HOST_OF_THIS_SCRIPT())
	{
...
void func_1(int iParam0)
{
	...
	func_10(NETWORK::_0xBA24095EA96DFE17(&uLocal_18), 1584, "sHostData");
	NETWORK::NETWORK_REGISTER_PLAYER_BROADCAST_VARIABLES(&Local_1602, 577, 9);
	func_11(NETWORK::_0x690806BC83BC8CA2(Local_1602[0 /*18*/]), 577, "m_showClientStruct");
	func_12(0);
...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_OBJECTS((4 - NETWORK::GET_NUM_RESERVED_MISSION_OBJECTS(0)));
				return;
			}
...
int func_96(var uParam0)
{
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[0])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "NOOSE_STAND", &(uParam0->f_1393[0]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[1])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "JACKET", &(uParam0->f_1393[1]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[2])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "DIVIDER", &(uParam0->f_1393[2]), 0);
		}
		else
		{
			return 0;
	...
	if (!ENTITY::DOES_ENTITY_EXIST(&(uParam0->f_1393[3])))
	{
		...
		{
			ANIMSCENE::SET_ANIM_SCENE_ENTITY(iVar0, "Noose", &(uParam0->f_1393[3]), 0);
		}
		else
		{
			return 0;
	...
	if (!func_155(uParam0, iVar0, 0, "BENJAMIN_NO_JACKET"))
	{
		return 0;
	}
	if (!func_155(uParam0, iVar0, 1, "Assistant"))
	{
		return 0;
	}
...
int func_154(int iParam0, int iParam1, vector3 vParam2)
{
	if (!STREAMING::HAS_MODEL_LOADED(iParam1))
	{
		return 0;
	}
	if (!ENTITY::DOES_ENTITY_EXIST(*iParam0) && NETWORK::CAN_REGISTER_MISSION_OBJECTS(1))
	{
