...
void func_6()
{
	...
	switch (func_14())
	{
		case 0:
			if (func_15())
			{
				Local_18.f_30 = TASK::_GET_SCENARIO_POINT_PED_IS_ACTIVE(Local_18);
		...
		case 2:
			...
			if ((SCRIPTS::HAS_SCRIPT_LOADED(&(Local_18.f_25)) && TASK::IS_PED_ACTIVE_IN_SCENARIO(Local_18, 0)) && func_19())
			{
				...
				iLocal_77 = TASK::_GET_SCENARIO_PROPSET_ENTITY(Local_18.f_6, "Knife");
				iLocal_78 = TASK::_GET_SCENARIO_PROPSET_ENTITY(Local_18.f_6, "Head");
