...
void func_4(var uParam0, var uParam1, var uParam2)
{
	...
	switch (uParam0->f_1352)
	{
		...
		case 2:
			...
			{
				NETWORK::RESERVE_NETWORK_MISSION_PEDS((0 - NETWORK::GET_NUM_RESERVED_MISSION_PEDS(0)));
				return;
			}
			uParam0->f_25 = 0;
			func_20(uParam0, 3);
...
{
	if (!ANIMSCENE::_0x25557E324489393C(uParam0->f_1373))
	{
		return;
	}
}
...
void func_49(var uParam0, var uParam1)
{
	...
	while (iVar0 <= 2)
	{
		...
		{
			if (!func_127(uParam0->f_12[iVar0 /*3*/], uParam1->f_3[iVar0 /*3*/]))
			{
				func_128(uParam0->f_12[iVar0 /*3*/], uParam1->f_3[iVar0 /*3*/]);
			}
	...
	switch (*uParam1)
	{
		...
		case 3:
			if ((ANIMSCENE::_0x25557E324489393C(uParam0->f_9) && ANIMSCENE::_0x477122B8D05E7968(uParam0->f_9, 1, 0)) && NETWORK::_NETWORK_HAS_CONTROL_OF_ANIM_SCENE(uParam0->f_9))
			{
				...
				while (iVar0 <= (5 - 1))
				{
					ANIMSCENE::SET_ANIM_SCENE_ENTITY(uParam0->f_9, func_134(iParam2, iVar0), &(uParam0->f_3[iVar0]), 0);
					iVar0++;
				}
...
void func_123(int iParam0, bool bParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6, bool bParam7)
{
	func_153(iParam0, 0, 0);
	if (func_154(iParam0))
	{
		...
		if (bParam3)
		{
			func_158(iParam0, fParam2, 1, bParam6);
		}
		else if (bParam1)
		{
			if (bParam4)
...
int func_129(var uParam0, var uParam1, int iParam2)
{
	...
	if (!func_13(*uParam1, 1))
	{
		...
		{
			iVar3 = iVar0;
			if (func_167((*uParam0)[iVar0 /*5*/], func_165(iParam2), func_166(iParam2, iVar3), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 8))
	{
		...
		{
			iVar4 = iVar0;
			if (func_167(uParam0->f_31[iVar0 /*5*/], func_169(iParam2), func_170(iParam2, iVar4), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	if (!func_13(*uParam1, 2048))
	{
		...
		{
			iVar5 = iVar0;
			if (func_167(uParam0->f_107[iVar0 /*5*/], func_172(iParam2), func_173(iParam2, iVar5), 1065353216 /* Float: 1f */))
			{
				iVar2++;
			}
			iVar0++;
	...
	{
		case 0:
			if (!func_13(*uParam1, 64) && func_167(uParam0->f_118[0 /*5*/], func_174(iParam2, 0), func_175(iParam2, 0), 1065353216 /* Float: 1f */))
			{
				func_18(uParam1, 64);
			}
			if ((!func_13(*uParam1, 16384) && func_167(uParam0->f_118[1 /*5*/], func_174(iParam2, 1), func_175(iParam2, 1), 1065353216 /* Float: 1f */)) && func_167(uParam0->f_118[2 /*5*/], func_174(iParam2, 2), func_175(iParam2, 2), 1065353216 /* Float: 1f */))
			{
		...
		case 1:
			...
			if (!func_13(*uParam1, 2097152))
			{
				...
				{
					iVar6 = iVar0;
					if (func_167(uParam0->f_118[iVar0 /*5*/], func_174(iParam2, 0), func_175(iParam2, iVar6), 1065353216 /* Float: 1f */))
					{
						iVar2++;
					}
					iVar0++;
...
void func_130(var uParam0, var uParam1, int iParam2)
{
	...
	if (iParam2 == 0)
	{
		...
		{
			if (func_13(*uParam0, 128) && func_191(uParam1->f_118[0 /*5*/], func_189(uParam1), &(uParam1->f_238), func_190(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 128);
			}
			if (func_13(*uParam0, 256) && func_193(uParam1->f_118[0 /*5*/], func_192(uParam1), &(uParam1->f_238), func_190(uParam1), func_179(uParam1)))
			{
				func_14(uParam0, 256);
			}
			if (func_13(*uParam0, 512) && func_191(uParam1->f_118[0 /*5*/], func_189(uParam1), &(uParam1->f_238), 0.5f, func_179(uParam1)))
			{
				func_14(uParam0, 512);
			}
			if (func_13(*uParam0, 1024) && func_193(uParam1->f_118[0 /*5*/], func_192(uParam1), &(uParam1->f_238), 0.5f, func_179(uParam1)))
			{
...
int func_145(var uParam0)
{
	...
	if (uParam0->f_1561)
	{
		if (uParam0->f_1578 == 0)
		{
			uParam0->f_1578 = ENTITY::_0x6F3068258A499E52(uParam0->f_1575, uParam0->f_1571, 7);
		}
		else if (ENTITY::_0x1FF441D7954F8709(uParam0->f_1578))
		{
			uParam0->f_1577 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(ENTITY::_0x4735E2A4BB83D9DA(uParam0->f_1578));
		}
		if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1577))
		{
			return 0;
		...
		OBJECT::_0xF49574E2332A8F06(uParam0->f_1577, 0f);
		OBJECT::_0x04D1D4E411CE52D0(uParam0->f_1577, uParam0->f_1562);
	}
	HUD::SET_TEXT_RENDER_ID(uParam0->f_1562);
...
void func_158(int iParam0, float fParam1, bool bParam2, bool bParam3)
{
	if (func_154(iParam0))
	{
...
int func_167(var uParam0, int iParam1, vector3 vParam2, int iParam5)
{
	if (uParam0->f_1 == 0)
	{
...
int func_180(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	{
		func_213((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_182(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	int iVar0;
	float fVar1;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		func_214((*uParam0)[iVar0 /*5*/], fParam1, fVar1, fParam3, iParam4);
		iVar0++;
	}
	if (fVar1 >= fParam3)
	{
...
int func_193(var uParam0, float fParam1, var uParam2, float fParam3, int iParam4)
{
	float fVar0;
...
int func_196(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_213((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
...
int func_198(int iParam0, int iParam1, var uParam2, float fParam3, var uParam4, float fParam5, int iParam6)
{
	int iVar0;
	int iVar1;
	float fVar2;
	...
	while (iVar3 <= iVar1)
	{
		func_214((*uParam2)[iVar3 /*5*/], fParam3, fVar2, fParam5, iParam6);
		iVar3++;
	}
	if (fVar2 >= fParam5)
	{
	...
	else
	{
		switch (iParam9)
		{
			case joaat("VOLCYLINDER"):
				iVar8 = VOLUME::_CREATE_VOLUME_CYLINDER_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_217());
				break;
			case joaat("VOLSPHERE"):
				iVar8 = VOLUME::_CREATE_VOLUME_SPHERE_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_217());
				break;
			case joaat("VOLBOX"):
				iVar8 = VOLUME::_CREATE_VOLUME_BOX_WITH_CUSTOM_NAME(vParam0, vParam3, vParam6, func_217());
				break;
		}
	}
	if (iVar9 & 8 != 0)
	{
		iVar9 = (iVar9 || func_218(PLAYER::GET_PLAYER_TEAM(iVar5)));
	}
...
int func_223(int iParam0, int iParam1)
{
	...
	if (iParam1 == 255)
	{
		return func_226(&(Global_1099294->f_4), iVar0, 5);
	}
	if (iParam1 == func_227())
	{
		return func_226(&(Global_1099294->f_4), iVar0, 5);
	...
	{
		return func_226(&(((*Global_1097610)[iParam1 /*51*/])->f_4), iVar0, 5);
	}
	return 0;
}
