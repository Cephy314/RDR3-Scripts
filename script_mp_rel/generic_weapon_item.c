...
void __EntryFunction__()
{
	...
	while (func_4())
	{
		...
		switch (func_5())
		{
			...
			case 1:
				func_7();
				if (TASK::_0x6AA3DCA2C6F5EB6D(Global_34) == joaat("LONGARM_CLEAN_ENTER") || TASK::_0x6AA3DCA2C6F5EB6D(Global_34) == joaat("SHORTARM_CLEAN_ENTER"))
				{
			...
			case 2:
				...
				break;
			case 3:
				if (TASK::_0x6AA3DCA2C6F5EB6D(Global_34) == joaat("LONGARM_CLEAN_EXIT") || TASK::_0x6AA3DCA2C6F5EB6D(Global_34) == joaat("SHORTARM_CLEAN_EXIT"))
				{
					func_6(4);
				}
				else
...
void func_7()
{
	...
	iVar0 = ENTITY::GET_OBJECT_INDEX_FROM_ENTITY_INDEX(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Global_34, 0));
	if (func_22(joaat("KIT_GUN_OIL"), 1) && (WEAPON::_0x0D78E1097F89E637(iVar0) != 0f && WEAPON::_0x0D78E1097F89E637(iVar0) > WEAPON::_0xD56E5F336C675EFA(iVar0)))
	{
